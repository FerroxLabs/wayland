        ...
        <li key={i} className='flex gap-12px'>
          <span
            className={classNames(
              ...
              step.done ? 'bg-[var(--success)] text-white' : 'bg-[var(--color-bg-4)] text-[var(--color-text-3)]'
            )}
          >
          ...
          <div className='flex flex-col gap-2px'>
            ...
            {step.body && <div className='text-12px text-[var(--color-text-3)] leading-relaxed'>{step.body}</div>}
          </div>
        </li>
      ))}
    </ol>
