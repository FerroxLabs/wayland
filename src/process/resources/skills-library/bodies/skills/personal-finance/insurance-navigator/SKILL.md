...
- [ ] Financial strength rating of insurer (AM Best A or better)?
- [ ] Claims satisfaction ratings (J.D. Power, Consumer Reports)?
- [ ] Exclusions and limitations comparison?
- [ ] Discount eligibility with each insurer?
- [ ] Bundling potential?

## Filing Claims Effectively

### Preparation (Before You Need to File)
...
**Input:** "Help me get started with insurance navigator"

**Output:** A structured insurance navigator plan tailored to the user's specific situation, following the process outlined above.
