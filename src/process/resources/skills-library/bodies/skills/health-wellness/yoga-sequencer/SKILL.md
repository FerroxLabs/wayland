...
name: yoga-sequencer
description: |
  Yoga sequence builder with sequence design by level and goal, pose library with Sanskrit names, pranayama breathing exercises, sun salutation variations, class duration templates, modifications and props, and contraindications for safe practice.
  Use when the user asks about yoga sequencer, or needs help with yoga sequence builder with sequence design by level and goal, pose library with sanskrit names, pranayama breathing exercises, sun salutation variations, class duration templates, modifications and props, and contraindications for safe practice.
  Do NOT use when the request requires professional medical advice or falls outside the scope of yoga sequencer.
license: Apache-2.0
metadata:
...
1. **What is your yoga experience level?** (Complete Beginner / Beginner / Intermediate / Advanced)
2. **What is the primary goal of this practice?** (Flexibility / Strength / Relaxation / Energy / Balance / Pain Relief / Stress Relief)
3. **How long do you want the session?** (15 / 30 / 45 / 60 / 75 / 90 minutes)
4. **What style do you prefer?** (Vinyasa / Hatha / Yin / Restorative / Power / Gentle)
5. **Do you have any injuries or areas to avoid?** (Wrists / Shoulders / Low back / Knees / Neck / Hips / None)
6. **What time of day will you practice?** (Morning / Midday / Evening / Before bed)
7. **Do you have any props available?** (Mat only / Blocks / Strap / Bolster / Blanket / Wall / All)
8. **Are there specific areas you want to focus on?** (Hips / Hamstrings / Shoulders / Back / Core / Full body)
...
2. WARM-UP (5-10 min)
   ...
   - Joint mobilization
   - Cat/Cow, gentle twists

3. SUN SALUTATIONS (5-15 min)
   - Build heat
   - Full-body integration
   - Progressively deepen

4. STANDING POSES (10-20 min)
   - Build strength and stability
   - Peak pose preparation
   - Balance challenges

5. PEAK POSE(S) (5-10 min)
   - Most challenging posture(s)
   - Full expression of practice theme
...
### Surya Namaskar A (Classical)

```
1. Tadasana (Mountain Pose) - Inhale arms up
2. Uttanasana (Standing Forward Fold) - Exhale fold
3. Ardha Uttanasana (Halfway Lift) - Inhale lengthen
4. Chaturanga Dandasana (Four-Limbed Staff) - Exhale lower
5. Urdhva Mukha Svanasana (Upward-Facing Dog) - Inhale lift
6. Adho Mukha Svanasana (Downward-Facing Dog) - Exhale press back
7. Ardha Uttanasana (Halfway Lift) - Inhale step forward
8. Uttanasana (Standing Forward Fold) - Exhale fold
9. Tadasana (Mountain Pose) - Inhale rise
```

### Surya Namaskar B

```
1. Utkatasana (Chair Pose) - Inhale
2. Uttanasana (Forward Fold) - Exhale
3. Ardha Uttanasana (Halfway Lift) - Inhale
4. Chaturanga Dandasana - Exhale
5. Urdhva Mukha Svanasana - Inhale
6. Adho Mukha Svanasana - Exhale
7. Virabhadrasana I (Warrior I) Right - Inhale
8. Chaturanga Dandasana - Exhale
9. Urdhva Mukha Svanasana - Inhale
10. Adho Mukha Svanasana - Exhale
11. Virabhadrasana I (Warrior I) Left - Inhale
12. Chaturanga Dandasana - Exhale
13. Urdhva Mukha Svanasana - Inhale
14. Adho Mukha Svanasana - Exhale (5 breaths)
15. Step forward, Uttanasana - Exhale
16. Utkatasana - Inhale
17. Tadasana - Exhale
```

### Gentle Sun Salutation (Beginner Modification)

```
1. Tadasana - Stand tall
2. Inhale arms overhead
3. Exhale fold forward (bend knees as needed)
4. Inhale halfway lift (hands on shins)
5. Exhale step back to tabletop
6. Inhale Cow Pose
7. Exhale Cat Pose
8. Inhale to neutral spine
9. Exhale press to Downward Dog (brief hold)
10. Walk feet to hands
11. Inhale halfway lift
12. Exhale fold
13. Inhale rise to stand
```

---

## Pose Library by Category
...
2. Right hand in Vishnu Mudra (fold index and middle fingers)
3. Close right nostril with right thumb
4. Inhale through left nostril (4 counts)
5. Close left nostril with right ring finger
6. Open right nostril, exhale (4 counts)
7. Inhale through right nostril (4 counts)
8. Close right nostril with thumb
9. Open left nostril, exhale (4 counts)
10. This completes one round. Do 5-10 rounds.
```

---

## Class Duration Templates

### 15-Minute Quick Flow

```
Centering + Breath: 1 min
Cat/Cow warm-up: 1 min
3x Sun Salutation A: 4 min
Standing Sequence (Warrior I, II, Triangle each side): 4 min
Floor (Pigeon, Seated Twist each side): 3 min
Savasana: 2 min
```
...
```
Centering + Pranayama: 2 min
Warm-up (Cat/Cow, Spinal Circles): 3 min
3x Sun Salutation A: 5 min
Standing Sequence: 8 min
  - Warrior I, Warrior II, Triangle, Half Moon (each side)
Balance Pose: 2 min
  - Tree Pose or Warrior III (each side)
Floor Sequence: 5 min
  - Pigeon, Seated Forward Fold, Twist
Savasana: 5 min
```

### 45-Minute Intermediate Flow

```
Centering + Pranayama: 3 min
Warm-up (Cat/Cow, Low Lunge, Downward Dog): 4 min
3x Sun Salutation A + 2x Sun Salutation B: 8 min
Standing Flow 1: 6 min
  - Warrior I, II, Extended Side Angle, Triangle
Standing Flow 2: 6 min
  - Warrior III, Half Moon, Revolved Triangle
Balance Sequence: 3 min
  - Tree, Eagle
Peak Pose + Preparation: 4 min
Cool-down Floor Sequence: 5 min
  - Pigeon, Seated Forward Fold, Supine Twist
Savasana: 6 min
```
...
```
Centering + Pranayama: 5 min
Warm-up: 5 min
  - Cat/Cow, Thread the Needle, Low Lunge, Downward Dog
Sun Salutations: 8 min
  - 3x Surya A, 2x Surya B
Standing Sequence 1: 8 min
  - Warrior I > Warrior III > Standing Split > Low Lunge (each side)
Standing Sequence 2: 8 min
  - Warrior II > Extended Side Angle > Triangle > Half Moon (each side)
Balance + Twists: 5 min
  - Tree, Eagle, Revolved Chair
Peak Pose + Variations: 5 min
Core Work: 3 min
  - Boat Pose, Plank, Side Plank
Cool-down: 5 min
  - Pigeon, Seated Forward Fold, Supine Twist, Happy Baby
Savasana + Closing: 8 min
```

### 90-Minute Deep Practice

```
Centering + Extended Pranayama: 8 min
Warm-up + Joint Mobilization: 7 min
Sun Salutations (5x A, 3x B): 12 min
Standing Flow 1 (Strength): 10 min
Standing Flow 2 (Balance): 8 min
Standing Flow 3 (Twists): 7 min
Arm Balances / Inversions: 8 min
Peak Pose Sequence: 7 min
Backbend Sequence: 5 min
Cool-down Floor Work: 8 min
Savasana: 10 min
```
...
```
1. Never force into a posture - find your edge and breathe
2. Sharp pain means stop immediately
3. Discomfort is okay; pain is not
4. Warm up before attempting peak poses
5. Use props without ego - they are tools, not crutches
6. Inform your instructor of all injuries and conditions
7. Hydrate before and after practice
8. Avoid eating a full meal within 2 hours of practice
```
...
### Goal: Stress Relief / Relaxation (Restorative)

```
1. Supported Child's Pose (Balasana) - 3 min
2. Supported Side Bend (over bolster) - 2 min each side
3. Supported Reclined Bound Angle (Supta Baddha Konasana) - 5 min
4. Supported Bridge (block under sacrum) - 3 min
5. Supported Twist (bolster between knees) - 3 min each side
6. Legs Up the Wall (Viparita Karani) - 5 min
7. Savasana with blanket and eye pillow - 10 min
```

### Goal: Energy / Morning Wake-Up

```
1. Seated Cat/Cow - 1 min
2. 5x Sun Salutation A (increasing pace) - 8 min
3. 3x Sun Salutation B - 6 min
4. Warrior I > Warrior III > Standing Split flow - 4 min
5. Chair Pose > Revolved Chair - 2 min
6. Camel Pose - 3 breaths x 2 rounds
7. Wheel Pose or Bridge - 3 breaths x 2 rounds
8. Brief Savasana - 3 min
```

### Goal: Flexibility (Yin-Style)

```
Hold each pose 3-5 minutes:
1. Butterfly (Seated Bound Angle)
2. Dragon Pose (Low Lunge) - each side
3. Sleeping Swan (Pigeon) - each side
4. Caterpillar (Seated Forward Fold)
5. Twisted Roots (Supine Twist) - each side
6. Banana Pose (Lateral Side Bend) - each side
7. Savasana - 5 min
```
...
```
1. Cat/Cow warm-up - 1 min
2. Plank Hold - 30-60 sec
3. Side Plank (each side) - 30 sec
4. Boat Pose (Navasana) - 5 breaths x 3
5. Bicycle Crunches (yogi style) - 10 each side
6. Forearm Plank - 30-60 sec
7. Bird Dog - 5 each side
8. Crow Pose (Bakasana) or prep - 5 attempts
9. Supine Core Work (leg lowers, dead bug) - 3 min
10. Savasana - 5 min
```
...
When generating a yoga sequence, present it as:

```
YOGA SEQUENCE: [Goal/Theme]
Level: [Beginner / Intermediate / Advanced]
Duration: [X] minutes
Style: [Vinyasa / Hatha / Yin / Restorative]
Props Needed: [List]
Focus Areas: [List]
...
# | Pose (Sanskrit) | Hold/Breaths | Side | Cues & Modifications
--|-----------------|-------------|------|---------------------
  |                 |             |      |

BREATH WORK:
[Pranayama technique and instructions]

CLOSING:
[Final relaxation and intention]

CONTRAINDICATION NOTES:
- [Relevant cautions for this sequence]
```

## Example

**Input:** "Help me get started with yoga sequencer"

**Output:** A structured yoga sequencer plan tailored to the user's specific situation, following the process outlined above.
