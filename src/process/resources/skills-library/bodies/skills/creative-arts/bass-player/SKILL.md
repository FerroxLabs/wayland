...
name: bass-player
description: |
  Groove technique, walking bass lines, slap bass, music theory for bass, and band dynamics - structured practice and performance guidance for electric and acoustic bass guitar
  Use when the user asks about bass player, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of bass player or requires a different specialized skill.
license: Apache-2.0
metadata:
...
The bass occupies a unique position bridging rhythm and harmony. Before diving into technique, internalize these principles:

- **Lock with the drummer.** Your relationship with the kick drum defines the pocket. Listen to the kick pattern and align your note placement with it.
- **Define the harmonic foundation.** The lowest note the audience hears sets the chord quality. A wrong bass note changes the entire chord.
- **Serve the song.** The best bass line is the one the song needs, not the one that shows off your chops.
- **Control dynamics.** You set the energy floor. When you pull back, the band breathes. When you push, the band lifts.
...
4. Practice at 60 BPM on open strings, quarter notes, for 5 minutes daily
...
### The Formula for Basic Walking

Over any chord, follow this beat-by-beat approach:

- **Beat 1:** Root of the current chord
- **Beat 2:** A chord tone (3rd or 5th)
- **Beat 3:** A scale tone or passing tone
- **Beat 4:** A leading tone into the NEXT chord (half step above or below the next root)

### Walking Bass Construction Exercise

**Over a ii-V-I in C major (Dm7 - G7 - Cmaj7):**

```
Dm7:     D - F - A - G#(leading tone to G)
G7:      G - B - D - Db(leading tone to C)
Cmaj7:   C - E - G - A (moving to next chord)
```
...
4. Replace beat 4 with chromatic leading tones
5. Add occasional chromatic passing tones on beat 3
6. Practice with a jazz play-along track at 120 BPM

### Common Jazz Progressions to Walk Over

- 12-bar blues in F and Bb
- Autumn Leaves changes (Cm or Gm)
- Rhythm changes (Bb)
- ii-V-I patterns through all 12 keys

## Slap Bass Technique

### The Slap (Thumb Strike)

1. Rotate your forearm so your thumb strikes the string with the bony side
2. Strike through the string, bouncing off immediately - think of a drumstick rebound
3. Hit the string where the fretboard ends (near the last fret)
4. The motion comes from wrist rotation, not arm movement
5. Start on the open E string, targeting a clean percussive pop

### The Pop (Finger Pull)

1. Hook your index or middle finger under the G or D string
2. Pull the string away from the fretboard about half an inch
3. Release and let it snap back against the frets
4. The tone should be bright and aggressive
...
E string: T (root)
G string: P (octave)
Rhythm:   T--P-T--P- (sixteenth note feel)
```
...
Learn to think in numbers instead of note names:

- **1-3-5-7** = Major 7 chord tones
- **1-b3-5-b7** = Minor 7 chord tones
- **1-3-5-b7** = Dominant 7 chord tones

This lets you transpose instantly. If someone says "play a minor groove," you play 1-b3-5-b7 patterns regardless of the key.
...
A: 4th (same fret as root) - 5th (2 frets up)
D: b7 (same fret as root) - root octave (2 frets up)
```

Practice this shape starting on every fret from 1 to 12.

## Band Dynamics and Communication

### Rehearsal Checklist

- [ ] Tune before every session (use a tuner, not your ear alone at first)
- [ ] Confirm song key and tempo before starting
- [ ] Establish who counts off and how endings are signaled
- [ ] Record rehearsals and listen back for balance issues
- [ ] Discuss arrangement decisions: who plays during the intro, who drops out in the bridge

### Stage Performance Tips

- **Watch the drummer's hi-hat hand** for tempo reference during loud stage volume
- **Use stage monitors wisely** - request kick drum and vocals in your monitor
- **Signal song sections** with your body language: lean in for chorus energy, step back for verses
- **Handle mistakes** by landing on the root of the next chord on beat 1 - the audience skips everything if beat 1 is solid

### Supporting Other Musicians

- When the singer is performing a quiet verse, reduce your volume and simplify
- When the guitarist solos, hold the groove steady and resist adding fills
- When the drummer shifts feel, follow within one bar
- Leave space in your parts for other instruments to breathe
...
- Transcribing bass lines by ear within one or two listens
- 30+ songs performance-ready
...
2. **Analyze context.** Review the information provided and identify key factors relevant to bass player
...
**Input:** "Help me with bass player for my current situation"

**Output:**

Based on your situation, here is a structured approach to bass player:
