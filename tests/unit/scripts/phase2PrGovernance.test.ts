...
const manifest = (): PremergeManifest => ({
  ...
  nano_fixture_helper: {
    repository: 'FerroxLabs/wayland-nano',
    source_commit_sha: '75a192920b27a5a485df91e35154be6dacba414c',
    merge_commit_sha: '17e80e83a78a4d068ce8e0588d6a8f5ee6d8ac57',
    cargo_lock_sha256: '3d6ec29f3b19e0b3778a5de222418ec497eaf79be8e93a92dd120d986bdb930a',
    ci_run_id: 33355945120,
    merged_at: '2026-08-31T04:35:28Z',
    merged_before_desktop: true,
...
const snapshot = (): GovernanceSnapshot => ({
  ...
  nano_fixture_helper_merge_time: '2026-08-31T04:35:28Z',
