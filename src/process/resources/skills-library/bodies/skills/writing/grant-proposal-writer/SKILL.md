...
description: |
  Government and research grant proposal development covering federal agencies (NIH, NSF, DOE), state programs, and academic research grants. Includes proposal structure, budget narratives, logic models, evaluation plans, compliance, and post-award management.
  Use when the user asks about grant proposal writer, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of grant proposal writer or requires a different specialized skill.
license: Apache-2.0
metadata:
...
1. **What type of organization are you?** (University, research institution, government entity, small business, nonprofit with research capacity?)
2. **What is the project or research you need funding for?** (Specific description of the work.)
3. **Have you identified a specific federal agency or program?** (NIH, NSF, DOE, USDA, DOD, state agency?)
4. **What is the funding amount you need?** (Calibrates which mechanisms to target.)
5. **What is the deadline or submission cycle?** (Federal grants have fixed submission dates.)
6. **Have you written government or research grants before?** (Calibrates level of guidance.)
7. **Do you have required institutional documentation?** (SAM registration, UEI number, negotiated indirect cost rate, IRB/IACUC approvals?)
8. **What is the project timeline?** (Most agencies want specific implementation schedules.)
9. **Do you have preliminary data or prior publications?** (Critical for research grant competitiveness.)
10. **Is this a new application, resubmission, or renewal?** (Each has different strategies.)
...
- **Timeline:** 60-120 days from announcement to deadline; 6-12 months to award decision
- **Typical components:** Abstract, project narrative, budget, budget justification, biosketches, letters of support, data management plan, compliance documentation
...
- **Timeline:** Annual or biannual cycles
...
- **Characteristics:** Scientifically rigorous, peer-reviewed, specific formats per agency
- **Format:** Agency-specific (NIH uses FORMS-H, NSF uses Research.gov)
- **Timeline:** Standard submission dates; 6-9 months to decision
- **Typical components:** Specific aims, research strategy, biosketches, budget, facilities, equipment, human subjects/animal protocols
...
- **Key requirement:** Small business concern (under 500 employees for most agencies)
...
2. **Geographic focus:** Does the funder fund in your area?
3. **Funding range:** Is your ask within their typical grant size?
4. **Eligible applicants:** Does your organization type qualify?
5. **Priority areas:** Does your project address their current funding priorities?
...
- **SAM.gov** --- System for Award Management, required registration for federal grants
- **Federal agency program announcements** --- FOAs (NIH), Dear Colleague Letters (NSF), BAAs (DOD)
...
PARAGRAPH 1: ORGANIZATIONAL INTRODUCTION
[Who you are, mission, brief track record. 2-3 sentences.]

PARAGRAPH 2: THE PROBLEM
[What need or problem does this project address? Use data.
3-4 sentences.]

PARAGRAPH 3: THE PROJECT
[What will you do? Be specific about activities, beneficiaries,
and expected outcomes. 4-6 sentences.]

PARAGRAPH 4: THE ASK
[How much are you requesting? What is the total project cost?
What is the timeline? 2-3 sentences.]

PARAGRAPH 5: THE FIT
[Why this funder? How does the project align with their priorities?
2-3 sentences.]

PARAGRAPH 6: CLOSING
[Thank them. Offer to provide additional information. 1-2 sentences.]

Sincerely,
[Executive Director or Principal Investigator]
[Title]
[Organization]
[Contact information]
```

## Phase 3: Full Proposal Structure

### Federal Grant Proposal (Typical Structure)

**1. Abstract/Project Summary (1 page)**
...
- Authentication of key biological resources (NIH)
...
INPUTS -->  ACTIVITIES -->  OUTPUTS -->  SHORT-TERM    -->  LONG-TERM
                                        OUTCOMES           OUTCOMES
(Resources)  (What you do) (Products/   (Changes in      (Systemic
                            services     knowledge,        changes,
                            delivered)   behavior,         community
                                        skills)           impact)

Staff time   Workshops     # of         Increased         Reduced
Funding      Mentoring     participants knowledge of X    rate of Y
Facilities   Outreach      # of         Changed           Improved
Partners     Training      sessions     behavior in X     community Z
Materials    Research       # of         Improved          Policy
                           products     skills in X       change
```
...
- Long-term outcomes may extend beyond the grant period
- Include external factors that could influence outcomes
...
PERSONNEL
  ...
  - Program Coordinator: [Name], [% FTE] = $XX,XXX
  - Fringe Benefits: [Rate %] x salaries = $XX,XXX

TRAVEL
  - Local travel: [# trips x miles x rate] = $X,XXX
  - Conference travel: [# trips x cost] = $X,XXX
...
SUPPLIES
  ...
  - Program materials: $X,XXX

CONTRACTUAL
  - Evaluator: $X,XXX
  - Consultants: [# days x rate] = $X,XXX

OTHER
  - Printing: $X,XXX
  - Communications: $X,XXX
  - Participant stipends: [# x amount] = $X,XXX

INDIRECT COSTS
  - [Negotiated rate %] x [Modified total direct costs] = $XX,XXX

TOTAL PROJECT COST: $XXX,XXX
AMOUNT REQUESTED FROM THIS FUNDER: $XXX,XXX
OTHER FUNDING (COMMITTED/PENDING): $XXX,XXX
```
...
- Include in-kind contributions to show organizational investment
- Budget should align precisely with the project description (every activity has a corresponding cost)
...
- **Progress reporting:** Annual or semi-annual narrative and data reports
- **Prior approval:** Required for budget changes exceeding 10%, key personnel changes, scope changes, no-cost extensions
...
- Final closeout report with outcomes data
- Submit on time --- late reports affect future eligibility
...
2. **Analyze context.** Review the information provided and identify key factors relevant to grant proposal writer
...
```template
## Grant Proposal Writer Analysis
...
**Input:** "Help me with grant proposal writer for my current situation"

**Output:**

Based on your situation, here is a structured approach to grant proposal writer:
