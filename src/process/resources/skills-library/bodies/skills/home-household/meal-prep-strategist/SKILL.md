---
name: meal-prep-strategist
description: |
  Weekly meal prep planning, batch cooking techniques, storage optimization, reheating methods, variety rotation systems, and time-efficient cooking strategies.
  Use when the user asks about meal prep strategist, or needs help with weekly meal prep planning, batch cooking techniques, storage optimization, reheating methods, variety rotation systems, and time-efficient cooking strategies.
  Do NOT use when the request requires professional specialized advice or falls outside the scope of meal prep strategist.
license: Apache-2.0
metadata:
...
Meal prep is not about eating the same sad chicken and rice for a week. Done well, it is a system that gives you:

- **Time savings**: 3-4 hours on prep day replaces 7-10 hours of daily cooking
- **Cost savings**: Planned grocery shopping reduces waste and impulse purchases by 30-50%
- **Nutritional consistency**: Pre-portioned meals make hitting macros and variety targets effortless
- **Decision fatigue elimination**: No daily "what's for dinner?" paralysis
- **Reduced food waste**: Everything purchased has a purpose
...
PROTEINS (select 2-3):
  1. _________________ (method: _______) qty: _______
  2. _________________ (method: _______) qty: _______
  3. _________________ (method: _______) qty: _______

GRAINS/STARCHES (select 2-3):
  1. _________________ qty: _______
  2. _________________ qty: _______

VEGETABLES (select 4-5):
  1. _________________ (method: _______) qty: _______
  2. _________________ (method: _______) qty: _______
  3. _________________ (method: _______) qty: _______
  4. _________________ (method: _______) qty: _______

SAUCES/DRESSINGS (select 2-3):
  1. _________________
  2. _________________
  3. _________________

BREAKFASTS: _________________________________
SNACKS: _____________________________________
```
...
- Soy sauce, vinegar (rice, balsamic, apple cider), hot sauce
- Garlic, onions, ginger
- Spice basics: cumin, paprika, chili powder, Italian seasoning, curry powder

### Step 3: Prep Day Execution (2.5-4 hours)
...
4. **Cool before storing**: Hot food in containers creates condensation, leading to soggy food and bacterial growth
...
4. **Italian**: Pesto or marinara
5. **Indian**: Curry simmer sauce (coconut milk + curry paste)
...
- **Silicone bags**: Good for freezer storage, reusable
...
- **Week 2**: Asian (soy, ginger, sesame, rice, stir-fry)
- **Week 3**: Mexican (cumin, lime, cilantro, beans, salsa)
- **Week 4**: Indian (curry, coconut, turmeric, lentils, naan)

Same base ingredients (chicken, rice, vegetables) become completely different meals.
...
PROTEIN        + GRAIN/STARCH    + VEGETABLE         + SAUCE           = MEAL
Chicken thigh    Rice               Roasted broccoli    Teriyaki          Bowl
Ground turkey    Quinoa             Sauteed peppers     Pesto             Wrap
Chickpeas        Sweet potato       Raw spinach         Tahini            Salad
Salmon           Farro              Roasted squash      Chimichurri       Plate
Tofu             Noodles            Stir-fry mix        Peanut sauce      Stir-fry
Pulled pork      Tortilla           Slaw                BBQ               Tacos
Eggs             Toast              Avocado + tomato    Hot sauce         Breakfast
```
...
- Prep low-carb snacks in advance
...
**Input:** "Help me get started with meal prep strategist"

**Output:** A structured meal prep strategist plan tailored to the user's specific situation, following the process outlined above.
