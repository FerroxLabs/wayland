---
name: tax-season-navigator
description: |
  Guides you through tax filing preparation with deduction checklists, software comparison, deadline tracking, and organization strategies to maximize returns and minimize stress.
  Use when the user asks about tax season navigator, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of tax season navigator or requires a different specialized skill.
license: Apache-2.0
metadata:
...
Before diving into tax preparation, clarify your situation:

- What is your filing status (single, married filing jointly, married filing separately, head of household)?
- Do you have income from multiple sources (W-2, 1099, self-employment, investments)?
- Did you have any major life changes this year (marriage, divorce, new child, home purchase, job change)?
- Have you been tracking expenses throughout the year, or are you starting from scratch?
- Did you make any charitable donations, retirement contributions, or education payments?
- Do you own a business or have freelance income?
- What filing method did you use last year, and were you satisfied with it?
- Are there any past-year tax issues (amendments, audits, back taxes) to address?
...
- [ ] Save copies of everything filed
...
- [ ] K-1 forms for partnership/S-corp/trust income
...
- [ ] Health insurance coverage documentation (1095 forms)
- [ ] Identity Protection PIN (if issued by IRS)

## Deduction Strategy Guide
...
- You had substantial state and local tax payments
...
- You are dealing with an IRS notice, audit, or back taxes
- Your return involves estate or trust income
- You want strategic tax planning beyond filing
- The stress of self-preparation outweighs the cost
...
4. **Save home improvement receipts** - These affect your cost basis
...
- [ ] Save a copy of your filed return (digital and physical)
- [ ] Set up direct deposit tracking for refunds
- [ ] Note your Adjusted Gross Income for next year's e-filing
- [ ] Review withholding and adjust W-4 if needed
- [ ] Set calendar reminders for next year's deadlines
- [ ] Store documents securely (keep returns for at least 7 years)
- [ ] Begin tracking deductions for next year immediately
- [ ] Consider whether to adjust estimated tax payments

## Common Filing Mistakes to Avoid

1. **Wrong filing status** - Review all options; head of household saves more than single
2. **Math errors** - Use software or double-check all calculations
3. **Missing income** - The IRS receives copies of all your 1099s
4. **Wrong bank account numbers** - Triple-check for direct deposit
5. **skipping to sign** - Unsigned returns are not valid
6. **Missing the deadline** - File an extension if you need more time
7. **Not reporting all income** - Even small 1099s matter
8. **Overlooking credits** - Many filers miss credits they qualify for
...
2. **Analyze context.** Review the information provided and identify key factors relevant to tax season navigator
...
**Input:** "Help me with tax season navigator for my current situation"

**Output:**

Based on your situation, here is a structured approach to tax season navigator:
