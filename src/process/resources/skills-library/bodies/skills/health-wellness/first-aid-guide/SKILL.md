...
description: |
  Comprehensive first aid reference covering emergency response protocols (DRSABCD), CPR basics, choking response, wound care, burn treatment, fracture and sprain care, allergic reaction management, heat and cold emergencies, and poisoning response. Reference only - always seek certified training.
