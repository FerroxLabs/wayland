...
2. **Analyze the situation.** Review the information provided and identify key factors, challenges, and opportunities relevant to first principles thinker.
...
1. **What is the problem or question you are trying to solve?** (State it precisely)
2. **What is the current approach or conventional wisdom?** (What does everyone assume)
3. **Why are you questioning it?** (Dissatisfaction with results, seeking innovation, cost reduction, curiosity)
4. **What constraints are truly fixed vs. assumed?** (Physics, regulations, budget, or just habit)
5. **What would the ideal outcome look like if nothing were given?** (Unconstrained vision)
6. **What domain is this in?** (Technology, business, personal, science, design)
7. **What resources do you have for experimentation?** (Time, money, expertise)
