---
name: executive-presence-coach
description: |
  Communication impact, body language mastery, meeting leadership, strategic visibility, and developing gravitas for professional influence and advancement.
  Use when the user asks about executive presence coach, or needs help with communication impact, body language mastery, meeting leadership, strategic visibility, and developing gravitas for professional influence and advancement.
  Do NOT use when the request requires professional specialized advice or falls outside the scope of executive presence coach.
license: Apache-2.0
metadata:
...
Executive presence is the ability to project confidence, credibility, and composure in a way that inspires trust and followership. It is not about being loud, aggressive, or dominating. It is about being intentional with how you show up.
...
**Key insight**: Gravitas and communication matter far more than appearance, but appearance is the first filter through which others perceive you.
...
4. **Supporting data**: Available if they ask
...
- Moderate your pace (rushing signals anxiety)
- Project from your diaphragm (not your throat)
- Eliminate filler words: "um," "like," "you know," "so," "basically"
...
- If it takes 10 minutes, make it take 5
...
4. **Resolution**: The outcome and lesson ("As a result, we now...")
...
- Head level, chin slightly up (not down toward phone)
...
- Do not cross arms (signals defensiveness)
...
- Hold eye contact for 3-5 seconds per person in groups
- In one-on-one conversations, maintain 60-70% eye contact
- Break eye contact by looking to the side (not down - down signals submission)
...
- Pre-circulate materials so the meeting is for discussion, not reading
...
- Direct discussion: "Let's hear from [name] on this"
- Manage tangents: "That's important - let's table it for a separate discussion"
...
- Close the loop: End with clear decisions, actions, and owners

### Virtual Meeting Presence

- Camera ON (non-negotiable for presence)
- Eye contact with camera lens (not the screen)
- Good lighting (facing a window or ring light)
- Clean, professional background
- Mute when not speaking (eliminates noise, signals when you have something to say)
- Stand up for important presentations (changes your vocal energy)
- Use names more often (compensates for reduced social cues)
...
- Engage on LinkedIn with substantive commentary
...
4. Be reliable and low-drama
5. Communicate your career goals clearly
6. Show gratitude and reciprocate with loyalty and performance
...
- Early warning on risks (no surprises)
- Public support and private feedback
...
- If you are wrong, own it immediately: "You're right, I need to reconsider that"
- If you disagree: "I see it differently, and here's why..."

### Decisiveness

- Gather sufficient information (not all information)
- State your recommendation clearly
- Acknowledge trade-offs and risks
- Commit to the decision and act
- Course-correct if new information emerges (this is not weakness, it is wisdom)
...
- [ ] Make one contribution in every meeting you attend
...
- [ ] Build one new relationship with a senior leader
...
```
EXECUTIVE PRESENCE COACH OUTPUT
===============================
...
**Input:** "Help me get started with executive presence coach"

**Output:** A structured executive presence coach plan tailored to the user's specific situation, following the process outlined above.
