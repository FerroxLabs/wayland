...
1. Are you building new construction, renovating, or retrofitting an existing building?
2. What type of building (single-family home, multi-family, commercial, institutional)?
3. Where is the building located (climate zone, urban/rural)?
4. What is your primary goal (energy savings, health, comfort, environmental impact, resale)?
5. What is your approximate budget range?
6. What is the building's current condition and age?
7. Have you had an energy audit or building assessment done?
8. Are there specific problems you want to solve (drafts, high bills, moisture, comfort)?
...
4. **Thermal bridge-free design**: Continuous insulation without gaps at connections
...
- [ ] Test for radon (every building should be tested)
- [ ] Ensure adequate ventilation (mechanical in tight buildings)
- [ ] Use low-VOC and zero-VOC products throughout
- [ ] Control moisture at the source (exhaust fans, vapor management)
- [ ] Maintain combustion appliances and ensure proper venting
- [ ] Use MERV 13+ air filters in HVAC systems
- [ ] Seal attached garage from living space
- [ ] Allow new materials to off-gas before occupancy when possible
- [ ] Use range hood vented to exterior when cooking
- [ ] Monitor CO2 levels as a proxy for ventilation adequacy
...
1. Get an energy audit and address envelope first
2. When water heater needs replacement, choose heat pump
3. When HVAC needs replacement, choose heat pump system
4. Add induction cooktop when range needs replacement
5. Install solar PV to power the electrified home
6. Add battery storage for resilience and optimization
...
- [ ] Complete a professional energy audit
- [ ] Identify and prioritize comfort and performance problems
...
- [ ] Understand building code requirements for upgrades
- [ ] Plan for proper moisture management with any changes
- [ ] Consider whole-building approach (avoid isolated fixes that create problems)
- [ ] Address health and safety issues first (radon, lead, asbestos, combustion safety)
- [ ] Establish a phased plan if budget requires staging improvements
...
2. **Analyze context.** Review the information provided and identify key factors relevant to green building advisor
