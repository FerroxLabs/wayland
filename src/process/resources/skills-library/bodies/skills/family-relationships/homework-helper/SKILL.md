...
description: |
  Study environment optimization, learning strategies by age, motivation techniques, executive function support, and defining the parent role in academic support.
  Use when the user asks about homework helper, or needs help with study environment optimization, learning strategies by age, motivation techniques, executive function support, and defining the parent role in academic support.
  Do NOT use when the request requires professional specialized advice or falls outside the scope of homework helper.
license: Apache-2.0
metadata:
...
- Ask guiding questions rather than give answers
- Communicate with teachers about persistent struggles
- Model learning behavior (read, study, be curious yourself)
...
- Turn homework time into a battle zone
- Prioritize grades over understanding
- Compare siblings or other children
- Use homework as punishment

### The Guiding Question Framework
...
- All supplies within reach (pencils, paper, calculator, etc.)
- Minimal visual distractions (face wall, not window or TV)
...
- Noise: Quiet or consistent background noise (white noise, not music with lyrics)
...
4:05 PM - Begin with most challenging subject (freshest brain)
4:25 PM - 5-minute break (physical movement)
4:30 PM - Second subject
4:50 PM - 5-minute break
4:55 PM - Remaining homework
5:15 PM - Review completed work, pack backpack for tomorrow
5:20 PM - Done! Free time earned
```
...
- **Grades 9-12**: 90-150 minutes, student manages independently

## Learning Strategies by Age
...
- Asking for help when stuck (model this yourself)
...
- Use backward planning: If a paper is due Friday, what must be done by Wednesday? Monday?
...
- They experience natural consequences of poor planning (within reason)
...
- **Practice testing**: Take practice tests under test-like conditions
...
TWO WEEKS BEFORE TEST:
  ...
  - Create study guide from notes, textbook, and assignments
  - Identify weak areas

ONE WEEK BEFORE:
  - Active recall practice daily (20-30 min)
  - Practice problems for math/science
  - Teach difficult concepts aloud
...
- Focus conversations on learning and goals, not grades
...
- Fostering curiosity: "That is an interesting question. Let us find out."
...
**Never**: Pay per grade, bribe for compliance, or use academic threats as punishment.

## Executive Function Support

Executive functions are the brain's management system. They develop through childhood and into the mid-20s. Homework struggles are often executive function struggles, not intelligence or motivation problems.
...
- Model healthy frustration management yourself
...
- Performance that does not match demonstrated ability

These may indicate ADHD, learning disabilities, anxiety, or other conditions that benefit from professional support.
...
I wanted to reach out about [specific concern]. I have noticed
that [specific observation at home]. We have tried [strategies
attempted].

I would appreciate your perspective on [specific question].
Could we discuss this by email or schedule a brief meeting?

Thank you for your time and dedication to [child's name]'s
learning.
```
...
**Input:** "Help me get started with homework helper"

**Output:** A structured homework helper plan tailored to the user's specific situation, following the process outlined above.
