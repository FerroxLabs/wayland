...
description: |
  Overview of fertility options, treatment timelines, emotional support strategies, cost planning frameworks, and decision-making guidance for individuals and couples navigating the fertility journey
...
- [ ] Both partners' complete medical histories
- [ ] Menstrual cycle history (length, regularity, changes)
- [ ] Previous pregnancies and outcomes (if any)
- [ ] Current medications and supplements
- [ ] Family history of fertility issues, genetic conditions, or early menopause
- [ ] Lifestyle factors: smoking, alcohol, caffeine intake, exercise frequency
- [ ] Duration of attempts to conceive
- [ ] Any previous fertility testing or treatment
- [ ] Insurance coverage details for fertility services
...
2. **Analyze context.** Review the information provided and identify key factors relevant to fertility journey guide
