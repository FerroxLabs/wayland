---
name: wedding-season-guest
description: |
  Navigates wedding season as a guest with guidance on gift etiquette, travel planning, budgeting for multiple events, dress code decoding, and being a supportive attendee.
  Use when the user asks about wedding season guest, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of wedding season guest or requires a different specialized skill.
license: Apache-2.0
metadata:
...
Before planning your wedding season, clarify:

- How many weddings are you attending this year?
- What is your total budget for wedding-related expenses?
- Are you attending as a single guest or with a partner?
- Are you in any wedding parties (bridesmaid, groomsman, etc.)?
- How far do you need to travel for each wedding?
- Are any of the weddings destination events?
- Do you have any dietary restrictions or accessibility needs?
- What is your relationship with each couple (close friend, family, colleague)?
- Are there pre-wedding events you are expected to attend (showers, bachelor/bachelorette)?
- Do you have any wardrobe that can be reused across events?

## Wedding Season Budget Planner
...
- Handmade or experience gifts can be meaningful and affordable
...
- Use travel points and rewards when possible
...
- Check consignment and resale shops for quality options
- Borrow from friends with similar sizing
...
- **Registry gifts**: Can be sent before or after the wedding (up to a year after)
- **Cash or checks**: Bring in a card to the reception or send before/after
- **Physical gifts**: Ship to the couple's address rather than bringing to the venue
- **Group gifts**: Coordinate one large registry item with other guests
...
- A small registry item paired with a meaningful personal touch
- Your enthusiastic presence and celebration is itself a gift
...
- Make the gift about you rather than the couple
...
- Never wear white, ivory, or cream (unless explicitly invited to)
- Avoid outfits that could upstage the couple
- When in doubt, slightly overdressed is better than underdressed
- Check the venue type and weather for practical considerations
- Bring a wrap or jacket for evening outdoor events
- Wear shoes you can actually dance and walk in
- Have a backup plan for weather (umbrella, layers)
...
- A statement clutch or evening bag
...
- Layer with different jackets or wraps
...
- [ ] Plan outfit and try everything on together
- [ ] Arrange transportation to/from venue
- [ ] Confirm event timeline and locations
...
- [ ] Cash for tips, valet, or unexpected needs
- [ ] Tissues
- [ ] Basic touch-up supplies (hair, makeup, lint roller)
- [ ] Comfortable backup shoes for dancing
- [ ] Medications if needed
- [ ] A light snack in case of long gaps between events
...
- Follow the couple's wishes about social media sharing
...
- Thank the couple briefly (they are busy - keep it short)
- Thank the parents or hosts if you can
- Do not take centerpieces unless announced
- Pace your drinking
- Stay until at least cake cutting or main events

## Wedding Party Member Guide
...
- Communicate your budget honestly and early with the couple
- Suggest affordable alternatives when asked for input on plans
- Split costs fairly among the party (not equally if incomes differ)
- It is acceptable to decline being in a wedding party for financial reasons
- The couple should not expect wedding party members to go into debt

## Navigating Tricky Situations

### Common Scenarios and How to Handle Them

**You cannot afford to attend:**
Respond honestly and kindly. Send a heartfelt card and gift within your means. A real friend will understand.

**You received an invitation but barely know the couple:**
You are not obligated to attend. RSVP no with warmth and send a card with good wishes.

**You want to bring a date but were not given a plus-one:**
Do not ask. The couple has budget and space constraints. Attend solo graciously.

**The wedding conflicts with another commitment:**
Choose the one where your presence matters most. Communicate early with regrets.

**You have dietary restrictions:**
Inform the couple when you RSVP. Eat a small meal beforehand as backup.

**You do not drink alcohol:**
No explanation needed. Ask the bartender for a mocktail or hold a sparkling water.
...
2. **Analyze context.** Review the information provided and identify key factors relevant to wedding season guest
...
**Input:** "Help me with wedding season guest for my current situation"

**Output:**

Based on your situation, here is a structured approach to wedding season guest:
