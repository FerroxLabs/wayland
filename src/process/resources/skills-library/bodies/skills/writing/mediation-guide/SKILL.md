...
- Seat Marcus and Priya across from each other at a round or rectangular table; you sit at the head equidistant
- Materials: whiteboard or large paper pad (for writing issues visibly), notepads and pens for each party, water, tissues available but not prominently displayed
- Silence your own devices; ask both parties to do the same at the opening
- Have the agreement template ready but not visible at the start

---

**MEDIATOR'S OPENING STATEMENT -- Full Script**

"Thank you both for coming in today. I know this hasn't been easy, and I genuinely appreciate that you've both agreed to try this process.

Before we begin, I want to be clear about my role today. I'm here as a neutral facilitator -- not as an investigator, not as HR enforcing a policy, and not as a judge deciding who's right. My job is to help you have a productive conversation that you might not be able to have on your own, and to help you find a way to work together that actually works for both of you.

You are going to decide any outcome today. I'm not going to tell you what to do, and nothing that gets agreed to here will happen without both of your consent.

Here's how today will work: First, each of you will have uninterrupted time to share your perspective on the situation -- I'll ask the other person to simply listen during that time, not respond yet. Then I'll summarize what I've heard, and we'll work together to identify the key issues. From there, we'll explore options, and if we reach agreements, we'll write them down clearly.

A word on confidentiality: what's said in this room stays in this room. I will not report the content of our conversation to your director or to the broader HR file, except for one thing -- if we reach an agreement, both of you will sign it and a copy will go into file, because that agreement is yours and deserves a record. The exception to confidentiality -- and I'm required to tell you this -- is if anyone says something that suggests serious risk of harm. In that case, I'm obligated to act on it. Does that make sense?

Now, I'd like to go through some ground rules that I'll ask both of you to agree to. These aren't meant to be restrictive -- they're meant to make this conversation actually productive.

One: one person speaks at a time. No interrupting.
Two: speak respectfully. No insults, no threats, no personal attacks. If something lands wrong, I'll name it.
Three: use 'I' statements. Speak from your own experience rather than characterizing what the other person 'always' or 'never' does.
Four: focus on what you need going forward, not just what's happened in the past.
Five: either of you can ask for a break at any time -- just say 'I need a minute' and we'll stop.
Six: either of you can end this process at any time. Participation is voluntary.
Seven: phones silenced for the duration.

Marcus, can you agree to those ground rules for today?
[Pause for response]
Priya, same question -- can you agree to these?
[Pause for response]

Great. Let's start. Marcus, I'd like to invite you to share your perspective first -- about 5 to 10 minutes, whatever you need. Priya, I'll ask you to simply listen right now -- you'll have full, uninterrupted time after Marcus finishes. Marcus, go ahead."

---

**PHASE 3 -- STORYTELLING: LISTENING TARGETS**
...
**Post-storytelling reflection for Priya (example):**
"Let me make sure I understand you. You're saying that when you don't receive status updates on Marcus's tasks until close to a deadline -- or after one is missed -- it puts the whole project schedule at risk, and it puts you in a position of having to explain delays to stakeholders without information. That feels unfair and professionally damaging to you. Is that right?"

---

**PHASE 4 -- ISSUE IDENTIFICATION**

Write these on the whiteboard, visible to both parties. These are neutral framings of the conflict -- not either party's words:

1. Communication norms and frequency -- what information flows between Marcus and Priya, when, and how
2. Decision-making process -- when and how technical decisions are made, and who has input at what stage
3. Professional respect in team settings -- how each party represents the other's work and competence to the team
4. Deadline and planning expectations -- what constitutes adequate notice and accountability for deliverables
5. Roles and boundaries -- where project management responsibility ends and technical autonomy begins

**After writing:** "Have I captured the main issues? Is there anything missing that needs to be on the table?" Allow additions.

**Shared interest to state explicitly:** "I want to name something I've heard from both of you: you both care about the project succeeding, and you both care about being seen as competent professionals by the team. Those are things you share. Let's keep that in mind as we work through the issues."

**Priority question:** "Which of these feels most important to address first?"
(Likely: communication norms or roles and boundaries -- these are the practical root of most of the tension. Start there.)

---

**PHASE 5 -- OPTION GENERATION: FACILITATION QUESTIONS**

After identifying the priority issue (likely communication frequency and format):

"Let's generate as many ideas as possible for how communication between you two could work. No evaluation yet -- just possibilities. What are some ways you've seen status updates work well in other projects or teams?"

"If you could design the ideal information flow -- what would Marcus know that Priya needs to know, and how would it get to her, without either of you feeling burdened?"

"You both seem to agree that last-minute surprises aren't working. What's the earliest point in the process where things could go differently?"

"What would need to be true for Marcus to feel like update requests were collaborative rather than surveillance?"
...
- To reality-test any agreement where one party seems to be agreeing to placate rather than genuinely commit

---

**PHASE 6 -- REALITY TESTING QUESTIONS**

For any proposed communication agreement:
"Walk me through next Tuesday. Marcus, you're working on [a feature]. Priya, you're preparing for a stakeholder update on Thursday. Under this arrangement -- what actually happens? Who does what, when?"

"What happens in a week where Marcus runs into a technical blocker that affects the timeline? Under this agreement, how does Priya find out, and when?"

"Marcus, if Priya sends you a check-in message on a day you're in deep focus work, what happens?"

"Priya, if you receive an update that's less detailed than you'd like, what's your move under this agreement?"

For the team meeting respect issue:
"Next team meeting, if a technical question comes up about Marcus's work area -- Priya, under our agreement, what do you do? Marcus, if you hear Priya answer a technical question, what's your response process?"
...
Parties: Marcus [Last Name], Senior Developer; Priya [Last Name], Project Manager
Facilitated by: [HR Manager Name], HR Manager, acting as neutral facilitator
Team: [Product Team Name]

Background: Marcus and Priya participated in a voluntary mediation session to
address communication and collaboration difficulties that had affected their
working relationship and team functioning. This agreement reflects their own
decisions and commitments.

AGREEMENTS:

1. STATUS UPDATES
   Marcus will provide Priya with a written status update on his active tasks
   every Tuesday by 12 PM, using the team's existing project tracking system.
   The update will include: current status (on track / at risk / blocked),
   estimated completion date, and any blockers that affect the timeline.

2. EARLY ESCALATION
   If Marcus identifies a risk that will cause a deliverable to miss its
   deadline by more than 2 business days, he will notify Priya within 24 hours
   of identifying the risk -- not at the deadline. This applies regardless of
   whether a solution has been found yet.

3. TECHNICAL DECISION-MAKING
   For decisions that affect only the technical implementation (how something
   is built), Marcus has decision authority and will document the decision in
   the project log. For decisions that affect scope, timeline, or stakeholder
   commitments, Marcus and Priya will discuss before a decision is finalized.
   Either party may initiate this conversation.

4. TEAM MEETING CONDUCT
   In team meetings, if a question arises about technical implementation,
   Priya will direct the question to Marcus rather than answer on his behalf.
   Marcus will answer technical questions in team settings without requiring
   follow-up justification from Priya in the same meeting. Either party who
   feels a boundary was crossed in a meeting will raise it privately with the
   other party within 24 hours rather than addressing it in the team setting.

5. REVIEW MECHANISM
   Marcus and Priya will meet privately (without HR) for 30 minutes on
   [date 4 weeks from Wednesday] to discuss how these agreements are working
   in practice. If either party finds a specific term is not working, they
   will bring a proposed modification to that meeting. If they cannot resolve
   a modification, either may request a follow-up session with [HR Manager].

6. CONFIDENTIALITY OF THIS PROCESS
   The content of today's conversation will remain between Marcus, Priya, and
   [HR Manager]. The existence of this agreement and its terms will be noted
   in HR file. Nothing from today's session will be used in performance
   reviews or disciplinary proceedings, except in the event that a term of
   this agreement itself becomes relevant to a subsequent HR matter.

Signatures:
Marcus [Last Name]: _______________________ Date: ___________
Priya [Last Name]:  _______________________ Date: ___________
Facilitated by:     _______________________ Date: ___________
```
