---
name: anxiety-coping-techniques
description: |
  Teaches specific named coping techniques for managing everyday anxiety (5-4-3-2-1 grounding, box breathing, cognitive reframing prompts, progressive muscle relaxation, the STOP technique). Gathers the user's anxiety triggers and context, then produces a personalized coping toolkit with step-by-step technique instructions and a situation-response map.
  Use when the user asks about coping with anxiety, managing nervousness, grounding techniques, calming anxious thoughts, or building an anxiety management toolkit.
...
- **Quick Protocol (5 minutes):**
  ...
  2. Identify the distortion type: catastrophizing (predicting worst-case), mind-reading (assuming others' reactions), all-or-nothing thinking (one mistake = total failure), fortune-telling (treating prediction as certainty)
  3. Write evidence FOR the thought being accurate (be honest -- this is not about dismissing the fear)
  4. Write evidence AGAINST the thought being accurate
  5. Write one balanced, realistic alternative thought that acknowledges real risk without catastrophizing. The goal is not "everything will be fine" -- that is bypassing. The goal is "the worst-case is possible but not probable, and I have handled difficult situations before."
  6. Read the alternative thought once. Do not argue yourself further. Close the notebook or phone.
...
1. **Never assess, diagnose, or rate clinical severity.** Do not say "your anxiety sounds mild/moderate/severe," do not use clinical diagnostic terms (generalized anxiety disorder, social anxiety disorder, panic disorder, PTSD), and do not suggest the user meets or does not meet criteria for any condition. These determinations belong to licensed clinicians.

2. **Limit the toolkit to 3-4 techniques maximum.** More choices do not improve outcomes -- they increase decision paralysis in the anxious moment. If the user's situation genuinely requires more, organize techniques into tiers (primary, backup) so the user always knows which to try first.

3. **Match technique to pattern, not to popularity.** Do not default to box breathing for everyone. A user whose primary symptom is racing thoughts and mental disconnection needs grounding first. A user whose primary symptom is muscle tension needs PMR. Ask about the dominant symptom before selecting.

4. **Every technique must include a "what to do if it does not help" instruction.** Never leave the user at a dead end. The backup should use a different mechanism (body-based vs. cognitive vs. grounding) so both the primary and backup do not fail for the same underlying reason.

5. **Provide exact timing in seconds or minutes for every technique step.** "Breathe slowly" is insufficient. Every inhale, hold, and exhale must have a specific second count. Vague instructions fail under pressure because the anxious mind cannot generate structure on its own -- the structure must be pre-supplied.

6. **If the user reports that breath-focused techniques increase their anxiety,** do not insist on breathing techniques. Breath-focus anxiety is real and documented -- some people become hyperaware of their breathing and experience the monitoring as distressing. Pivot to grounding (5-4-3-2-1) and cognitive techniques (STOP, reframing) which direct attention outward or toward thoughts rather than toward the breath.

7. **Include both reactive techniques (for anxious moments) and one daily preventive practice.** Reactive techniques alone build an emergency toolkit but not resilience. Daily practice lowers baseline physiological arousal over weeks and makes techniques more effective under pressure through familiarity and conditioned response.

8. **Anchor the daily practice to an existing habit using habit-stacking.** A free-floating "practice every day" instruction has low follow-through. Attach it to something the user already does reliably -- morning coffee, brushing teeth, commute, lunch. Ask what existing habits could serve as an anchor if the user does not suggest one.

9. **If the user describes physical symptoms during anxiety** (chest pain, numbness, dizziness, shortness of breath, heart palpitations), provide the wellness tools requested but note clearly that these physical symptoms should be evaluated by a healthcare provider to rule out non-anxiety causes. Do not assume these symptoms are anxiety-related. This note should be placed prominently -- not buried in the "when to seek professional support" section.

10. **If the user describes anxiety that significantly impairs daily functioning** -- avoiding work, school, or important activities most weeks; relationships affected by avoidance or reassurance-seeking; sleep disrupted more nights than not -- include a clear, non-alarmist note that persistent anxiety affecting daily functioning warrants speaking with a licensed mental health professional. Frame it as an addition to the toolkit, not a replacement, and not a suggestion that they are "too anxious" for these tools.

11. **Do not use clinical rating scales or ask users to score themselves on standardized instruments** (GAD-7, PHQ-9, SCARED, etc.). These are clinical assessment tools. If any numerical rating is used, limit it to informal self-anchoring within a technique (e.g., urge surfing's 1-10 wave observation), not as an assessment of the user's overall anxiety level.
...
### Technique 1: Silent 5-4-3-2-1 Grounding

**Why this technique for you:** Your mind blanks under pressure, which is a sign that attention has collapsed inward into threat-scanning mode. 5-4-3-2-1 redirects attention outward to the environment, which interrupts that cycle without requiring you to focus on your breathing or your thoughts. It is also completely invisible -- you simply appear to be looking around the room.

**When to use:** 5-15 minutes before presenting, when anxiety is building at your desk; also anytime during the presentation if your mind blanks or you feel suddenly disoriented

**Duration:** 2-4 minutes for a full pass; a partial pass (5-4-3) takes under 90 seconds and is useful in the middle of a presentation
...
4. **3 things you can HEAR:** Listen deliberately to ambient sound. Air conditioning hum. Distant keyboard clicks. The low rumble of a passing vehicle. If the room is very quiet, include your own quiet breathing as one of the three. Name each sound.
5. **2 things you can SMELL:** Notice what is in the air -- the room's ambient smell (recycled air, coffee, carpet), your own clothing, a nearby person's coffee. If nothing is distinct, name the quality of the air: cool, neutral, slightly metallic from the A/C. Either works.
6. **1 thing you can TASTE:** The current taste in your mouth. Recent coffee, water, mint from a previous mint. If nothing, the neutral taste of your saliva. This step is brief.
7. Return to the room normally. You have completed one pass. If anxiety is still high, immediately begin a second pass starting at 5 again. The second pass typically produces a more noticeable shift than the first.

**What you will feel during this technique:**
Within 30-60 seconds, thoughts that were looping rapidly will begin to slow. You will notice the room more clearly than you did before. There may be a slight sense of mental quiet or a brief pause in the anxious narrative. Physically, your heart rate will not drop immediately -- that is not the purpose of this technique. The purpose is to interrupt the thought loop that is amplifying the physical symptoms.

**How to know it is working:**
The anxious thoughts have slowed from a rapid loop to intermittent. You can hold a sensory observation (naming the scuff on the chair) for 2-3 full seconds without the anxious thought immediately returning. You feel more aware of the physical room around you than you did at the start.

**If it does not help:**
Move to the STOP Technique (Technique 2). The shift to a structured 4-step framework with deliberate action at the end can break a loop that pure sensory grounding could not.

---

### Technique 2: STOP Technique

**Why this technique for you:** This technique gives your anxious mind a specific, brief structure to follow, then hands off to deliberate action. It is invisible to anyone around you, takes 60-90 seconds, and works by naming what you are feeling (which reduces amygdala activation even in very brief windows) before committing to a concrete next action. It is especially useful for the gradual anxiety build that starts hours before presenting.

**When to use:** When anxiety is building at your desk earlier in the day; in the 5 minutes immediately before a presentation; after a moment during the presentation that spiked anxiety (e.g., a difficult question, a moment of blanking)
...
4. **P -- Proceed:** Choose one specific, concrete behavioral action and execute it in the next 5 seconds. Not "try to calm down." Examples: "I will re-read my opening sentence one time." "I will walk into the meeting room and pour a glass of water." "I will say 'That is a good question' and look at my slide." "I will take a sip of water and resume talking." The action does not have to be calming -- it has to be deliberate and specific. Deliberate action breaks the freeze response.

**What you will feel during this technique:**
The Observe step creates a brief, noticeable mental shift -- a few seconds where anxiety feels slightly external, something being examined rather than something you are fully inside. This is the goal. The Proceed step will feel slightly mechanical, which is correct -- the structure is providing scaffolding that anxiety has temporarily removed.

**How to know it is working:**
After Proceed, you are doing one specific thing rather than frozen or looping. The anxiety has not disappeared, but you are moving again. That is the working state for this technique.

**If it does not help:**
Use the physiological sigh (Technique 4) as a single-breath reset, then choose a Proceed action and move immediately. If the anxiety is the pre-event thought loop (night before), switch to Cognitive Reframing (Technique 3) which addresses the content of the thoughts directly.

---

### Technique 3: Cognitive Reframing -- Quick Thought Record

**Why this technique for you:** The specific symptom of "mind going blank rehearsing talking points the night before" is a cognitive anxiety pattern -- your mind is predicting failure so vividly that the prediction itself is interfering with the actual mental rehearsal. A quick written thought record breaks this by separating the fear (a cognitive prediction) from the evidence (what has actually happened in comparable situations). This is the one technique in your toolkit that requires writing and is therefore limited to private preparation time, not the presentation itself.

**When to use:** The evening before a presentation when you notice your mind looping on "what if I blank," "I don't know this well enough," or similar spirals during preparation

**Duration:** 5-8 minutes for a complete record
...
4. Write the evidence against this thought. Example: "I have given approximately 25 presentations this year and lost my place significantly in one of them." "My manager has explicitly said my presentations are well-structured." "My notes are on the screen as backup." Write all the counter-evidence.
5. Write one balanced, realistic alternative thought. The goal is NOT positive thinking ("I will definitely do great"). The goal is accuracy. Example: "It is possible I will lose my place for a moment, and that happens to experienced presenters. I have strong notes as backup. My track record over 25 presentations is much stronger than this one fear moment suggests. I know this material."
6. Read the alternative thought once, slowly. Put the notebook or phone down. Do not engage further. You have completed the record.

**What you will feel during this technique:**
The anxious thought will not disappear. It may immediately reassert itself after you write the alternative. This is normal -- the value is not eliminating the thought but reducing its certainty. After completing the record, most people describe the anxious thought as feeling "like one possibility" rather than "what will definitely happen."

**How to know it is working:**
The original thought feels less absolute. You are able to hold the alternative thought as plausible (not necessarily probable or certain -- just plausible). The mental loop slows or briefly stops after you set the notebook down.

**If it does not help:**
Some anxious thoughts are too deeply entrenched for a single reframing session to shift significantly. Do not repeat the record a second time -- rewriting the same thought multiple times in one session can paradoxically reinforce it. Instead, switch to 5-4-3-2-1 grounding for 3-4 minutes to exit the cognitive loop entirely, then put the presentation preparation away for the night.

---

### Technique 4: Physiological Sigh (Emergency Reset)

**Why this technique for you:** This is your fastest emergency tool -- a single double-inhale breath that activates the parasympathetic nervous system within 30 seconds. It is included as a backup and
