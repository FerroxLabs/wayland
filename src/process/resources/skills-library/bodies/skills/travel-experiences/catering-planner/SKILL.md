...
- Is coordinating with a catering company and needs contract guidance, questions to ask, or vendor comparison frameworks
- Is self-catering an event and needs prep timelines, kitchen logistics, food safety protocols, and service setup guidance
- Needs to create a menu that accommodates multiple dietary restrictions while remaining cohesive and appealing
- Is managing event day food service logistics -- timing, staffing ratios, buffet flow, temperature control, or plated service sequencing
- Needs food presentation and display guidance for buffets, plated dinners, or food stations
- Is dealing with a large-scale event (100+ guests) and needs to manage quantity scaling, vendor coordination, or multi-station setup
...
- The user is seeking guidance on starting or running a catering business -- use a small business or hospitality entrepreneurship skill
- The user needs help with large-scale institutional food service (hospital cafeteria, school lunch program, airline catering) -- these have distinct regulatory and logistics profiles beyond event scope
- The question is about food safety certification (ServSafe, HACCP training) at a professional/regulatory level -- use a food safety compliance skill

---

## Process

### Step 1: Gather Core Event Requirements

Before producing any catering plan, collect the following information. Missing even two or three of these makes quantity calculations and budget estimates unreliable.

- **Event type and formality:** Wedding, corporate lunch, cocktail party, fundraiser gala, birthday, holiday party, memorial reception, or other. Formality determines service style and price tier.
- **Guest count:** Confirmed RSVP vs. estimated. Ask for both -- use RSVP count for ordering but flag if estimate is significantly higher.
- **Service style:** Plated/sit-down, buffet, cocktail (passed appetizers only), food stations, family style, or hybrid (e.g., plated dinner with dessert station).
- **Event duration and time of day:** A 2-hour cocktail hour vs. a 5-hour wedding reception require completely different quantity calculations. Time of day determines appropriate meal type (breakfast, brunch, lunch, cocktail, dinner).
- **Venue and kitchen access:** Full commercial kitchen on-site, partial kitchen, venue with no kitchen (transport-only), outdoor with no power (must use Sterno or battery warmers). This determines what can be cooked vs. must be prepared off-site.
- **Budget:** Total budget and per-head target. If the user hasn't thought in per-head terms, introduce that framing immediately -- it is the most useful unit for catering decisions.
- **Dietary restrictions and allergies:** How many vegetarians, vegans, gluten-free, nut-allergic, kosher, halal, or other? Is anyone at risk for anaphylaxis? Will this information be collected on the RSVP or does the user need a collection strategy?
- **Alcohol:** Full open bar, beer and wine only, limited signature cocktail, champagne toast only, BYOB, or dry event. Alcohol dramatically affects both budget and logistics.
- **Hiring a caterer vs. self-catering:** This changes the skill output significantly. Self-catering requires detailed prep timelines, equipment lists, and staffing plans. Hiring requires vendor evaluation and contract guidance.
- **Setup and cleanup scope:** What time does venue access begin? Is there a hard end time? Who is responsible for post-event cleanup?

### Step 2: Determine Service Style and Menu Structure

Once the basic requirements are confirmed, use the event type, duration, time of day, and budget to recommend the appropriate service style and menu structure.

- **Match service style to event formality and budget:** Plated service costs the most (requires 1 server per 15-20 guests) but delivers the highest perceived formality. Buffet serves more guests per staff hour (1 server per 25-30 guests) but requires more food volume (guests take 25-30% more than plated portions). Stations create flow and engagement but require more setup space and specialized staffing at each station.
- **Set menu tiers by event type and time:** Use the Menu Planning Reference Table below. Key anchor rules: a cocktail-only event needs 10-12 passed pieces per person per 2 hours. A full dinner service needs a minimum of: salad or soup, one protein (two options for 50+ guests), two sides, bread, and dessert.
- **Design for dietary coherence, not just compliance:** Do not bolt dietary options on as an afterthought. Build a menu where at least one primary protein, one side, and one dessert are naturally vegan and gluten-free -- that covers vegetarian, vegan, gluten-free, and dairy-free guests without separate "special plates" for most people.
- **Apply seasonal logic:** Spring -- lighter preparations, raw bar, asparagus, pea shoots, citrus. Summer -- grilled proteins, cold soups, stone fruits, corn. Fall -- braised meats, root vegetables, squash, apple desserts. Winter -- slow-cooked dishes, hearty grains, citrus, chocolate. Seasonal produce is 20-40% cheaper and higher quality.
- **Flavor and texture balance:** Every menu needs contrast. If the main is rich (braised short rib), the salad must be acidic and light (arugula, lemon vinaigrette). If the main protein is mild (poached salmon), add umami punch in the side (miso glazed roasted mushrooms). Never serve three soft or three crunchy textures in a row.
- **Menu writing standard:** Use descriptive, sensory language. "Pan-seared airline chicken breast with roasted garlic jus and wilted spinach" communicates quality. "Chicken with sauce and vegetables" communicates nothing. Mark every item with dietary symbols: V (vegetarian), VG (vegan), GF (gluten-free), DF (dairy-free), N (contains nuts). List allergens explicitly below each item.

### Step 3: Calculate Food and Beverage Quantities

Apply the quantity formulas below to the confirmed guest count and service style. Always calculate before shopping or ordering -- never estimate by intuition at events over 30 people.
...
**Scaling protein for raw purchase weight:** Cooked yield from raw protein averages 65-75% for boneless cuts (chicken breast, pork tenderloin, fish fillet) and 55-65% for bone-in cuts (chicken quarters, beef short rib, rack of lamb). To hit 7 oz cooked per person for 80 guests: 80 x 7 oz = 560 oz cooked. At 70% yield: 560 / 0.70 = 800 oz raw = 50 lbs to purchase.
...
4. **Rentals:** Chafing dishes, serving vessels, linens, tableware, glassware, tables, chairs (if not included in venue). Often overlooked in initial budgets.
5. **Service charge and tax:** Caterers typically add 18-22% service charge on top of food/labor costs. Sales tax applies to food and rentals in most jurisdictions. This can add 25-30% to the base quote -- always include it.
...
- Reduce from 3 entree choices to 2: simplifies prep, reduces waste by 10-15%
- Use seasonal produce: can reduce ingredient costs by 15-25%
- Dessert station (one cake, brownies, cookies) vs. individually plated desserts: saves $5-$15 per person
- Eliminate one passed appetizer course: saves $3-$8 per person

### Step 5: Design the Event Day Timeline
...
- Venue access time must be at least 3-4 hours before guests arrive for a full dinner service; 2 hours minimum for a buffet-only event.
- Staff briefing must happen 45-60 minutes before guests arrive -- never during service.
- Kitchen breakdown begins during dessert, not after the event ends.

**Standard timeline template for an evening dinner (6:30 PM guest arrival):**

```
9:00 AM   Confirm final headcount with all vendors
10:00 AM  Venue access -- catering team arrives
10:30 AM  Equipment setup: chafing dishes, stations, bar cart
11:30 AM  Deliveries arrive -- verify against order sheet, check temperatures
12:00 PM  Prep begins: chopping, portioning, marinating, cold prep
1:00 PM   Tables set -- linens, flatware, glassware, centerpieces
2:30 PM   Bar stocked and staged; non-alcoholic beverages iced
3:00 PM   Hot items begin cooking (items with long cook times)
4:30 PM   Passed appetizer trays prepped, covered, and refrigerated
5:00 PM   Full walk-through: table settings, station layout, bar setup
5:30 PM   Final prep on mains; all cold items plated and covered
5:45 PM   Staff briefing: roles, course timing, dietary flags, allergy alerts
6:15 PM   Appetizer trays ready at kitchen pass; servers in position
6:30 PM   GUESTS ARRIVE -- cocktail hour begins, apps passed
7:30 PM   Guests seated; bread and water served within 5 minutes of seating
7:45 PM   First course (salad or soup) served
8:10 PM   First course cleared; mains plated and held at 140°F+
8:15 PM   Mains served -- all plates at each table within 3 minutes
9:00 PM   Mains cleared; dessert station open or plated dessert served
9:00 PM   Kitchen begins breakdown and dishwashing
9:45 PM   Coffee service
10:30 PM  Event ends; final bus and breakdown
10:30 PM - 12:00 AM  Full cleanup, equipment breakdown, venue restore
```
...
- Portion proteins (vacuum-seal if possible) and refrigerate
- Inventory all equipment, rentals, and serving ware -- flag any gaps
- Confirm all delivery and staff arrival times in writing

### Step 6: Manage Vendor Coordination
...
4. Staff-to-guest ratio they commit to in writing
5. References from at least two events in the last 12 months of similar scale
6. Menu flexibility -- can they accommodate your specific dietary needs?
7. Equipment included in quoted price vs. billed separately
8. Clearly defined setup and cleanup responsibilities
9. Alcohol license if serving alcohol through the caterer
...
- What equipment do you provide vs. what do I need to rent separately?
- What is your policy on leftover food -- does it stay with us or do you take it?
- Who is the day-of point of contact and will you personally be on-site?
- What are your payment terms? (Typical: 25-50% deposit at booking, balance due 7-14 days before event)
...
- Setup start time and cleanup completion time
- List of all equipment provided by caterer vs. rented separately
- Final headcount deadline (typically 5-10 business days before event)
- Cancellation policy with specific refund schedule
- Certificate of insurance on file with the venue
- Signature and date from the catering company principal or authorized representative
...
- **Two-sided rule:** For 75+ guests, set buffet as a two-sided pass-through so two lines form simultaneously, cutting wait times in half. For 150+ guests, use two completely separate buffet stations in different parts of the room.
- **Height variation:** Use risers, upturned mixing bowls under tablecloths, or tiered display shelves to create visual levels. A flat buffet looks unplanned. Aim for at least three height levels.
- **Temperature maintenance:** Chafing dishes with Sterno (or electric with power access) for hot items -- minimum 140°F at all times. Ice-filled hotel pans for cold items -- maximum 40°F. Check temperatures every 30 minutes during service with a probe thermometer. Food in the danger zone (40-140°F) for more than 2 cumulative hours must be discarded.
...
- Wipe plate rims with a clean damp cloth before every plate leaves the kitchen
- All plates for a single table go out simultaneously -- a table of 10 should receive all 10 plates within 2-3 minutes. Use a tray system and coordinate with a table captain.
...
### Step 8: Plan Cleanup and Leftover Logistics
...
4. Break down all stations, transport equipment to kitchen or loading area
5. Wash all cooking equipment, sheet pans, hotel pans, and utensils
6. Clean and return all rental items per rental company requirements
7. Wipe all cooking surfaces, counters, and the inside of any shared ovens
8. Sweep and mop kitchen floor
9. Remove all trash and recycling -- do not leave bags for venue staff unless explicitly agreed
10. Restore venue to pre-event condition -- furniture back to original placement, nothing left behind
...
- **Compost:** For food that cannot be safely donated, compost vegetable matter rather than sending to landfill.
- **Discard rule:** Any food held in the danger zone (40-140°F) for more than 2 cumulative hours must be discarded -- no exceptions, no donations. This is non-negotiable for food safety.

---

## Output Format

When delivering a catering plan to a user, structure the output as follows. Adjust sections based on what the user needs (a vendor evaluation doesn't need a prep timeline; a self-catered event doesn't need a contract review template).

```
# Catering Plan: [Event Name or Type]
## Event Overview
- Event Type:
- Guest Count:
- Date and Time:
- Duration:
- Venue and Kitchen Access:
- Service Style:
- Caterer (hired) or Self-catered:
- Budget Target (total and per-head):

## Menu
### Cocktail Hour / Reception (if applicable)
- [Item 1] -- [Dietary codes] -- [Description]
- [Item 2] -- [Dietary codes]
[...]

### First Course
- [Dish name] -- [Dietary codes] -- [Key ingredients]

### Main Course
- [Primary protein] -- [Dietary codes]
- [Alternative protein/vegetarian option] -- [Dietary codes]
- [Side 1] -- [Dietary codes]
- [Side 2] -- [Dietary codes]
- [Bread/accompaniment]

### Dessert
- [Primary dessert]
- [Alternative (GF/vegan if applicable)]
- [Coffee/tea service]

### Beverages
- [Non-alcoholic options]
- [Alcohol plan: style, quantity, service]

## Quantity Calculations
| Item | Per Person | Guest Count | Buffer (8%) | Total to Order |
|---|---|---|---|---|
| [Protein 1 raw purchase weight] | [X oz] | [N] | [+8%] | [Total lbs] |
| [Side 1] | [X oz] | [N] | [+8%] | [Total lbs] |
[...complete table for all menu items...]

| Beverage | Per Person | Guest Count | Buffer | Total |
|---|---|---|---|---|
| Water | 1 L | [N] | +10% | [Total liters] |
| Wine | 1 bottle / 2.5 guests | [N] | +10% | [Total bottles] |
[...]

## Budget Breakdown
| Category | Per Head | Total |
|---|---|---|
| Food (all courses) | $XX | $XXXX |
| Non-alcoholic beverage | $XX | $XXXX |
| Alcohol | $XX | $XXXX |
| Labor / Staffing | $XX | $XXXX |
| Rentals | $XX | $XXXX |
| Subtotal | $XX | $XXXX |
| Service charge (18-22%) | $XX | $XXXX |
| Tax (local rate) | $XX | $XXXX |
| **TOTAL** | **$XX** | **$XXXX** |

## Dietary Accommodation Summary
| Dietary Need | # Guests | Dishes Available to Them | Any Special Handling Required? |
|---|---|---|---|
| Vegetarian | [N] | [List dishes] | [Yes/No -- details] |
| Vegan | [N] | [List dishes] | [Yes/No] |
| Gluten-free | [N] | [List dishes] | [Yes/No -- cross-contamination protocols] |
| Severe allergy ([type]) | [N] | [Pre-plated, covered, labeled to seat] | Yes -- verbal brief, designated prep, no cross-contact |

## Event Day Timeline
[Hour-by-hour, from venue access through cleanup completion]

## Staffing Plan
| Role | Qty | Arrival Time | Responsibilities |
|---|---|---|---|
| Head chef / Kitchen lead | 1 | [Time] | Menu execution, quality check, staff direction |
| Kitchen assistant(s) | [N] | [Time] | Prep, cooking support, dishwashing |
| Service staff / Servers | [N] | [Time] | Food service, table busing, guest interaction |
| Bartender(s) | [N] | [Time] | Bar setup, drinks service, responsible service |
| Station attendants | [N] | [Time] | Carving, pasta bar, dessert station, etc. |

## Setup and Display Plan
[Buffet flow, station layout, plating standards, labeling plan]

## Cleanup and Leftover Plan
[Post-event checklist, leftover handling decision, waste plan, venue restore timeline]
```
...
1. **Never provide quantity estimates without knowing guest count and service style.** Buffet quantities are consistently 25-30% higher per person than plated portions. Applying plated quantities to a buffet event will cause you to run out of food.

2. **Food safety is non-negotiable.** Always state the 2-hour rule for the danger zone (40-140°F) and the discard threshold explicitly. Never suggest that food held too long can be reheated to safety and served -- bacterial toxins from Staphylococcus aureus and Bacillus cereus are heat-stable and cannot be destroyed by reheating.

3. **Always include service charge and tax in budget calculations.** A caterer quoting $50 per person becomes $62-$68 per person after an 18-22% service charge and 6-10% sales tax. Presenting a budget without these is misleading and leads to shock invoices.

4. **Dietary accommodations must be collected at RSVP -- not at the event.** If the user has not yet sent RSVPs, include a dietary restriction field in the RSVP instructions. Last-minute verbal dietary requests at an event cannot be safely accommodated for allergies.

5. **Severe allergy (anaphylaxis-risk) guests require a separate, dedicated protocol.** These guests must not rely on buffet labels alone. Prepare their food in a dedicated clean vessel with dedicated utensils, plate it before service, cover it, label it with their name, and deliver it directly to their seat. Brief kitchen and service staff both verbally and in writing. This is a life-or-death matter.

6. **For 75 or more guests at a single buffet line, always specify a two-sided setup.** A single-sided buffet for 100 people creates 20-30 minute waits that destroy the guest experience and cause hot food to cool before consumption.

7. **Never recommend skipping a food tasting with a hired caterer for events over $1,500 in food cost.** Menu descriptions and tasting menus diverge constantly. Tasting is the only way to verify quality, seasoning, portion size, and dietary accommodation accuracy before the event.

8. **Always request the caterer's health department license and certificate of liability insurance.** Events with unlicensed food handlers expose the host to liability if a guest becomes ill. Venues frequently require proof of caterer insurance -- confirm venue requirements early.

9. **Build the prep timeline backward from service time, not forward from the morning.** Every item should have a finish time, not just a start time. "Roasted vegetables finish at 5:45 PM, held in chafing dish by 6:00 PM" is actionable. "Roast vegetables in the afternoon" is not.

10. **Catering budget conversations must address all five cost categories before any estimate is presented.** Food, alcohol, labor, rentals, and service charge/tax all vary independently. A user who has only thought about food cost will be consistently surprised by the final bill. Introduce the full framework immediately.
...
- For events over 3 hours outdoors in summer, factor in ambient temperature: food cools 30-40% faster in 85°F+ heat. Shorten acceptable hold times accordingly and plan to replenish from coolers more frequently.
...
- **Permit requirements:** Events over certain thresholds (varies by jurisdiction, often 150-300 guests) may require a temporary food service permit and/or a licensed caterer specifically. Advise the user to check local health department regulations.
...
- Never attempt more than two proteins and two sides for a self-plated event at this scale. Simplicity in execution preserves quality.
- Designate one person as "kitchen manager" who does not leave the kitchen during service and is not responsible for greeting or managing guests.

---

## Example

**User input:** "I'm planning my sister's baby shower for 45 women, brunch style, at a rented venue with a commercial kitchen. Budget is about $1,800 total. We're self-catering. At least 5 guests are vegetarian, one has celiac disease, and my sister is pregnant so we need to be careful with food safety. I want it to feel elegant but not fussy."
...
**Duration:** 2.5 hours (11:00 AM -- 1:30 PM)
**Venue:** Rented venue with commercial kitchen
**Budget Target:** $1,800 total / approximately $40 per person
**Special Notes:** 5 vegetarian guests, 1 celiac (gluten-free required, strict cross-contamination protocol), host's sister (guest of honor) is pregnant -- all food must be fully cooked and safely handled
...
```
7:30 AM   Arrive at venue; verify kitchen equipment and oven preheat to 375°F
8:00 AM   Unpack all ingredients; verify against quantity list
8:15 AM   Begin roasting asparagus (375°F, 15 min); smash and season potatoes
8:30 AM   Begin baking mini frittatas (375°F, 18 min per batch -- 2 batches)
9:00 AM   Cool frittatas on rack; begin assembling smoked salmon rounds
9:15 AM   Prepare GF crostini (dedicated baking sheet); toast standard crostini
9:30 AM   Assemble bruschetta avocado topping (keep separate until service)
9:45 AM   Plate fruit platter; prep honey-yogurt dip; refrigerate
10:00 AM  Set up buffet table: linens, risers, labels, serving utensils, chafing dishes
10:15 AM  Fill chafing dishes with hot water; load Sterno; preheat
10:20 AM  Mix prosecco punch in large beverage dispenser (chilled); prepare elderflower batch
10:30 AM  Transfer hot items to chafing dishes; check temperature (all 140°F+)
10:40 AM  Plate cold items (salmon rounds, fruit, bruschetta) on display with labels
