---
name: financial-fraud-protection
description: |
  Comprehensive guide to protecting against financial fraud including identity theft prevention strategies, credit monitoring setup, scam identification (phishing, vishing, romance, investment), fraud reporting procedures, credit freeze and lock mechanisms, recovery steps after fraud occurs, elder fraud awareness, and teaching children about scam recognition.
  Use when the user asks about financial fraud protection, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of financial fraud protection or requires a different specialized skill.
license: Apache-2.0
metadata:
...
1. Have you or a family member been a victim of fraud or identity theft?
2. Do you monitor your credit reports regularly?
3. Do you have a credit freeze in place?
4. Are there elderly family members who may be targets for scams?
5. Do you receive frequent unsolicited calls, emails, or messages?
6. How do you currently protect sensitive financial information?
7. Do you use online banking and payment apps?
8. Are you concerned about a specific type of fraud?
9. Do you share financial information with family members or caregivers?
10. Have you educated your household members about common scams?

---

## Phase 1: Identity Theft Prevention
...
- [ ] Limit what you carry in your wallet (only cards you need today)
- [ ] Store sensitive documents in a locked safe or secure location
...
- [ ] Use secure connections (HTTPS, VPN on public Wi-Fi)
- [ ] Do not enter financial information on public computers
...
- [ ] Collect mail promptly; hold mail when traveling
...
- [ ] Balances you do not recognize
- [ ] Late payments on accounts that are not yours
- [ ] Collection accounts that are not yours
- [ ] Public records (bankruptcies, judgments) that are not yours
...
- When in doubt, go directly to the organization's website (do not click the link)
...
- "This is Microsoft/Apple. Your computer has a virus."
- "You've won a sweepstakes. Pay the tax to claim your prize."
...
- Legitimate companies never call to demand gift card payment
- If in doubt, hang up and call the organization at their official number
...
- Starts asking for money (emergency, travel to see you, medical crisis)
- Stories do not add up or change over time
- Wants to move off the dating platform to private messaging quickly
...
- Tell friends and family about the relationship (outside perspective matters)
...
- Returns that are consistently too good to be true
...
- Be especially cautious of cryptocurrency and forex trading schemes
...
## Phase 4: Credit Freeze and Lock
...
4. Store these PINs securely (you need them to lift the freeze)
...
- Lift takes effect within 1 hour (by law for online/phone, 3 business days by mail)
...
## Phase 5: Fraud Reporting and Recovery
...
4. File a police report (you will need this for disputes and creditors)
...
- [ ] Notify the Social Security Administration if your SSN was compromised
- [ ] Contact the IRS if tax fraud is suspected (IRS Identity Protection PIN)
- [ ] File with the FTC at IdentityTheft.gov for your personalized recovery plan
...
- Consider an identity theft protection service during recovery
- Review and update your fraud alert or credit freeze as needed
...
USPS Mail Fraud: 1-877-876-2455
FCC (phone scams): fcc.gov/consumers/guides/stop-unwanted-calls
...
- May be isolated (fewer people to consult about suspicious contacts)
- May be experiencing cognitive decline affecting judgment
- Often reluctant to report fraud due to embarrassment
...
- Establish a trusted contact person at their financial institution
- Consider a credit freeze if they are not actively seeking new credit
- Know the signs of financial exploitation (sudden changes in spending, new "friends" with financial interest, confusion about finances)
- Report suspected elder fraud to Adult Protective Services

---

## Phase 7: Teaching Kids About Scams
...
- Protect passwords and do not share them with friends
- Understand in-app purchases and gaming scams
...
- Understand financial basics (how credit works, why SSN matters)
- Recognize romance scams on social media
...
- "Here's how to check if a website is legitimate before buying anything"
...
- [ ] Credit monitoring active (free or paid)
- [ ] Annual credit report review scheduled
- [ ] Important documents secured (safe, cloud backup)
- [ ] Pre-approved credit offers opted out
...
- [ ] Review Social Security statement annually (ssa.gov)
- [ ] Update passwords annually for financial accounts
- [ ] Discuss new scam types with family regularly
...
2. **Analyze context.** Review the information provided and identify key factors relevant to financial fraud protection
...
```template
## Financial Fraud Protection Analysis
...
**Input:** "Help me with financial fraud protection for my current situation"

**Output:**

Based on your situation, here is a structured approach to financial fraud protection:
