...
description: |
  Practical guide to designing corporate wellness programs covering needs assessment, engagement strategies, program components, measurement and metrics, incentive design, and demonstrating ROI for organizational health and wellbeing initiatives.
...
1. **What is the organizational context?** (Size, industry, culture, workforce demographics)
2. **What is driving this initiative?** (Health costs, engagement, retention, leadership)
3. **What wellness programs exist today?** (And what is working or not)
4. **What data is available?** (Claims data, engagement surveys, absenteeism)
5. **What is the budget?** (Per employee per year, total program budget)
6. **Who is the executive sponsor?** (Crucial for sustainability)
7. **What are the workforce health challenges?** (Stress, MSK, chronic disease, mental health)
8. **Are there union or regulatory considerations?** (Privacy, EEOC, ADA)
...
2. **Analyze context.** Review the information provided and identify key factors relevant to wellness program designer
