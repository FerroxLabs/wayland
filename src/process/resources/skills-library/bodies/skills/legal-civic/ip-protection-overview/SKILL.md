---
name: ip-protection-overview
description: |
  Compares the four main types of intellectual property protection: copyright, trademark, patent, and trade secret. Explains what each protects, how protection is obtained, duration, registration processes, and when each type applies. Produces a structured comparison to help users identify which protections may apply to their work.
  Use when the user wants to understand intellectual property basics, needs to identify which IP protection applies to their creation, or wants to prepare for a consultation with an IP attorney.
  Do NOT use for filing patent or trademark applications, IP infringement analysis, licensing agreement drafting, or specific legal advice on IP disputes.
license: Apache-2.0
metadata:
...
- The user wants specific analysis of an employment contract's IP ownership provisions -- use `employment-contract-reader`
- The user wants to understand NDA protections for confidential information in a specific business context -- use `nda-clause-explainer`
- The user is asking about copyright infringement they may have committed (for example, using an image they found online) -- this is infringement analysis requiring legal advice, not general IP education
...
1. **Always present the disclaimer at the top of every output.** IP law is an area where incomplete information can cause serious financial and legal harm. The disclaimer is not boilerplate -- it is a substantive boundary.

2. **Never tell a user whether their specific work qualifies for a specific type of IP protection.** Present the legal requirements and let the user evaluate with professional guidance. Saying "your invention is patentable" or "your logo will definitely get trademark registration" is practicing law, not providing legal literacy.

3. **Never advise a user to file or not to file a specific IP application.** Identify the relevant considerations, costs, timelines, and risks -- but the decision belongs to the user in consultation with a qualified attorney.

4. **Always flag the patent public disclosure timing trap explicitly and prominently whenever the user describes a potential invention.** The loss of international patent rights through a pre-filing disclosure is a one-way, irreversible event. This is the single most time-sensitive issue in all of IP law for innovators.

5. **Always distinguish between copyright protecting expression and not protecting ideas.** This is the most commonly misunderstood boundary in copyright law. Users consistently believe they can copyright an idea, a concept, a style, or a method -- they cannot. The idea-expression dichotomy must be explained clearly every time copyright is discussed.

6. **Always distinguish between trademark rights arising from use vs. registration.** Common law trademark rights exist without registration. Federal registration expands and strengthens those rights but does not create them from scratch. Failing to explain this leads users to believe unregistered marks are unprotected, which is wrong.

7. **Always note the work-for-hire doctrine when discussing copyright in any context involving an employer-employee or client-contractor relationship.** The assumption that "I made it, I own it" is wrong in both the employment context (employer owns it automatically) and frequently wrong in the contractor context (contractor may own it by default without a written assignment). This misunderstanding has caused enormous commercial disputes.

8. **Always specify actual dollar amounts and timeframes for each IP type.** Abstract descriptions of "costly" or "time-consuming" processes are unhelpful. Users need to understand that a copyright registration costs $45-$65, a trademark filing costs $250-$350 per class, and a utility patent costs $5,000-$15,000+. These numbers calibrate expectations and help users decide where to allocate resources.

9. **Always address the possibility of layered IP protection when the user's situation involves a complex creation.** A single product or business can -- and often should -- have multiple types of IP protection applied to different elements simultaneously. Presenting the four types as mutually exclusive leads to under-protection.

10. **Always flag the jurisdiction limitation of every statement of IP law.** U.S. IP law governs the specific rules, costs, and timelines provided in this skill. Users in other countries or with cross-border operations need jurisdiction-specific legal advice. This is especially critical for patent timing (the international grace period issue), trademark coverage (national or regional scope), and trade secret law (which varies significantly by country).

11. **Never present fair use as a reliable permission to use copyrighted material.** Fair use is a defense evaluated case by case by a court. There is no formula, no safe percentage, no safe number of seconds. Users who rely on assumed fair use without legal advice regularly face infringement claims.

12. **Always address the strategic trade-off between patent and trade secret protection for processes and formulas.** These two options are mutually exclusive in a meaningful sense: once you file a patent application, the information will be publicly disclosed. Users making this decision without understanding the trade-off may permanently foreclose their best strategic option.
...
- **Patent co-inventorship:** Each person who contributed to the conception of at least one claim of the patent is a co-inventor. Each co-inventor in the U.S. independently has the right to practice the invention and license it to third parties without the other inventors' consent (though they must share proceeds). This is catastrophic for companies that have not obtained inventor assignment agreements.
- **The fix:** Employment agreements and contractor agreements must include written IP assignment provisions transferring all IP rights -- including copyright, patents, and trade secrets -- to the company. These agreements should be signed BEFORE work begins. Assignment of already-created IP requires explicit language.
- When handling this edge case, always note that specific ownership questions -- especially involving past work without assignment agreements -- require an attorney review of existing agreements and applicable law.

---

### Freelancers and Independent Contractors -- The Copyright Ownership Trap

This is one of the most practically impactful and consistently misunderstood areas of copyright law.

- The default rule: an independent contractor who creates a work owns the copyright in that work, regardless of whether the client paid for it, unless a valid written work-for-hire agreement or copyright assignment has been signed.
- The nine statutory categories for work-for-hire with contractors are narrow: contribution to a collective work, part of a motion picture or other audiovisual work, a translation, a supplementary work, a compilation, an instructional text, a test, answer material for a test, and an atlas. Custom software, website code, marketing collateral, and standalone illustrations do NOT automatically fall in these categories.
- The practical implication: A company that pays a freelance developer $50,000 to build a custom software platform may own nothing -- the developer retains the copyright unless a written assignment was executed. This has been litigated in numerous high-profile cases.
- When a user asks about who owns their work product: present the work-for-hire doctrine clearly, explain the contractor default rule, and direct them to have any existing or future agreements reviewed by an attorney.

---

### Domain Names vs. Trademarks -- A Persistent Confusion

Users frequently conflate domain name ownership with trademark rights. These are legally distinct.

- Registering a domain name (through GoDaddy, Namecheap, or any registrar) gives you a contractual right to use that domain name through ICANN's domain name system. It is NOT a trademark registration and does NOT create trademark rights.
- Owning a trademark does NOT automatically entitle you to the corresponding domain name.
- Domain disputes are handled through ICANN's Uniform Domain Name Dispute Resolution Policy (UDRP), which evaluates whether a domain was registered in bad faith by someone without legitimate rights (cybersquatting). If you have a trademark registration, you are in a much stronger position in a UDRP proceeding.
- Registering a business name with a state secretary of state is ALSO not a trademark registration. A state business registration gives you the right to operate a business under that name in that state -- it creates no IP rights in the name.
- The user should conduct a trademark search AND check domain availability as separate, parallel steps before launching a brand.

---

### International IP -- Priority Filing and Multi-Jurisdiction Strategy

When a user has any international business presence or ambitions, the territorial nature of IP law creates significant complexity.

- **Copyright:** The Berne Convention (179 member countries) provides that works created in one member country are automatically protected in all other member countries under each country's local copyright law. This is the most internationally seamless IP protection -- but enforcement still requires local legal action in each country.
- **Trademarks:** Rights are territorial. A U.S. federal trademark registration provides no rights in the EU, Canada, or China. Options for international filing: (1) file directly in each country (expensive), (2) use the Madrid Protocol (administered by WIPO) to file an "international application" designating multiple countries from a single filing for a base fee plus per-country fees. The Madrid Protocol currently covers 130 countries. A U.S. trademark application can serve as the "home" application for a Madrid filing.
- **Patents:** Rights are entirely territorial. Options: (1) file directly in each country, (2) use the Patent Cooperation Treaty (PCT) -- a single "international application" filed with WIPO that establishes a filing date in all 157 PCT member countries and provides an international search report, but still requires entering national phase (separate national filings with translation costs) within 30 months of the priority date in each target country. PCT filing costs: $1,500-$3,000+ in initial fees, plus $5,000-$15,000+ per country in national phase.
- **Trade secrets:** Protected by domestic law in each country. There is no international trade secret treaty equivalent to the Berne Convention. Contractual protections (NDAs with governing law and choice of forum clauses) are the primary tool for international trade secret protection.

---

### Recipes, Formulas, and Food Products -- Patent vs. Trade Secret Decision

This specific scenario comes up frequently (food entrepreneurs, craft beverage producers, artisans) and involves a specific strategic decision with long-term consequences.

- A recipe or formula can theoretically be patented as a "composition of matter" if it is novel, non-obvious, and useful. However, patent protection requires full public disclosure of the formula in the patent application. Once published (18 months after filing), every competitor can see the exact formula.
- A recipe cannot typically be protected by copyright -- functional information (ingredient ratios, cooking steps) is not protectable expression, though the creative description of a recipe in narrative form may be.
- The dominant strategy for food/beverage formulas: trade secret. Keep the formula confidential, restrict access, execute NDAs with manufacturing partners, and use "split formula" manufacturing (have different facilities produce different components and combine them in-house so no single contractor knows the full formula).
- Design the product label as a separate copyrightable work and file trademark applications for the brand name and logo.
- The trade secret strategy works only for formulas that cannot be reverse-engineered from the finished product -- a food scientist with access to the product may be able to identify the ingredients and approximate ratios. Consider whether your formula is actually reverse-engineerable before assuming trade secret protection is durable.

---

### Early-Stage Startups and IP Asset Building Before Fundraising

Investors -- especially institutional venture capital -- conduct IP due diligence before investing. IP ownership gaps are a common deal-killer.

- All founder IP contributions must be formally assigned to the company entity before fundraising. "I contributed the technology I developed" is not sufficient without a signed IP assignment agreement or technology transfer agreement from each founder.
- All employee and contractor work product should be covered by written IP assignment agreements. Standard startup employment offers include a Proprietary Information and Inventions Agreement (PIIA) that assigns all work product to the company -- if these have not been executed with early employees or contractors, there may be ownership gaps.
- Key registrations to have in place before a Series A: (1) federal trademark application for the primary brand name and product name(s), (2) copyright registrations for key creative assets (website design, software if distributed), (3) any patent applications filed (even provisional applications to establish priority dates).
- Trade secret program: investors want to see that confidential technology is actually being treated as confidential -- access controls, NDA programs, and employee departure procedures all provide evidence of a functional trade secret program.
...
> "I've built a mobile app for tracking personal finances. I came up with a unique algorithm for categorizing transactions automatically that I haven't seen anywhere else. The app has a name and logo I designed myself. I showed a demo to investors last month at a pitch event but haven't launched publicly yet. I work alone but I'm about to hire my first developer. What should I protect and how?"

---

**Full Output:**

## IP Protection Analysis: Personal Finance Mobile App

> **Disclaimer:** This analysis provides general legal literacy and educational information only.
> It does not constitute legal advice. Consult a qualified IP attorney for advice specific to your
> situation. Laws vary by jurisdiction and change over time.
...
- **⚠️ Critical Timing Concern:** A public demonstration at a pitch event likely constitutes a "public disclosure" for U.S. patent purposes. The 1-year U.S. grace period has already begun running. If the algorithm may be patentable, a patent application (at minimum a provisional application) should be filed within the next 11 months -- sooner is strongly preferred. Internationally, most jurisdictions require filing BEFORE public disclosure -- those opportunities may already be foreclosed. Consult a patent attorney immediately.
