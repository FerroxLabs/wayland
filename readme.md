...
[Why Choose Wayland?](#-why-choose-wayland-over-claude-cowork) ·
...
**Wayland is more than a chat client.** It's a Cowork platform where AI agents work alongside you on your computer — reading files, writing code, browsing the web, and automating tasks. You see everything the agent does, and you're always in control.

|                                 | Traditional AI Chat Clients | **Wayland (Cowork)**                                                                                                           |
| :------------------------------ | :-------------------------- | :---------------------------------------------------------------------------------------------------------------------------- |
...
Wayland ships with a complete AI agent engine. Unlike tools that require you to install CLI agents separately, **Wayland works the moment you install it**.
...
> Morph-animated slide-to-slide transitions with coherent story pacing; powered by [OfficeCLI](https://github.com/TradeCanyon/OfficeCli).
...
> Paper/thesis writing and production-ready document editing via the `docx` skill; powered by [OfficeCLI](https://github.com/TradeCanyon/OfficeCli).
...
> Generate/refresh spreadsheets with `xlsx` for analysis, auto-formatting, and charts; powered by [OfficeCLI](https://github.com/TradeCanyon/OfficeCli).
...
If you already use Claude Code, Codex, Hermes Agent, or OpenClaw, Wayland auto-detects them and lets you Cowork with all of them — alongside the built-in agent.

**Supported Agents:** Built-in Agent (zero setup) • Claude Code • Codex • Qwen Code • Goose AI • OpenClaw • Augment Code • CodeBuddy • Kimi CLI • OpenCode • Factory Droid • GitHub Copilot • Qoder CLI • Mistral Vibe • Nanobot • Wayland-Core (Rust engine, bundled zero-config agent) • Snow CLI • Kiro • Hermes Agent • Cursor Agent and more
...
- **Supported backends** — Claude Code, Codex, Gemini, Snow CLI, Wayland-Core; other ACP backends with `mcpCapabilities.stdio` are auto-supported
...
Other AI apps give you a chatbox with your API key. **Wayland gives you a full Cowork agent.**
...
| AWS Bedrock credentials                 | Bedrock-powered Agent via Wayland-Core      |
| Ollama / LM Studio (local)              | Local model Cowork Agent                    |
| NewAPI Gateway                          | Unified access to 20+ models                |

Same agent capabilities — file read/write, web search, image generation, tool use — regardless of which model powers it. Wayland supports **20+ AI platforms** including cloud services and local deployments.
...
Wayland also supports [NewAPI](https://github.com/QuantumNous/new-api) gateway service — a unified AI model hub that aggregates and distributes various LLMs. Flexibly switch between different models in the same interface to meet various task requirements.
...
- **Three-tier Skills** — Builtin skills (shipped with Wayland), custom skills (your own), and Extension skills (contributed by third-party extensions); enable/disable per conversation with the skill indicator
...
Wayland supports three skill layers: **built-in** skills (shipped with the app), **custom** skills (user-defined), and **extension** skills (loaded from the Extension SDK).
...
Wayland includes **20 professional assistants** with predefined capabilities, extendable through custom skills:
...
**Custom Skills**: Create skills in the `skills/` directory, enable/disable skills for assistants to extend AI capabilities. Skills come from three sources: builtin (shipped with Wayland), custom (your own), and Extension (contributed via the Extension SDK). Built-in skills include `pptx`, `docx`, `pdf`, `xlsx`, `mermaid`, and more.
...
_Your 24/7 AI assistant — access Wayland from any device, anywhere._
...
> **Setup:** Wayland Settings → WebUI Settings → Channel, configure the Bot Token.
...
> [Remote Internet Access Tutorial](https://github.com/TradeCanyon/Wayland/wiki/Remote-Internet-Access-Guide-Chinese)
...
- **Keep-awake** — Wayland automatically prevents system sleep while tasks are active, and detects missed triggers after wake
...
> [Image generation model configuration guide](https://github.com/TradeCanyon/Wayland/wiki/Wayland-Image-Generation-Tool-Model-Configuration-Guide)
...
## 🤔 Why Choose Wayland Over Claude Cowork?
...
Wayland is a **free and open-source Multi-AI Agent Desktop**. Compared to Claude Cowork which only runs on macOS and is locked to Claude, Wayland is its full-model, cross-platform enhanced version.

| Dimension     | Claude Cowork | Wayland                                                            |
| :------------ | :------------ | :---------------------------------------------------------------- |
...
A: <strong>No.</strong> Wayland has a built-in AI agent that works immediately after installation. Just sign in with Google or enter any API key. If you also have CLI tools like Claude Code or Gemini CLI installed, Wayland will auto-detect and integrate them for even more capabilities.
</details>

<details>
<summary><strong>Q: What can I do with Wayland?</strong></summary>
A: Wayland is your <strong>private Cowork workspace</strong>. The built-in agent can batch organize folders, process Excel data, generate documents, search the web, and generate images. With Multi-Agent Mode, you can also leverage Claude Code, Codex, and other powerful CLI agents through the same interface.
</details>

<details>
<summary><strong>Q: Is it free?</strong></summary>
A: Wayland is completely free and open source. You can sign in with Google to use Gemini for free, or use API keys from any provider you prefer.
</details>

<details>
<summary><strong>Q: Can I run Wayland on a server (headless)?</strong></summary>
A: Yes — Wayland WebUI mode runs as a standalone HTTP server. See the WebUI section above for setup instructions.
</details>
...
> **Made a video about Wayland?** [Let us know on X](https://x.com/Wayland) and we'll feature it here!
...
- [📖 Complete Installation Guide](https://github.com/TradeCanyon/Wayland/wiki/Getting-Started) — Detailed steps from download to configuration
- [⚙️ LLM Configuration Guide](https://github.com/TradeCanyon/Wayland/wiki/LLM-Configuration) — Multi-platform AI model configuration
- [🤖 Multi-Agent Mode Setup](https://github.com/TradeCanyon/Wayland/wiki/ACP-Setup) — Integrate terminal AI agents
- [🔌 MCP Tool Configuration](https://github.com/TradeCanyon/Wayland/wiki/MCP-Configuration-Guide) — Model Context Protocol server setup
- [🌐 WebUI Configuration Guide](https://github.com/TradeCanyon/Wayland/wiki/WebUI-Configuration-Guide) — Complete WebUI setup and configuration tutorial

**🎯 Use Cases**

- [📁 File Management](https://github.com/TradeCanyon/Wayland/wiki/file-management) — Smart file organization
- [📊 Excel Processing](https://github.com/TradeCanyon/Wayland/wiki/excel-processing) — AI-driven data processing
- [🎨 Image Generation](https://github.com/TradeCanyon/Wayland/wiki/Wayland-Image-Generation-Tool-Model-Configuration-Guide) — AI image creation
- [📚 More Use Cases](https://github.com/TradeCanyon/Wayland/wiki/Use-Cases-Overview)

**❓ Support & Help**

- [❓ FAQ](https://github.com/TradeCanyon/Wayland/wiki/FAQ) — Questions and troubleshooting
- [🔧 Configuration & Usage Tutorials](https://github.com/TradeCanyon/Wayland/wiki/Configuration-Guides) — Complete configuration documentation
...
- [GitHub Discussions](https://github.com/TradeCanyon/Wayland/discussions) — share ideas and exchange tips
- [Report Issues](https://github.com/TradeCanyon/Wayland/issues) — bugs and feature requests
- [Release Updates](https://github.com/TradeCanyon/Wayland/releases) — get the latest version
...
[Report Bug](https://github.com/TradeCanyon/Wayland/issues) · [Request Feature](https://github.com/TradeCanyon/Wayland/issues)
