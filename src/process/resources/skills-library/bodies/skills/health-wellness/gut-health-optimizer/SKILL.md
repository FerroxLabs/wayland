...
description: |
  Evidence-based microbiome optimization through prebiotics, probiotics, fermented foods, fiber diversity, elimination diets, and lifestyle factors for digestive wellness.
  Use when the user asks about gut health optimizer, or needs help with evidence-based microbiome optimization through prebiotics, probiotics, fermented foods, fiber diversity, elimination diets, and lifestyle factors for digestive wellness.
  Do NOT use when the request requires professional medical advice or falls outside the scope of gut health optimizer.
license: Apache-2.0
metadata:
...
> **HEALTH DISCLAIMER**: This guide provides general educational information about digestive health and nutrition. It is not a substitute for professional medical advice. If you have diagnosed digestive conditions (IBS, IBD, SIBO, celiac disease, etc.), are taking medications, or experience persistent digestive symptoms, consult a gastroenterologist or registered dietitian before making significant dietary changes. Elimination diets should ideally be supervised by a healthcare professional.
...
Your gastrointestinal tract hosts approximately 38 trillion microorganisms, collectively weighing 2-5 pounds. This ecosystem includes:

- **Bacteria**: 500-1000+ species, dominated by Firmicutes and Bacteroidetes phyla
- **Fungi**: Including Candida, Saccharomyces species
- **Archaea**: Methane-producing organisms
- **Viruses**: Bacteriophages that regulate bacterial populations

### Why Microbiome Diversity Matters

Higher microbial diversity consistently correlates with better health outcomes. A diverse microbiome:

- Produces a wider range of short-chain fatty acids (SCFAs)
- Provides greater immune system training and regulation
- Offers more robust resistance to pathogenic colonization
- Supports broader nutrient synthesis (vitamins K, B12, folate, biotin)
...
- Microbial metabolites crossing the blood-brain barrier

This explains documented connections between gut health and mood, anxiety, cognition, and sleep quality.

## The 30-Plant Challenge

Research from the American Gut Project found that people who consumed 30+ different plant foods per week had significantly more diverse microbiomes than those eating fewer than 10.
...
Total unique plants this week: _____
Target: 30+
```
...
- Add berries to breakfast (blueberries, raspberries, strawberries = 3 plants)
- Use grain rotation: rice one day, quinoa next, oats next
...
**Week 2**: Switch to whole grains at all meals
**Week 3**: Add 2 additional servings of vegetables
**Week 4**: Add nuts, seeds, or berries as snacks
**Ongoing**: Continue expanding variety

**Hydration**: Increase water intake proportionally with fiber. Fiber without adequate water causes constipation.

## Prebiotic Foods

Prebiotics are specific fibers and compounds that selectively feed beneficial bacteria.
...
The Stanford SONC study (2021) found that a high-fermented-food diet increased microbiome diversity more than a high-fiber diet over 10 weeks.
...
- When fermented food intake is consistently low
...
- [ ] Appropriate storage (many require refrigeration)
...
- Brain fog, fatigue, or joint pain without clear cause
...
- Refined sugar
- Alcohol
- Caffeine (reduce gradually to avoid withdrawal)
...
- All meats, poultry, fish (unprocessed)
...
4. If no reaction, move to next food group
...
Foods eaten:
  ...
  Snacks: ___________________________

Symptoms (rate 0-3: none, mild, moderate, severe):
  Bloating: ___   Gas: ___   Pain: ___
  Diarrhea: ___   Constipation: ___
  Nausea: ___   Reflux: ___
  Energy: ___   Brain fog: ___
  Skin: ___   Joint pain: ___
  Mood: ___   Sleep quality: ___

Reintroduction food tested: ________________
...
- **Artificial sweeteners**: Some evidence of microbiome disruption (sucralose, saccharin)
...
- [ ] Minimize processed food to less than 20% of intake
...
**Input:** "Help me get started with gut health optimizer"

**Output:** A structured gut health optimizer plan tailored to the user's specific situation, following the process outlined above.
