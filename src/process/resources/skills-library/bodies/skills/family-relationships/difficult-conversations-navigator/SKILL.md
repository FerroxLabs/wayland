---
name: difficult-conversations-navigator
description: |
  Preparation frameworks for hard conversations, emotional regulation techniques, active listening, repair after conflict, and follow-up strategies for productive dialogue.
  Use when the user asks about difficult conversations navigator, or needs help with preparation frameworks for hard conversations, emotional regulation techniques, active listening, repair after conflict, and follow-up strategies for productive dialogue.
  Do NOT use when the request requires professional specialized advice or falls outside the scope of difficult conversations navigator.
license: Apache-2.0
metadata:
...
- Wait too long (resentment builds, making calm dialogue harder)
- Have the conversation at the wrong time or place
- Lack a clear goal for what they want to achieve

## The Preparation Framework

### Step 1: Clarify Your Objective

Before ANY difficult conversation, answer these questions:

```
CONVERSATION PREPARATION

What is the situation? (Facts only, no interpretation)
___________________________________________________

What is my goal for this conversation?
[ ] Understanding (I want to understand their perspective)
[ ] Behavior change (I need something to change)
[ ] Boundary setting (I need to establish/enforce a limit)
[ ] Information sharing (I need to share something difficult)
[ ] Relationship repair (I want to restore connection)
[ ] Decision making (We need to decide something together)
...
What might they be feeling or thinking? (Empathy check)
___________________________________________________
```

### Step 2: Separate the Three Conversations
...
- You have had time to prepare your thoughts
...
- At social events or in front of children
- When either person is under extreme stress about something else
...
- Avoid the urge to rebut while they are speaking
...
- Look for solutions that address both people's core concerns
- Agree on specific, observable commitments

### The Closing (Secure Agreement)

- Summarize what was decided
- Clarify specific actions each person will take
- Set a follow-up time to check in
- Express appreciation: "Thank you for having this conversation with me"
...
4. Ask a question instead of reacting (buys time and shifts focus)
...
4. Do NOT say "calm down" (it has the opposite effect)
5. Offer a break: "Would it help to take 10 minutes and come back to this?"
...
- Return at the agreed time, even if you do not feel ready

## Active Listening Techniques

### The HEAR Framework

**H**alt: Stop what you are doing. Full attention. No phone, no multitasking.
**E**mpathize: Try to understand their emotional experience, not just their words.
**A**sk: Clarify with open-ended questions. "Can you tell me more about that?"
**R**eflect: Mirror back what you heard. "It sounds like you felt dismissed when..."
...
- "If I were in your position, I think I'd feel... Is that close?"

### What to Listen For

- **Content**: The facts and events they describe
- **Emotion**: The feelings beneath the words (often unspoken)
- **Values**: What matters to them in this situation
- **Needs**: What they want or need going forward
- **Identity**: What this situation means about who they are

## Repair After Conflict

### The Effective Apology (Five Components)

1. **Acknowledgment**: "I understand that [specific action/behavior]..."
2. **Responsibility**: "That was my fault / I should not have done that"
3. **Impact recognition**: "I can see that it made you feel [emotion]"
4. **Commitment**: "Going forward, I will [specific change]"
...
- Accept that trust recovery takes longer than trust damage
...
- Consider involving HR for serious issues
...
- Express needs as requests, not demands
...
```
DIFFICULT CONVERSATIONS NAVIGATOR OUTPUT
========================================
...
**Input:** "Help me get started with difficult conversations navigator"

**Output:** A structured difficult conversations navigator plan tailored to the user's specific situation, following the process outlined above.
