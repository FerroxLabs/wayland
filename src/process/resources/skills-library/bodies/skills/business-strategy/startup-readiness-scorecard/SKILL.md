---
name: startup-readiness-scorecard
description: |
  Startup launch readiness assessment evaluating team composition, market validation, product maturity, financial preparedness, and legal foundation to produce a go/no-go scorecard.
  Use when the user asks about startup readiness scorecard, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of startup readiness scorecard or requires a different specialized skill.
license: Apache-2.0
metadata:
...
4. What is each founder's time commitment (full-time, part-time)?
...
9. How are potential customers solving this problem today?
...
14. What feedback have early users provided?
...
19. What revenue model are you planning?
...
24. What regulatory requirements apply to the business?
25. Have you consulted a startup attorney?
...
- Founding team dynamics (trust, communication, decision-making)
- Equity split fairness and vesting schedules
- Advisory board quality and engagement
- Ability to recruit early employees
...
4. Verbal commitment to buy at a specific price
5. Expressed strong interest in interviews
6. Survey respondents said they would buy
7. Friends and family said it is a good idea
...
- [ ] Product can handle expected early user volume
- [ ] Known bugs are documented and non-critical
- [ ] Security basics are covered (auth, encryption, input validation)
- [ ] Onboarding flow guides new users to value
...
- [ ] Funding sufficient for next 12+ months
...
- [ ] Employee/contractor agreements template ready
- [ ] Terms of service and privacy policy drafted
- [ ] Regulatory requirements identified and addressed
- [ ] Trademark search completed for company/product name
...
──────────────────────────────────────────────────────────────
Team Composition               [   ]        x 0.25 = [      ]
Market Validation              [   ]        x 0.20 = [      ]
Product Readiness              [   ]        x 0.20 = [      ]
Financial Preparedness         [   ]        x 0.15 = [      ]
Legal Foundation               [   ]        x 0.10 = [      ]
Go-to-Market Readiness         [   ]        x 0.05 = [      ]
Resilience and Adaptability    [   ]        x 0.05 = [      ]
──────────────────────────────────────────────────────────────
...
- Do not spend money on product development yet
...
- Seek mentors and advisors who have built similar businesses
...
- Begin GTM experiments in parallel with product work
...
- Prepare metrics dashboards for post-launch learning
- Plan the first 30/60/90 days post-launch
...
2. **Analyze context.** Review the information provided and identify key factors relevant to startup readiness scorecard
...
```template
## Startup Readiness Scorecard Analysis
...
**Input:** "Help me with startup readiness scorecard for my current situation"

**Output:**

Based on your situation, here is a structured approach to startup readiness scorecard:
