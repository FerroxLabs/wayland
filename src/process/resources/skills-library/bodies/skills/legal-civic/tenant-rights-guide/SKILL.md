...
description: |
  Provides a plain-language overview of common tenant rights including notice requirements, repair obligations, security deposit protections, eviction procedures, and anti-retaliation rules. Helps tenants understand their position and prepare for conversations with landlords, tenant rights organizations, or attorneys.
  Use when the user has a question about their rights as a renter, is facing a landlord dispute, wants to understand eviction procedures, or needs to know their obligations as a tenant.
...
- A tenant believes a rent increase, eviction filing, or service reduction occurred in response to a repair request or code enforcement complaint they made -- a potential retaliation claim
- A tenant moved out and did not receive their security deposit back within the time their state requires, or received a deduction they believe is improper (e.g., charged for normal wear and tear)
- A tenant is in a month-to-month rental arrangement and wants to understand their notice rights for termination or rent increases
- A tenant suspects they are being discriminated against in the terms, conditions, or enforcement of their tenancy based on a protected characteristic
...
- The user is a subtenant in a commercial co-working arrangement or business license situation -- these are not residential tenancies
- The user is asking for specific legal advice about a lawsuit they intend to file -- recommend an attorney; litigation strategy is outside the scope of legal literacy
- The user needs a formal demand letter drafted -- describe what the letter should include, but explain that a legal aid attorney or tenant rights organization can help draft one that will be effective in their jurisdiction
- The user is in a vacation rental or hotel stay (less than 30 days in most states) -- short-term occupancy laws differ fundamentally from residential tenancy law
- The user's dispute involves a condominium association or HOA as the adverse party -- HOA disputes involve a separate body of law, use a specialized skill if available

---

## Process

### Step 1: Gather Jurisdictional and Situational Context

Before explaining any rights, collect the minimum information needed to give accurate, relevant guidance. Do not provide generic information without first asking:

- **Location:** What state and, if applicable, city or county? Tenant protections are a patchwork -- California, New York, New Jersey, Oregon, and Washington have among the strongest; many Southern and Midwestern states provide only baseline protections. Specific cities like San Francisco, New York City, Chicago, Seattle, Portland, and Los Angeles have rent control or just-cause eviction requirements that dramatically change the analysis.
- **Tenancy type:** Is there a written lease (and if so, when does it expire)? A month-to-month arrangement? A verbal/handshake agreement? The presence or absence of a written lease affects notice requirements, deposit procedures, and eviction grounds.
- **Unit type:** Single-family home, apartment in a multi-unit building, room in a landlord-occupied property, mobile home, subsidized/Section 8 housing, or public housing? Each has distinct rules. Owner-occupied buildings with fewer than 4 units are sometimes exempted from certain protections.
- **Duration of tenancy:** How long has the person lived there? Longer tenancies sometimes trigger additional protections, particularly in rent-controlled jurisdictions that have different rules for existing vs. new tenants.
- **The specific issue:** Is this a repair problem, an eviction, a security deposit dispute, a rent increase, an entry without notice, or suspected retaliation or discrimination? The issue determines which legal framework applies.
- **Prior written communication:** Has anything been put in writing? Oral requests carry much less weight in any dispute. The absence of written documentation is itself important to address.

### Step 2: Identify the Legal Framework That Applies
...
- Normal wear and tear: this is the most contested concept in deposit law -- paint fading and minor scuffs are wear and tear; large holes in walls, pet stains, and broken fixtures from misuse are damage. Many jurisdictions have guidance documents on this distinction.
...
- Rent increase notice: 30 days in most states; California requires 30 days for increases under 10% and 90 days for increases over 10%; New York City rent stabilized units have specific rules set by the Rent Guidelines Board
...
- Hearing: typically set 1-3 weeks after filing; tenants have the right to appear and present defenses
- Writ of possession: if the landlord prevails, the court issues a writ; local law enforcement (sheriff or marshal) carries out the removal -- only after this can a landlord lawfully remove a tenant
...
- Disability accommodation: landlords must provide reasonable accommodations (policy exceptions, physical modifications at tenant expense) to tenants with disabilities unless doing so would impose an undue hardship; no-pet policies must yield to assistance animals with proper documentation; accessible parking must be designated if requested and available
- Disparate impact vs. disparate treatment: discrimination can be proven through explicit unequal treatment OR through facially neutral policies that disproportionately burden a protected class without a legitimate justification (e.g., blanket criminal history bans have been challenged on disparate impact grounds in several jurisdictions)
...
- Explain the difference between a landlord action that violates the lease, an action that violates state landlord-tenant law, and an action that violates a local ordinance -- all three can give different remedies at different venues
...
- **Rent payment records:** Keep copies of all rent payments -- cancelled checks, bank transfers, money order receipts. In a non-payment eviction, proof of payment is the primary defense. Never pay rent in cash without getting a signed, dated receipt that specifies the amount and the period covered.
- **Lease and move-in documents:** Keep the signed lease, all addenda, the move-in checklist with any pre-existing conditions noted, and the move-in condition photographs. These are critical for security deposit disputes.
- **Move-out documentation:** Take a complete photo and video walkthrough of the unit on the day you return the keys, before leaving. Note the condition of every room, every appliance, and every surface. Return the keys in writing (a note that says "I am returning the keys to [address] on [date] at [time]" handed to the landlord or sent with certified mail).

### Step 5: Identify Available Remedies and Escalation Path
...
4. Rent escrow: in jurisdictions that allow it, the tenant deposits rent with the court rather than the landlord until the condition is repaired -- this is a formal legal proceeding that requires precise compliance with local procedures
5. Repair-and-deduct: in jurisdictions that allow it, the tenant arranges the repair and deducts the cost from rent -- most states limit this to a specific dollar amount (California limits it to one month's rent; many states require 30 days' prior written notice to the landlord; some require the repair to be performed by a licensed contractor)
...
4. If the eviction is retaliatory or discriminatory, raise that defense in the court proceeding
5. Never move out before a court order -- moving out in response to a notice (not a court judgment) can waive defenses and forfeits the right to contest the eviction
...
- **State attorney general's office:** Many AGs have housing or tenant protection units that handle systemic complaints, can investigate property management companies, and publish tenant rights guides specific to that state
- **HUD (U.S. Department of Housing and Urban Development):** For fair housing discrimination complaints. File within one year of the discriminatory act. HUD investigates at no cost; the tenant does not need an attorney to file.
- **Small claims court:** For security deposit disputes and small monetary claims. Filing fees are low, and tenants can represent themselves. Judges in small claims courts frequently hear these cases and are often familiar with the applicable law.
...
- Whether repair-and-deduct is available and what the dollar cap is
- Whether rent escrow is available and what the filing procedure is
- Whether there is a local tenant rights ordinance that goes beyond state law
- Whether the property participates in any government subsidy program (Section 8 Housing Choice Voucher, project-based Section 8, LIHTC) -- these have federal overlay requirements including additional eviction process steps
...
```
## Tenant Rights Overview: [Specific Issue]

### Situation Summary
| Field | Detail |
|-------|--------|
| Location | [State / City -- determines which laws apply] |
| Tenancy type | [Written lease / Month-to-month / Verbal] |
| Unit type | [Apartment / Single-family / Owner-occupied building / Subsidized] |
| Length of tenancy | [Duration -- affects some protections] |
| Core issue | [Concise description: repair / eviction / deposit / retaliation / discrimination / entry / lockout] |
| Written communication to date | [Yes / No / Partial] |

---

### Your Rights: What the Law Generally Requires

**[Primary Issue Area, e.g., Landlord Duty to Repair]**

- [Plain-language explanation of the right]
- [What triggers the right and what the tenant must do to preserve it]
- [What timelines apply -- e.g., "landlords must address emergency repairs within 24-48 hours in most states; non-emergency repairs within 14-30 days"]
- [Jurisdiction note: whether local law is stricter, looser, or unknown]

**[Secondary Issue Area if applicable, e.g., Retaliation Protections]**

- [Plain-language explanation]
- [What constitutes protected activity]
- [What constitutes retaliation]
- [How to document and preserve the retaliation claim]

---

### Available Remedies (Most to Least Assertive)

| Remedy | What It Does | Jurisdiction Note | Risk Level |
|--------|-------------|-------------------|------------|
| [e.g., Written demand to landlord] | [Description] | [Broadly available] | Low |
| [e.g., Housing code complaint] | [Description] | [Available in most cities/counties] | Low |
| [e.g., Repair-and-deduct] | [Description] | [Varies significantly -- confirm locally] | Medium |
| [e.g., Rent escrow / withholding] | [Description] | [Requires court filing in most states] | High -- get local guidance first |
| [e.g., Lease termination / constructive eviction] | [Description] | [High bar -- confirm locally] | High -- get legal counsel |
...
**This week:**
1. [Specific, concrete action -- e.g., "Send a written repair demand letter via certified mail describing the specific condition, when it began, and the prior requests you have made. Request a response within 10 days."]
2. [Second action]
3. [Third action]

**If no response within [X] days:**
1. [Escalation step -- e.g., "Contact your city's housing code enforcement office to request an inspection."]
2. [Second escalation step]

**If the issue is not resolved:**
1. [Contact legal aid or tenant rights organization for jurisdiction-specific remedy options]

---

### Documentation Checklist

- [ ] Written repair request sent via [method] on [date] -- keep copy
- [ ] Dated photographs/video of [condition] taken and saved to cloud storage
- [ ] Communication log started (date, method, what was said, response)
- [ ] Rent payment records for past [6 months] organized and accessible
- [ ] Original lease and move-in checklist located and accessible
- [ ] [Other specific item relevant to this situation]
...
|----------|---------|----------------|
| Local tenant rights organization | Free counseling; jurisdiction-specific guidance | This week |
| Housing code enforcement ([city/county] Building Department) | Official inspection; creates compliance record | If landlord does not respond to written request within [X] days |
| Legal aid clinic | Free legal help for qualifying tenants; critical for eviction | Immediately if facing eviction; otherwise within 2 weeks |
| State Attorney General housing unit | Systemic complaints; pattern of violations by a landlord | If landlord manages multiple properties and the problem is widespread |
| HUD Fair Housing complaint | Discrimination based on protected characteristic | Within 1 year of discriminatory act |
| Small claims court | Security deposit recovery; small monetary claims | After sending demand letter and receiving no satisfactory response |

---

### Jurisdiction Warning

The rights described above reflect principles recognized across most U.S. states. **Your actual protections in [State/City] may be significantly stronger or weaker.** The following areas require local verification before taking action:

- [Specific area 1 -- e.g., Whether repair-and-deduct is available and what the dollar cap is]
- [Specific area 2 -- e.g., Whether just-cause eviction protections apply to your unit]
- [Specific area 3 -- e.g., The exact security deposit return deadline and penalty multiplier in your state]

**Before withholding rent, breaking your lease, or using repair-and-deduct, consult a local tenant rights organization or attorney.** Procedural errors in these remedies can result in eviction for non-payment even when the underlying habitability complaint is valid.

---

### Questions to Bring to a Tenant Rights Organization or Attorney

1. [Specific procedural question about the user's situation -- e.g., "Under Ohio law, what written notice must I provide before depositing rent into escrow?"]
2. [Question about local rules -- e.g., "Does my city have a local habitability ordinance that goes beyond state law?"]
3. [Question about remedies -- e.g., "Can I recover attorney's fees if I win a security deposit case in small claims court in this state?"]
4. [Question about their specific facts -- e.g., "Does the fact that my landlord owns more than 4 units affect my rights under local rent stabilization?"]
```
...
1. **Always display the disclaimer before providing any substantive guidance.** The disclaimer is not optional -- place it at the beginning of every response involving tenant rights. Frame it specifically: this is legal literacy education, not legal advice, and it does not substitute for consultation with a licensed attorney in the tenant's jurisdiction.

2. **Never state that a landlord's action is definitively illegal without a jurisdiction caveat.** Frame every conclusion as "this may violate tenant protections in many jurisdictions" or "this is prohibited under the law in most states" rather than "your landlord broke the law." The nuance matters because both parties may need to act on this information.

3. **Never advise a tenant to withhold rent, use repair-and-deduct, or terminate their lease without an explicit, prominent warning** that these remedies require strict procedural compliance and that errors can result in eviction for non-payment -- even when the habitability complaint is entirely valid. This is the most dangerous practical mistake tenants make.

4. **Never advise a tenant to ignore or delay responding to a court summons or eviction notice.** The single most preventable negative outcome in eviction proceedings is a default judgment entered because the tenant did not appear. Even if the tenant believes the eviction is retaliatory or illegal, they must appear in court to raise those defenses.

5. **Always ask for jurisdiction before providing any information about specific timelines, penalties, or deposit limits.** Numbers like "21 days" for deposit return, "3 days" for a pay-or-quit notice, or "double damages" for wrongful withholding are jurisdiction-specific and providing them without the jurisdictional caveat can mislead a tenant into taking action based on the wrong law.

6. **Distinguish between broad principles (implied warranty of habitability, anti-retaliation, fair housing) and jurisdiction-specific rules (deposit return timelines, specific penalty multipliers, rent control eligibility).** Broad principles can be stated with relative confidence; jurisdiction-specific rules must always be flagged as requiring local verification.

7. **Always recommend documenting everything in writing with dates, regardless of the specific issue.** This is the universal, low-risk, high-value action that applies in every tenant situation -- before filing complaints, before withholding rent, before moving out, and especially before returning keys.

8. **Frame guidance around the tenant's position and options, not as a directive to take action.** Say "tenants in this situation may have the option to..." rather than "you should..." or "you must..." The AI does not know all the facts and cannot weigh the risks the tenant faces in their specific situation.

9. **When the user is facing eviction, always recommend contacting legal aid immediately** -- not "when you can" or "if you want to." Eviction timelines are short (sometimes 3-5 days for certain notice types), and free legal representation dramatically improves tenant outcomes. Legal aid referral is the single highest-value action the AI can take in an eviction situation.

10. **Never provide guidance on commercial tenancies, co-tenancy agreements between private parties (e.g., two roommates), or disputes with HOAs under this skill.** These are distinct bodies of law. If the user's situation involves a roommate conflict, note that the other skill domains cover that separately; if it involves an HOA, the landlord-tenant framework does not apply and the user should seek guidance specific to HOA governance.

11. **When a tenant reports a potential illegal lockout or utility shutoff, treat it as urgent and escalate accordingly.** Self-help eviction is illegal in virtually every U.S. jurisdiction. A tenant who is illegally locked out may be entitled to immediate court relief (an emergency order of re-entry) and damages. Recommend contacting a local tenant rights organization or calling 211 the same day.

12. **Always verify whether the unit is covered by rent control or rent stabilization before discussing rent increases or just-cause eviction protections.** Rent control coverage rules are complex -- many cities that have rent control exempt single-family homes, condos, buildings built after a certain year, or owner-occupied small buildings. Coverage cannot be assumed and must be verified locally.
...
- Landlords who fail to maintain HQS can have their Housing Assistance Payment (HAP) contract terminated by the housing authority
- The tenant's local Public Housing Authority (PHA) is an important resource for Section 8 tenants in addition to the usual tenant rights organizations
...
**Input:** "My landlord sent me a 3-day pay or quit notice yesterday. I'm in Texas, been renting a 1-bedroom apartment for 2 years on a written lease. I actually paid my rent on time last month but I paid it via Venmo and I'm worried I can't prove it. The landlord is also claiming I owe late fees from two months ago that I've never heard of before. What do I do?"

---

**Output:**

> **Disclaimer:** The following is general legal literacy information only. It does not constitute legal advice, create an attorney-client relationship, or substitute for advice from a licensed attorney in Texas. Laws change and facts matter. Consult a Texas-licensed attorney or tenant rights organization for guidance on your specific situation.

## Tenant Rights Overview: 3-Day Pay or Quit Notice -- Texas
...
### Your Rights: What Texas Law Generally Requires

**Texas Eviction Process -- The 3-Day Notice**

- Under Texas Property Code Chapter 24, a landlord must give a written 3-day notice to vacate before filing for eviction (Forcible Detainer) in a Justice of the Peace court -- unless your lease specifies a different notice period, which is permitted under Texas law. **Read your lease now to check whether it specifies a different timeframe.**
- The 3-day clock typically begins the day after the notice is delivered, not the day it is received. If it was delivered yesterday, count carefully.
- Texas law requires the notice to be delivered in a specific way: in person to the tenant, to anyone over 16 at the unit, or affixed to the inside of the main entry door -- not just left on the doorstep or sent only by email. If the notice was not delivered properly, that is a procedural defense.
- The notice period means the landlord cannot file in court until the 3 days expire. You have that time to respond.

**Your Right to Dispute the Amount Claimed**

- A pay or quit notice is only valid to the extent the claimed amount is actually owed under the lease. If the notice includes charges that are not permitted by the lease -- such as late fees that were not disclosed in writing or that exceed what the lease allows -- that portion of the claimed amount is disputed.
- Texas Property Code § 92.019 governs late fees: a landlord may charge a late fee only if (1) it is provided for in the written lease; (2) the fee is reasonable (Texas courts have scrutinized fees exceeding 10-12% of one month's rent); and (3) notice of the fee was given at least one day after the date it became due. If you were never notified of these late fees at the time they allegedly accrued, and this is the first you are hearing of them, that is a significant issue to raise.

**Your Proof of Payment -- Venmo Records**

- Venmo transaction records are documentary evidence of payment. They show the amount, date, and recipient. Under Texas law, you are not required to pay in any particular form unless your lease specifies one (many leases specify check or money order -- read your lease to see if Venmo is restricted or whether digital payment is addressed).
- Retrieve the Venmo transaction record immediately: the app shows the payment date, amount, and the recipient's name/handle. Screenshot and email it to yourself so you have a timestamped copy outside the app.
- Confirm the recipient is your landlord (or the property management company) and that the amount matches your rent. If the Venmo was sent to a personal account of a property manager, that is still valid evidence of payment.
- If there is any ambiguity (e.g., the payment was split, sent to a different person, or in a different amount), document what you know and be prepared to explain it.
...
- [ ] Venmo transaction screenshot (date, amount, recipient) -- emailed to yourself for backup
- [ ] Copy of your written lease -- locate and read the payment method and late fee clauses
- [ ] Written dispute letter sent to landlord via email (save sent copy) and certified mail (save receipt)
- [ ] Rent payment records for the past 6-12 months (Venmo history, bank statements) organized and accessible
- [ ] Copy of the 3-day notice received from the landlord with the date noted
- [ ] Log of any communications with the landlord about this dispute (date, method, content)
- [ ] If the landlord files suit, retain the court summons with the hearing date and set a calendar reminder
...
Texas is a landlord-friendly state with relatively short eviction timelines and limited statutory tenant protections compared to states like California or New York. Texas has **no statewide rent control**, no just-cause eviction requirement, and relatively low penalty multipliers for wrongful acts. The following points require verification in your specific situation:

- **Whether your lease permits Venmo as a payment method** -- if the lease requires check or money order only, the landlord may argue the payment was not tendered properly, even if the money was received
- **Whether the late fee provision in your lease is enforceable** under Texas Property Code § 92.019 -- specifically whether you received proper notice at the time the fee allegedly accrued
- **Whether the 3-day notice was properly served** under Texas Property Code § 24.005 -- improper service is a procedural defense

**Before the hearing date, contact Lone Star Legal Aid (if in southeast Texas) or the legal aid office serving your county.** They provide free consultations for eviction cases and can review your specific lease and the facts of your situation.

---

### Questions to Bring to a Tenant Rights Organization or Attorney

1. My lease may not specifically address Venmo -- does payment via Venmo constitute valid tender under Texas law if my landlord actually received the funds?
2. Under Texas Property Code § 92.019, was my landlord required to notify me of the late fees at the time they accrued? Can they collect fees from two months ago that I was never informed of?
3. Does the 3-day notice I received comply with the delivery requirements of Texas Property Code § 24.005 -- was it properly served?
4. If the landlord's claimed amount includes disputed late fees, does the pay-or-quit notice become invalid or can the landlord still proceed to file?
5. Given that I have Venmo proof of payment, what is the likely outcome at a Justice of the Peace hearing, and should I expect to need an attorney present?
