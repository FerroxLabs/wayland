---
name: college-prep-parent
description: |
  Guide parents through the complete college preparation journey from 9th through 12th grade, including financial planning with 529s and FAFSA, campus visits, application support, scholarship strategy, managing expectations, handling rejection, and the emotional process of letting go.
  Use when the user asks about college prep parent, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of college prep parent or requires a different specialized skill.
license: Apache-2.0
metadata:
...
1. What grade is your student currently in?
2. Has your family started discussing post-secondary goals? What is your student interested in?
3. What is your realistic budget range for college (annual or total)?
4. Has your student taken the PSAT, SAT, or ACT yet?
5. What is your student's approximate GPA and course rigor (AP, IB, honors)?
6. Are there specific schools your family is considering?
7. Are there special circumstances (first-generation, recruited athlete, legacy, financial hardship, learning differences)?
8. What is your biggest concern right now - financial, academic, emotional, or logistical?
...
- Understand GPA calculation at your school (weighted vs. unweighted)
...
- Take SAT Subject Tests or AP exams as appropriate
...
Testing Timeline:
- October: PSAT/NMSQT
- December-January: First SAT or ACT attempt
- March-April: Second attempt (if needed)
- May: AP Exams
- June: Final SAT/ACT attempt (if needed)
- Consider: Test-optional schools if scores do not reflect ability
```
...
- Narrow to 8-12 schools in three tiers:
  ...
  - **Likely (2-3):** Very confident of admission; would be happy to attend
- Every school on the list should be one your student would genuinely attend
...
- October 15-November 1: CSS Profile deadline (for many schools)
- November 1-15: Early Decision / Early Action deadlines
- December: Early Decision results arrive
- January 1-15: Regular Decision deadlines
- Continue strong senior year grades (senioritis is real and can cost admission)
```
...
- Create a master spreadsheet tracking:
  ...
  - Test score submission status
  - Financial aid deadlines and forms required
...
- Compare financial aid packages carefully (see comparison worksheet)
- April: Revisit top choices if possible
- May 1: National Decision Day - deposit due
- May-June: Send final transcript, complete housing forms
- June-August: Orientation, placement tests, roommate connections
```
...
- Can be transferred to another beneficiary (sibling, parent, even yourself)
- New rule: Unused 529 funds can be rolled into a Roth IRA (up to $35,000 lifetime, subject to conditions)

**Strategy by Timeline:**
| Years Until College | Investment Approach |
|---|---|
| 10+ years | Aggressive growth (stock-heavy allocation) |
| 5-9 years | Moderate (balanced stock/bond) |
| 2-4 years | Conservative (bond-heavy) |
| 0-1 years | Capital preservation (stable value/money market) |
...
- If your financial situation has changed, contact the financial aid office for a professional judgment review
- Divorced/separated parents: Only the custodial parent completes FAFSA (the parent the student lived with more)
...
- Apply for many smaller scholarships ($500-$2,000) - less competition
...
Cost of Attendance        $______     $______     $______

Grants/Scholarships
  Institutional           $______     $______     $______
  Federal (Pell)          $______     $______     $______
  State                   $______     $______     $______
  Outside                 $______     $______     $______
Total Free Money          $______     $______     $______

NET COST (COA - Free $)   $______     $______     $______

Loans Offered
  Federal Direct Sub      $______     $______     $______
  Federal Direct Unsub    $______     $______     $______
  Parent PLUS             $______     $______     $______
Total Loans               $______     $______     $______

Work-Study Offered        $______     $______     $______

OUT OF POCKET per year    $______     $______     $______
Total 4-year cost         $______     $______     $______
```
...
- Book a meal in the dining hall
- Check if overnight visits are available
...
- What support services exist for students who struggle?
...
- Compare your student to their peers
- Make them feel your self-worth depends on their acceptance letter
- Post their acceptances on social media without permission
...
- "It is fine" (dismissing their genuine disappointment)
- "Call admissions and argue."

### Letting Go

The college process is also a separation process. Your child is becoming an adult.

- Start giving them more autonomy during high school (managing their schedule, doing laundry, cooking, budgeting)
- Practice not texting them for an entire day
- Discuss expectations for communication once they are at school
- Prepare for the emotional weight of move-in day
- Know that your relationship will change - and it can become even stronger
- Connect with other parents going through the same transition
- Make plans for your own next chapter

## When College Is Not the Right Path

Not every student should go to a four-year college immediately (or ever). Discuss alternatives honestly:

- **Community college:** Affordable, flexible, transfer pathways
- **Trade and vocational schools:** Electrician, plumber, HVAC, welding, cosmetology - high demand, strong salaries, lower debt
- **Apprenticeships:** Earn while you learn in skilled trades
- **Gap year:** Structured gap year programs, travel, work, volunteering
- **Military service:** GI Bill benefits, training, structure, service
- **Entrepreneurship:** Some students learn best by doing
- **Workforce entry:** Some careers do not require degrees

The goal is not college. The goal is a meaningful, self-sufficient adult life. Support the path that fits your child.

## Parent Support Resources

- **FAFSA Help:** studentaid.gov or call 1-800-433-3243
- **Net Price Calculators:** Available on every college website
- **College Board:** BigFuture tools and resources
...
2. **Analyze context.** Review the information provided and identify key factors relevant to college prep parent
...
**Input:** "Help me with college prep parent for my current situation"

**Output:**

Based on your situation, here is a structured approach to college prep parent:
