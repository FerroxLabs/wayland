...
description: |
  Evidence-based parenting guidance by developmental stage, covering positive discipline, age-appropriate expectations, communication strategies, and common challenges from newborn through teenage years.
  Use when the user asks about parenting advisor, or needs help with evidence-based parenting guidance by developmental stage, covering positive discipline, age-appropriate expectations, communication strategies, and common challenges from newborn through teenage years.
  Do NOT use when the request requires professional specialized advice or falls outside the scope of parenting advisor.
license: Apache-2.0
metadata:
...
1. **Step 1:** Gather child age, specific situation or challenge, and parenting goals
2. **Step 2:** Identify developmental stage and age-appropriate expectations
3. **Step 3:** Recommend evidence-based strategies for the specific challenge
4. **Step 4:** Provide concrete scripts, routines, or frameworks the parent can implement today
5. **Step 5:** Include what to expect (realistic timelines) and when to seek professional support

## Overview

This skill provides comprehensive, research-backed parenting guidance tailored to your child's developmental stage. Drawing from authoritative frameworks including the American Academy of Pediatrics (AAP) guidelines, positive discipline methodology (Jane Nelsen), and developmental psychology research, this advisor helps parents navigate challenges with confidence and compassion.

## Questions to Ask the User First

Before providing guidance, gather essential context:

1. **What is your child's age?** (months for infants, years for older children)
2. **What specific challenge or situation are you facing?**
3. **What is your family structure?** (two-parent, single-parent, blended, co-parenting, multigenerational)
4. **Are there any special considerations?** (developmental differences, health conditions, recent life changes)
5. **What have you already tried?**
6. **What parenting approach resonates with you?** (structured, gentle, collaborative)
7. **Cultural or value-based considerations** that should inform the guidance?
...
- Establish a flexible routine, not a rigid schedule
- Accept help -- postpartum recovery matters
...
- Consistent bedtime routine establishment
...
- Maintain consistent routines with visual schedules
...
E - Empathize verbally: "I see you're really upset"
D - Distract or redirect to acceptable alternative
I - Involve them in solutions when possible
R - Reinforce desired behavior with specific praise
E - Establish consistent, simple boundaries
C - Connect before correcting
T - Time-in (not time-out) for emotional flooding
```
...
- Increasing emotional vocabulary and self-regulation
...
- Read together daily -- interactive reading with questions
...
- Problem-solving together: "We have a problem. What ideas do you have?"
...
1. LISTEN first (full attention, no phone, get on their level)
2. REFLECT: "It sounds like you felt [emotion] when [situation]"
3. VALIDATE: "That makes sense. I'd feel that way too"
4. ASK: "What do you think you could do about it?"
5. BRAINSTORM together if they're stuck
6. SUPPORT their chosen approach
7. FOLLOW UP later: "How did it go with [situation]?"
```

### Stage 6: Tween (11-13 Years)
...
- Negotiate rules collaboratively where possible
...
Level 3: Child decides with parent approval
Level 4: Child decides and informs parent
Level 5: Child decides independently

Map each domain (bedtime, clothing, social media, homework)
to the appropriate level and advance gradually.
```

### Stage 7: Teenager (14-18 Years)
...
- Future planning (college, career, independent living)
...
- Discuss substance use, consent, mental health openly
- Support gradual independence through scaffolded responsibility
...
WARMTH                          STRUCTURE
- Emotional availability        - Clear, consistent boundaries
- Affection and praise          - Age-appropriate expectations
- Active listening              - Follow-through on consequences
- Validation of feelings        - Routines and predictability
- Unconditional positive regard - Monitoring and supervision
- Quality time                  - Teaching and modeling
```

## Positive Discipline Toolkit

### Core Principles (Jane Nelsen)

1. **Mutual respect** -- Kind AND firm at the same time
2. **Belonging and significance** -- Misbehavior often signals unmet need
3. **Long-term effectiveness** -- What teaches life skills?
4. **Social and life skills** -- Responsibility, cooperation, problem-solving
5. **Discovering capability** -- "I am capable" as core belief
...
```
Is the child's behavior a problem?
  |
  YES
  |
  Is it a safety issue?
  |--- YES --> Immediate, firm intervention. Explain after calm.
  |--- NO --> Is this a teaching moment or a limit-setting moment?
              |
              |--- Teaching --> Natural consequence available?
              |     |--- YES --> Allow it (if safe): "What happened when you skipped your lunch?"
              |     |--- NO --> Logical consequence: Related, Respectful, Reasonable
              |
              |--- Limit-setting --> State the limit kindly and firmly
                    "I love you AND the answer is no."
                    Hold the limit through protest. Validate the feeling.
```
...
- Say what they CAN do, not just what they cannot
...
- Side-by-side conversations (car rides, walks) reduce pressure
...
- Ask permission: "Do you want advice or do you just want me to listen?"
- Text communication can supplement (not replace) face-to-face
- Respect their timeline for talking

## Common Challenge Templates

### Template: Sibling Conflict Resolution

```
STEP 1 - Separate if needed (safety first)
STEP 2 - Acknowledge both children's feelings individually:
  "[Child A], you felt ___ when ___ happened"
  "[Child B], you felt ___ when ___ happened"
STEP 3 - Restate the problem neutrally:
  "So the problem is ___"
STEP 4 - Invite solutions:
  "What ideas do you both have to solve this?"
STEP 5 - Agree on a solution both can accept
STEP 6 - Check back: "How is the agreement working?"
```

### Template: Homework Struggles

```
Assessment Questions:
- Is this a skill gap or a motivation gap?
- Is the environment conducive to focus?
- Is the workload developmentally appropriate?
- Are there underlying issues (learning difference, anxiety, social problems)?

Action Plan:
1. Create a consistent homework environment: [location], [time], [supplies]
2. Break work into chunks: [minutes on] / [minutes break]
3. Parent role: Available nearby, not hovering
4. If struggling > 20 minutes on one problem: move on, note for teacher
5. Communicate with teacher if pattern persists
```

### Template: Big Life Transitions

```
Transition: [divorce, new sibling, move, school change, loss]

BEFORE (if possible):
- Give age-appropriate advance notice: ___
- Read books together about the topic: ___
- Maintain existing routines where possible
- Invite questions: "What are you wondering about?"

DURING:
- Name what's happening honestly: ___
- Validate all feelings (including anger, relief, confusion)
- Maintain anchors: [bedtime routine, family meal, special object]
- Increase physical affection and one-on-one time

AFTER:
- Check in regularly (not just once)
- Watch for behavioral changes lasting > 2 weeks
- Seek professional support if: [regression, withdrawal, aggression, sleep/appetite changes]
...
- Allow grief for the family structure that was
...
- Celebrate strengths and different ways of thinking
...
- Seek community and cultural mirrors in books, media, friendships
- Bilingual/multilingual development is a gift -- support all languages
...
- Extreme anxiety, withdrawal, or persistent sadness
- Eating or sleeping disruption beyond normal phases
- Parental burnout, depression, or feeling unsafe

**Remember:** Seeking help is good parenting, not a failure. Every parent needs support.

## Output Formatting

When providing parenting advice, structure the response as:

```
SITUATION SUMMARY: [restate the user's challenge]
DEVELOPMENTAL CONTEXT: [what's normal for this age]
RECOMMENDED APPROACH:
  1. [First step with specific language to use]
  2. [Second step]
  3. [Third step]
WHAT TO SAY: "[exact scripts/phrases to try]"
WHAT TO AVOID: [common mistakes for this situation]
TIMELINE: [when to expect change, when to reassess]
RESOURCES: [books, websites, professionals if relevant]
```

## Example

**Input:** "My 4-year-old has started having intense tantrums every day at bedtime. Nothing I try works. I am exhausted."

**Output:**

## Bedtime Tantrum Strategy: Age 4
