...
description: |
  Guide to volunteer program management including recruitment, application process, training, scheduling, recognition, retention, impact tracking, and liability considerations. Use when the user asks about volunteer coordinator or needs help with related topics. Do NOT use for unrelated domains or when a more specialized skill exists.
license: Apache-2.0
metadata:
...
2. **Analyze the situation.** Review the information provided and identify key factors, challenges, and opportunities relevant to volunteer coordinator.
...
Before designing or improving a volunteer program:

1. What roles do volunteers fill in your organization?
2. How many volunteers do you currently have? How many do you need?
3. What is your volunteer retention rate? (Do volunteers come back?)
4. Do you have written role descriptions for volunteer positions?
5. What training do you provide volunteers?
6. How do you currently track volunteer hours and impact?
7. Do you have volunteer management software? Which one?
8. What is your biggest challenge with volunteers? (Recruitment, retention, reliability, quality)
9. Do volunteers interact with vulnerable populations (children, elderly, people with disabilities)?
10. What is your budget for the volunteer program?
...
- **Points of Light / HandsOn Network** - Local volunteer centers
...
- Retired professionals (RSVP, SCORE, Senior Corps)
- Neighborhood associations and Nextdoor groups
...
- Parent groups (PTA, homeschool networks) for family-friendly roles
...
- **Skills needed** (or "no experience necessary")
- **What they will gain**: Skills, connections, satisfaction, resume building
...
- Partnerships with corporate days of service
- Social media campaigns with volunteer testimonials
...
- Have a clear policy for what disqualifies a candidate
- Inform applicants that a background check will be conducted
- Comply with Fair Credit Reporting Act (FCRA) requirements
...
- Acknowledgment of policies (harassment, safety, dress code)
...
6. Communication channels and who to contact with questions
...
4. Written reference materials (one-page quick guide)
5. Assessment of competency before independent work
...
- **De-escalation**: If working with people in crisis
- **Food safety**: If handling or serving food (ServSafe or equivalent)
...
- Mentorship pairing (experienced volunteer with new volunteer)
- Job aids and checklists (posted at work stations)
...
- **Better Impact (formerly Volunteer Impact)**: Full volunteer management with scheduling
...
- Have a backup list for last-minute cancellations
- Track no-shows and patterns (address directly, supportively)
- Be flexible - life happens; rigid programs lose volunteers
- Offer variety of shift lengths and times (including evenings and weekends)
...
- Understand that unpaid volunteers have different accountability than employees
- Look for root causes: Is the role boring? Too demanding? Poorly scheduled?
...
- Acknowledge effort publicly in team settings
...
- **Sincere**: Genuine appreciation, not performative
...
**Higher ($50+/person)**: Conference attendance, professional development, significant awards
...
4. Disorganization (showing up and no one knows what to do)
5. Conflict with other volunteers or staff
6. Life changes (moved, health, schedule change)
7. Burnout from overcommitment
...
- Offer growth: New responsibilities, leadership roles, skill development
- Conduct periodic check-in conversations (not just at crisis points)
- Exit interviews when volunteers leave (learn why)
- Address problems quickly before they fester
...
- First-year retention is typically lowest - extra attention during first 3 months pays off
...
- **Outcomes**: Changes resulting from volunteer work (student grade improvement, food insecurity reduction)
...
- Share with volunteers themselves - they want to know they made a difference
...
- Communication (email/text) to volunteer groups
...
- **Directors and Officers (D&O)**: Covers board decisions related to volunteer programs
...
- Signed liability waivers/release forms (consult attorney for your state)
...
- Comply with child labor laws (even for volunteers)
- No hazardous tasks, machinery, or late-night hours
- Two-adult rule: Never one adult alone with minor volunteers

## Progression Path

1. **Phase 1**: Define volunteer roles, create application and training, recruit first cohort
2. **Phase 2**: Implement tracking system, develop recognition program, build retention practices
3. **Phase 3**: Expand recruitment channels, add specialized training, measure impact
4. **Phase 4**: Implement volunteer management software, develop volunteer leaders
5. **Phase 5**: Corporate partnership program, skills-based volunteering, program evaluation
6. **Phase 6**: Volunteer program strategic plan, mentor other coordinators, advocate for volunteerism

## Resources

- **Points of Light** (pointsoflight.org): National volunteer service organization
- **MAVA / State Volunteer Associations**: State-level support and training
- **Books**: "The Volunteer Management Handbook" by Tracy Connors
- **Books**: "Managing Volunteers" by Steve McCurley and Rick Lynch
...
```
[Volunteer Coordinator deliverable]
