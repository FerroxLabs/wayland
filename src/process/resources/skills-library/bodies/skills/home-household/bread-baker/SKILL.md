...
name: bread-baker
description: |
  Complete guide to artisan bread baking including sourdough starter cultivation, dough hydration science, shaping techniques, oven setup, troubleshooting, and foundational recipes.
  Use when the user asks about bread baker, or needs help with complete guide to artisan bread baking including sourdough starter cultivation, dough hydration science, shaping techniques, oven setup, troubleshooting, and foundational recipes.
  Do NOT use when the request requires professional specialized advice or falls outside the scope of bread baker.
license: Apache-2.0
metadata:
...
- Type 00: 11-12.5% protein (fine grind, extensible gluten, great for pizza/focaccia)

**Water**: Hydrates flour proteins to form gluten; activates enzymes; controls dough consistency. Temperature is critical for fermentation rate.

**Salt**: Strengthens gluten, controls fermentation rate, develops flavor. Standard ratio: 2% of flour weight.

**Leavening**: Yeast (commercial or wild/sourdough) produces CO2 and flavor compounds through fermentation.
...
**Day 1**: Mix 50g whole wheat or rye flour + 50g water (room temperature). Stir vigorously. Cover loosely. Store at 72-78F (22-26C).

**Day 2**: Discard all but 50g. Add 50g flour + 50g water. Stir, cover.

**Days 3-5**: Repeat daily discard and feeding. You may see activity (bubbles) or none. Both are normal. A foul smell in early days is normal and will resolve.
...
**Readiness Test (Float Test)**: Drop a teaspoon of starter into water. If it floats, it is active enough to leaven bread. This test is not perfectly reliable but is a useful indicator.
...
4. Repeat twice daily for 2-3 days
5. Most starters survive weeks of neglect; months is possible
...
- Edges are slightly pulling away from container

- **1:30 PM - Pre-shape**: Gently turn dough onto unfloured surface. Use a bench scraper to shape into a loose round. Let rest 20 minutes (bench rest).
- **2:00 PM - Final Shape**: Shape into a boule (round) or batard (oval). Place seam-side up in a floured banneton or towel-lined bowl.
...
- **7:00 AM - Score and Bake**:
  ...
  3. Score with a razor blade or lame: single decisive slash, 1/4 inch deep, at 30-degree angle
  4. Transfer to preheated Dutch oven
  5. Bake covered: 20 minutes at 500F
  6. Uncover, reduce to 450F: 20-25 minutes until deep golden brown
  7. Internal temperature target: 205-210F (96-99C)
- **7:50 AM - Cool**: Remove to wire rack. Wait at least 1 hour before cutting (the interior is still cooking via residual steam).
...
4. Roll toward you, using the seam and friction to create surface tension
...
4. Fold bottom third up, press to seal
5. Roll into a log, sealing seam with heel of hand
6. Gently taper ends
...
**Good**: Cast iron skillet with ice cubes on lowest rack + spray bottle
**Budget**: Roasting pan inverted over baking stone
...
- **Sheet pan**: Works but less heat transfer, less oven spring
...
- Proofing box or warm spot setup
...
- Top with olive oil, flaky salt, rosemary
...
- Proof until 1 inch above pan rim
...
- Add 1 tablespoon honey or molasses for flavor balance
...
**Input:** "Help me get started with bread baker"

**Output:** A structured bread baker plan tailored to the user's specific situation, following the process outlined above.
