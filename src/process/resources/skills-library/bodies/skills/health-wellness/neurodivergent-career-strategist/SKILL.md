---
name: neurodivergent-career-strategist
description: |
  Strengths-based career guidance for neurodivergent individuals covering career selection aligned with cognitive strengths, workplace accommodations, disclosure decisions, job search strategies, and interview preparation.
  Use when the user asks about neurodivergent career strategist, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of neurodivergent career strategist or requires a different specialized skill.
license: Apache-2.0
metadata:
...
- What is your neurodivergent profile (ADHD, autism, dyslexia, multiple)?
- Are you formally diagnosed? Are you comfortable sharing this at work?
- What are your current career situation and goals?
- What work environments have you thrived in? What has been unbearable?
- What are your strongest skills and deepest interests?
- Are you currently employed, job searching, or considering a career change?
- Have you ever requested workplace accommodations? How did it go?
- What does your ideal work day look like (hours, structure, social interaction)?

## Strengths-Based Career Selection
...
- Creative fields (design, writing, music, video production)
- Sales (social energy, variety, immediate feedback)
- Consulting (project-based variety, new problems constantly)
...
- Accounting and finance (rules-based, precision)
- Library and archival science (organization, systems, quiet)
- Technical writing (clarity, precision, structure)
...
- Entrepreneurship (big-picture thinking, creative solutions)
- Skilled trades (hands-on, spatial reasoning)

## Workplace Accommodations

### Your Rights

In the United States, the Americans with Disabilities Act (ADA) requires employers with 15+ employees to provide reasonable accommodations for qualified individuals with disabilities, which includes neurodevelopmental conditions like ADHD and autism.
...
- The employer must engage in an "interactive process" to find solutions

### Common Accommodations by Need

**Focus and attention:**
| Accommodation | How to Request It |
|--------------|-------------------|
| Private or quiet workspace | "I produce my best work in a low-distraction environment" |
| Noise-canceling headphones policy | "Headphones help me maintain focus on detailed tasks" |
| Flexible work-from-home days | "I'm most productive with some remote days for deep work" |
| Modified meeting schedule | "Batching meetings allows me to protect deep work blocks" |
| Written instructions for verbal tasks | "I retain information best when I can reference it in writing" |
| Task management tools | "A project management tool helps me track multiple priorities" |

**Sensory needs:**
| Accommodation | How to Request It |
|--------------|-------------------|
| Adjusted lighting (desk lamp vs fluorescent) | "Fluorescent lighting causes headaches that reduce my productivity" |
| Designated quiet space | "I need periodic access to a quiet space to reset" |
| Flexible dress code | "Comfortable clothing helps me focus; scratchy fabrics are highly distracting" |
| Scent-free zone | "Strong scents cause concentration difficulties for me" |

**Executive function:**
| Accommodation | How to Request It |
|--------------|-------------------|
| Flexible deadlines with advance notice | "I work best with advance notice on deadlines rather than same-day requests" |
| Regular check-in meetings with manager | "Brief weekly check-ins help me stay aligned on priorities" |
| Written agendas before meetings | "I contribute best when I can prepare in advance" |
| Extended time for complex reports | "Additional time produces significantly higher quality work from me" |
| Break schedule flexibility | "Short breaks improve my sustained performance over the day" |

### The Accommodation Request Process

1. **Decide what you need** (use the lists above as starting points)
2. **Get documentation** from your healthcare provider (letter confirming condition and recommended accommodations)
3. **Submit a formal request** to HR or your manager (email creates a paper trail)
4. **Frame it as performance optimization** not as a limitation
5. **Propose specific solutions** rather than just describing the problem
6. **Be prepared to negotiate** - the employer can suggest alternative accommodations

**Sample request language:**
"I have a medical condition that affects [specific function]. My healthcare provider has recommended [specific accommodation] to help me perform at my best. I'd like to discuss how we can implement this. I have documentation available if needed."
...
- You are struggling and accommodations could prevent failure
- You want to contribute to normalizing neurodiversity at work
...
- The role does not require accommodations
- You are in an industry with known bias (though this is changing)
...
- Use job alerts to reduce the daily search burden
...
- Ask about remote work, flexible hours, and management style during interviews
...
- Bring a notebook - writing key words helps you stay on track
...
- Ask for the interview format in advance (who, how long, what type of questions)
- Request interview questions in advance if possible (some companies will provide them)
...
- Prepare 3-5 questions to ask them (shows engagement and gives you control)
...
- Use "shutdown routines" to transition out of work mode
...
- Social demands exceeding your capacity
...
- Returning to routines and structure
- Potentially taking time off

### Career Growth

- Seek roles that increase alignment with your strengths over time
- Consider management carefully: it may move you away from what you do best
- Pursue specialist or individual contributor tracks where available
- Build a reputation around your unique contributions
...
2. **Analyze context.** Review the information provided and identify key factors relevant to neurodivergent career strategist
...
```template
## Neurodivergent Career Strategist Analysis
...
**Input:** "Help me with neurodivergent career strategist for my current situation"

**Output:**

Based on your situation, here is a structured approach to neurodivergent career strategist:
