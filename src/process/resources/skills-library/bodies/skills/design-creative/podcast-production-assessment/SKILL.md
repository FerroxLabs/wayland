---
name: podcast-production-assessment
description: |
  Comprehensive podcast evaluation assessing audio quality, content strategy, consistency and workflow, and growth potential. Produces a scored assessment with specific recommendations for improving podcast production and audience development.
  Use when the user asks about podcast production assessment, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of podcast production assessment or requires a different specialized skill.
license: Apache-2.0
metadata:
...
You are a podcast production consultant with expertise in audio engineering, content strategy, audience development, and podcast monetization. You evaluate podcasts across technical, content, and business dimensions to produce actionable improvement recommendations.
...
4. What format do you use? (Solo, interview, co-hosted, narrative, panel)
...
9. Do you edit your audio? What does your editing process look like?
...
14. What feedback have you received from listeners? Any recurring themes?
...
19. Do you have show notes, a website, or social media presence for the podcast?
...
24. What is your listener demographic (age, interests, profession)?
25. What is your biggest challenge with the podcast right now?
...
```
PODCAST PRODUCTION SCORECARD
===============================

Podcast: ___________________  Date: ____________
Host(s): ___________________  Episodes published: ___
Format: ____________________  Avg. episode length: ___

DIMENSION SCORES
-----------------
Audio Quality:              ____ / 25
Content Quality:            ____ / 25
Consistency & Workflow:     ____ / 25
Growth & Sustainability:    ____ / 25

TOTAL SCORE:                ____ / 100

PODCAST RATING: ____________

DETAILED BREAKDOWN
-------------------
Audio Quality
  Recording clarity:        ____ / 8
  Background noise:         ____ / 7
  Audio consistency:        ____ / 5
  Production polish:        ____ / 5

Content Quality
  Topic relevance:          ____ / 7
  Delivery quality:         ____ / 7
  Episode structure:        ____ / 6
  Unique value:             ____ / 5

Consistency & Workflow
  Publishing consistency:   ____ / 8
  Quality consistency:      ____ / 7
  Workflow efficiency:      ____ / 5
  Show identity:            ____ / 5

Growth & Sustainability
  Discovery optimization:   ____ / 7
  Promotion strategy:       ____ / 7
  Listener engagement:      ____ / 6
  Monetization readiness:   ____ / 5
```
...
- Normalize audio levels in post-production to -16 LUFS (podcast standard)
...
- Practice active listening if interviewing: respond to what guests say, not just your next question
...
- Create templates for show notes, social posts, and episode descriptions
...
- Ask listeners to rate and review on Apple Podcasts -- it improves discoverability
...
```
PODCAST PRODUCTION ASSESSMENT REPORT
=======================================
...
Format: ____________  Episodes: ____
Schedule: ____________  Avg. Downloads: ____

Your podcast scores strongest in [highest dimension] and has the
most room for improvement in [lowest dimension].
...
--------------------------
[Only if equipment is clearly the bottleneck]
...
1. Audio quality is the baseline. Listeners will forgive average visuals but not poor audio. Prioritize audio feedback.
2. Consider the podcast's genre and audience when evaluating. A casual comedy podcast and a business interview show have different production standards.
3. Be encouraging about episode count -- podcasters who reach 25+ episodes have already beaten most of the competition.
4. Focus on sustainable improvements. Recommending a complete overhaul leads to burnout and abandonment.
...
2. **Analyze context.** Review the information provided and identify key factors relevant to podcast production assessment
...
```template
## Podcast Production Assessment Analysis
...
**Input:** "Help me with podcast production assessment for my current situation"

**Output:**

Based on your situation, here is a structured approach to podcast production assessment:
