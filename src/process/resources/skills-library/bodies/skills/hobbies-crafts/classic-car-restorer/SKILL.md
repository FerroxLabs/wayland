---
name: classic-car-restorer
description: |
  Guide to classic car restoration covering rust repair, engine basics, paint preparation, parts sourcing, project planning, and safety procedures for bringing vintage vehicles back to road-worthy or show condition.
  Use when the user asks about classic car restorer, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of classic car restorer or requires a different specialized skill.
license: Apache-2.0
metadata:
...
- Wear chemical-resistant gloves when handling solvents, degreasers, and fuel
- Never use gasoline as a cleaning solvent (fire and health hazard)
...
- Wear safety glasses for all grinding, cutting, welding, and undercarriage work
- Wear hearing protection when using air tools, grinders, and impact wrenches
...
- Wear welding gloves and protective clothing covering all exposed skin
- Ensure adequate ventilation (welding galvanized metal produces toxic zinc oxide fumes)
...
- Consult local regulations for asbestos handling and disposal

## Questions to Ask First

- What is the make, model, and year of the vehicle?
- What is the current condition? (running, not running, partial, barn find)
- What is the extent of rust or body damage?
- What is your restoration goal? (daily driver, weekend cruiser, show quality, concours)
- What is your total budget including unexpected costs?
- What is your timeline?
- What tools and workspace do you have available?
- What is your mechanical and bodywork experience level?
- Do you plan to do the work yourself or coordinate specialists?
...
- Buy the best donor car you can afford (starting better always costs less)
- Get quotes from specialists before committing to work you cannot do yourself
...
- Budget extra time for parts sourcing (some parts take months to locate)
- Plan for seasonal workflow (painting in warm, dry months)
...
- Floor pans (especially under carpets and mats)
...
4. Prime immediately after treatment dries (bare metal rusts within hours)
...
4. Fit the patch precisely, leaving a consistent gap for welding
5. Tack-weld the patch in place, then complete the seams with short welds to prevent warping
6. Allow cooling between weld passes to minimize heat distortion
7. Grind welds smooth with a flap disc
8. Apply seam sealer to welded joints from the inside
...
- Repair cost exceeds the value of the restored vehicle (unless sentimental value applies)
- In these cases, consider finding a better donor car
...
4. Pull spark plugs and inspect (color indicates running condition)
5. Perform a compression test on each cylinder
6. Check for cracked or damaged exhaust manifolds
...
- All cylinders uniformly low: general engine wear (may need rebuild)
- Add a tablespoon of oil to a low cylinder and retest: if compression improves significantly, the rings are worn
...
- Adjust or replace valve lifters
- Replace clutch (rear-wheel drive vehicles)
...
- Machine work (boring, honing, surfacing) should always be done by an experienced machine shop
- Keep the original engine if possible for value and authenticity
...
4. Sand body filler smooth, progressing through 80, 150, 220 grit
5. Apply epoxy primer (2 coats) as the foundation
6. Apply high-build primer-surfacer (2-3 coats) for final leveling
7. Block-sand primer with 320-grit, then 400-grit until perfectly smooth
...
- Shape with a body file or 80-grit sandpaper while semi-cured for efficiency
- Final sand with 150-220 grit
...
- Understanding of paint mixing, reduction, and application technique
...
- Get references and see previous work before committing
- Expect professional paint to cost $3,000-15,000+ depending on quality level
...
- Swap meets and car shows (networking and rare finds)
- New Old Stock (NOS) parts (original parts never installed, often premium priced)
- Aftermarket performance parts (when modification is acceptable)
...
4. Buy a parts car if available and affordable (much cheaper per-part than buying individually)
5. Order long-lead-time parts first (chrome, upholstery, glass can take weeks to months)
6. Verify part numbers and fitment before ordering (measure twice, order once)
...
- Compare reproduction parts to original parts before installing (fit and finish differences are common)
- Buy critical safety components (brakes, steering, suspension) from reputable manufacturers only
...
- Create a master list of all parts needed
...
- Test-fit doors, hood, trunk for proper alignment
...
- Replace or rebuild the braking system completely
...
- Install weatherstripping, glass, and trim
...
- Install the interior (carpet, upholstery, headliner, dash)
- Install all trim, chrome, and exterior accessories
...
- Test brakes thoroughly before driving on public roads
- Start with short, low-speed test drives and gradually increase
- Adjust alignment, carburetor, timing, and brakes as needed
- Address any squeaks, rattles, or issues systematically

## Common Mistakes to Avoid

- Starting disassembly without photographing and labeling everything
- Underestimating the budget by 50% or more (the most common mistake)
- Beginning multiple systems simultaneously instead of completing one at a time
- Skipping rust repair under paint (it always comes back)
- Using body filler to hide structural problems
- Buying a project car with a rare or discontinued engine and transmission
- Not setting a realistic budget and timeline before starting
- Ordering parts without verifying exact fitment and measurements
- Cutting corners on safety systems (brakes, steering, structural integrity)
- Working without proper safety equipment
- Losing motivation mid-project (join a community for accountability and support)
- Not keeping records for insurance and future reference

## When to Hire a Professional

- Media blasting (sandblasting, soda blasting) for complete paint removal
- Welding and major structural repair (if you are not a competent welder)
- Engine machine work (boring, honing, balancing)
- Transmission rebuilding
- Paint application (especially modern multi-stage systems)
- Upholstery and convertible top installation
- Chrome plating and polishing
- Glass installation
- Electrical diagnostics beyond basic circuits
...
2. **Analyze context.** Review the information provided and identify key factors relevant to classic car restorer
...
**Input:** "Help me with classic car restorer for my current situation"

**Output:**

Based on your situation, here is a structured approach to classic car restorer:
