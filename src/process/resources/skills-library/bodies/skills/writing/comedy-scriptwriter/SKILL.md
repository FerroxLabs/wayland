---
name: comedy-scriptwriter
description: |
  Complete comedy writing guide covering sitcom structure with cold opens and multi-story episodes, sketch writing, late night format, web series development, comedy room dynamics, and spec script creation.
  Use when the user asks about comedy scriptwriter, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of comedy scriptwriter or requires a different specialized skill.
license: Apache-2.0
metadata:
...
1. **What format are you writing in?** (Multi-cam sitcom, single-cam sitcom, sketch, late night, web series, feature film, stand-up?)
2. **What is your comedic sensibility?** (Absurdist, observational, dark, physical, satirical, dry, character-driven?)
3. **What shows or comedians do you admire most?** (Reveals their taste and target audience.)
4. **Are you writing a spec, an original pilot, or a packet?** (Different purposes and formats.)
5. **Do you have a concept or are you developing from scratch?** (Starting point.)
6. **Have you written comedy before?** (Scripts, stand-up, sketches, humor essays?)
7. **What is the goal?** (Get staffed, create a show, build a portfolio, compete in a contest, produce for YouTube?)
8. **Are you writing alone or in a room?** (Solo writing vs collaborative dynamics.)
9. **Do you have a deadline?** (Submission dates, production schedules, program deadlines.)
...
**Page count:** 44-52 pages (multi-cam is double-spaced)
...
**Page count:** 28-38 pages (single-cam is single-spaced, like a feature)
**Filming:** One camera, no audience, varied locations, film-style editing

### The A/B/C Story Structure
...
- Carries the emotional weight of the episode
...
- Has its own arc but can be simpler
...
- Provides tonal variety and pacing breaks
- Not every episode needs a C story, but most have one

### Beat Sheet: Half-Hour Single-Cam (Broadcast, 2-Act)
...
- B story development: B characters engage with their problem
...
- A story climax: The moment of maximum comedy and/or emotional truth
- B story resolution: B plot resolves (often connects back to A thematically)
- A story resolution: Problem solved (or accepted), lesson learned (or not)
...
**Seinfeld:** Self-absorbed friends make mountains out of molehills
**Ted Lasso:** Optimist confronts cynicism (and wins)
**What We Do in the Shadows:** Ancient vampires navigate modern life
**It's Always Sunny:** Terrible people's schemes backfire spectacularly

Your engine should be expressible in one sentence and should generate unlimited story possibilities.
...
**Punchline:** Violates that expectation in a surprising but logical way

The surprise must be both unexpected AND make a kind of sense. Randomness is not funny. Surprise that retroactively reframes the setup is funny.

### Joke Types for Script Writing

**The Callback:** Reference an earlier joke or moment. Creates a sense of a shared world. More rewarding the further back the original reference was.

**The Runner:** A joke that repeats and escalates throughout the episode. Each recurrence should add something (context change, escalation, subversion).

**The Tag:** An additional punchline that follows the initial joke. "One more thing" that extends the laugh.

**The Topper:** A joke that is funnier than the one before it in a sequence. Always top your previous joke; never follow a big laugh with a small one.

**The Button:** The final joke that ends a scene, sketch, or conversation. Must be the strongest joke in the sequence.

**The Misdirect:** Lead the audience to expect one thing, then deliver another. The gap between expectation and reality is the comedy.
...
Scene 2: Lie requires a bigger lie to maintain.
Scene 3: Lie requires an absurd, elaborate deception.
...
- A flaw that undermines their want
- A consistent logic (their behavior may be insane, but it follows THEIR logic)
...
4. Third beat: Escalate further or subvert expectations
5. Blackout/Button: End on the biggest laugh
...
- **End on a high.** The hardest part of sketch writing is the ending. End on the biggest laugh. When in doubt, blackout.
...
- **The Substitution:** Replace one element of a familiar situation with something unexpected
- **The Slow Reveal:** What seems normal is gradually revealed to be insane
- **The Competition:** Two or more characters one-up each other to absurd extremes
...
- **Pre-produced piece / Remote** (3-5 minutes)
- **Guest interview 1** (8-12 minutes)
- **Guest interview 2 or performance** (5-8 minutes)
...
**Punchline:** The joke (the shortest, most surprising element)
...
- Quality over quantity: 10 great jokes beat 30 mediocre ones
...
- **Short and tight.** Every second must earn its place.
- **End each episode with a reason to subscribe/follow** (not a cliffhanger necessarily, but a promise of more)
...
4. **The room** punches up each draft collectively
...
- **Read the room.** Know when to pitch and when to listen.
- **Specificity wins.** "He does something weird" is a placeholder. "He alphabetizes the chips at a party" is a joke.
...
- **Do not change the status quo.** No one dies, breaks up permanently, or reveals a major secret. Your spec exists within the show's world.
- **Hit every character.** Give each regular character something to do.
...
**Daily jokes:** Write 10 jokes about today's news. Every day. Volume produces quality.
**Scene work:** Write a 2-page comedic scene between two characters with opposing goals. No stage directions --- comedy must live in the dialogue.
**Sketch of the week:** Write one complete sketch per week. Time it by reading aloud.
**Cold open challenge:** Write a cold open for your favorite sitcom in 30 minutes.
**The worst version:** Write the worst, most obvious version of a joke first. Then find what is actually funny about the premise underneath it.
...
2. **Analyze context.** Review the information provided and identify key factors relevant to comedy scriptwriter
...
**Input:** "Help me with comedy scriptwriter for my current situation"

**Output:**

Based on your situation, here is a structured approach to comedy scriptwriter:
