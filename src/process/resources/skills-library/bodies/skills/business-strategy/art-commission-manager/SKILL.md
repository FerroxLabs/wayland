---
name: art-commission-manager
description: |
  Guides artists through the full commission lifecycle including pricing formulas, contract templates, revision policies, client communication, and delivery workflows for sustainable freelance art practices.
  Use when the user asks about art commission manager, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of art commission manager or requires a different specialized skill.
license: Apache-2.0
metadata:
...
## Commission Pricing Framework

### Base Rate Calculation

Use the **Living Rate Formula** to establish a sustainable base hourly rate:

```
Annual Living Costs + Business Expenses + Profit Margin (20%)
------------------------------------------------------------- = Hourly Base Rate
...
- Price range: $[base x 3] - $[base x 6+]

### Additional Character and Element Pricing

- Extra character: +50-80% of base character price
- Complex background: +30-60% of base price
- Props/pets/vehicles: +10-25% per element
- Animation (simple loop): +100-200% of static price
...
- **Payment methods**: List accepted platforms and currencies
...
- Additional revision rate: $[amount] per round or hourly rate
- Revision window: Client must request revisions within [X] days of delivery
...
- Revisions at this stage: High cost, low flexibility
...
Maintain a log for each commission:

```
Commission: [Client Name] - [Project Title]
Date Started: [Date]
Revision Round | Stage | Description | In-Scope? | Notes
1 | Concept | Changed pose from sitting to standing | Yes | Within included rounds
2 | Sketch | Added second character | No | Quoted $X, client approved
3 | Color | Adjusted skin tone slightly warmer | Yes | Minor color tweak
```
...
Thank you for reaching out about a commission! I'd love to work with you.

Based on your description, this would fall under my [Tier Name] tier,
starting at $[amount]. Here's what that includes:
- [Deliverable summary]
- [Included revisions]
- [Estimated timeline]

To get started, I'll need:
1. Detailed character/scene description or reference sheet
2. Reference images for style, mood, or color direction
3. Intended use (personal, social media, commercial)
4. Any hard deadlines

Once I have those details, I'll send a formal quote and contract.
...
- **Commission start**: Confirmation email with timeline and first milestone date
- **Each milestone**: Deliver work-in-progress with clear instructions on what feedback is needed
- **Mid-project check-in**: Brief status update if timeline is longer than 2 weeks
- **Final delivery**: Deliver files with usage reminder and request for testimonial
- **Post-delivery follow-up**: Check in 1 week later, invite to share with credit

## Delivery Best Practices

### File Delivery Checklist

- [ ] High-resolution final file (300 DPI for print, 72 DPI web version)
- [ ] File formats as agreed (PSD, PNG, TIFF, JPG as appropriate)
- [ ] Watermarked preview sent before final payment
- [ ] Unwatermarked files delivered after payment confirmation
- [ ] Layered source file if included in agreement
- [ ] Color profile noted (sRGB for web, CMYK if print use)

### Delivery Methods

- **Small files (<25MB)**: Email attachment or cloud link
- **Large files (25MB-2GB)**: Cloud storage with expiring link (30-day window)
- **Very large files (>2GB)**: File transfer service or split delivery
- **Physical delivery**: Tracked shipping with insurance for original artwork

### Post-Delivery Protection

- Archive all project files, correspondence, and contracts for minimum 2 years
- Keep low-resolution copies of all delivered work for portfolio use
- Document the contract terms for each piece in case of future disputes
- Screenshot delivery confirmation and payment receipts

## Queue and Workload Management

### Capacity Planning

- Track average hours per tier from completed commissions
- Set a maximum active commission count (typically 3-5 simultaneous projects)
- Maintain a waitlist with estimated start dates when at capacity
- Block out personal project time and rest days in your schedule

### Commission Status Tracker

```
Client | Project | Tier | Status | Deposit | Due Date | Notes
Jane D | OC Portrait | Tier 2 | Color stage | Paid | Feb 15 | Awaiting Gate 3 feedback
Alex M | Book Cover | Tier 3 | Sketching | Paid | Mar 1 | Commercial license
[Waitlist] | Sam K | Tier 1 | Est. start: Mar 5 | -- | -- | --
```
...
- Comparable artists in your niche have higher rates
- You're completing work faster (higher effective hourly rate erodes income)
...
2. **Analyze context.** Review the information provided and identify key factors relevant to art commission manager
...
```template
## Art Commission Manager Analysis
...
**Input:** "Help me with art commission manager for my current situation"

**Output:**

Based on your situation, here is a structured approach to art commission manager:
