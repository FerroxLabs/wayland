---
name: phone-cleanup-guide
description: |
  Recover storage space, audit apps, organize photos, improve battery life, and boost phone performance with step-by-step cleanup procedures for iOS and Android.
  Use when the user asks about phone cleanup guide, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of phone cleanup guide or requires a different specialized skill.
license: Apache-2.0
metadata:
...
Open Messages > Menu > Settings > Storage > Free up space

### Clear App Caches

**iPhone:** (No global cache clear - per app)
Settings > General > iPhone Storage > [App] > Offload App (keeps data) or Delete App
...
### Step 1: Find Apps You Don't Use
...
[ ] Delete screenshots (search "screenshots" in Photos)
[ ] Delete failed/blurry photos
[ ] Delete duplicates (use built-in or third-party tool)
[ ] Review videos - delete what you won't rewatch
[ ] Delete burst photos (keep best, delete rest)
[ ] Empty "Recently Deleted" folder (still using space for 30 days)
```

**iPhone Duplicates:**
Photos > Albums > Duplicates (iOS 16+) > Merge
...
**iPhone:**
Settings > Photos > Optimize iPhone Storage (keeps thumbnails locally)

**Android (Google Photos):**
Google Photos > Profile > Photos settings > Backup > Storage saver
...
[ ] Restart phone (clears memory - do this weekly)
[ ] Update OS to latest version
[ ] Update all apps
[ ] Close background apps (iPhone: swipe up from bottom; Android: recent apps button)
[ ] Disable unnecessary notifications
    - Settings > Notifications > review each app
[ ] Reduce animations
    - iPhone: Settings > Accessibility > Motion > Reduce Motion
    - Android: Developer Options > Window/Transition animation scale > 0.5x
...
**Battery below 80% health?** Consider replacement (often cheaper than new phone).

## Notification Declutter
...
```
[ ] Delete screenshots and unused photos
[ ] Uninstall apps not used this month
[ ] Clear browser tabs and bookmarks
[ ] Review and cancel unused subscriptions
    - iPhone: Settings > [your name] > Subscriptions
    - Android: Google Play > Payments & subscriptions
[ ] Empty recently deleted items
```

### Yearly (30 minutes)

```
[ ] Full app audit - remove unused
[ ] Review cloud storage usage
[ ] Update all passwords (use password manager)
[ ] Review privacy settings
[ ] Check for OS update
[ ] Back up phone to computer or cloud
[ ] Clear old text message conversations
...
2. **Analyze context.** Review the information provided and identify key factors relevant to phone cleanup guide
...
**Input:** "Help me with phone cleanup guide for my current situation"

**Output:**

Based on your situation, here is a structured approach to phone cleanup guide:
