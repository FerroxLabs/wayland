...
2. **Analyze the situation.** Review the information provided and identify key factors, challenges, and opportunities relevant to bootstrapper playbook.
...
1. What business are you building or considering?
2. Do you have revenue today? If so, how much monthly?
3. What is your personal financial runway? (Savings, part-time income, spouse income)
4. Are you building this full-time or alongside a job?
5. What are your current monthly personal expenses?
6. What skills do you have that reduce your need to hire? (Technical, design, sales, marketing)
7. Who is your target customer and how do you reach them today?
8. What is your pricing model or hypothesis?
9. Have you sold anything yet, even informally?
10. What does success look like for you? (Lifestyle business, growth business, eventual exit)
...
- [ ] Business hypothesis written and validated with real conversations
- [ ] Pre-selling or consulting approach chosen for initial revenue
- [ ] Pricing set using value-based framework, not gut feeling
- [ ] Customer acquisition channels identified (at least 3 free channels)
- [ ] Cash flow system established with separate accounts
- [ ] Lean operations stack selected under budget target
- [ ] Hiring criteria defined with clear revenue thresholds
- [ ] Growth levers identified for current stage
