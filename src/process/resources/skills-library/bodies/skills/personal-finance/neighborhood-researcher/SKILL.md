...
2. **Analyze the situation.** Review the information provided and identify key factors, challenges, and opportunities relevant to neighborhood researcher.
...
1. What type of property are you considering (primary residence, investment, vacation)?
2. What is most important to you (schools, safety, commute, walkability, affordability)?
3. Do you have children or plan to, and what ages?
4. What is your daily commute destination and maximum acceptable commute time?
5. Do you prefer urban, suburban, or rural settings?
6. What is your budget range, and how does that match the area's pricing?
7. Are there specific amenities that are non-negotiable (parks, restaurants, hospitals)?
8. How long do you plan to live in this property?
9. Do you have pets, and do you need specific outdoor access or spaces?
10. Are there cultural, religious, or community factors that are important to you?
...
- Check for recent leadership changes or major policy shifts
- Look at enrollment trends (growing or shrinking)
- Research any upcoming school redistricting that could change assignments

---

## Phase 2: Crime Statistics Analysis
...
- Crime rates vs. crime counts (population-adjusted rates are more meaningful)
...
- [ ] Look for signs of property care and community investment
- [ ] Note street lighting adequacy
- [ ] Check for active neighborhood watch programs
- [ ] Look for security cameras and alarm systems on neighboring homes
- [ ] Research local police response times and station proximity

---

## Phase 3: Walkability and Transit Analysis
...
- [ ] Map transit routes to your workplace and other key destinations
- [ ] Verify weekend and evening service availability
- [ ] Check transit agency website for planned route changes or expansions
- [ ] Research ride-share availability in the area
...
- Distance to restaurants, cafes, shops
- Distance to parks and green spaces
- Street trees and aesthetic appeal
- Traffic speed and volume on local streets
- Pedestrian friendliness (do drivers yield, is there lighting)

---

## Phase 4: Future Development Plans
...
- Mixed-use development (often increases walkability and property values)
- Transit expansion (new stations, routes)
- Hospital or medical facility construction
...
- Affordable housing developments in high-end areas (perception impact)
- Cell tower or power substation construction
...
- Understand overlay districts (historic, flood, environmental)
- Verify the property's zoning matches your intended use

---

## Phase 5: Property Value Trends
...
- County assessor records (historical assessed values)
- MLS data (through a real estate agent)
- Federal Reserve Economic Data (FRED) -- broader market trends
- Case-Shiller Home Price Index -- metro area trends
...
```
NEIGHBORHOOD VALUE TREND ANALYSIS
==================================
Neighborhood: _________________________________

Year    | Median Price | % Change | Avg DOM | Inventory
--------+-------------+----------+---------+----------
Current | $__________ | ________% | _______ | _________
Year-1  | $__________ | ________% | _______ | _________
Year-2  | $__________ | ________% | _______ | _________
Year-3  | $__________ | ________% | _______ | _________
Year-5  | $__________ | ________% | _______ | _________

5-Year Compound Annual Growth Rate: _________%
City Average 5-Year CAGR: _________%
Comparison (above/below city average): _________%
```

---

## Phase 6: Community Amenities Assessment
...
- Community garden or farmers market presence
- Youth sports leagues and programs
- Active homeowner associations (if applicable)
- Community newsletters or social media groups
- Volunteer organizations and civic engagement

---

## Phase 7: Noise Assessment
...
4. **Research:** Flight path maps (FAA), rail schedules, planned road projects
5. **Use a decibel meter app** to quantify noise levels at different times
6. **Talk to neighbors** about noise issues they experience
...
- Walking: Distance, sidewalk availability, safety
- Remote work: How many days, does this change the calculus?
...
======================
Route: From _____________ to _____________

DRIVING:
  Round-trip distance: _______ miles
  Working days per month: _______
  Gas cost per gallon: $_______
  Vehicle MPG: _______
  Monthly gas cost: $_______
  Tolls (monthly): $_______
  Parking (monthly): $_______
  Wear and tear ($0.15/mile): $_______
  Monthly driving cost: $_______
  Annual driving cost: $_______
  Time per day (round trip): _______ hours

TRANSIT:
  Monthly pass cost: $_______
  Annual transit cost: $_______
  Time per day (round trip): _______ hours

COST DIFFERENCE:
  Annual savings of ____________ by ____________
  Time difference: _______ hours per day x _______ days/year = _______ hours/year
```

---

## Phase 9: Comprehensive Neighborhood Scoring
...
Factor                  | Weight | Nbhd A | Nbhd B | Nbhd C
------------------------+--------+--------+--------+--------
Schools                 | x ___  | ____   | ____   | ____
Safety/Crime            | x ___  | ____   | ____   | ____
Walkability             | x ___  | ____   | ____   | ____
Commute Time            | x ___  | ____   | ____   | ____
Property Values/Trends  | x ___  | ____   | ____   | ____
Amenities              | x ___  | ____   | ____   | ____
Noise Level             | x ___  | ____   | ____   | ____
Future Development      | x ___  | ____   | ____   | ____
Affordability           | x ___  | ____   | ____   | ____
Community Feel          | x ___  | ____   | ____   | ____
------------------------+--------+--------+--------+--------
WEIGHTED TOTAL          |        | ____   | ____   | ____
```

**Assign weights based on your priorities (total weights should sum to 10).**
...
- [ ] Visit on a weekday evening after work hours
- [ ] Visit on a Saturday afternoon
- [ ] Visit on a Friday or Saturday night
- [ ] Walk the neighborhood on foot (not just drive through)
- [ ] Visit local shops and restaurants
- [ ] Sit in a local park and observe
- [ ] Talk to people in the neighborhood
- [ ] Check the condition of homes, yards, and common spaces
- [ ] Observe traffic patterns and parking availability
- [ ] Note the presence or absence of people walking, biking, playing outdoors
...
```
[Neighborhood Researcher deliverable]
