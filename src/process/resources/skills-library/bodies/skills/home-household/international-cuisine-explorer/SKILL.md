...
description: |
  Guide home cooks through regional cuisines worldwide with pantry building, authentic techniques, flavor profiles, ingredient substitutions, and culturally respectful cooking practices
  Use when the user asks about international cuisine explorer, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of international cuisine explorer or requires a different specialized skill.
license: Apache-2.0
metadata:
...
1. Which cuisine or region are you most interested in exploring?
2. What is your current cooking experience level?
3. Are there dietary restrictions or allergies to consider?
4. What kind of grocery stores and specialty markets are accessible to you?
5. Do you already have any international ingredients or equipment?
6. Are you looking for weeknight-friendly dishes or weekend projects?
7. How adventurous are you with unfamiliar flavors and textures?
8. Are you cooking for yourself, a partner, or a family (including children)?
9. Do you have experience with any international cuisines already?
10. Is there a specific dish that inspired your interest?

## Flavor Profile Atlas

### Understanding Regional Flavor Foundations

Each cuisine builds on a foundational flavor base. Learning these bases unlocks hundreds of dishes.
...
- Dried chili flakes (multiple types as you grow)
...
- Dried lentils
- Canned tomatoes (whole, San Marzano style)
...
Sichuan peppercorns, black cardamom, asafoetida, tamarind block, palm sugar, kaffir lime leaves, galangal, shrimp paste, black vinegar, fermented black beans, dried shrimp, teff flour, berbere spice

### Pantry Storage Tips

- Whole spices keep 2-3 years; ground spices 6-12 months
- Store spices away from heat and light
- Date your spices when you buy them
- Fish sauce and soy sauce last years in the pantry
- Coconut milk should be used within a few days of opening (freeze extra)
- Fresh aromatics (lemongrass, galangal, curry leaves) freeze well
- Buy small quantities of new spices until you know you'll use them

## Essential Techniques by Region
...
- Use high heat, move food constantly
- Add aromatics first (ginger, garlic), then proteins, then vegetables
...
- Add over a finished dish or as a base for cooking
...
4. Add ground spices, toast briefly (30 seconds)
5. Add tomatoes or yogurt, cook down
6. Add protein/vegetables and liquid
...
4. Blend with soaking liquid into a smooth paste
...
- Balance: acid (lime), heat (chili), salt, sweetness (tomato/fruit)
...
- Asian grocery stores are the best value for East and Southeast Asian ingredients
- Indian/South Asian grocery stores carry spices at a fraction of supermarket prices
- Latin American markets (tiendas) have authentic chilies, masa, and specialty items
- Middle Eastern markets carry tahini, spices, nuts, and flatbreads
- Online retailers fill gaps for hard-to-find items
- Build relationships with specialty store staff - they often have cooking tips

## Cultural Respect in Cooking

### Approaching Other Cuisines Thoughtfully

- **Learn the context**: Understand the cultural significance of dishes before adapting them
- **Credit the source**: Name the cuisine, region, and tradition when sharing
- **Avoid "improving" traditional recipes**: Master the original before creating variations
- **Respect sacred or ceremonial foods**: Some dishes have spiritual significance
- **Seek authentic voices**: Learn from cookbooks, videos, and teachers from within the culture
- **Acknowledge your learning journey**: "I'm learning to cook Thai food" not "I make the best Thai food"
- **Support businesses from the culture**: Buy ingredients from immigrant-owned shops
- **Be honest about adaptations**: "This is my take on..." or "Inspired by..."
- **Listen to feedback**: If someone from the culture offers correction, receive it graciously
...
- Appreciates regional variations within a cuisine
...
2. **Analyze context.** Review the information provided and identify key factors relevant to international cuisine explorer
...
```template
## International Cuisine Explorer Analysis
...
**Input:** "Help me with international cuisine explorer for my current situation"

**Output:**

Based on your situation, here is a structured approach to international cuisine explorer:
