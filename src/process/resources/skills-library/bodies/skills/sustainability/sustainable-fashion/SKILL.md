...
description: |
  Guide to building a sustainable wardrobe including ethical brand evaluation, secondhand shopping strategies (ThredUp, Poshmark, consignment), capsule wardrobe principles for sustainability, fabric guide covering organic, recycled, and problematic materials, clothing care techniques to extend garment life, and basic repair and mending skills.
  Use when the user asks about sustainable fashion, or needs help with guide to building a sustainable wardrobe including ethical brand evaluation, secondhand shopping strategies (thredup, poshmark, consignment), capsule wardrobe principles for sustainability, fabric guide covering organic, recycled, and problematic materials, clothing care techniques to extend garment life, and basic repair and mending skills.
  Do NOT use when the request requires professional specialized advice or falls outside the scope of sustainable fashion.
license: Apache-2.0
metadata:
...
1. **Step 1:** Audit current wardrobe: what is worn regularly, what is neglected, what needs replacing
2. **Step 2:** Establish sustainable fashion priorities: longevity, ethics, environmental impact, budget
3. **Step 3:** Build a capsule wardrobe framework with versatile core pieces
4. **Step 4:** Identify sustainable sourcing options: secondhand, ethical brands, local makers
5. **Step 5:** Create a purchasing decision framework: need vs. want, cost-per-wear calculation

## Questions to Ask First

1. What is your current relationship with clothing and shopping?
2. What is your budget for clothing (monthly or annual)?
3. What is your primary motivation (environmental, ethical, financial, minimalism)?
4. Do you already have a sense of your personal style, or are you developing it?
5. What is your lifestyle (professional, casual, active, varied)?
6. What climate do you live in?
7. Are there specific ethical concerns you prioritize (labor conditions, animal welfare, environmental impact)?
8. Do you have any sewing or mending skills?
9. Are there secondhand stores, consignment shops, or thrift stores accessible to you?
10. How much closet space do you have?

---

## Phase 1: Understanding Fashion's Impact
...
- Garment workers in many countries earn below living wages
- The average consumer buys 60% more clothing than 15 years ago and keeps each item half as long

### The Sustainable Fashion Hierarchy

```
1. WEAR WHAT YOU HAVE (most sustainable garment is the one already in your closet)
2. BORROW OR SWAP (use without consuming)
3. BUY SECONDHAND (extend the life of existing garments)
4. BUY SUSTAINABLE (new from ethical/sustainable brands)
5. BUY CONVENTIONAL (last resort -- choose quality and timeless design)
```

---

## Phase 2: Ethical Brand Evaluation
...
- [ ] Environmental practices: Do they minimize water use, chemicals, and carbon emissions?
- [ ] Certifications: Do they hold third-party certifications (see below)?
- [ ] Circularity: Do they offer repair, resale, or recycling programs?
- [ ] Longevity: Are garments designed to last?
...
- Claims about one aspect (recycled packaging) while ignoring major impacts (production)
- Offsetting instead of reducing

---

## Phase 3: Secondhand Shopping
...
- Look for stains, pilling, and wear in photos (or in person)
- Research retail prices to ensure secondhand prices are actually good deals
- Set up saved searches and alerts for specific brands or items
- Shop off-season for better deals (winter coats in summer)
- Check return policies (some platforms have limited or no returns)
- Wash all secondhand clothing before wearing
...
- Price fairly (check comparable sold listings)
- Ship quickly and package neatly
...
- Donate, sell, or swap "Never Wear" items
- Identify gaps in "Love/Wear Often" pile

**Step 2: Define Your Core Palette**
Choose 3-4 neutral base colors and 2-3 accent colors that work together:

```
Example Palette:
  Neutrals: Black, white, navy, gray
  Accents: Burgundy, olive, camel

Every piece should work with at least 3 others in your wardrobe.
```
...
- More investment in pieces you love and wear regularly
- Reduced environmental footprint

---

## Phase 5: Fabric Guide
...
- Air dry when possible (dryer agitation increases shedding)
- Choose tightly woven synthetics over fleece or loose knits

---

## Phase 6: Clothing Care to Extend Life
...
- Store off-season clothing in breathable garment bags (not plastic)
- Button and zip garments before storing

---

## Phase 7: Repair and Mending
...
4. Repeat 4-6 times through each pair of holes
5. Wrap thread around base of button several times (creates shank)
...
- Zipper replacement
- Leather or heavy material repair
...
## Phase 8: Building a Sustainable Shopping Mindset

### Before Every Purchase, Ask:

1. Do I actually need this, or do I just want it right now?
2. Do I have something similar already that serves the same purpose?
3. Can I borrow, rent, or buy this secondhand?
4. Will I wear this at least 30 times (the "cost per wear" test)?
5. Does it fit well and feel comfortable right now (not "when I lose weight" or "after alterations")?
6. Does it work with at least 3 things already in my wardrobe?
7. Is it made from quality materials that will last?
8. Do I know who made this and under what conditions?
9. What happens to this garment at the end of its life?
10. If I saw this again next week, would I still want it? (If unsure, wait.)
...
$100 jacket worn 200 times = $0.50 per wear (great value)
$20 trendy top worn 3 times = $6.67 per wear (poor value)

Before buying, ask: "Will I wear this at least 30 times?"
If yes, it is likely a good purchase.
If no, reconsider.
```
...
- Local textile recycling events
...
**Input:** "I want to dress more sustainably but I am on a tight budget. I cannot afford expensive ethical brands. What can I do?"
...
**2. Secondhand First (Cost: 50-80% less than retail)**
| Source | Best For | Price Range |
|--------|----------|-------------|
| ThredUp | Everyday basics | $5-25 |
| Poshmark | Brand names | 40-70% off retail |
| Local thrift stores | Everything | $2-15 |
...
| Brand | Price Point | Certifications |
|-------|------------|----------------|
| Pact | $15-40 | Fair Trade, GOTS organic |
| Uniqlo (select lines) | $15-50 | BlueSign materials |
| H&M Conscious | $10-40 | Recycled materials (verify claims) |
