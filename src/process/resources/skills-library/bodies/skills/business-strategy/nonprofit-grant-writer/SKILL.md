...
2. **Analyze the situation.** Review the information provided and identify key factors, challenges, and opportunities relevant to nonprofit grant writer.
...
This guide focuses on private foundation, community foundation, and corporate giving grants for nonprofit organizations. For government and academic research grants, see the Grant Proposal Writer skill.

Before beginning a grant-seeking effort:

1. What is your organization's mission and current programs?
2. What specific project or program needs funding?
3. What is the total project budget and how much do you need from grants?
4. Does your organization have 501(c)(3) status (or a fiscal sponsor)?
5. What is your track record of grant management? Have you received grants before?
6. Do you have the infrastructure to track and report on grant-funded activities?
7. What is your timeline for needing funds?
8. Who will manage the grant if awarded? (Program staff, finance staff)
9. Do you have audited financial statements or a recent financial review?
10. What data do you have demonstrating the need your project addresses?
...
- **Corporate giving programs**: Company websites, CSR reports
...
4. Check geographic restrictions - many funders are location-specific
5. Review past grant recipients - are they similar to your organization?
6. Note typical grant amounts - do not apply for $100,000 from a funder that typically gives $5,000
7. Check deadlines and application cycles
...
- Is our request within their typical grant range?
- Have they funded similar projects before?
- Are we eligible? (Some require invitation only, or 3+ years of operation)

**If 4+ answers are "yes," it is worth pursuing.**
...
- Have someone outside your organization read it for clarity
- Submit before the deadline (ideally 1+ week early)
...
- Connection to funder's priorities
...
- Avoid circular logic ("We need a shelter because we lack a shelter")
...
- Trend data showing the problem is growing
...
- How this project builds on your existing work
...
- **Frequency**: When will data be collected and analyzed?
- **External evaluator**: Required by some funders for large grants
- **Reporting plan**: How results will be shared with funder and stakeholders
...
- Include in-kind contributions (volunteer time, donated space)
- Indirect costs: Check funder's policy (some cap at 10-15%, some disallow)
...
- Key accomplishments and impact data
...
- Match your language to the funder's priorities and terminology
- Follow formatting instructions exactly (margins, font, page limits)
...
- Exaggerate impact or make promises you cannot keep
- Ignore evaluation - funders want to know if their money made a difference
- Exceed page limits or word counts
- Submit late - late submissions are almost never reviewed
...
- Connect spending to outcomes (show return on investment)
- Submit reports on time - late reports jeopardize future funding
...
- Acknowledge funding publicly (with permission)
...
- Provide updates on the project's continued impact
...
- A "no" this year can become a "yes" next year with relationship building
...
- Never rely on a single funder for more than 30% of budget
- Plan 6-12 months ahead - grants have long lead times

## Progression Path

1. **Phase 1**: Learn prospect research, write your first LOI
2. **Phase 2**: Submit first full proposal, learn from feedback (win or lose)
3. **Phase 3**: Build a grant calendar, manage 5-10 applications per year
4. **Phase 4**: Successfully manage multi-year grants, master reporting
5. **Phase 5**: Develop funder relationships, secure renewals, mentor others
6. **Phase 6**: Strategic grants management - align grants with organizational strategy, diversify funding

## Resources

- **Grant Professionals Association** (grantprofessionals.org): Training, certification (GPC)
- **Candid Learning** (learning.candid.org): Free grant writing courses
- **GrantSpace by Candid**: Templates, tools, and guides
- **Books**: "The Only Grant-Writing Book You'll Ever Need" by Ellen Karsh
- **Books**: "Winning Grants Step by Step" by Mim Carlson
...
```
[Nonprofit Grant Writer deliverable]
