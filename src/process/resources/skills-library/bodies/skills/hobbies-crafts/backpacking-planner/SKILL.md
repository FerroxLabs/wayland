---
name: backpacking-planner
description: |
  Guide to backpacking including gear selection, trip planning, navigation, meal planning, water treatment, Leave No Trace, bear country protocols, and fitness preparation.
  Use when the user asks about backpacking planner, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of backpacking planner or requires a different specialized skill.
license: Apache-2.0
metadata:
...
Before planning a backpacking trip:

1. What is your backpacking experience? (Never / Day hiker wanting to go overnight / Some backpacking / Experienced)
2. What is your fitness level? (Sedentary / Moderately active / Very active / Athletic)
3. Where do you want to go? (Specific trail or general region)
4. How many nights? (1 night / 2-3 nights / Week+ / Thru-hike)
5. Who is going? (Solo, partner, group, family)
6. What season? (Summer / Shoulder season / Winter)
7. What is your budget for gear? ($200-500 / $500-1,000 / $1,000-2,000 / $2,000+)
8. Do you own any gear already? What?
9. Any medical conditions or dietary needs?
10. What terrain and climate will you encounter? (Mountains, desert, forest, coastal)

## The Big 3: Pack, Shelter, Sleep System
...
- Premium UL: ULA Circuit (~$275) - 39 oz, cult following
...
- **Freestanding tent**: Easiest setup, works on any surface, heaviest
  ...
  - Naturehike Cloud-Up 2 (~$100, 4 lb 6 oz) - excellent budget option
- **Trekking pole tent/tarp tent**: Uses hiking poles for structure, lighter
  - Durston X-Mid 2P (~$250, 2 lb 4 oz) - best value UL shelter
  - Six Moon Designs Lunar Solo (~$250, 1 lb 10 oz) - single person
- **Hammock**: Comfortable, requires trees, cold underneath (needs underquilt in cold)
...
- Single vs double wall: Double wall reduces condensation but weighs more
...
- Quilt vs bag: Quilts are lighter (no material under you where it compresses anyway) but less versatile in cold
- Recommendations:
  - Budget: Kelty Cosmic 20 (~$100) or Hammock Gear Econ Quilt (~$150)
  - Mid-range: REI Magma 15 (~$300) or Enlightened Equipment Revelation (~$265)
...
- Types:
  ...
  - Self-inflating: Comfortable, moderate weight, durable
  - Foam: Cheapest, lightest, indestructible, least comfortable
- Recommendations:
  - Therm-a-Rest NeoAir XLite NXT (~$200, R4.5, 12 oz) - best all-around
  - Nemo Tensor (~$170, R4.2, 15 oz) - quieter alternative
  - Therm-a-Rest Z Lite Sol (~$45, R2.0, 14 oz) - bombproof foam pad
...
4. **Elevation gain**: 1,000 ft of gain ≈ 1 extra mile of effort
5. **Naismith's Rule**: Allow 1 hour per 3 miles + 1 hour per 2,000 ft elevation gain
6. **Camp locations**: Identify potential campsites, water sources along route
7. **Permits**: Many popular trails require permits (plan months ahead)
...
- **BLM land**: Generally open camping, minimal permits
...
- Agree on when to call for help if you do not return on time
...
- **CalTopo**: Route planning, printing custom maps
...
- Check position regularly (do not wait until you are lost)
- If lost: STOP. Sit, Think, Observe, Plan. Backtrack to last known position if possible.
...
- Never rely on a single water source - have backup plan
...
1. **Plan ahead and prepare**: Know regulations, conditions, and your capabilities
2. **Travel and camp on durable surfaces**: Use established sites and trails
3. **Dispose of waste properly**: Pack out ALL trash, bury human waste in catholes (6-8 inches deep, 200 feet from water)
4. **Leave what you find**: Do not take natural objects
5. **Minimize campfire impacts**: Use a stove instead, or use established fire rings with small fires
6. **Respect wildlife**: Observe from distance, store food properly
...
- PCG (Pacific Crest Trail) method:
  ...
  3. Haul food bag up, tie off
  4. Bag should hang 12+ feet above ground, 6+ feet from trunk, 5+ feet below branch
...
- Make noise while hiking (talking, clapping) to avoid surprising bears
- Carry bear spray in grizzly country, accessible (hip belt holster)
- Know the difference: Black bears (scare away), Grizzly bears (play dead if attacked during defensive charge)
...
- **Back pain**: Proper pack fit and weight distribution, core strength

## Safety Considerations

- Tell someone your itinerary and expected return
- Carry first aid kit: Bandages, pain medication, antihistamines, blister care, SAM splint, wound care
- Know basic first aid: Wound treatment, splinting, recognizing altitude sickness, hypothermia, heat illness
- Carry emergency communication: Satellite communicator (Garmin inReach) for areas without cell service
- Know your limits: Turning back is always acceptable
- Lightning protocol: Get below treeline, avoid exposed ridges, avoid tall isolated trees, crouch on pad if caught in open
- River crossings: Unbuckle hip belt and sternum strap (so you can ditch pack if swept away), use trekking poles, face upstream, cross at wide/shallow points
...
- Identify your heaviest items and address those first

## Progression Path

1. **Phase 1**: Day hike with full pack to test gear and fitness, car camp as base
2. **Phase 2**: One-night backpacking trip on well-marked trail, 3-5 miles from car
3. **Phase 3**: Multi-night trips, increase distance, diverse terrain
4. **Phase 4**: Solo trips, off-trail navigation, shoulder season conditions
5. **Phase 5**: Multi-week trips, thru-hike sections, mentoring newer hikers
6. **Phase 6**: Full thru-hikes (AT, PCT, CDT), international trekking, trail advocacy

## Resources

- **Books**: "The Ultimate Hiker's Gear Guide" by Andrew Skurka
- **Books**: "NOLS Wilderness Navigation" (essential skills)
- **Apps**: Gaia GPS, FarOut, AllTrails, Lighterpack
- **YouTube**: Darwin Onthetrail, Homemade Wanderlust, Andrew Skurka
- **Reddit**: r/Ultralight, r/backpacking, r/WildernessBackpacking
...
2. **Analyze context.** Review the information provided and identify key factors relevant to backpacking planner
...
**Input:** "Help me with backpacking planner for my current situation"

**Output:**

Based on your situation, here is a structured approach to backpacking planner:
