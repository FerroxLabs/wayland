---
name: live-performance-coach
description: |
  Expert guidance for live music performance covering stage presence, setlist construction, sound check protocol, crowd engagement techniques, managing performance anxiety, and delivering memorable shows.
  Use when the user asks about live performance coach, related techniques, best practices, or needs guidance in this domain.
...
- What is your performance experience level (first gig, regular gigging, touring)?
- Are you a solo artist, duo, or full band?
- What genre do you perform?
- What size venues do you typically play (open mics, clubs, theaters, festivals)?
- What is your biggest performance challenge right now?
- Do you experience stage fright or performance anxiety?
- How long is a typical set for you?
- Do you have any upcoming shows you are preparing for?

## Stage Presence

### What Stage Presence Actually Is

Stage presence is not a gift you are born with. It is a set of learnable behaviors rooted in three things:

1. **Commitment:** Every movement and expression is intentional, not accidental
2. **Connection:** You are performing WITH the audience, not AT them
3. **Confidence:** Not arrogance; rather, the visible belief that you belong on that stage
...
- Avoid unconscious repetitive movements (swaying, rocking, tapping foot constantly)
...
- Where do you close your eyes and turn inward?
...
- Make eye contact with specific people (not scanning; real eye contact for 2-3 seconds)
- Between songs: relaxed, present, approachable

### The Camera Test

Record yourself performing a full set. Watch it without sound. Does your body tell the story of the songs? If you look the same in every song, you need more physical variation.

## Setlist Construction

### The Arc of a Set

A great setlist tells a story with its own narrative arc:

```
Song 1: OPENER
  - High energy, confident, sets the tone
  - Your most accessible song (not necessarily your best)
  - Tells the audience: "You're in good hands"

Songs 2-3: ESTABLISH
  - Keep energy up, build momentum
  - Songs the audience responds to well
  - No deep cuts yet

Song 4-5: FIRST VALLEY
  - Bring the energy down slightly
  - A ballad or mid-tempo song
  - Creates contrast that makes the next peak feel bigger

Songs 6-7: SECOND PEAK
  - Energy back up
  - Fan favorites, singalong potential
  - This is the middle of your set - own it

Song 8: THE MOMENT
  - Your most emotionally powerful song
  - This is where you connect deepest
  - Can be quiet or loud, but must be authentic

Song 9: BUILD TO CLOSE
  - Energy rising toward the finale
  - Fun, engaging, gets people moving

Song 10: CLOSER
  - Your biggest, most memorable song
  - Leave them wanting more
  - Should end definitively (not fade out)

ENCORE (if applicable):
  - 1-2 songs
  - One intimate, one explosive
  - The final song is the last impression
```
...
- If you are losing them: make eye contact, ask a question, change the plan
...
4. Get comfortable on the stage before the audience arrives
...
- Bass
- Guitars/keys
- Vocals (each singer individually)
...
- Arrive on time (sound check times are often tight)
- Know your gear: bring backup cables, batteries, strings, picks
- Do not play during someone else's sound check
- Thank the sound engineer by name if possible
- If you have specific needs (effects, monitors), communicate them before sound check
...
- Agree on a signal system with the engineer: thumb up = more, thumb down = less, point to what
...
- Ask a question: "How many of you have been to this venue before?"
- Make a joke if it is natural (do not force comedy)
...
- Inside jokes only the band understands
- Technical complaints ("I can't hear my monitor")

**Silence is okay:** A confident pause between songs, where you take a drink of water and let the moment breathe, is better than nervous chatter.

### During Songs

**Call and response:** Teach the audience a simple part and have them sing it back
**Singalongs:** On your most well-known songs, pull the mic back and let the crowd sing
**Clapping:** Start a clap pattern during a bridge or breakdown
**Physical direction:** "Everybody put your hands up" works at festivals, not at jazz clubs - read the room
**Dedications:** Dedicate a song to someone in the audience or to the city you are in
**The quiet moment:** Drop to a whisper and watch the crowd lean in
...
Performance anxiety is a normal physiological response. Your body is preparing for a high-stakes situation by flooding you with adrenaline. The symptoms (racing heart, shaky hands, dry mouth, nausea) are the same chemicals that enhance performance - if you reframe them.
...
- Light exercise: a 15-minute walk helps burn off excess adrenaline
...
- Focus on what you want to give the audience, not what you fear they will think
...
- Focus on the music, not on yourself. Lose yourself in the song.
...
- Never stop and apologize mid-song unless absolutely necessary.
...
- [ ] All instruments, stands, and cables
- [ ] Backup strings, picks, sticks, batteries
- [ ] Setlist (printed copies for each member + sound engineer)
- [ ] Merch (if selling)
- [ ] Water bottles for stage
- [ ] Towel for sweat/spills
- [ ] Contact info for venue and sound engineer
- [ ] Change of clothes (especially for sweaty shows)
...
- Talk to audience members who want to connect
- Have a merch table ready (even if it is just a QR code)
- Post a thank-you to the venue on social media
...
2. **Analyze context.** Review the information provided and identify key factors relevant to live performance coach
...
```template
## Live Performance Coach Analysis
...
**Input:** "Help me with live performance coach for my current situation"

**Output:**

Based on your situation, here is a structured approach to live performance coach:
