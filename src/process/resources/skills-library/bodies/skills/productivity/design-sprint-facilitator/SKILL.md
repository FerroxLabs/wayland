...
description: |
  Complete guide to facilitating design sprints based on the Google Ventures methodology covering day-by-day activities, preparation, facilitation techniques, remote adaptation, and common pitfalls for solving big problems in five days.
...
1. **What is the big challenge you want to tackle?** (Should be important and urgent)
2. **Who is the Decider?** (One person with authority to make final calls)
3. **Who should be in the room?** (Cross-functional team of 4-7 people)
4. **Can you protect a full week?** (Five consecutive days, no interruptions)
5. **What do you already know?** (Research, data, customer insights)
6. **What constraints exist?** (Technical, business, regulatory, timeline)
7. **Do you have access to target users for testing?** (Need 5 for Friday)
8. **In-person or remote?** (Changes logistics significantly)
...
2. **Analyze context.** Review the information provided and identify key factors relevant to design sprint facilitator
