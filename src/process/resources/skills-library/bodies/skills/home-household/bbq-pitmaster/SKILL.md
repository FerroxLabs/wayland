...
name: bbq-pitmaster
description: |
  Master the art of barbecue with guidance on smoker types including offset, kamado, pellet, and kettle, wood selection and flavor profiles, meat selection and preparation, rubs and marinades, temperature management, smoking times by cut, sauce recipes, and competition BBQ fundamentals.
  Use when the user asks about bbq pitmaster, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of bbq pitmaster or requires a different specialized skill.
license: Apache-2.0
metadata:
...
1. What type of smoker or grill do you have (or are you looking to buy)?
2. What is your experience level with smoking (first time, some experience, experienced)?
3. What are you planning to smoke (specific cut of meat)?
4. How many people are you cooking for?
5. What style of BBQ interests you (Texas, Kansas City, Carolina, Memphis, or your own)?
6. Do you have a preferred fuel (charcoal, wood, pellets)?
7. What is your time availability (some cooks take 12+ hours)?
8. Are there any specific problems you are having (temperature control, dry meat, bitter smoke)?
...
- Burns real wood or a wood/charcoal combination
...
- Thin blue smoke is the goal, not billowing white smoke
...
- Long lifespan (decades if cared for)
- Holds moisture well
...
- Expensive
- Temperature adjustments are slow (ceramic holds heat; if you overshoot, it takes time to come back down)
...
- Less hands-on, less "craft" feeling
...
- Do not wrap meat early - let the bark develop

### Kettle Grill (Weber Kettle)
...
- Also works for grilling, searing, and baking
...
- Smoke flavor is good but not as deep as a stick burner

**The Snake Method:**
Arrange charcoal briquettes in a C-shape around the perimeter of the grill, two briquettes wide and two high. Place wood chunks every 4-5 inches along the snake. Light one end. The fire slowly burns along the snake, providing 6-8 hours of consistent heat (225-275 degrees F) without intervention.
...
- **Classic:** Hickory + cherry (bold with sweetness)
- **Texas brisket:** Post oak (the standard) or oak + mesquite (small amount)
- **Competition ribs:** Cherry + apple (sweet and fruity; gives great color)
- **Poultry:** Apple + pecan (mild and nutty)
- **Universal blend:** Oak + cherry (works with everything)
...
- Never use softwoods (pine, cedar, spruce, fir) - they contain resin that produces toxic, acrid smoke
- Never use treated, painted, or processed wood
- Green (freshly cut) wood produces harsh smoke - use seasoned (dried 6-12 months) wood
- Bark-on is fine for most woods but some pitmasters remove bark to reduce creosote
- Less is more - you can always add more smoke, but you cannot remove bitterness from over-smoking
...
3. Square off edges for even cooking
4. Apply binder (yellow mustard or hot sauce - flavor disappears; it just helps rub adhere)
5. Apply rub generously (Texas-style: coarse black pepper + kosher salt, 50/50)
6. Refrigerate uncovered overnight for bark development (optional but recommended)
```
...
- Spritz every hour after bark sets (apple cider vinegar or apple juice)
- The Stall: Internal temp will plateau around 150-170 degrees F for hours (moisture evaporation cooling the meat). Wait it out or wrap (the Texas Crutch).
- Wrap in butcher paper at 165-170 degrees F internal (preserves bark better than foil)
- Pull at 200-205 degrees F internal when a probe slides in like warm butter
- Rest for at least 1 hour (2-4 hours is better) in a cooler wrapped in towels
...
2. Trim any excess flaps or loose meat
3. Apply rub generously on both sides
4. Let ribs sit with rub for 30 minutes to overnight
```
...
Phase 1 (3 hours): Smoke unwrapped at 225 degrees F
  - Bone side down
  - Spritz hourly after the first 2 hours
  - This builds bark and smoke flavor

Phase 2 (2 hours): Wrap in foil at 225 degrees F
  - Place ribs meat side down on foil
  - Add liquid (apple juice, butter, brown sugar, honey - or none)
  - Seal tightly
  - This tenderizes through braising

Phase 3 (1 hour): Unwrap, sauce (optional), finish at 225-275 degrees F
  - Unwrap and return to grate bone side down
  - Apply sauce in thin layers (2-3 coats in the last 30 minutes)
  - Sauce will set and get tacky

Total time: approximately 6 hours

For baby backs: Use 2-1-1 method (shorter times due to smaller size)
```

**Doneness Test:** Pick up the ribs with tongs from the middle. They should bend and the surface should crack but not fall apart. Bones should wiggle but not pull clean out. "Fall off the bone" is actually overcooked for competition standards - but cook to your preference.
...
- Spritz every hour after bark sets
- Expect the Stall around 160 degrees F
- Wrap at 165 degrees F internal if you want to push through the stall faster
- Pull at 200-205 degrees F when the bone pulls out cleanly
- Rest 1-2 hours, then pull (shred) by hand or with bear claws
- Mix in some of the rendered juices from the wrap
...
- Brine for 4-12 hours for juicier results (1/4 cup salt per quart of water)
- Pull at 165 degrees F internal (thigh)
- For crispy skin: pat dry, apply oil or butter under the skin, cook at higher temp, or finish over direct heat
...
That is it. The beef is the star. Apply generously.
```
...
Mix well. Store in an airtight container for up to 6 months.
Makes about 1 cup.
```
...
Inject every 1-2 inches in a grid pattern, pumping slowly as you
withdraw the needle. Use approximately 1-2 oz per pound of meat.
```
...
You control temperature primarily through oxygen (airflow), not by adding or removing fuel.

**Intake Vent (Bottom):** Controls oxygen supply. More open = hotter. More closed = cooler.
**Exhaust Vent (Top/Chimney):** Should be mostly open to allow clean smoke to exit. Closing it traps creosote and produces bitter, dirty smoke.
...
Combine in a saucepan. Simmer 20-30 minutes, stirring occasionally.
Adjust sweetness/heat to taste. Makes about 3 cups.
```

### Carolina Vinegar Sauce (Eastern NC)
...
Combine and shake well. No cooking required.
Thin, tangy, and meant to be poured over pulled pork.
```
...
Combine in a saucepan. Simmer 10 minutes.
Tangy, mustardy, perfect with pulled pork.
```
...
Whisk together. Refrigerate at least 1 hour before serving.
Traditionally served with smoked chicken.
```

## Competition BBQ Basics

### The Four Competition Categories (KCBS Standard)

1. **Chicken** - Usually thighs; judges look for bite-through skin, moisture, seasoning
2. **Pork Ribs** - Spare or baby back; judges look for tenderness (a clean bite without falling off the bone), flavor, appearance
3. **Pork** - Usually pulled pork from a Boston butt; judges look for moisture, smoke ring, flavor, texture
4. **Brisket** - Sliced (from the flat) and/or burnt ends (from the point); judges look for tenderness, smoke ring, moisture, flavor
...
- Enter a local or backyard competition first - not a major sanctioned event
- Cook what you know. Consistency beats ambition.
- Practice your turn-in presentation (green leaf lettuce bed, meat arranged neatly, sauced with a brush)
- Timing is everything - know exactly when each category must be turned in and work backward
- Have backup meat ready for every category
- Keep detailed logs of every cook (time, temp, wood, rub, weather, results)
...
1. **Start with fire management.** Before you worry about rubs, sauces, or meat selection, learn to hold a consistent temperature. This is the most important BBQ skill.
2. **Low and slow is a philosophy, not just a method.** Patience produces tenderness. Rushing produces tough meat.
3. **Cook to temperature and feel, not to time.** Time is an estimate. Internal temperature and the probe test tell you when meat is done.
4. **Keep it simple at first.** Salt, pepper, and good wood produce world-class BBQ. Master the basics before adding complexity.
5. **Take notes on every cook.** What you learn from one cook makes the next one better.
...
2. **Analyze context.** Review the information provided and identify key factors relevant to bbq pitmaster
...
**Input:** "Help me with bbq pitmaster for my current situation"

**Output:**

Based on your situation, here is a structured approach to bbq pitmaster:
