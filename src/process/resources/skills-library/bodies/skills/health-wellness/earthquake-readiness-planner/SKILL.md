...
1. **Location:** What seismic zone are you in? (e.g., California, Pacific Northwest, New Madrid, Alaska)
2. **Building type:** Wood frame, unreinforced masonry, concrete, steel frame, mobile home?
3. **Building age:** When was it built? (pre-1970 is higher risk in many regions)
4. **Household:** How many people? Children, elderly, people with disabilities?
5. **Current preparedness:** Do you have supplies, a plan, or structural improvements?
6. **Pets:** Types and how many?
7. **Workplace:** Do you need workplace preparedness guidance too?
...
2. **Analyze context.** Review the information provided and identify key factors relevant to earthquake readiness planner
