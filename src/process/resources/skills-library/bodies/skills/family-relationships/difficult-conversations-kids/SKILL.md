---
name: difficult-conversations-kids
description: |
  Provides age-appropriate language frameworks and conversation guides for discussing difficult topics with children, including divorce, death, major life changes, illness, and family disruptions. Produces structured conversation plans with opening scripts, follow-up responses, and ongoing support strategies.
  Use when the user needs help talking to a child about a difficult topic such as divorce, death, moving, serious illness, or other major life changes.
...
- A caregiver needs to disclose a serious illness in the family -- a parent's cancer diagnosis, a sibling's chronic condition, their own mental health struggle -- in a way that does not create disproportionate fear
- A parent needs to explain significant financial change: job loss, bankruptcy, housing instability, or household downsizing
- A parent needs to explain incarceration of a family member
- A parent is preparing a child for a difficult family event: a sibling leaving for the military, a parent deploying, a grandparent moving into memory care
- A caregiver wants to follow up after a child overheard difficult information from another source and needs help correcting misinformation and rebuilding trust
...
- The user is managing active suicidal ideation in their child -- use crisis resources and emergency mental health referral immediately
- The child has a significant developmental disability that requires an individualized communication approach -- a developmental pediatrician or behavioral specialist should guide the framework
- The topic is primarily about sex education -- use a sex education skill, not a difficult-conversations framework
- The parent is seeking legal or custody advice -- refer to a family law attorney

---

## Process

### Step 1: Gather the Specific Inputs Needed to Build the Guide

Before generating anything, collect the following information. If the user has not provided it, ask directly and concisely. Do not generate a generic guide without knowing the child's age and the specific topic.

- **The specific topic:** What, exactly, needs to be communicated? (A death? Whose? How? When did it happen or when will it happen?) A divorce announcement? A diagnosis? The precision of the topic determines the precision of the script.
- **The child's age:** Age in years, not just a stage ("my daughter" is not sufficient). A 5-year-old and a 9-year-old require fundamentally different language frameworks.
- **What the child already knows:** Has the child overheard conversations? Been told something partial? Been given a euphemism by another adult? Known someone was sick but not that they might die?
- **The timeline:** Is this conversation happening today, this week, or in the future? Is the event already past, ongoing, or imminent?
- **Who else will be present:** Will both parents deliver the news together? Is this a single-parent household? Are other children present?
- **The family's relevant beliefs:** Does the family have a religious or cultural framework about death, divorce, or hardship that the parent wants incorporated? (Do not assume. Do not omit this if relevant.)
- **The child's temperament and history:** Is this child generally anxious? Have they experienced other difficult events? Are there existing behavioral or emotional concerns the parent is managing?

### Step 2: Apply the Correct Developmental Framework
...
- Primary fear is abandonment and disruption of routine. Reassure that caregiving will continue.
- Do not use euphemisms -- "went to sleep" at this age creates sleep fear. "Grandma died" is appropriate.
...
- They process in short bursts -- they may cry and then ask to play 10 minutes later. This is not indifference; it is age-appropriate compartmentalization.
...
- They are highly attuned to adult inconsistency -- if parents say "we will always be a family" but then behave as adversaries, the child's trust erodes quickly.
- They need explicit permission to have opinions and feelings that differ from the adults around them.
...
- They may externalize: blame a parent, blame the medical system, blame themselves in more sophisticated self-critical ways.
- They need to know they will have a role in decisions that affect them -- "You will have input on..." rather than "We will tell you what is happening."
- They often benefit from private time to process before group family conversations.
- Watch for parentification: teens are sometimes drawn into adult emotional support roles during family crises. Name this explicitly and protect against it.

### Step 3: Identify the Topic-Specific Content Requirements
...
- Address the practical questions children care most about: Where will I sleep? Where will my stuff be? Who picks me up from school? Do not assume they are asking about abstract family structure.
...
- Discuss prognosis at an age-appropriate level -- do not promise outcomes you cannot guarantee, but do communicate the treatment plan and the family's involvement.
...
- Prepare the child for questions from peers -- give them language they can use: "My dad is away. I don't want to talk about it."

### Step 4: Build the Three-Layer Conversation Structure
...
### Step 5: Identify What NOT to Say for This Specific Topic
...
- **Age-inappropriate euphemisms:** See the death section above.
- **Parentification language:** "You're the man of the house now." "I don't know what I'd do without you." "You're so mature, I can talk to you like an adult about this." This recruits the child into adult emotional labor.
- **Blame and loyalty recruitment (divorce):** "Your father did this to our family." "Ask your mother." Any negative characterization of the other parent to the child.
...
- Followed by an invitation: "Does that make sense?" or "Do you have more questions about that?"

### Step 7: Build the Follow-Up and Monitoring Plan
...
### Step 8: Assemble and Format the Conversation Guide

Compile all of the above elements into the structured output format below. The guide should be immediately usable by a parent reading it alone before the conversation. It should feel like having a calm, expert advisor sitting next to them.
...
```
## Conversation Guide: [Specific Topic] - Child Age [X]

---

### Preparation Checklist
- [ ] Setting: [Specific location and why]
- [ ] Timing: [Time of day, relative to events, what to avoid]
- [ ] Who should be present: [Names or roles; note who should NOT be present and why]
- [ ] What the child already knows: [Summary of prior knowledge]
- [ ] What you know that the child does not know yet: [Key information gap]
- [ ] Your own emotional state: [Brief note on what the parent needs for themselves before this conversation]

---

### Opening Words (Say This First)
> "[1-2 sentences that signal the conversation is serious and invite the child to settle in]"
> Pause. Make eye contact. Move to be at the child's physical level.

---

### The Disclosure (Say This Next)
> "[The core information in 2-4 sentences at age-appropriate level. Clear. No euphemisms. Ends with a pause, not a question.]"

Wait for the child to respond. Do not fill the silence.

---

### Key Messages for This Conversation (Repeat These Throughout)
1. [Core message 1 - in exact child-facing language]
2. [Core message 2 - in exact child-facing language]
3. [Core message 3 - in exact child-facing language]
...
|-----------------|-------------------|---------------------|
| "[Specific phrase]" | [Specific explanation] | "[Alternative]" |
| "[Specific phrase]" | [Specific explanation] | "[Alternative]" |
| "[Specific phrase]" | [Specific explanation] | "[Alternative]" |
| "[Specific phrase]" | [Specific explanation] | "[Alternative]" |
...
| The Child Might Ask | Respond With |
|---------------------|--------------|
| "[Question]" | "[Exact response script]" |
| "[Question]" | "[Exact response script]" |
| "[Question]" | "[Exact response script]" |
| "[Question]" | "[Exact response script]" |
| "[Question]" | "[Exact response script]" |
...
| Reaction | What the Reaction Means | What to Do | What to Say |
|----------|------------------------|------------|-------------|
| Crying | [Meaning in context] | [Physical and verbal guidance] | "[Script]" |
| Anger / Acting Out | [Meaning in context] | [Physical and verbal guidance] | "[Script]" |
| Silence / Shutting Down | [Meaning in context] | [Physical and verbal guidance] | "[Script]" |
| Apparent Indifference | [Meaning in context] | [Physical and verbal guidance] | "[Script]" |
| Unexpected Questions (off-topic) | [Meaning in context] | [Physical and verbal guidance] | "[Script]" |
| Physical Reaction (running away, hiding) | [Meaning in context] | [Physical and verbal guidance] | "[Script]" |

---

### Closing the Conversation
> "[2-4 sentences that re-anchor the child in love, stability, and open access to the parent. End with an explicit invitation to return to the topic.]"
...
**Next 24 hours:**
- [Specific action or observation]
- [Specific action or observation]

**Next 1-2 weeks:**
- [Specific action or observation]
- [Recommended activities to support processing]

**Ongoing:**
- [How to keep the topic accessible without forcing it]
- [How to mark meaningful moments: anniversaries, holidays, milestones without the person]

**Refer for professional support if:**
- [Specific behavioral indicator 1 with timeframe]
- [Specific behavioral indicator 2 with timeframe]
- [Specific behavioral indicator 3 with timeframe]

---

### A Note for the Parent
[1-2 sentences acknowledging the difficulty of what they are doing, and what they need to take care of themselves before and after.]
```
...
1. **Never generate a guide without knowing the child's age in years.** Developmental frameworks vary enough between ages 5 and 9 that a single guide covering "school age" will be wrong for half its readers. If age is not provided, ask before generating.

2. **Use the actual words "died" and "death" for any death-related guide involving children under 12.** Euphemisms like "passed away," "lost," "gone to sleep," "gone to a better place," or "no longer with us" are cognitively confusing to children under 10 and, in the case of sleep-related euphemisms, can create nighttime fear. Acknowledge the family's cultural or religious language, but include the plain word alongside it.

3. **"This is not your fault" must appear explicitly in every divorce and every death guide** -- not as a parenthetical, but as a named key message. Self-blame is the most common and damaging cognitive distortion in children experiencing family disruption. No guide is complete without directly addressing it.

4. **Do not give the parent more than 3 core messages to deliver in one sitting.** Research on children's working memory and emotional processing under stress confirms that information delivered during high-affect states is poorly retained. If additional information is important, it goes in the follow-up plan, not the initial conversation.

5. **Scripts must be written at vocabulary level appropriate to the age being addressed.** Do not write child-facing language that contains multi-clause sentences, subjunctive mood, or abstract concepts for children under 7. Test each sentence by asking: could a child of this age repeat this sentence back? If not, simplify it.

6. **The What NOT to Say section is mandatory for every guide.** Parents under emotional stress default to exactly the phrases on this list. Without it, the guide is incomplete. Include at least 4 specific phrases with explanations of the harm mechanism, not just the label "harmful."

7. **Never promise outcomes you cannot control.** Scripts must not include "Everything will be okay," "You will love your new house," "Daddy will get better," or "Your parents will stop fighting." If the parent genuinely does not know the outcome, teach them to name that: "I don't know exactly what will happen, but I will always tell you the truth."

8. **Follow-up indicators for professional referral must be behavioral and time-bounded, not vague.** "Seems withdrawn" is not a referral threshold. "Has not played with friends or participated in activities she previously enjoyed for more than 4 weeks" is. Every guide must include at least 3 specific indicators with timeframes.

9. **Do not include religious or spiritual framing unless the user has explicitly requested it.** Provide neutral placeholder language and explicitly note: "You can add your family's beliefs here." If the user has mentioned a faith tradition, integrate it appropriately but do not impose it if they have not.

10. **Protect the child from the parent's emotional needs in the script.** The parent will be distressed. Scripts for parental emotion should model that it is okay to be sad ("I'm sad too"), but must not invite the child to comfort the parent, must not end with the parent crying without re-anchoring the child, and must not include language that recruits the child as a support figure. If the parent is likely to be significantly distressed, recommend they have a support person available for themselves immediately after the conversation.

11. **Always include a preparation note for the parent's own emotional state.** A parent who has not had a moment to compose themselves before the conversation will derail it. The preparation checklist should include a brief note on the parent's own readiness -- not as judgment, but as practical setup for success.

12. **Do not offer a single conversation template for multiple-child households of significantly different ages.** If the user has a 4-year-old and a 10-year-old, they need two separate guides -- or one combined opening script and two separate follow-up frameworks. Never apply a single age-based script to both.
...
Then ask what the child believes they know before saying anything else. This allows the parent to identify misinformation, fill gaps, and correct without invalidating the child's experience. Children who receive second-hand bad news often receive a more alarming or distorted version than the truth -- the parent's job is to replace fear with fact, not to compete with what the child has already heard.
...
Anchor the conversation heavily in the concrete and predictable: what will change, what will stay the same, exactly. Anxious children catastrophize around uncertainty. The more specifics the parent can offer, the better.

Provide the child with an explicit mechanism for coming back to the topic: "If you think of a question at 3 in the morning, you can come wake me up." This permission often reduces nighttime anxiety even if the child never uses it.
...
The scripts in this scenario must be especially careful about tone -- a parent who is frightened will communicate fear regardless of the words they use. The guide should acknowledge this and suggest the parent practice the opening lines aloud before the conversation.
...
For children 8-11: Name it more directly -- "Uncle Tom died from suicide. That means he chose to end his own life. He was very, very sick in his mind -- the kind of sick that doctors call a mental illness -- and his thoughts were so painful that he could not see another way. It is very sad." Immediately address: "Nothing you did or said caused this."

For teens: Be honest, use the word suicide, and move quickly to both grief support and safety assessment. Ask directly: "Sometimes when someone we know dies this way, it can bring up hard feelings or thoughts. I want to ask you directly -- have you had any thoughts about hurting yourself?" This is a necessary question and does not plant the idea.

For any disclosure involving suicide, recommend concurrent consultation with a child therapist regardless of how the child initially responds.

---

## Example

**User Input:** "I need to tell my 8-year-old son that his dad and I are getting divorced. We haven't told him anything yet. He has probably sensed the tension at home but doesn't know specifics. We are trying to keep things as stable as possible for him. We will both be there for the conversation."

---

## Conversation Guide: Parents' Divorce -- Child Age 8
...
- [ ] **What he already knows:** He has sensed tension. He does not know the specifics. He may have his own private theories about what is wrong.
- [ ] **What you know that he does not:** That the decision is final. That living arrangements are being worked out. What will stay the same for him and what will change.
- [ ] **Your own emotional state:** Both parents should take 10-15 minutes alone before this conversation to breathe and settle. It is fine to be visibly emotional -- it is not fine to cry so hard that he becomes responsible for comforting you. Have a plan for after: each parent should have a person to call when the conversation is over.
...
- Regressive behavior -- toileting accidents, baby talk, bedwetting in a child who was previously dry -- lasting more than 2 weeks
- Any statement that suggests hopelessness: "I wish I wasn't here," "I don't care what happens to me," "Nobody cares about me anyway"
- Intense or escalating loyalty conflict -- refusing to see one parent, extreme distress at transitions, taking on one parent's anger as his own
