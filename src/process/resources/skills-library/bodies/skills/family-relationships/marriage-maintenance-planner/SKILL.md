---
name: marriage-maintenance-planner
description: |
  Proactive marriage maintenance guidance covering regular check-in rituals, intentional date planning, identifying and interrupting conflict patterns, growing together through life stages, and keeping the partnership vital.
  Use when the user asks about marriage maintenance planner, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of marriage maintenance planner or requires a different specialized skill.
license: Apache-2.0
metadata:
...
- How long have you been married or in your committed partnership?
- What is going well in your relationship right now?
- What area feels like it needs the most attention?
- Do you have children? What are their ages?
- How much quality time do you currently spend together weekly?
- When was your last date night or dedicated couple time?
- How do you handle conflict currently? Is there a recurring pattern?
- Is there a specific life transition you are navigating (new baby, career change, empty nest)?

## The Relationship Check-In

### Why Regular Check-Ins Matter

Research from the Gottman Institute shows that couples who turn toward each other's bids for connection at least 86% of the time remain together. Couples who miss bids (turn away or turn against) divorce at significantly higher rates. Regular check-ins create structured opportunities for connection that busy life otherwise crowds out.

### Weekly Check-In (30-45 Minutes)

Schedule a recurring weekly time. Protect it like a business meeting. Suggested structure:
...
- "How is our intimacy (emotional and physical)?"
- "What is one thing we can improve together next month?"
...
- Family planning or parenting alignment
- Career and lifestyle direction
- Relationship satisfaction assessment (see below)
...
## Intentional Date Planning

### Why Date Nights Are Non-Negotiable

After the initial romance phase, couples often stop dating each other. The errands, children, careers, and routines fill the space where curiosity and play used to live. Regular dates are not a luxury; they are maintenance.

### Date Night Framework

**Frequency:** Weekly is ideal. Biweekly is minimum. Monthly is crisis mode.
...
- Focus on each other as people, not as co-managers of a household

### Date Ideas by Category

**Novel experiences (the best kind for long-term couples):**
Research shows that novel, exciting experiences together reactivate the brain's reward pathways in ways that familiar activities do not.

- Take a class together (cooking, pottery, dance, language)
- Explore a neighborhood you have never been to
- Go to a live performance (comedy, music, theater)
- Try an escape room or puzzle challenge
- Visit a museum or exhibition neither of you has seen
...
- Stargazing from a blanket in the yard
- Game night for two (board games, card games)
...
Gottman's research found that stable, happy couples have a ratio of at least 6 positive interactions for every 1 negative interaction during conflict. Outside of conflict, the ratio in happy couples is closer to 20:1. Date nights are positive interaction deposits in the relationship bank.
...
Most couples have a predictable conflict dance. Common patterns:

**Pursue-Withdraw:** One partner raises issues (pursuer) while the other shuts down or avoids (withdrawer). The more the pursuer pushes, the more the withdrawer retreats, creating a vicious cycle.

**Escalation:** Both partners match each other's intensity, and small disagreements become big fights quickly.

**Demand-Comply:** One partner makes demands, the other complies resentfully. Surface peace, underground anger.

**Identify your pattern and name it together.** When you can say "We're doing our thing again" in the middle of a conflict, you create distance from the pattern and make it easier to change course.
...
- Moving physically closer instead of further apart

**The 20-minute rule:** If a conversation becomes flooded (heart rate above 100 bpm, feeling attacked or overwhelmed), take a 20-minute break. Do something calming (not rehearsing your argument). Return and try again. Flooded brains cannot process conflict productively.
...
- Discuss expectations about money, family, career openly
...
- Sleep deprivation is the enemy; extend grace to each other
- Touch each other: hold hands, hug, maintain physical affection even when exhausted
...
- Travel together without children
- Have honest conversations about desire, intimacy, and satisfaction
- Individual growth is necessary; support each other's development
...
- Discuss retirement vision and lifestyle alignment
- Address health changes with compassion and adaptation
- Prioritize friendship as the foundation

## Communication Frameworks

### The Softened Startup

How you start a difficult conversation determines its outcome 96% of the time (Gottman).

**Formula:** "I feel [emotion] about [specific situation], and I need [specific request]."

**Example:** "I feel disconnected from you when we spend every evening on our phones. I need us to have 30 minutes of phone-free time after dinner."

**Not:** "You're always on your phone and you never pay attention to me."
...
4. Find the overlap between your dreams
5. Create a temporary, workable compromise that honors both dreams
...
- You are having the same fight without resolution repeatedly
- Contempt, criticism, or stonewalling are becoming your default
- There has been a betrayal (emotional or physical) that you cannot resolve alone
- You feel more like roommates than partners
- One or both of you are unhappy and conversations do not help
- A major life transition is creating distance you cannot bridge
...
2. **Analyze context.** Review the information provided and identify key factors relevant to marriage maintenance planner
...
```template
## Marriage Maintenance Planner Analysis
...
**Input:** "Help me with marriage maintenance planner for my current situation"

**Output:**

Based on your situation, here is a structured approach to marriage maintenance planner:
