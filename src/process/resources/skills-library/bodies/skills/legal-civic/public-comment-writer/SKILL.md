---
name: public-comment-writer
description: |
  Teaches users to write structured public comments for local government proceedings, regulatory proposals, and public hearings. Covers the IPAR structure (Identify, Position, Argue, Request), formatting for different submission types, and strategies for making comments more persuasive and likely to be considered.
  Use when the user wants to submit a public comment to a government body, needs to write testimony for a public hearing, or wants to respond to a proposed regulation or policy change.
...
- **Preserving future options:** A strong record may support future regulatory actions, legislative changes, or community organizing based on documented impacts.

Explain these purposes to the user and let them decide whether the comment is worth their effort given their actual goals.
...
- Request specific conditions or modifications that would make the proposal even better or more likely to survive opposition (this shows engagement and gives decision-makers something to offer both sides).

Support without substance ("I think this is great") contributes less to the record than support with specificity ("The proposed bike lane on Oak Street is consistent with the city's Active Transportation Plan Section 3.4 and would connect two existing lane segments currently separated by a half-mile gap").
...
- Help the user draft the comment in the clearest possible language, avoiding idioms, complex subordinate clauses, and jargon. The goal is precision, not eloquence.
...
- For curriculum decisions, special education program changes, school closures, or boundary changes, the legal standards the board must meet are set by state education code (e.g., in California, Education Code § 35160 et seq. for curriculum and § 48980 for parent rights notices).
- If the issue involves special education services, the Individuals with Disabilities Education Act (IDEA) and Section 504 of the Rehabilitation Act impose federal requirements that constrain what a school board may do. An IDEA-specific comment should reference the specific federal requirements and ask whether the proposed change is consistent with them.
...
**User Input:**
"My city is proposing to allow a large-format grocery store -- about 80,000 square feet -- in an area currently zoned neighborhood commercial, which limits buildings to 25,000 square feet. They'd need a zoning amendment and a conditional use permit. The site is on the corner of Harbor Boulevard and Lincoln Avenue, adjacent to a residential neighborhood. My concerns are: the traffic will be terrible (Harbor is already congested), the store will threaten the small grocery stores in the area, and the proposed 24/7 operating hours will hurt nearby residents with light and noise all night. I want to oppose this at the planning commission hearing next Thursday. I have 3 minutes to speak."
...
```
═══════════════════════════════════════════════════════════
PUBLIC COMMENT -- Zoning Amendment No. ZA-2024-0091 and
Conditional Use Permit Application No. CUP-2024-0044
Large-Format Grocery Store, Harbor Boulevard and Lincoln Avenue
═══════════════════════════════════════════════════════════

TO:    City of [City Name] Planning Commission
FROM:  [Your Full Name], Resident/Property Owner
       [Street Address, City, State, ZIP]
       [email@example.com] | [(555) 000-0000]
DATE:  [Date]
RE:    Zoning Amendment No. ZA-2024-0091 (Neighborhood Commercial
       Maximum Floor Area Ratio Amendment) and Conditional Use
       Permit Application No. CUP-2024-0044 (Large-Format Retail,
       80,000 sq. ft. Grocery, Harbor Blvd. and Lincoln Ave.)
