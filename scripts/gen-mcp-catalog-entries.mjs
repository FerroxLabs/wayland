...
const DATA = [
  // ── Media creation ─────────────────────────────────────────────
  {
    ...
    title: 'fal.ai',
    tier: 'core',
    cats: ['media', 'automation'],
    tags: ['fal', 'image', 'video', 'audio', 'generation'],
    maint: 'official',
    brand: '#0099FF',
    ...
    web: 'https://fal.ai/docs/documentation/setting-up/mcp',
    repo: 'https://github.com/fal-ai/fal-mcp',
    transport: 'remote',
    rtype: 'streamable-http',
  ...
  {
    id: 'com.replicate/replicate-mcp',
    title: 'Replicate',
    tier: 'core',
    cats: ['media', 'developer'],
    tags: ['replicate', 'image', 'video', 'models'],
    maint: 'official',
    brand: '#000000',
    ...
    web: 'https://replicate.com/docs/reference/mcp',
    repo: 'https://github.com/replicate/replicate-mcp',
    transport: 'remote',
    rtype: 'streamable-http',
  ...
  {
    id: 'ai.higgsfield/higgsfield-mcp',
    title: 'Higgsfield',
    tier: 'core',
    cats: ['media'],
    tags: ['higgsfield', 'video', 'image', 'cinematic'],
    maint: 'official',
    brand: '#000000',
  ...
  },
  {
    ...
    tier: 'worker',
    cats: ['media'],
    tags: ['flux', 'bfl', 'image', 'generation'],
    maint: 'official',
    brand: '#000000',
    ...
    web: 'https://docs.bfl.ai/api_integration/mcp_integration',
  ...
  {
    id: 'ai.recraft/recraft-mcp',
    title: 'Recraft',
    tier: 'worker',
    cats: ['media', 'design'],
    tags: ['recraft', 'image', 'vector', 'svg'],
    maint: 'official',
    brand: '#000000',
    ...
    web: 'https://www.recraft.ai/docs/mcp-reference/getting-started',
  ...
  {
    id: 'com.tavily/tavily-mcp',
    title: 'Tavily',
    tier: 'core',
    cats: ['search', 'research'],
    tags: ['tavily', 'search', 'extract'],
    maint: 'official',
    brand: '#0EA5A4',
    desc: 'AI-native web search plus page extraction, mapping, and crawling - Tavily’s official hosted MCP.',
    web: 'https://docs.tavily.com/documentation/mcp',
  ...
  },
  {
    ...
    tier: 'worker',
    cats: ['search', 'research'],
    tags: ['jina', 'reader', 'search', 'extract'],
    maint: 'official',
    brand: '#EB1C24',
    ...
    web: 'https://github.com/jina-ai/MCP',
    ...
    auth: 'api-key',
    provider: 'Jina AI',
    signup: 'https://jina.ai/api-dashboard/',
    envName: 'JINA_API_KEY',
  },
  {
    id: 'com.apify/apify-mcp',
    title: 'Apify',
    tier: 'worker',
    cats: ['automation', 'search', 'data'],
    tags: ['apify', 'scraping', 'actors'],
    maint: 'official',
    brand: '#3083ED',
    ...
    web: 'https://github.com/apify/apify-mcp-server',
    ...
    auth: 'oauth',
    provider: 'Apify',
    signup: 'https://console.apify.com',
  },
  {
    id: 'com.ref/ref-tools-mcp',
    title: 'Ref',
    tier: 'worker',
    cats: ['developer', 'search'],
    tags: ['ref', 'docs', 'documentation'],
    maint: 'official',
    brand: '#4F46E5',
  ...
  },
  {
    ...
    tier: 'worker',
    cats: ['search', 'research'],
    tags: ['you', 'search', 'news', 'research'],
    maint: 'official',
    brand: '#7C3AED',
    desc: 'Web and news search plus multi-step research with citations - You.com’s official hosted MCP, with a free no-key tier.',
    web: 'https://you.com/docs/build-with-agents/mcp-server',
    repo: 'https://you.com/docs/build-with-agents/mcp-server',
    transport: 'remote',
    rtype: 'streamable-http',
  ...
  {
    id: 'so.linkup/linkup-mcp',
    title: 'Linkup',
    tier: 'worker',
    cats: ['search', 'research'],
    tags: ['linkup', 'search', 'research'],
    maint: 'official',
    brand: '#1A56DB',
    desc: 'Real-time web search, autonomous research, and page fetch - Linkup’s official hosted MCP.',
    web: 'https://github.com/LinkupPlatform/linkup-mcp-server',
  ...
  {
    id: 'ai.perplexity/perplexity-mcp',
    title: 'Perplexity',
    tier: 'core',
    cats: ['search', 'research'],
    tags: ['perplexity', 'sonar', 'search', 'research'],
    maint: 'official',
    brand: '#20808D',
    desc: 'Real-time search plus deep research and reasoning powered by Sonar - Perplexity’s official MCP.',
    web: 'https://docs.perplexity.ai/guides/mcp-server',
  ...
  {
    id: 'io.tinyfish/agentql-mcp',
    title: 'AgentQL',
    tier: 'builder',
    cats: ['automation', 'data'],
    tags: ['agentql', 'extraction', 'scraping'],
    maint: 'official',
    brand: '#2D7FF9',
    desc: 'Turn a natural-language prompt into structured data from any web page - AgentQL’s official MCP.',
    web: 'https://github.com/tinyfish-io/agentql-mcp',
    repo: 'https://github.com/tinyfish-io/agentql-mcp',
    transport: 'stdio',
    registry: 'npm',
    pkg: 'agentql-mcp',
    runtime: 'npx',
    auth: 'api-key',
    provider: 'AgentQL',
    signup: 'https://dev.agentql.com',
    envName: 'AGENTQL_API_KEY',
  },
  {
    id: 'org.wikipedia/wikipedia-mcp',
    title: 'Wikipedia',
    tier: 'worker',
    cats: ['knowledge', 'research'],
  ...
  {
    id: 'org.arxiv/arxiv-mcp-server',
    title: 'arXiv',
    tier: 'worker',
    cats: ['knowledge', 'research'],
    tags: ['arxiv', 'papers', 'science'],
    maint: 'community',
    brand: '#B31B1B',
    ...
    transport: 'stdio',
    registry: 'pypi',
    pkg: 'arxiv-mcp-server',
    runtime: 'uvx',
    auth: 'none',
  },
  {
    id: 'com.duckduckgo/duckduckgo-mcp-server',
    title: 'DuckDuckGo',
    tier: 'worker',
    cats: ['search'],
    ...
    web: 'https://github.com/nickclyde/duckduckgo-mcp-server',
  ...
  {
    id: 'com.grafana/grafana-mcp',
    title: 'Grafana',
    tier: 'builder',
    cats: ['observability', 'devops'],
    ...
    web: 'https://github.com/grafana/mcp-grafana',
    ...
    envName: 'GRAFANA_SERVICE_ACCOUNT_TOKEN',
  },
  {
    id: 'com.railway/railway-mcp',
    title: 'Railway',
    tier: 'builder',
    ...
    web: 'https://docs.railway.com/ai/mcp-server',
    repo: 'https://docs.railway.com/ai/mcp-server',
    transport: 'remote',
    rtype: 'streamable-http',
    url: 'https://mcp.railway.com',
    auth: 'oauth',
    provider: 'Railway',
    signup: 'https://railway.com',
  },
  {
    id: 'com.airtable/airtable-mcp',
    title: 'Airtable',
    tier: 'worker',
    cats: ['productivity', 'database'],
    ...
    web: 'https://support.airtable.com/docs/using-the-airtable-mcp-server',
    repo: 'https://support.airtable.com/docs/using-the-airtable-mcp-server',
    transport: 'remote',
    rtype: 'streamable-http',
    url: 'https://mcp.airtable.com/mcp',
    auth: 'oauth',
    provider: 'Airtable',
    signup: 'https://airtable.com/create/tokens',
  },
  {
    id: 'com.newrelic/newrelic-mcp',
    title: 'New Relic',
    tier: 'builder',
    cats: ['observability', 'devops'],
    tags: ['newrelic', 'monitoring', 'nrql'],
    maint: 'official',
    brand: '#1CE783',
    desc: 'Run NRQL, inspect alerts, entities, deployments, and golden metrics - New Relic’s official hosted MCP.',
    web: 'https://docs.newrelic.com/docs/agentic-ai/mcp/overview',
    repo: 'https://docs.newrelic.com/docs/agentic-ai/mcp/overview',
    transport: 'remote',
    rtype: 'streamable-http',
    ...
    header: 'Api-Key',
    provider: 'New Relic',
    signup: 'https://one.newrelic.com/api-keys',
    envName: 'NEW_RELIC_API_KEY',
  },
  {
    ...
    transport: 'stdio',
    registry: 'npm',
    pkg: '@digitalocean/mcp',
    runtime: 'npx',
    auth: 'api-key',
    provider: 'DigitalOcean',
    signup: 'https://cloud.digitalocean.com/account/api/tokens',
    envName: 'DIGITALOCEAN_API_TOKEN',
  },
  {
    id: 'com.render/render-mcp',
    title: 'Render',
    tier: 'builder',
    cats: ['infrastructure', 'devops'],
    tags: ['render', 'deploy', 'hosting'],
    maint: 'official',
    brand: '#5E5BFF',
    desc: 'Manage services, Postgres, key-value stores, metrics, and logs - Render’s official hosted MCP.',
    web: 'https://render.com/docs/mcp-server',
    ...
    auth: 'api-key',
    provider: 'Render',
    signup: 'https://dashboard.render.com/u/settings/api-keys',
    envName: 'RENDER_API_KEY',
  },
  {
    id: 'com.heroku/heroku-mcp',
    title: 'Heroku',
    tier: 'builder',
    cats: ['infrastructure', 'devops'],
    tags: ['heroku', 'deploy', 'hosting'],
    maint: 'official',
    brand: '#430098',
    desc: 'Manage apps, dynos, add-ons, pipelines, Postgres, and logs - Heroku’s official hosted MCP.',
    web: 'https://github.com/heroku/heroku-mcp-server',
    ...
    auth: 'oauth',
    provider: 'Heroku',
    signup: 'https://heroku.com',
  },
  {
    id: 'com.netlify/netlify-mcp',
    title: 'Netlify',
    tier: 'builder',
    cats: ['infrastructure', 'devops'],
    ...
    web: 'https://github.com/netlify/netlify-mcp',
    ...
    auth: 'api-key',
    provider: 'Netlify',
    signup: 'https://app.netlify.com/user/applications',
    envName: 'NETLIFY_PERSONAL_ACCESS_TOKEN',
  },
  {
    id: 'io.prisma/prisma-mcp',
    title: 'Prisma',
    tier: 'builder',
    cats: ['database', 'developer'],
    tags: ['prisma', 'orm', 'postgres'],
    maint: 'official',
    brand: '#2D3748',
    desc: 'Run migrations and manage Prisma Postgres databases - create, list, query, and back up - Prisma’s official hosted MCP.',
    web: 'https://www.prisma.io/docs/cli/mcp',
    repo: 'https://www.prisma.io/docs/cli/mcp',
    transport: 'remote',
    rtype: 'streamable-http',
    url: 'https://mcp.prisma.io/mcp',
    auth: 'oauth',
    provider: 'Prisma',
    signup: 'https://console.prisma.io',
  },
  {
    id: 'com.planetscale/planetscale-mcp',
    title: 'PlanetScale',
    tier: 'builder',
    cats: ['database', 'developer'],
    ...
    web: 'https://planetscale.com/docs/connect/mcp',
    repo: 'https://planetscale.com/docs/connect/mcp',
    transport: 'remote',
    rtype: 'streamable-http',
  ...
  {
    id: 'com.clickhouse/clickhouse-mcp',
    title: 'ClickHouse',
    tier: 'builder',
    cats: ['database', 'data'],
    ...
    web: 'https://github.com/ClickHouse/mcp-clickhouse',
  ...
  },
  {
    ...
    auth: 'api-key',
    provider: 'Redis',
    signup: 'https://redis.io/try-free/',
    envName: 'REDIS_PWD',
  },
  {
    id: 'dev.convex/convex-mcp',
    title: 'Convex',
    tier: 'builder',
    cats: ['database', 'developer'],
    ...
    web: 'https://docs.convex.dev/ai/convex-mcp-server',
    repo: 'https://docs.convex.dev/ai/convex-mcp-server',
    transport: 'stdio',
    registry: 'npm',
    pkg: 'convex',
    runtime: 'npx',
  ...
  },
  {
    ...
    web: 'https://github.com/chroma-core/chroma-mcp',
    ...
    auth: 'api-key',
    provider: 'Chroma',
    signup: 'https://trychroma.com',
    envName: 'CHROMA_API_KEY',
  },
  {
    id: 'com.browserbase/browserbase-mcp',
    title: 'Browserbase',
    tier: 'builder',
    cats: ['automation', 'browser'],
    ...
    web: 'https://docs.browserbase.com/integrations/mcp/setup',
    ...
    envName: 'BROWSERBASE_API_KEY',
  },
  {
    id: 'io.daytona/daytona-mcp',
    title: 'Daytona',
    tier: 'builder',
    cats: ['developer', 'automation'],
    tags: ['daytona', 'sandbox', 'code-exec'],
    maint: 'official',
    brand: '#3FB950',
    desc: 'Drive Daytona sandboxes - filesystem, git, processes, and code execution - Daytona’s official MCP.',
    web: 'https://www.daytona.io/docs/en/mcp',
    repo: 'https://www.daytona.io/docs/en/mcp',
    transport: 'stdio',
    registry: 'npm',
    pkg: '@daytonaio/cli',
    runtime: 'npx',
    ...
    auth: 'api-key',
    provider: 'Daytona',
    signup: 'https://app.daytona.io',
    envName: 'DAYTONA_API_KEY',
  },
  {
    id: 'com.circleci/circleci-mcp',
    title: 'CircleCI',
    tier: 'builder',
    cats: ['devops', 'developer'],
    tags: ['circleci', 'ci', 'pipelines'],
    maint: 'official',
    brand: '#000000',
    desc: 'Analyze build failures, run pipelines, and detect flaky tests - CircleCI’s official MCP.',
    web: 'https://github.com/CircleCI-Public/mcp-server-circleci',
    repo: 'https://github.com/CircleCI-Public/mcp-server-circleci',
    transport: 'stdio',
    registry: 'npm',
    pkg: '@circleci/mcp-server-circleci',
    runtime: 'npx',
    auth: 'api-key',
    provider: 'CircleCI',
    signup: 'https://app.circleci.com/settings/user/tokens',
    envName: 'CIRCLECI_TOKEN',
  },
  {
    id: 'com.buildkite/buildkite-mcp',
    title: 'Buildkite',
    tier: 'builder',
    cats: ['devops', 'developer'],
    tags: ['buildkite', 'ci', 'pipelines'],
    maint: 'official',
    brand: '#14CC80',
    desc: 'Inspect pipelines, builds, jobs, and test runs - Buildkite’s official hosted MCP.',
    web: 'https://buildkite.com/docs/apis/mcp-server',
    repo: 'https://buildkite.com/docs/apis/mcp-server',
    transport: 'remote',
    rtype: 'streamable-http',
    url: 'https://mcp.buildkite.com/mcp',
    auth: 'oauth',
    provider: 'Buildkite',
    signup: 'https://buildkite.com',
  },
  {
    id: 'co.axiom/axiom-mcp',
    title: 'Axiom',
    tier: 'builder',
    cats: ['observability', 'data'],
    tags: ['axiom', 'logs', 'apl'],
    maint: 'official',
    brand: '#000000',
    desc: 'Query and analyze logs and events with APL - Axiom’s official hosted MCP.',
    web: 'https://axiom.co/docs/console/intelligence/mcp-server',
    repo: 'https://axiom.co/docs/console/intelligence/mcp-server',
    transport: 'remote',
    rtype: 'streamable-http',
    url: 'https://mcp.axiom.co/mcp',
    auth: 'oauth',
    provider: 'Axiom',
    signup: 'https://app.axiom.co',
  },
  {
    ...
    transport: 'stdio',
    registry: 'npm',
    pkg: '@upstash/mcp-server',
    runtime: 'npx',
    auth: 'api-key',
    provider: 'Upstash',
    signup: 'https://console.upstash.com/account/api',
    envName: 'UPSTASH_API_KEY',
  },
  {
    id: 'dev.jam/jam-mcp',
    title: 'Jam.dev',
    tier: 'builder',
    cats: ['developer', 'devops'],
    tags: ['jam', 'debugging', 'bug-reports'],
    maint: 'official',
    brand: '#FF6213',
    ...
    web: 'https://jam.dev/docs/debug-a-jam/mcp',
    repo: 'https://jam.dev/docs/debug-a-jam/mcp',
    transport: 'remote',
    rtype: 'streamable-http',
    url: 'https://mcp.jam.dev/mcp',
    auth: 'oauth',
    provider: 'Jam.dev',
    signup: 'https://jam.dev',
  },

  // ── Business / fintech / marketing / productivity ──────────────
  {
    id: 'com.paypal/paypal-mcp',
    title: 'PayPal',
    tier: 'worker',
    cats: ['payments', 'sales'],
    tags: ['paypal', 'payments', 'invoices'],
    maint: 'official',
    brand: '#003087',
    desc: 'Create and manage invoices, transactions, subscriptions, disputes, and orders - PayPal’s official hosted MCP.',
    web: 'https://docs.paypal.ai/developer/tools/ai/mcp-quickstart',
    repo: 'https://docs.paypal.ai/developer/tools/ai/mcp-quickstart',
    transport: 'remote',
    rtype: 'streamable-http',
  ...
  },
  {
    ...
    web: 'https://github.com/square/square-mcp-server',
    ...
    auth: 'oauth',
    provider: 'Square',
    signup: 'https://squareup.com',
  },
  {
    id: 'com.canva/canva-mcp',
    title: 'Canva',
    tier: 'worker',
    cats: ['design', 'media'],
    ...
    web: 'https://www.canva.dev/docs/mcp/',
    repo: 'https://www.canva.dev/docs/mcp/',
    transport: 'remote',
    rtype: 'streamable-http',
    url: 'https://mcp.canva.com/mcp',
    auth: 'oauth',
    provider: 'Canva',
    signup: 'https://www.canva.com',
  },
  {
    id: 'com.plaid/plaid-mcp',
    title: 'Plaid',
    tier: 'builder',
    cats: ['payments', 'data'],
    tags: ['plaid', 'fintech', 'diagnostics'],
    maint: 'official',
    brand: '#000000',
    desc: 'Debug Items, inspect Item health and Link conversion, and read usage analytics - Plaid’s official Dashboard MCP.',
    web: 'https://plaid.com/docs/resources/mcp/',
    repo: 'https://plaid.com/docs/resources/mcp/',
    transport: 'remote',
    rtype: 'streamable-http',
    url: 'https://api.dashboard.plaid.com/mcp',
    auth: 'oauth',
    provider: 'Plaid',
    signup: 'https://dashboard.plaid.com',
  },
  {
    id: 'com.webflow/webflow-mcp',
    title: 'Webflow',
    tier: 'worker',
    cats: ['design', 'productivity'],
    tags: ['webflow', 'cms', 'website'],
    maint: 'official',
    brand: '#146EF5',
    desc: 'Read and write site data, CMS collections and schemas, and generate code - Webflow’s official hosted MCP.',
    web: 'https://developers.webflow.com/mcp/reference/getting-started',
    ...
    auth: 'oauth',
    provider: 'Webflow',
    signup: 'https://webflow.com',
  },
  {
    id: 'com.resend/resend-mcp',
    title: 'Resend',
    tier: 'worker',
    cats: ['communication', 'productivity'],
    ...
    web: 'https://resend.com/docs/mcp-server',
  ...
  {
    id: 'com.customerio/customerio-mcp',
    title: 'Customer.io',
    tier: 'worker',
    cats: ['communication', 'sales'],
    tags: ['customerio', 'marketing', 'segments'],
    maint: 'official',
    brand: '#7131FF',
    ...
    web: 'https://docs.customer.io/ai/mcp/get-started/',
    repo: 'https://docs.customer.io/ai/mcp/get-started/',
    transport: 'remote',
    rtype: 'streamable-http',
    url: 'https://mcp.customer.io/mcp',
    auth: 'oauth',
    provider: 'Customer.io',
    signup: 'https://fly.customer.io',
  },
  {
    ...
    transport: 'stdio',
    registry: 'npm',
    pkg: '@twilio-alpha/mcp',
    runtime: 'npx',
    auth: 'api-key',
    provider: 'Twilio',
    signup: 'https://console.twilio.com',
    envName: 'TWILIO_CREDENTIALS',
  },
  {
    id: 'com.dropbox/dropbox-mcp',
    title: 'Dropbox',
    tier: 'worker',
    cats: ['files-and-docs', 'productivity'],
    tags: ['dropbox', 'files', 'storage'],
    maint: 'official',
    brand: '#0061FF',
    desc: 'Browse, search, and read your Dropbox files and folders - Dropbox’s official hosted MCP (beta).',
    web: 'https://help.dropbox.com/integrations/connect-dropbox-mcp-server',
    repo: 'https://help.dropbox.com/integrations/connect-dropbox-mcp-server',
    transport: 'remote',
    rtype: 'streamable-http',
    url: 'https://mcp.dropbox.com/mcp',
    auth: 'oauth',
    provider: 'Dropbox',
    signup: 'https://www.dropbox.com',
  },
  {
    id: 'com.typeform/typeform-mcp',
    title: 'Typeform',
    tier: 'worker',
    cats: ['productivity', 'sales'],
    tags: ['typeform', 'forms', 'surveys'],
    maint: 'official',
    brand: '#262627',
    desc: 'Read your forms and read or write contacts - Typeform’s official hosted MCP (beta).',
    web: 'https://www.typeform.com/developers/get-started/mcp/',
    repo: 'https://www.typeform.com/developers/get-started/mcp/',
    transport: 'remote',
    rtype: 'streamable-http',
    url: 'https://api.typeform.com/mcp',
    auth: 'api-key',
    provider: 'Typeform',
    signup: 'https://admin.typeform.com/account#/section/tokens',
    envName: 'TYPEFORM_TOKEN',
  },
  {
    id: 'io.coda/coda-mcp',
    title: 'Coda',
    tier: 'worker',
    cats: ['productivity', 'knowledge'],
    tags: ['coda', 'docs', 'tables'],
    maint: 'official',
    brand: '#F46A54',
    desc: 'Read and write Coda docs, tables, rows, and formulas in natural language - Coda’s official hosted MCP (beta).',
    web: 'https://help.coda.io/hc/en-us/articles/44722661982989',
    repo: 'https://help.coda.io/hc/en-us/articles/44722661982989',
    transport: 'remote',
    rtype: 'streamable-http',
    url: 'https://coda.io/apis/mcp',
    auth: 'api-key',
    provider: 'Coda',
    signup: 'https://coda.io/account',
    envName: 'CODA_API_TOKEN',
  },
];
...
function buildGuide(d, file) {
  ...
  const target = isRemote
    ? `the hosted MCP at ${fence}${d.url}${fence}`
    : `${fence}${d.runtime} ${d.pkg}${fence} on first launch`;
  const steps = [];
  steps.push({
    id: 'install',
  ...
  const yaml = ['---', 'guideVersion: 1.0.0', `estimatedMinutes: ${d.auth === 'none' ? 1 : 2}`, 'steps:'];
...
const EXCLUDE = new Set(['dev.convex/convex-mcp', 'io.daytona/daytona-mcp']);
let rank = 100;
let added = 0;
const newRows = [];
for (const d of DATA) {
  if (EXCLUDE.has(d.id)) {
    console.log('EXCLUDE (needs runtime args)', d.id);
    continue;
  }
