...
description: |
  Designs a 4-day upper/lower or push-pull-legs strength training program for intermediate lifters with compound and accessory programming, periodized progression, wave loading, and planned deload cycles. Gathers the user's training history, equipment, and goals to produce a structured multi-week program.
  Use when the user asks about intermediate lifting programs, 4-day splits, upper/lower routines, or push-pull-legs programming.
  Do NOT use for complete beginners with under 6 months of lifting experience (use beginner-strength-training), advanced periodization theory (use training-program-periodization), or sport-specific conditioning (use sports-specific-conditioning).
license: Apache-2.0
metadata:
...
- The user wants to transition from a beginner full-body program (e.g., StrongLifts 5x5, Starting Strength, GZCLP) to a more structured split with dedicated volume and recovery windows
- The user wants to simultaneously develop strength AND hypertrophy with a periodized approach -- not just chase one or the other
- The user asks about wave loading, weekly undulating periodization (WUP), double-progression, or rep range manipulation as tools for continued progress
...
- The user is preparing for a powerlifting, weightlifting, or strongman competition where meet-specific peaking and competition strategy are required -- use a sport-specific skill
- The user asks primarily about nutrition, caloric programming, or macro ratios for muscle gain -- use `nutrition-for-muscle-gain` or the relevant nutrition skill
- The user reports an active injury, chronic joint pain, or is returning from a significant layoff of 8+ weeks -- these require individualized assessment beyond program design
- The user's goal is exclusively cardiovascular fitness, sport conditioning, or endurance -- use `sports-specific-conditioning`

---

## Process

### Step 1: Conduct a Thorough Training History Intake

Before designing anything, gather the following. Do NOT skip this step -- program design without these inputs produces a generic template, not a targeted program.

- **Training age and consistency:** How many months or years of structured lifting? How many missed weeks in the last 6 months? Consistency gaps of 2+ weeks reset adaptation faster than people expect.
- **Current program structure:** What split are they running now? How many sets per session? Are they tracking progressive overload?
- **Stall point identification:** Which lifts have stopped progressing? For how long? This reveals whether they need more volume, more recovery, or a periodization shift.
- **Estimated working weights on the four primary compounds:** Ask for a recent training max (a weight they could grind for 1--3 reps on a good day) or their current working sets. Use these to calibrate the program's starting loads and wave structure.
- **Primary goal orientation:** Place them on a spectrum -- pure strength (think 1-5 rep strength expression), pure hypertrophy (volume-driven muscle growth), or balanced (the most common intermediate goal). This determines rep range architecture.
- **Available training days and session duration:** 4 days is the sweet spot for intermediate lifters. Sessions typically run 60--90 minutes. More than 90 minutes usually signals too much volume or too much rest time.
- **Equipment inventory:** Full commercial gym, home gym with power rack and barbell, dumbbells only, resistance bands? Equipment constraints determine exercise selection for every accessory slot.
- **Injury history and movement limitations:** Any history of shoulder impingement, low back issues, or knee problems? These affect exercise selection directly (e.g., high-bar vs. low-bar squat, overhead press vs. landmine press, conventional vs. sumo deadlift).

---

### Step 2: Classify the Lifter and Select the Appropriate Split
...
**Heavy-Light Upper/Lower logic:** Heavy Upper (4x4--6 on bench/row), Light Upper (3x10--12 on OHP/pull-up), Heavy Lower (4x4--6 squat), Light Lower (3x8--10 deadlift + accessories). This delivers both intensity and volume stimuli in the same week without crushing fatigue.

**PPL logic (5--6 days):** Push day: chest/shoulders/triceps. Pull day: back/biceps. Legs day. Run the sequence twice in a 6-day block with one rest day. Each session has lower volume per muscle (8--12 sets) since frequency is higher.

---

### Step 3: Program the Primary Compound Lifts
...
- Upper B secondary: Weighted Pull-Up or Lat Pulldown (vertical pull)
- Lower A primary: Barbell Back Squat (knee-dominant)
- Lower A secondary: Romanian Deadlift (hip-dominant, same day -- lighter load, not a competition with the primary)
- Lower B primary: Conventional or Sumo Deadlift (hip-dominant)
- Lower B secondary: Front Squat or Goblet Squat (knee-dominant -- lighter, technique-focused)
...
**RPE as a loading guide:** Teach the user to use RPE 7--8 on Week 1, RPE 8--9 on Week 2, RPE 9 on Week 3. Do NOT go to RPE 10 (true max effort) on primary compounds within a program block -- this creates excessive fatigue and injury risk.

---

### Step 4: Program Secondary Compounds and Accessory Work
...
- On upper days: include at least one direct bicep and one direct tricep exercise; 2--3 sets each, 12--15 reps
...
**Exercise rotation:** Keep the same accessory movements for the full 4-week block to allow meaningful progressive overload. Rotating exercises too frequently prevents progression tracking.

---

### Step 5: Build the Periodization and Progression Model
...
- This typically cycles every 3--6 weeks per accessory lift
...
### Step 6: Build the Deload Protocol
...
- Focus on movement quality, bar path, tempo control (3-second eccentric)
...
**Psychological management:** Many intermediate lifters skip deloads because they feel good in Week 3 and want to keep going. Explain that fatigue masks fitness -- the performance peak typically appears 3--5 days after the deload ends, not during the heavy week.

---

### Step 7: Specify Session Structure and Warm-Up Protocol
...
4. Core work at the end of the session
...
- What metrics to track: log working weights, sets, reps, and RPE for every primary compound every session

**Tracking recommendation:** A simple training log (paper or app) recording: date, exercise, sets × reps, weight used, and a brief RPE note. Without tracking, progression rules cannot be applied correctly.
...
```
## Intermediate Strength Program: [Goal Focus]

**Split:** [Upper/Lower | Heavy-Light Upper/Lower | Push-Pull-Legs]
**Training Days:** [e.g., Monday / Tuesday / Thursday / Friday]
**Block Length:** 4 weeks (3 working weeks + 1 deload)
**Primary Compound Periodization:** Wave loading (4x8 → 4x6 → 4x5 → deload)
**Accessory Periodization:** Double-progression within rep range
...
|-------|---------------------------|-------------|-----------|----------------------------------|
| 1     | Barbell Bench Press       | 4 × 8/6/5   | 2--3 min  | Wave: W1@RPE7, W2@RPE8, W3@RPE9  |
| 2     | Barbell Bent-Over Row     | 3 × 8--10   | 90s--2min | Double-progression               |
| 3     | Dumbbell Incline Press    | 3 × 10--12  | 90s       | Double-progression               |
| 4     | Single-Arm Dumbbell Row   | 3 × 10--12  | 60--90s   | Double-progression               |
| 5     | Tricep Rope Pushdown      | 2 × 12--15  | 60s       | Double-progression               |
| 6     | Dumbbell Bicep Curl       | 2 × 12--15  | 60s       | Double-progression               |

**Day 1 Notes:** [Coaching cues for primary lift, movement focus, common errors to avoid]

---

### Day 2: Lower A -- Knee-Dominant (Squat Focus)

| Order | Exercise                  | Sets × Reps | Rest      | Progression Method               |
|-------|---------------------------|-------------|-----------|----------------------------------|
| 1     | Barbell Back Squat        | 4 × 8/6/5   | 3--4 min  | Wave: W1@RPE7, W2@RPE8, W3@RPE9  |
| 2     | Romanian Deadlift         | 3 × 8--10   | 2 min     | Double-progression               |
| 3     | Bulgarian Split Squat     | 3 × 10--12  | 90s       | Double-progression               |
| 4     | Leg Curl (Seated/Lying)   | 3 × 10--12  | 60--90s   | Double-progression               |
| 5     | Standing Calf Raise       | 3 × 12--15  | 60s       | Double-progression               |
| 6     | Hanging Leg Raise / Ab Work | 2 × 10--15 | 60s      | Volume progression (reps first)  |

**Day 2 Notes:** [Squat cue reminders, RDL hinge mechanics, split squat loading note]
...
| Order | Exercise                  | Sets × Reps | Rest      | Progression Method               |
|-------|---------------------------|-------------|-----------|----------------------------------|
| 1     | Barbell Overhead Press    | 4 × 8/6/5   | 2--3 min  | Wave: W1@RPE7, W2@RPE8, W3@RPE9  |
| 2     | Weighted Pull-Up / Lat Pulldown | 3 × 6--10 | 2 min  | Double-progression               |
| 3     | Dumbbell Lateral Raise    | 3 × 12--15  | 60s       | Double-progression               |
| 4     | Face Pull (Cable or Band) | 3 × 15--20  | 60s       | Light -- technique and health    |
| 5     | Overhead Tricep Extension | 2 × 12--15  | 60s       | Double-progression               |
| 6     | Hammer Curl               | 2 × 12--15  | 60s       | Double-progression               |

**Day 3 Notes:** [OHP bracing cue, lat pulldown vs. pull-up decision, face pull importance for shoulder health]

---

### Day 4: Lower B -- Hip-Dominant (Deadlift Focus)

| Order | Exercise                  | Sets × Reps | Rest      | Progression Method               |
|-------|---------------------------|-------------|-----------|----------------------------------|
| 1     | Conventional Deadlift     | 4 × 8/6/5   | 3--4 min  | Wave: W1@RPE7, W2@RPE8, W3@RPE9  |
| 2     | Front Squat or Goblet Squat | 3 × 8--10 | 2 min    | Double-progression               |
| 3     | Single-Leg Romanian Deadlift | 3 × 10--12 | 90s    | Double-progression               |
| 4     | Leg Press or Hack Squat   | 3 × 10--12  | 90s       | Double-progression               |
| 5     | Seated Calf Raise         | 3 × 12--15  | 60s       | Double-progression               |
| 6     | Ab Wheel Rollout / Pallof Press | 2 × 8--12 | 60s  | Volume progression (reps first)  |

**Day 4 Notes:** [Deadlift setup cues, front squat mobility requirements or goblet alternative, SL-RDL balance focus]

---

### Wave Loading Schedule -- Primary Compounds

| Week | Sets × Reps | RPE Target | Load Guideline           | Notes                        |
|------|-------------|------------|--------------------------|------------------------------|
| 1    | 4 × 8       | RPE 7      | ~70--72% estimated 1RM   | Should feel moderately hard  |
| 2    | 4 × 6       | RPE 8      | ~75--78% estimated 1RM   | Last 1--2 reps challenging   |
| 3    | 4 × 5       | RPE 9      | ~80--83% estimated 1RM   | Heaviest week -- grind reps  |
| 4    | 3 × 8       | RPE 5--6   | ~60% of Week 3 weight    | Deload -- technique focus    |

---

### Progression Rules

**Primary compounds (wave loading):**
- Add 5 lbs to lower body lifts (squat, deadlift) at the start of each new 4-week cycle
- Add 2.5--5 lbs to upper body lifts (bench, OHP) at the start of each new 4-week cycle
- If Week 3 sets are not completed as prescribed (missed reps), repeat the wave at the same load before adding weight

**Secondary compounds (double-progression):**
- Begin at the lower end of the rep range
- Add 1--2 reps per set each session where you have reps in reserve
- When all prescribed sets hit the top of the rep range for two consecutive sessions, add the minimum increment and reset to the bottom of the range
- Typical cycle: 3--6 weeks per secondary lift before adding weight

**Accessories (double-progression, same rules):**
- Advance reps before advancing weight
- For isolation movements (curls, pushdowns, laterals), use 2.5 lb microplates or dumbbell increments when available

---

### Deload Protocol (Week 4 of Every Block)

| Variable        | Working Weeks (1--3)     | Deload Week (4)              |
|-----------------|--------------------------|------------------------------|
| Working weight  | Per wave schedule        | 60% of Week 3 working weight |
| Sets per exercise | As prescribed          | Reduce by 1 (4→3, 3→2)       |
| Rep ranges      | Per program              | Maintain -- focus on form    |
| Session duration | 60--90 minutes          | 45--60 minutes               |
| RPE target      | 7--9 (per week)          | 5--6 across all exercises    |

**Post-deload:** Return to Week 1 of the new cycle with previous Week 1 weights + planned increment.

---

### Next Block Progression Checklist

Before starting each new 4-week block:
- [ ] Did all working sets in Week 3 complete as prescribed?
- [ ] Was the deload completed as planned?
- [ ] Add 5 lbs lower / 2.5--5 lbs upper to primary compound Week 1 load
- [ ] Review accessories -- any stuck on same weight for 3+ weeks? Consider technique audit
- [ ] Note any persistent soreness or pain -- address before loading increases
```
...
1. **Always present the disclaimer before any training guidance.** Health and injury risk are real; the disclaimer is not optional boilerplate.

2. **Never prescribe specific starting weights.** Provide percentage-based guidelines (e.g., "approximately 70% of estimated 1RM") or RPE targets, and direct the user to select loads based on their own recent performance. A weight that is correct for one intermediate lifter is dangerous for another.

3. **Never program the same primary compound on consecutive days.** Squat on Monday means no squat (even as a secondary) on Tuesday. The 48-hour minimum recovery window between sessions stressing the same primary movement pattern is non-negotiable at this volume and intensity level.

4. **Every primary compound must have an explicit periodization structure.** Generic "add weight when it gets easy" is a beginner instruction. Every primary lift in this skill gets either wave loading (strength/balanced goal) or a clearly defined double-progression scheme (hypertrophy focus) with specific rep range bounds.

5. **Every program block must include a programmed deload week.** Do not present a deload as optional or leave its timing to the user's discretion unless explicitly applying autoregulated deload criteria. Intermediate lifters accumulate fatigue faster than they perceive it -- built-in recovery is structurally required.

6. **Volume caps exist for a reason -- enforce them.** Intermediate lifters frequently want to add "just one more exercise." The maximum productive accessory volume for an intermediate lifter in a 4-day split is 10--20 working sets per muscle group per week across all sessions. Exceeding this consistently produces junk volume and impairs recovery.

7. **Rest intervals must be specified for every exercise category.** Primary compounds: 3--4 minutes (lower body), 2--3 minutes (upper body). Secondary compounds: 90 seconds to 2 minutes. Accessories: 60--90 seconds. Isolation work: 60 seconds. Insufficient rest between compound sets is one of the most common causes of stalled progress and form breakdown in intermediate lifters.

8. **Include at least one unilateral movement per training day.** Bilateral compound movements mask side-to-side strength imbalances. A lifter who squats 225 lbs bilaterally may have a 15--20% left-right strength deficit that only becomes visible -- and injury-producing -- under heavier loads. Bulgarian split squats, single-leg RDLs, single-arm rows, and alternating dumbbell presses address this systematically.

9. **Do not rotate accessory exercises within a 4-week block.** Muscle confusion is a myth; progressive overload requires tracking the same movement over time. Changing exercises every session or every week resets the learning curve and prevents meaningful load progression on accessories.

10. **If the user reports persistent joint pain, technical breakdown under load, or symptoms beyond normal training soreness (sharp pain, swelling, numbness, tingling), stop programming and advise them to consult a qualified healthcare professional or sports medicine practitioner.** Do not attempt to program around an undiagnosed injury.

11. **Never recommend supplements, ergogenic aids, or specific dietary products.** If the user asks about nutrition to support the program, redirect to nutrition-specific skills. This skill covers training structure only.

12. **The face pull (or equivalent rear delt/external rotator exercise) is mandatory on every upper day or at minimum twice per week.** OHP and bench press are anterior-dominant; the face pull counteracts accumulated internal rotation and protects the shoulder girdle. It is a structural health exercise, not optional accessory volume.

---

## Edge Cases

### Case 1: User Is Stalled on Multiple Lifts Simultaneously
...
- If the stall is isolated to upper body while lower body progresses, check for shoulder mobility restrictions, elbow positioning issues, or grip width problems that limit bench/OHP mechanics

### Case 2: Home Gym with Barbell, Power Rack, and Dumbbells Only (No Cables or Machines)
...
- Leg extension → Spanish squat with band, sissy squat
- Cable lateral raise → Dumbbell lateral raise (no loss of effectiveness)
- Tricep pushdown → Tricep overhead extension, close-grip push-up, skull crushers
- Face pull → Band pull-apart, prone Y-T-W on a flat bench

**Additional adaptation:** Use tempo manipulation to increase difficulty without load: 3-second eccentric (lowering phase), 1-second pause at stretch, 1-second concentric. This significantly increases time under tension and muscle damage stimulus with the same weight.

### Case 3: User Has 5--6 Days Available and Wants Maximum Hypertrophy
...
- Day 4--6: Repeat the sequence
- Day 7: Rest
- Deload every 4th week: reduce to one PPL circuit (3 sessions that week) at 60% intensity

**Volume note:** Because frequency doubles, per-session volume should be lower. Target 10--14 working sets per session maximum. The higher weekly frequency provides the volume stimulus; individual session volume should feel manageable.

### Case 4: User Has Only 3 Days Available
...
- Reduce accessories to 2 per session to maintain session duration under 75 minutes

### Case 5: User Wants to Emphasize One Lift (e.g., Bring Up a Lagging Bench Press)
...
- Add one additional tricep exercise on each upper day (triceps are frequently the limiting factor in bench press)
- Maintain OHP but move it to a secondary slot on Upper B -- do not eliminate it entirely

### Case 6: User Has Shoulder or Knee Discomfort (Not Acute Injury)
...
- Add terminal knee extension (TKE with band) as a warm-up to improve VMO activation

**Persistent or worsening discomfort:** Do not attempt to program around worsening symptoms. Advise the user to consult a sports medicine physician, orthopedic specialist, or physical therapist.

### Case 7: User Is Transitioning FROM a Competition-Oriented Program Back to General Intermediate Training
...
- Do not rush back to pre-competition working weights; let the 4-week wave structure build back to them naturally

---

## Example

**User Input:** "I've been lifting for about 14 months, started on GZCLP and ran it for 10 months before stalling out on most of my main lifts. I switched to a random 4-day bro split for the last month but I don't think it's structured well. I train Monday, Tuesday, Thursday, Friday at a commercial gym. My current bests are roughly: squat 195 lbs for 3 sets of 5, bench 145 lbs for 3x5, deadlift 255 lbs for 1x5, OHP 95 lbs for 3x5. My goal is to get bigger and stronger -- I don't want to sacrifice either. I have access to everything at a commercial gym."

---

**Output:**

## Intermediate Strength Program: Balanced Strength-Hypertrophy

**Split:** Upper/Lower (A/B variation)
**Training Days:** Monday (Upper A) / Tuesday (Lower A) / Thursday (Upper B) / Friday (Lower B)
**Block Length:** 4 weeks per cycle -- 3 working weeks + 1 deload week
**Primary Compound Periodization:** Wave loading (4×8 → 4×6 → 4×5 → deload)
**Accessory Periodization:** Double-progression within stated rep range

**Program Rationale:** Your GZCLP background means you have a solid strength base and understand progressive overload. The stall on multiple lifts simultaneously is classic late-linear territory -- your nervous system and musculature have adapted enough that session-to-session loading no longer drives progress. The solution is not more volume; it is organized intensity variation across weeks. This Upper/Lower split gives every primary lift twice-weekly frequency, structured wave loading for continued strength development, and enough accessory volume to drive meaningful hypertrophy alongside strength. At your current numbers (195 squat, 255 deadlift, 145 bench, 95 OHP), you're solidly mid-intermediate -- this structure is appropriate and should drive progress for 12--18 months before requiring more advanced periodization.

---

### Estimated 1RM Reference (Epley Formula Approximations)
...
- Total session target: 60--75 minutes.
...
- 48-hour minimum before Lower B (Friday) -- this is why Tuesday training works well.
...
- Lateral raise: the controlled eccentric (3 seconds lowering) matters more than the weight used. Most lifters use too much weight on laterals and generate no stimulus in the target muscle.
...
- Single-leg RDL: use a light dumbbell in the opposite hand (contralateral loading) for better balance and hip control. Start lighter than you think -- balance will be the limiting factor, not strength.
