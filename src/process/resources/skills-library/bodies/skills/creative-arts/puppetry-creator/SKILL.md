---
name: puppetry-creator
description: |
  Expert puppetry guidance covering puppet design, construction methods, performance technique, and voice work for hand puppets, marionettes, rod puppets, and shadow puppets
  Use when the user asks about puppetry creator, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of puppetry creator or requires a different specialized skill.
license: Apache-2.0
metadata:
...
- What type of puppet are you interested in (hand, rod, marionette, shadow, tabletop)?
- What is the purpose (personal project, performance, education, film/video, therapy)?
- What is your experience level with puppet building and performing?
- What is your budget for materials?
- Who is your intended audience (children, adults, mixed)?
- Do you have access to a workshop and basic tools?
- Are you building for yourself to perform, or for others?
- What is the scale of the production (solo show, ensemble, one puppet, many)?

## Puppet Types and Selection
...
- One performer can operate one or two puppets
...
- Strings can tangle
- Requires overhead space and bridge or rail for performer
...
- Easy to create transformations and magical effects
...
- Sightlines limited to the screen area
...
4. How do they move? Fast/slow, smooth/jerky, big/small?
...
- Silhouette test: is the character recognizable in shadow?
...
- Hands and face get the most audience attention; invest detail there
- Consider the performance space: bigger venue needs bigger puppet
...
- Do not over-engineer; add complexity only where needed
...
1. Draw the character from the front, side, and back
2. Indicate where joints and pivot points will be
3. Mark where the performer's hands will control the puppet
4. Draw the mechanism separately: how does the inside work?
5. Build a rough mockup from paper or cardboard before committing to final materials
6. Test the mockup for movement range and performer ergonomics
...
- Hot glue for fabric and detail attachment
- Foam sheets for mouth plate
- Plastic mesh or styrene for mouth plate stiffener
- Felt, ping-pong balls, or acrylic hemispheres for eyes
...
4. Attach the mouth plate inside the head shape
5. Test hand position and mouth movement
6. Cover with fleece: stretch fabric over form, glue at seams
...
4. Attach body to head at the neckline
5. Hands: carved foam, fabric gloves, or felt shapes
6. Ensure the performer can comfortably reach the arm rods

### Paper Mache and Found Materials

**For rod puppets and masks:**

1. Create an armature from crumpled newspaper, wire, or cardboard
2. Layer paper mache strips (newspaper + paste) over the armature
3. Paste recipe: white glue diluted 2:1 with water, or flour paste
4. Apply 4-6 layers, allowing each to dry
5. Sand smooth when completely dry
6. Paint with acrylic paint
7. Seal with clear coat (polyurethane or acrylic medium)

**Advantages:** Very inexpensive, sculptural freedom, strong when layered
**Tip:** Add a final layer of tissue paper for a smooth painting surface
...
4. Punch holes at joint locations
5. Attach pieces with brass fasteners (loose enough to move freely)
6. Attach control rods at key movement points (one for the body, one for the active hand)
7. Optional: cut out areas and back with colored cellophane for color shadow effects
...
- Control bar (airplane style or paddle style) from wood
- Leather or fabric for joints
...
4. Attach strings from control bar to puppet attachment points
5. String order matters: head strings first, then shoulders, hands, knees, back
6. Tune the string lengths precisely; even 1cm difference affects movement
...
- Hand strings to a separate detachable bar
- Knee strings to a leg bar (tilts for walking)
- Practice handling before performing
...
- Eye contact with scene partners creates relationship
...
- Breath rhythm changes with emotion: fast when excited, slow when calm
...
- Picking up objects: show effort proportional to the object's implied weight
...
- Establish the puppet's ground plane and stick to it
- When using a playboard, the puppet's ground is the board edge
...
- Keep the top of the head still; move the bottom jaw
- Opening corresponds to vowel sounds; consonants close or narrow the mouth
...
- Mouth movement lagging behind the audio
- Jaw opening too wide (looks like shouting constantly)
...
- The puppet stage (playboard, booth, or curtain) hides the performer
- Puppet should appear 6-12 inches above the playboard edge
- Watch from the front periodically (use a mirror or video monitor)
- Avoid reaching too high (arms fatigue) or too low (puppet sinks)
- Practice entrances and exits: the puppet walks on, not appears magically
- Sightlines: check that the audience cannot see your arms or head

### Visible Performer Technique

When the puppeteer is visible (tabletop, Bunraku-style):

- Neutral facial expression: the puppet's face, not yours, tells the story
- Direct your breath and energy into the puppet
- Your body should be still and composed; movement belongs to the puppet
- Wear neutral dark clothing to minimize distraction
- Eye focus: look at the puppet or at what the puppet is looking at
- Practice in front of a mirror; audience sees everything
...
4. Add quality: breathy, raspy, crisp, nasal, resonant
5. Add rhythm: fast talker, slow drawl, staccato, singsong
6. Add a verbal habit or catch phrase for recognition
7. Test the voice while performing; it must be sustainable for the entire show
...
- Warm up before every performance (humming, lip trills, gentle scales)
- Stay hydrated; room temperature water is best
- Avoid vocal fry and tension in character voices
- If a voice hurts, adjust the technique; pain means damage
- Do not whisper for long periods (more stressful than speaking)
- Rest the voice between performances
- Learn to project from the diaphragm, not the throat

### Multiple Characters

- Create maximum contrast between characters for clarity
- Change at least two parameters between characters (pitch + pace, placement + quality)
- Physical change supports vocal change: different posture for each puppet
- Practice switching rapidly; scenes with dialogue between your characters are common
- The audience should never wonder which character is speaking
...
- Transformation: characters can change shape, size, species
- The impossible: flying, shrinking, magic are easy with puppets
...
4. Audience participation moment (especially for children's shows)
5. Resolution that satisfies the emotional journey
...
- Counting, singing, or calling out together
- Keep instructions simple and clear
- Have a plan for unexpected audience responses
...
- Professional booth (collapsible, touring-ready)
...
- Shadow puppetry: single point source behind the screen
...
- Sound effects: live or triggered (bells, whistles, recorded effects)

### Rehearsal Process

1. **Read-through**: voices only, establish characters and pacing
2. **Blocking with puppets**: work out staging and movement
3. **Technical run**: add lights, sound, and any special effects
4. **Full runs**: build stamina and consistency
5. **Audience preview**: test with a small, friendly audience
6. **Notes and polish**: refine based on audience response
7. Puppetry rehearsal takes longer than you expect; schedule generously

## Practice Exercises

### Daily Practice (15-20 minutes)

1. **Lip sync drill**: play a podcast or audiobook, lip sync a puppet to the voice (5 min)
2. **Walking drill**: walk a puppet smoothly across a surface at consistent level (3 min)
3. **Focus drill**: puppet picks up objects, examines them, puts them down with clear focus (3 min)
4. **Character switch**: alternate between two character voices and physicalities (4 min)
5. **Mirror work**: perform in front of a mirror, watch the puppet, not yourself (5 min)

### Weekly Practice (30-45 minutes)

- Run through a complete short scene or routine
- Record and review: watch the puppet, not yourself
- Practice one specific skill you want to improve
- Experiment with a new puppet type or technique
- Watch professional puppetry performances for inspiration and study
...
4. Sew a body tube from fleece, attach arm tubes with rod pockets
...
2. **Analyze context.** Review the information provided and identify key factors relevant to puppetry creator
...
**Input:** "Help me with puppetry creator for my current situation"

**Output:**

Based on your situation, here is a structured approach to puppetry creator:
