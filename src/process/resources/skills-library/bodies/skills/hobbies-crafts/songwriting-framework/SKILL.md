---
name: songwriting-framework
description: |
  Provides an intermediate-level framework for writing songs including song
  structure templates (verse, chorus, bridge, pre-chorus, intro, outro),
  lyric development processes (theme narrowing, imagery, rhyme scheme
  selection), melody-chord relationship basics, and revision techniques.
  Use when the user wants to write a song, develop lyrics, choose a song
  structure, or improve an existing song draft. Do NOT use for music theory
  fundamentals like scales and intervals (use music-theory-fundamentals),
  beginner guitar chords (use guitar-beginner-foundations), or recording
...
- The user wants to choose between competing song structures and understand the trade-offs of each for their genre and message
- The user wants to improve a song draft -- strengthen the hook, fix a bridge that does not land, or resolve lyric cliches
- The user asks specifically about rhyme scheme selection, lyric imagery techniques, or how melody relates to chord changes
- The user is co-writing with another person and needs a shared framework to divide the work
...
- The user wants a structured daily or weekly practice schedule for an instrument -- use `practice-routine-builder` instead
- The user is asking about music licensing, publishing royalties, or copyright registration -- use a legal/business skill or defer to a professional
- The user wants to analyze a specific existing song academically (form analysis, harmonic analysis) without writing anything new -- this skill is generative, not analytical

---

## Process

### Step 1: Gather the Songwriting Brief

Before writing a single lyric or selecting a structure, collect the inputs that will drive every subsequent decision.

- **Theme or subject:** Ask what the song is fundamentally about. Push past the first answer. "Heartbreak" is a category. "The three weeks after a breakup when you still check someone's Instagram at midnight" is a song. Use follow-up questions: "What specifically happened?" "What do you want to say that you could not say at the time?"
- **Genre and reference artists:** Ask for 2-3 songs or artists that feel like the right neighborhood. This encodes tempo, instrumentation texture, lyric density, and production expectations simultaneously. A user who says "like Phoebe Bridgers" means something completely different from one who says "like Taylor Swift's 1989."
- **Mood and emotional arc:** Ask not just what the song feels like at the start, but where it ends emotionally. A song that begins in grief and ends in grief is a lament. A song that begins in grief and ends in gratitude is a transformation. The emotional arc determines everything about structure, bridge placement, and how the outro should resolve.
- **Existing material inventory:** Ask if they have any of the following already: a chord progression, a melodic fragment they can hum or describe, a title or hook phrase, a verse or chorus draft, or a specific line they love. Existing material is an anchor -- work outward from it rather than starting from nothing.
- **Instrument and playing level:** What they will write on (guitar, piano, voice only, DAW/loops) determines chord complexity recommendations, key selection advice, and how to frame the melody-chord relationship guidance. A guitarist with five open chords gets different suggestions than a pianist who reads music.
- **Intended use:** Is this for performing live, recording, submitting to a co-write, sharing privately, or entering a competition? Competitions often have time limits (under 4 minutes). Live performance allows more extended outros. This context shapes length and structure recommendations.

---

### Step 2: Narrow the Theme to a Central Image or Moment

Generic themes produce generic songs. The most memorable songs in any genre are specific -- so specific they feel universal. This step is the most important creative discipline in the entire process.

- **The snapshot technique:** Ask the user to describe the theme as a single, specific scene -- a place, a time of day, one action happening. "Loneliness" is not a scene. "Eating cereal alone in an apartment at 11 PM with the TV on for company" is a scene. The snapshot does not have to appear verbatim in the song, but every lyric decision should be filtered through it.
- **The five senses audit:** For whatever snapshot the user identifies, ask: what do they see, hear, smell, feel physically, and taste in that moment? Even one concrete sensory detail in a verse (the fluorescent hum of a gas station, the specific weight of a winter coat) anchors the song in lived experience. Listeners recognize specificity even if they have never been to the exact place.
- **The title test:** Before writing a single section, try to summarize the song in a 3-7 word title. If the title cannot be written, the theme is not focused enough. Good title tests: "Would someone want to find this song on Spotify?" "Does the title create an expectation the song can fulfill?" "Does the title contain a natural hook rhythm?"
- **The emotional arc map:** Define two emotional coordinates: where the song starts emotionally, and where it ends. Common arcs that work structurally:
  - Confusion -- clarity (verse to chorus reveals the insight)
  - Hope -- loss (the chorus is the painful realization)
...
### Step 3: Select a Song Structure

Structure is not a cage -- it is a contract with the listener. Present options based on genre, theme complexity, and the user's experience level, and explain the trade-offs of each.
...
- Best for: songs with a strong, singable hook; pop, country, mainstream rock, R&B.
...
- Best for: songs where the verse feels conversational and the chorus is an explosion; modern pop, pop-country, radio rock.
...
- Best for: sophisticated, lyric-driven songs; jazz-influenced writing; Burt Bacharach, Carole King early work, musical theater ballads.
...
- Best for: narrative songs, character songs, protest songs, story-driven country. Bob Dylan, Joni Mitchell, Josh Ritter, Gillian Welch.
...
- Running time can exceed 5:00 because the structure allows expansion. This is the only structure where exceeding 5 minutes is acceptable.

**Recommendation protocol:** For first-time songwriters or anyone without a specific structural reason to choose otherwise, recommend Verse-Chorus or Verse-Pre-Chorus-Chorus. For narrative-focused or folk-influenced writers, recommend Verse-Refrain. Save AABA and Through-Composed for writers with existing craft experience.

---

### Step 4: Develop Lyrics Section by Section
...
- Verse melody sits below the chorus melody in the singer's range, creating headroom for the chorus to lift.
...
- Syllable count in choruses is shorter per line than verses -- the melody stretches longer notes, giving each word more weight.
- Rhyme schemes for choruses: AABB (couplets) feels resolved and satisfying. ABAB works but requires more setup. Many modern pop choruses use AABB or even just a single repeated line (AAA).
...
- Keep pre-choruses to 2-4 lines and under 8 bars. If it gets longer, it becomes a second verse.
...
- Three effective bridge types:
  1. **The revelation bridge:** The singer realizes something they did not know in the verses. Changes the meaning of what came before.
  2. **The acceptance bridge:** The singer makes peace with the situation. Sets up the final chorus as an emotionally transformed repeat.
  3. **The counter-argument bridge:** The singer voices the opposing view they have been suppressing. Creates tension before the final chorus resolves it.
...
### Step 5: Select and Apply a Rhyme Scheme

Rhyme scheme is not decoration -- it is a structural scaffold that the listener's ear follows unconsciously. A rhyme scheme that breaks inconsistently creates a subliminal sense of wrongness even for listeners who cannot name why.
...
- When in doubt, default to ABCB for verses.
...
### Step 6: Connect Melody to Chord Progressions
...
### Step 7: Revise Using the Three-Pass Method
...
- Identify consonant clusters that create tongue-twisters at tempo: "sixth street streetlights," "that thick brick bridge." Replace any that require rehearsal to pronounce cleanly.
...
- Check section lengths against genre expectations:
  - Pop verse: 8 bars standard, 16 bars maximum before needing a pre-chorus
  - Pop chorus: 8 bars standard, can be 4 bars in high-energy styles
  - Bridge: 8 bars standard (4 bars is too short; 16 bars is too long unless instrumental)
  - Total song length targets: pop 3:00-3:30, rock/indie 3:30-4:30, folk/country 3:00-4:00, ballad 4:00-5:00, through-composed up to 6:00
- Confirm the outro provides appropriate resolution for the emotional arc. A song about acceptance should not end on an unresolved chord. A song about lingering loss can fade on a repeated chorus because the repetition itself communicates the ongoing state.
...
```
## Song Blueprint: [Working Title]

### Songwriting Brief
| Field            | Content                                         |
|------------------|-------------------------------------------------|
| Core theme       | [specific snapshot description]                 |
| Genre / style    | [genre + reference artist if provided]          |
| Mood             | [primary mood descriptor]                       |
| Emotional arc    | [starting emotion] --> [ending emotion]         |
| Structure        | [chosen structure + rationale]                  |
| Key / Instrument | [key if known, instrument]                      |
...
|---------------|----------|-----------------------------------|-----------------------|--------------|
| Intro         | 4-8 bars | Set sonic and emotional world     | [chords]              | N/A          |
| Verse 1       | 8 bars   | Set scene, specific detail        | [chords]              | [scheme]     |
| Pre-Chorus    | 4 bars   | Build tension toward chorus       | [chords]              | [scheme]     |
| Chorus        | 8 bars   | Emotional peak + hook             | [chords]              | [scheme]     |
| Verse 2       | 8 bars   | Advance/deepen story              | [chords]              | [scheme]     |
| Pre-Chorus    | 4 bars   | Rebuild tension                   | [chords]              | [scheme]     |
| Chorus        | 8 bars   | Repeat (same words)               | [chords]              | [scheme]     |
| Bridge        | 8 bars   | New perspective / revelation      | [new chords]          | [scheme]     |
| Final Chorus  | 8 bars   | Transformed repeat (key change?)  | [chords]              | [scheme]     |
| Outro         | 4-8 bars | Resolution or fade                | [chords]              | N/A          |

*Adjust rows based on the structure chosen (remove Pre-Chorus rows for folk/Verse-Refrain, etc.)*

---

### Lyric Worksheet

**Verse 1** | Rhyme scheme: [ABCB / ABAB / AABB]
Line 1: [Lyric draft or writing prompt -- set the scene: where, when, who]
Line 2: [Lyric draft or writing prompt -- sensory detail only a local/insider would know]
Line 3: [Lyric draft or writing prompt -- action or movement]
Line 4: [Lyric draft or writing prompt -- emotional reaction; rhymes with Line 2]

**Pre-Chorus** (if applicable) | Rhyme scheme: [open / AA]
Line 1: [Rising tension -- state the question or urgency]
Line 2: [Increase the pressure; can rhyme with line 1 or remain open]
Line 3 (optional): [Land on an unresolved feeling that demands the chorus]

**Chorus** | Rhyme scheme: [AABB / ABAB]
Line 1 (hook): [The central message in one singable phrase -- this is the song's thesis]
Line 2: [Reinforce or expand the hook; rhymes with Line 1 if AABB]
Line 3: [Deepen the emotional weight]
Line 4: [Complete the thought; rhymes with Line 3; returns to hook territory]

**Verse 2** | Rhyme scheme: [same as Verse 1]
Line 1: [New scene or time shift -- must advance beyond Verse 1]
Line 2: [New sensory detail]
Line 3: [Complication, contrast, or consequence]
Line 4: [Build toward chorus re-entry; rhymes with Line 2]

**Bridge** | Bridge type: [Revelation / Acceptance / Counter-Argument]
Line 1: [The thing the song has not said yet]
Line 2: [Deepen or complicate Line 1]
Line 3: [The turn -- the realization or pivot]
Line 4: [Set up the final chorus; optional -- can end after Line 3 for dramatic effect]

---

### Melody and Chord Notes
- **Verse chord function:** [explain the I-IV-V-vi relationships at work]
- **Chorus chord function:** [explain why these chords carry the emotional peak]
- **Bridge chord departure:** [identify what is new -- borrowed chord, relative minor/major shift, etc.]
- **Hook melody shape:** [describe -- rising, falling, stepwise, leap-driven; identify peak note and which word it lands on]
- **Key and range check:** [confirm the chorus peak note fits comfortably below the singer's ceiling]

---

### Revision Checklist
**Pass 1 -- Lyric Truth**
- [ ] Every verse line contains at least one concrete, sensory image
- [ ] No unexamined cliches (list any found: ________________)
- [ ] Every abstract noun in verses replaced with its specific image
- [ ] Emotional arc delivers: song moves from [start state] to [end state]
- [ ] Bridge contains the pivot moment for the emotional arc

**Pass 2 -- Singability**
- [ ] Every line sung at tempo -- no syllable crowding
- [ ] Natural word stress aligns with melodic stress throughout
- [ ] No consonant clusters requiring unusual dexterity at tempo
- [ ] Breath plan works -- no line exceeds 12-14 syllables without a natural pause

**Pass 3 -- Structure**
- [ ] Chorus hits harder than verse (melody lifts, lyric is more universal)
- [ ] Bridge is genuinely different in at least 2 of: chords, melody, perspective, rhythm
- [ ] All sections are appropriate lengths for the genre
- [ ] Outro provides the correct type of resolution for the emotional arc
- [ ] Target length: [X:XX] -- within range for [genre]
```
...
1. **Never write the complete song for the user.** The framework provides structure, prompts, directional examples, and craft guidance. The creative choices -- specific words, images, and lines -- must come from the user. Providing line-complete lyrics removes the songwriter from their own song and produces material that does not sound like them.

2. **Always narrow the theme before selecting structure.** A vague theme ("love," "loss," "finding yourself") will produce structurally correct but emotionally empty songs. The snapshot test is not optional. If the user cannot describe their theme as a specific scene or moment, ask follow-up questions until they can.

3. **The hook belongs in the chorus.** If a user's draft has their strongest, most memorable line buried in Verse 2, identify it explicitly and recommend moving it. The chorus is where the listener is trained to expect the payoff; burying the payoff in a verse is the most common structural mistake in amateur songwriting.

4. **Rhyme scheme consistency is non-negotiable within repeated sections.** If Verse 1 is ABCB, Verse 2 must be ABCB. Inconsistency within a section type breaks the subliminal contract the song makes with the listener in the first pass. Chorus-to-chorus and verse-to-verse schemes must hold.

5. **Never recommend forcing an exact rhyme at the cost of natural word order.** Inverted syntax ("Through the darkness she walked / Her name I called") sounds archaic and removes the conversational naturalness that makes lyrics relatable. Slant rhyme with natural syntax is always superior to perfect rhyme with inverted syntax.

6. **Bridge must introduce something new.** A bridge that restates the chorus sentiment in slightly different words is not a bridge -- it is a third chorus placed in the wrong structural position. The bridge must change at least two structural parameters: chord progression, melodic register, lyric perspective, or rhythmic feel. If the user's bridge feels like "more of the same," help them identify what the song has not yet said.

7. **Song length targets are not suggestions -- they are audience expectations.** Pop radio expects 3:00-3:30. A folk storytelling song can reach 4:30. Going over 5:00 in any non-progressive genre is a significant barrier to the song being heard, shared, or remembered. When a draft is running long, identify which section can be cut (typically the third verse, an extended outro, or a redundant pre-chorus) before recommending any other revision.

8. **Verses carry specificity; choruses carry universality.** This is the central lyric architecture principle. Verses must have concrete images, named places, specific actions. Choruses must have language that any listener can inhabit. A chorus that is too specific ("I drove down Route 9 at 11 PM in a 2003 Civic") traps the song in the writer's specific experience. A verse that is too abstract ("I felt sad and alone") fails to earn the chorus. Both failures are equally damaging.

9. **Singability check is mandatory before any draft is considered complete.** Lines that read well on the page frequently fail when sung at tempo. Syllable crowding, stress conflicts, breath-point problems, and consonant clusters are invisible on the page and obvious when sung. The user must sing -- not read -- every line before the pass is complete.

10. **When the user provides existing lyrics, analyze before prescribing.** Do not immediately suggest structural changes to a draft without first auditing it against the revision checklist. Identify what is already working (a strong image, a good hook, a verse that earns its chorus) before addressing problems. Songwriters abandon drafts that receive only critique; they revise drafts that receive specific, actionable feedback on both strengths and gaps.
...
- Write "dummy lyrics" (also called "mouth music" or "melodic scat") first: sounds that fit the rhythm and stress pattern without meaning anything, like "I was something in the morning." Then replace each syllable position with real words that match the stress.
- For chords: the melodic peak note should be a chord tone or a strongly supported tension tone (9th, 4th going to 3rd) of whatever chord underlies it. Work from the melody's note center to identify what chord family will sound natural underneath.
...
- For chords: identify the emotional tone of the lyric. Sad or introspective lyrics pair with progressions anchored in vi (minor tonic) or IV-I movements. Hopeful or resolving lyrics pair with I-V-IV movements. Uncertain or restless lyrics pair with unresolved V-IV or ii-V suspensions.
- Recommend the user speak the lyrics over a single droned chord first to feel the rhythm, then introduce chord changes at the phrase boundaries.
...
- **General principle for all languages:** do not impose English-language rhyme conventions on lyrics written in another language. Let the phonological patterns of the target language guide rhyme choices. Slant rhyme in the user's language is always preferable to a perfect rhyme that sounds unnatural in that language.
...
- Resolve creative conflicts with the "serve the song" principle: if both writers cannot agree on a line, ask which version better serves the emotional arc and structural function of that specific moment -- not which is the more clever or clever-feeling line.
- Before the session, explicitly agree on the central theme (Step 2) and confirm both writers are writing the same song. Co-writing sessions that skip theme alignment produce two half-songs that do not cohere.
...
- In the final 5 minutes, do only Pass 2 (singability) -- sing the song once at full tempo and fix any line that cannot be sung as written. Save Pass 1 and Pass 3 for a follow-up session.
- Remind the user that the speed draft is a first draft, not a finished song. The goal is to capture the instinctive emotional truth of the theme before the analytical brain starts second-guessing. A 30-minute draft that is 70% good is better than a perfectionist stall that produces nothing.
...
- Identify which of these four chorus failures is occurring:
  ...
  3. **The chorus melody does not lift above the verse** -- the melody stays in the same register, so the chorus does not feel like an arrival.
  4. **The chorus says what the verse already said** -- there is no new emotional or thematic information in the chorus; it is the verse restated more loudly.
- For failure type 1: identify the most universal emotional statement in the existing chorus and rebuild around it, moving the specific details back to a verse.
- For failure type 2: ask the user "What is the single thing this song is trying to say?" That answer is the hook line. Write it first, then build the other chorus lines around it.
- For failure type 3: analyze the note range of the verse melody and deliberately start the chorus melody at least a minor third higher. Alternatively, strip the arrangement at the end of the verse and let the chorus detonate with full instrumentation.
- For failure type 4: return to the emotional arc. If the verse is "situation A," the chorus must be "meaning of situation A" or "transformation from A to B" -- not more of A.
...
- Consider who is "singing" the song -- is it in first-person from the commissioner to the subject? Second-person address ("you always...")? Third-person narrative? Choose one perspective and hold it throughout.
- For wedding songs specifically: plan the emotional arc to end in celebration or gratitude, not in uncertainty or longing. The bride/groom hearing the song at the reception needs a resolved, joyful ending. Save the complex emotional arcs for personal songwriting.

---

## Example

**Input:** "I want to write an indie-folk song about the weird feeling after a long-term relationship ends and you are technically fine -- functioning, going to work, eating -- but you feel like a ghost of yourself. I play piano. My chord vocabulary includes minor chords, 7ths, and I'm comfortable with Am, Dm, Em, F, C, G, and their 7th variants. No existing material yet."

**Output:**

## Song Blueprint: "Still Here" (Working Title)
