...
- User needs to evaluate competing claims about a policy's projected costs, benefits, or feasibility using primary evidence
- User is preparing to vote on a ballot measure with environmental components and wants to understand what it actually does versus what advocates and opponents claim
- User wants to map the stakeholder landscape for a policy debate -- who is involved, what they argue, what evidence they use, and where their interests lie
- User is a student, journalist, or engaged citizen who needs to build a rigorous, evidence-based understanding of an environmental policy question without being told what to think about it
...
- User's business must comply with a specific environmental permit, regulation, or enforcement action -- this is legal and regulatory compliance work, not citizen policy research
- User needs help designing a lobbying campaign, writing political fundraising materials, or organizing a ballot initiative drive -- this skill explicitly avoids partisan strategy
- User is asking about international treaty frameworks (Paris Agreement, Kyoto Protocol, Convention on Biological Diversity) as diplomatic instruments -- those require a distinct foreign policy and international law framework
- User wants to understand the underlying science behind an environmental problem (how particulate matter damages lungs, how nutrient loading causes hypoxia) without reference to policy -- science education is a separate task
...
Before doing any research, establish what the user actually needs to know and why. These questions shape everything:

- **Policy level and jurisdiction:** Is this a federal rule (EPA, Army Corps, USFWS), a state statute or regulation, a regional compact (RGGI, Western Climate Initiative), a county ordinance, or a city zoning code amendment? Each level has different legislative processes, different official sources, and different timelines.
- **Stage of the policy:** Is this a bill (not yet law), a proposed rule (in notice-and-comment period), an enacted statute (passed but possibly being implemented), a final rule (published in the Code of Federal Regulations or state equivalent), or a policy under litigation or review?
- **Specificity of user's question:** Does the user have a bill number, agency docket number, or policy name? Or are they exploring a topic area (e.g., "how do states regulate agricultural runoff")?
- **User's purpose:** Voting on a ballot measure requires different depth than a graduate seminar paper; writing a formal public comment requires knowledge of the legal standard for that comment process; preparing for a city council meeting requires knowing who already has input on the record.
- **User's baseline knowledge:** Policy-naive users need the mechanism explained before they can evaluate evidence. Users who follow policy actively may need only targeted deep dives.

Clarify all five dimensions before proceeding. If the user has a specific bill or rule, ask for the number or sponsoring agency. A bill number like H.R. 5376 or a docket number like EPA-HQ-OAR-2021-0317 anchors all subsequent research in primary documents.

---

### Step 2: Identify the Policy Mechanism
...
- Conservation payments: USDA Conservation Reserve Program pays farmers per acre per year to take highly erodible land out of production
...
- Key questions: Who is liable? What cleanup standard applies (risk-based vs. background)? What does the remediation cost, and who actually pays when PRPs are insolvent?

---

### Step 3: Map the Legislative and Regulatory Process
...
- Final Rule: published in the Federal Register, codified in the Code of Federal Regulations (40 CFR for EPA, 30 CFR for MSHA, 43 CFR for BLM, etc.)
- Final rules are subject to Congressional Review Act disapproval (rarely used but important when control of Congress changes); to judicial review in federal courts
...
### Step 4: Identify and Evaluate Sources
...
- Peer-reviewed scientific literature (not press releases about studies)
...
- Reliance on a single outlier study when multiple studies reach different conclusions
...
4. Does the organization's funding create a plausible interest in the conclusion?
5. Do other independent analyses reach similar conclusions?
6. Is the claim about empirical effects (jobs lost, tons of pollution reduced) or about values (how much a clean river is "worth")?

---

### Step 5: Conduct the Stakeholder Analysis
...
- **Environmental justice communities:** Communities disproportionately exposed to pollution -- often low-income, often communities of color -- have distinct interests that may differ from mainstream environmental groups. They may support stricter regulation but oppose trading programs that could concentrate pollution near their communities (the "hot spot" problem in cap-and-trade).
- **Labor unions:** Interests vary sharply by industry. Unions representing fossil fuel workers (UMWA, USW) may oppose climate regulations; unions representing building trades may support clean energy incentives that create construction jobs.
- **State and local governments:** Often regulated entities themselves (municipal water systems, transit agencies) while also serving as regulators and enforcers. States with different economic profiles often divide into regional coalitions in federal policy debates.
- **Scientific and academic community:** Generally not a unified voice, but consensuses emerge through meta-analyses, National Academies reports, and IPCC-style assessment processes. Note when a scientific claim has a clear consensus vs. when it is an area of active research with genuine uncertainty.
...
- Organizational capacity (a Fortune 500 company's detailed regulatory comment carries more weight in legal proceedings than a form-letter campaign, but both are in the record)
- Potential conflicts of interest (financial, ideological, political)
- History with this policy area (did they support or oppose predecessor policies?)

---

### Step 6: Evaluate the Evidence for Effectiveness

Effectiveness claims in environmental policy require specific analytical scrutiny. Apply these tests:
...
**Distributional analysis:** Who benefits and who bears costs is as important as the aggregate numbers. A policy that produces $10 billion in aggregate economic benefits but concentrates harms in a single low-income community is different from one with the same aggregate effects distributed broadly. Look for distributional analysis in RIAs; note when it is absent.

---

### Step 7: Assess Implementation Feasibility

A well-designed policy can fail at implementation. Assess feasibility concretely:

**Regulatory authority:** Does the implementing agency have clear statutory authorization? Major federal environmental rules are routinely challenged on the grounds that the agency exceeded its statutory authority. The Supreme Court's 2022 decision in West Virginia v. EPA limited EPA's authority to require grid-wide "generation shifting" under CAA Section 111(d). Know what legal challenges a rule faces or is likely to face.
...
- Self-reporting with auditing: most common; accuracy depends on penalties for false reporting

**Implementation timeline:** From statute to enforceable standard, the federal rulemaking process typically takes 3-7 years for complex rules. State implementation plans (SIPs) required under NAAQS can take additional years. Factor this timeline into assessments of when a policy would actually take effect.

**Interaction effects with existing policy:** New policies layer onto existing regulatory frameworks. A state carbon price might interact with federal fuel economy standards, utility rate regulation, and renewable portfolio standards -- with complex effects that single-policy analyses miss.

---

### Step 8: Help the User Synthesize and Position
...
- Whether the economic disruption costs are "worth it": value judgment, reflects priorities, cannot be answered with evidence alone
...
- Aggregate efficiency vs. distributional equity (cap-and-trade may achieve emissions reductions at lower aggregate cost but may concentrate pollution in disadvantaged communities)

These trade-offs are not resolvable with evidence -- they reflect what the user values. Make that explicit rather than pretending there is a "correct" answer.
...
```
## Environmental Policy Research: [Policy Name or Topic]

### Research Question
[The precise question being investigated -- specific enough to be answerable]

### Policy Snapshot
| Parameter                | Value                                                   |
|--------------------------|--------------------------------------------------------|
| Policy area              | [Energy / Air quality / Water / Land use / Waste / Wildlife / Climate] |
| Government level         | [Federal / State: name / Regional compact / Local: jurisdiction] |
| Policy stage             | [Pre-introduction / Introduced / In committee / Passed one chamber / Enacted / Proposed rule / Final rule / Under litigation] |
| Primary mechanism        | [Command-and-control / Cap-and-trade / Carbon tax / Subsidy / Disclosure / Voluntary / Liability] |
| Enabling statute (if rule)| [Statute name and section]                             |
| Official identifier      | [Bill number, docket number, CFR citation, or ordinance number] |
...
|--------------------------|-------------------|-------------------------------|-------------------------------------|--------------------------|
| [Name stakeholder precisely] | [Support/Oppose/Conditional] | [Their specific argument] | [Studies or data they cite] | [Financial/political interest] |
| [Stakeholder 2]          |                   |                               |                                     |                          |
...
|--------------------------|---------------------|-----------------------|-------------------|--------------------------|
| [Specific factual claim] | [Primary source ID] | [Study design type]   | [Strong/Moderate/Weak/Contested] | [What the evidence can't tell us] |

### Cost-Benefit Analysis
| Factor                   | Estimated Magnitude | Methodology Used   | Who Bears It / Who Benefits | Timeframe     | Confidence Level |
|--------------------------|---------------------|--------------------|-----------------------------|---------------|------------------|
| Cost: [Specify precisely] | [$ range or %]     | [How calculated]   | [Which group]               | [Short/long term] | [High/Medium/Low] |
| Benefit: [Specify precisely] | [$ range or quantified units] | [VSL, hedonic, etc.] | [Which group] | [Timeframe] | [Confidence] |
| Distributional note      | [Who gains, who loses disproportionately] | | | | |

### Implementation Assessment
| Factor                   | Assessment                                                |
|--------------------------|-----------------------------------------------------------|
| Implementing agency      | [Agency name, relevant division or program office]        |
| Statutory authority      | [Legal basis; note if contested]                          |
| Compliance monitoring    | [How compliance is measured -- CEMs, stack tests, self-reporting] |
| Enforcement mechanism    | [Civil penalties, permit revocation, criminal liability; penalty tiers] |
| Timeline to implementation | [Rulemaking timeline, attainment dates, phase-in schedule] |
| Interaction with existing rules | [How this layers on or replaces existing requirements] |
| Legal vulnerability      | [Pending or likely litigation challenges]                 |
| Precedent jurisdictions  | [Where similar policies exist; age of policy; measured results] |

### Scientific Consensus vs. Policy Debate
| Question                 | Type                     | Current Status                            |
|--------------------------|--------------------------|-------------------------------------------|
| [Is X a problem?]        | Scientific/empirical     | [Consensus / Active research / Disputed]  |
| [Will policy Y fix X?]   | Empirical policy claim   | [Evidence from comparable cases]          |
| [Is cost Z acceptable?]  | Value judgment           | [Legitimately contested -- depends on priorities] |

### Research Gaps and Open Questions
1. [Specific factual question that would change your evaluation if answered differently]
2. [Data that would be needed to resolve a contested empirical claim]
3. [Aspect of the policy design that is unclear from available sources]

### Forming Your Position
- **What the evidence clearly supports:** [Factual claims with strong evidentiary basis]
- **Where evidence is mixed or uncertain:** [Contested empirical questions]
- **Value trade-offs that only you can weigh:** [Where priorities, not evidence, determine the answer]
- **The strongest argument for support:** [Steelman the pro-policy case]
- **The strongest argument against:** [Steelman the anti-policy case]
- **Next research steps for this specific question:** [What to look up, where, and why]
```
...
1. **Never state or imply a policy position.** This skill builds research capacity. The AI's role ends at "here is what the evidence shows and here are the trade-offs." The moment the AI says "you should support this" or "this policy is clearly the right approach," it has violated the skill's core purpose. Phrase conclusions as "the evidence is consistent with," not "this proves we should."

2. **Always name the specific policy mechanism before evaluating the policy.** Cap-and-trade and a carbon tax are both market-based instruments but have fundamentally different political economy, price certainty profiles, and distributional effects. Treating them as equivalent because both "put a price on carbon" produces confused analysis.

3. **Separate scientific consensus claims from policy claims at every stage.** The physics of CO2 forcing, the toxicology of lead, and the epidemiology of particulate matter health effects are scientific consensus claims -- the AI should not artificially balance them with industry-funded contrarian views. The question of what regulatory response is appropriate is a policy claim where genuine disagreement is legitimate.

4. **Primary sources over summaries, always.** A CBO score should be cited from the CBO's actual report, not from a party press release summarizing it. A study's conclusions should be verified in the abstract or paper, not accepted from an advocacy summary that may misrepresent them. Press releases about research are not the research.

5. **Cost-benefit analysis must always be symmetric.** It is intellectually dishonest to present only compliance costs for regulated industry without also presenting quantified environmental and health benefits, and vice versa. If the user has seen a source that presents only one side, call that framing out explicitly without dismissing the source entirely.

6. **Discount rates and time horizons must be stated explicitly.** A $100 benefit 30 years from now is worth approximately $41 today at a 3% discount rate and approximately $13 at a 7% discount rate. Most cost-benefit disagreements in long-horizon environmental policy reduce, partly, to disagreements about the appropriate discount rate. Always identify what discount rate a study used.

7. **Environmental justice analysis is mandatory for any policy affecting pollution distribution.** Even if the user doesn't ask about it, a complete policy analysis must address whether the policy could concentrate pollution in communities already bearing disproportionate environmental burdens. This is not an optional add-on -- it is a required dimension of any complete analysis.

8. **Implementation feasibility is as important as policy design quality.** A well-designed policy that cannot be monitored, enforced, or resourced will not achieve its goals. Always assess the agency's capacity, the monitoring methodology's reliability, and the penalty structure's deterrent effect -- not just the stated goals of the policy.

9. **Precedent jurisdictions must be evaluated in context.** When citing another jurisdiction's results (e.g., "Sweden's carbon tax reduced emissions"), identify how similar the jurisdictions are in terms of economic structure, energy mix, population density, and policy context. Do not use a cherry-picked success or failure story as a definitive predictor.

10. **Acknowledge genuine scientific uncertainty without manufacturing it.** Some policy debates involve genuine scientific uncertainty (the precise ecosystem effects of a specific pesticide at low doses; the exact climate sensitivity range). Others involve manufactured uncertainty campaigns designed to delay policy action. Distinguish them by looking at the weight of peer-reviewed evidence, the consensus position of relevant professional scientific societies, and whether "dissenting" scientists have relevant credentials and peer-reviewed publications in the field.
...
- The administrative record of a rule (all comments, agency responses, technical support documents) becomes evidence in subsequent court challenges; a comment that documents data gaps or methodological flaws can support later litigation
- Help the user identify: What specific provision do they want to comment on? What evidence or argument supports their position? What data does the agency appear to have overlooked?
...
- Who is funding the campaigns for and against (required disclosures in campaign finance filings; searchable through state campaign finance databases)
- The teach the user that ballot measure titles and summary language are often written by the sponsoring side and can be misleading -- always read the actual operative text
...
- Are the study authors' affiliations or funding sources disclosed? Did a regulated industry fund a study finding no harm from its product?
- If the study is genuinely new and high quality, it represents scientific debate within the research community -- note it as such, not as a reason to dismiss the consensus, but as a reason to track the literature
...
- Help the user find the relevant court docket (PACER for federal courts; most have public docket searches) to understand the case status
...
- Check whether the project triggers environmental review requirements (CEQA in California, SEQRA in New York, NEPA if any federal nexus exists) -- environmental review documents contain substantial technical analysis and public comment records
...
- When the user is confused about "who controls this," walk them to the specific statute and find the relevant provision on state/federal division of authority

---

## Example

**Input:** "My state legislature is considering a bill that would require all new passenger cars sold in the state to be zero-emission vehicles by 2035. I've seen ads saying this will cost families thousands of dollars and I've seen ads saying it will save them money. I don't know what to believe. How do I figure out what's actually true?"
...
The policy applies to manufacturers and dealers, not to current vehicle owners. It does not require anyone to give up an existing car. Beginning in model year 2035, new passenger vehicles -- cars and light trucks up to a specified gross vehicle weight, typically 8,500 pounds -- sold by dealerships in the state must have zero tailpipe emissions.
...
Compliance flexibility mechanisms: manufacturer ZEV credit systems allow automakers to earn credits for ZEV sales and bank or trade them, providing some flexibility in the transition.
...
1. **Your state's specific bill text:** Read the actual bill. Does it adopt California's ACCII verbatim (Section 177 adoption) or does it create an independent standard? This determines legal vulnerability. Does it include any low-income assistance provisions (EV rebates, used EV incentives)?
2. **Your state's grid carbon intensity:** Find your state's average grid emissions factor (EPA eGrid data, updated annually). In a state with significant coal generation, lifecycle GHG benefits are smaller than in a state with high renewable penetration.
3. **Your state's electricity rate vs. gasoline price ratio:** The fuel cost savings calculation depends entirely on local prices. High electricity states (Hawaii, California) may see smaller fuel savings than low-electricity states.
4. **Fiscal impact on state transportation funding:** As EV share grows, state gas tax revenue declines. Has your state transportation department or fiscal office analyzed how road maintenance will be funded in a largely-EV fleet? Some states are moving to vehicle miles traveled (VMT) fees.

### Forming Your Position

- **What the evidence clearly supports:** ZEV mandates reduce tailpipe emissions to zero for covered vehicles; EVs have meaningfully lower lifetime fuel and maintenance costs for most drivers at current prices; air quality benefits in high-traffic areas are real and measurable; upfront purchase price gap is real but declining and partially offset by federal tax credits; low-income households face a transitional access challenge that policy design can address or ignore.
- **Where evidence is mixed or uncertain:** Exact timeline to
