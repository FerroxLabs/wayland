...
2. **Analyze the situation.** Review the information provided and identify key factors, challenges, and opportunities relevant to youth leadership.
...
1. How old is the young person, and what grade are they in?
2. What are their primary interests and passions?
3. Are they naturally outgoing, or more introverted (leadership comes in many forms)?
4. What leadership experiences have they had so far (formal or informal)?
5. What is their goal -- personal growth, college applications, community impact, or all three?
6. How much time per week can they commit to leadership activities?
7. Are there specific skills they want to develop (public speaking, organizing, mentoring)?
8. What opportunities exist at their school and in their community?
9. Do they prefer working with peers, younger kids, or adults?
10. Is there a cause or issue they care deeply about?

---

## Phase 1: Understanding Youth Leadership

### Leadership is Not Just Being in Charge
...
- **Leading by example:** Modeling behavior, values, and work ethic
...
- Committee chairs (events, communications, fundraising)
...
4. Design campaign materials (posters, social media, handouts)
5. Write and practice a campaign speech
6. Network -- talk to students in every group, not just your friends
...
Who I Am (15 seconds):
  Brief introduction -- name, grade, what people know you for

Why I'm Running (30 seconds):
  What I care about and why this position matters to me

My Platform (60 seconds):
  2-3 specific, actionable ideas
  For each: What I will do, How I will do it, Why it matters

Closing (15 seconds):
  Call to action, memorable final line, thank the audience
```
...
- Follow through on campaign promises (or explain honestly why something was not possible)
- Document what you accomplish for your successor
- Collaborate across committees and organizations
- Listen to student concerns and act on them

---

## Phase 3: Community Service Projects
...
Mission: _________________________________
Target Community: _________________________________
Need Being Addressed: _________________________________
...
Timeline:
  Planning Phase: _____________ to _____________
  Execution Phase: _____________ to _____________
  Wrap-Up/Reflection: _____________ to _____________
```
...
- Write thank-you notes to partners and volunteers
...
## Phase 4: Public Speaking for Teens
...
### Speech Structure for Any Occasion

```
TELL THEM WHAT YOU'RE GOING TO TELL THEM (Introduction)
  - Hook (story, question, startling fact, quote)
  - State your main point or thesis
  - Preview your key points (2-3 maximum)

TELL THEM (Body)
  - Point 1 + evidence/story/example
  - Transition
  - Point 2 + evidence/story/example
  - Transition
  - Point 3 + evidence/story/example

TELL THEM WHAT YOU TOLD THEM (Conclusion)
  - Summarize key points
  - Call to action or memorable closing line
...
- Church or community group presentations
- School announcements
- Family events (holiday toasts, event introductions)
- Recording practice speeches on video for self-review

---

## Phase 5: Resume Building for Teens
...
GPA: [if above 3.0] | Relevant Courses: [AP/Honors courses]
...
COMMUNITY SERVICE
-----------------
[Role], [Organization/Project]                [Dates]
- [What you did and what impact it had]
- [Hours contributed or measurable outcomes]
...
Interests: [Brief mention of genuine interests]
...
- Show consistency (multi-year commitment signals genuine interest)
- Include both school and community activities

---

## Phase 6: College Application Enhancement

### What Colleges Look for in Leadership

**Depth and commitment:** Sustained involvement over multiple years, not just senior year padding.

**Impact and initiative:** Did you make something happen, or just hold a title?

**Growth and reflection:** Can you articulate what you learned and how you grew?

**Authenticity:** Activities that connect to your genuine interests, not what you think colleges want.
...
- Leadership programs (Boys/Girls State, HOBY, Bank of America Student Leaders)
- Service programs (City Year, Habitat for Humanity, local nonprofits)
- Internships (local businesses, organizations related to interests)

---

## Phase 7: Teamwork Skills
...
- Knowing when to involve an adult or advisor

### Team Project Management for Teens
...
Timeline:
  Milestone 1: _________________ Due: _________
  Milestone 2: _________________ Due: _________
  Milestone 3: _________________ Due: _________
  Final Deadline: _________________________________

Communication Plan:
  Meeting frequency: _________________________________
  Communication tool: _________________________________
...
- Sports coaching for younger teams
- Camp counselor
...
- College students (near-peer mentoring)
- Alumni networks
...
- Document quantifiable achievements (funds raised, people served, growth metrics)
- Reflect quarterly on what you have learned and how you have grown
...
- [ ] Practice public speaking in any setting
...
- [ ] Develop a specific skill (public speaking, organizing, mentoring)
...
- [ ] Pursue meaningful summer experience
- [ ] Begin building your resume and activities list
...
- [ ] Apply leadership experience to college essays
- [ ] Continue service and leadership (do not stop after applications are submitted)

---

## Volunteer Leadership Resources

- **Points of Light:** Resources for youth volunteering and service
- **DoSomething.org:** Youth-led campaigns and causes
- **VolunteerMatch:** Find local volunteer opportunities
- **Key Club (Kiwanis):** High school service organization
- **National Honor Society:** Academic and service organization
- **HOBY (Hugh O'Brian Youth Leadership):** Leadership development seminars
- **Boys/Girls State:** Government leadership programs
