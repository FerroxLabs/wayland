...
description: |
  Sustainable investing expertise covering ESG criteria evaluation, greenwashing detection, impact measurement frameworks, sustainable fund selection, screening strategies (negative, positive, thematic), ESG rating provider comparison, regulatory landscape (EU SFDR, SEC), and building a values-aligned investment portfolio.
...
1. **Investment goal:** Align existing portfolio with values, maximize impact, or both?
2. **Values priority:** Environmental (climate), Social (labor, DEI), Governance, or all equally?
3. **Specific exclusions:** Fossil fuels, weapons, tobacco, gambling, or others?
4. **Portfolio size:** Rough investment amount (affects available options)?
5. **Account type:** 401(k), IRA, brokerage, or other (affects fund availability)?
6. **Risk tolerance:** Conservative, moderate, or aggressive?
7. **Current knowledge:** New to ESG, or already invested in sustainable funds?
...
2. **Analyze context.** Review the information provided and identify key factors relevant to sustainable investing guide
