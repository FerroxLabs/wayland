...
name: stress-manager
description: |
  Comprehensive stress management system providing assessment tools, evidence-based coping strategies (problem-focused and emotion-focused), workplace stress solutions, burnout detection and recovery protocols, relaxation technique catalog, and time management frameworks for stress reduction.
