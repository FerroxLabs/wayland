---
name: research-communicator
description: |
  Expert guidance for communicating research findings to non-specialist audiences through press releases, lay summaries, conference presentations, media interviews, and public engagement strategies.
  Use when the user asks about research communicator, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of research communicator or requires a different specialized skill.
license: Apache-2.0
metadata:
...
- What is your research field and specific findings to communicate?
- Who is the target audience (media, policymakers, general public, funders, peers)?
- What is the communication format (press release, lay summary, talk, interview)?
- What is the significance of the findings in plain terms?
- Are there common misconceptions about your field you need to address?
- Is there a publication or event timeline driving this communication?
- Have you done media interviews or public talks before?
- Are there sensitivities (preliminary data, dual-use concerns, patient privacy)?

## Press Releases

### Structure

A research press release follows an inverted pyramid: most important information first, supporting detail later.

```
HEADLINE
[Active voice, plain language, states the finding, under 15 words]

SUBHEADLINE (optional)
[Adds context, significance, or method]

PARAGRAPH 1: THE LEAD
[What was found, why it matters, in 2-3 sentences.
Answer: "So what?" for a non-specialist reader.]

PARAGRAPH 2: CONTEXT
[What problem does this solve? What gap does it fill?
Why was this research needed?]

PARAGRAPH 3: QUOTE FROM LEAD RESEARCHER
[Human voice explaining significance. Write this for the researcher
to approve - scientists rarely write good quotes on their own.]

PARAGRAPH 4: METHOD SUMMARY
[How was this done? Keep it high-level.
"The team analyzed 10,000 patient records" not
"We performed multivariate logistic regression."]

PARAGRAPH 5: RESULTS IN DETAIL
[Key numbers, comparisons, magnitudes.
Translate statistics into meaning.]

PARAGRAPH 6: QUOTE FROM CO-AUTHOR OR COLLABORATOR
[Different perspective, adds credibility.]

PARAGRAPH 7: LIMITATIONS AND NEXT STEPS
[What this does NOT prove. What comes next.
This is where you build trust with journalists.]

PARAGRAPH 8: BOILERPLATE
[About the institution, funding sources, journal citation.]
```

### Writing Principles

**The "grandmother test":** Could a non-scientist relative understand the first three paragraphs? If not, simplify further.
...
- Always provide both absolute and relative numbers for health statistics
...
Lay summaries translate research for non-specialist readers: patients, funders, policymakers, journalists, and the general public. Many funders and journals now require them.

### Structure Template

```
TITLE: [Plain language, 10-12 words max]

WHAT WE STUDIED (1-2 sentences):
[The question, in everyday language]

WHY IT MATTERS (2-3 sentences):
[The real-world problem this addresses]

WHAT WE DID (3-4 sentences):
[Methods, simplified. Include scale: how many subjects, how long]

WHAT WE FOUND (3-4 sentences):
[Results in plain language with context]

WHAT THIS MEANS (2-3 sentences):
[Implications for real people, next steps]

WHAT WE DON'T KNOW YET (1-2 sentences):
...
- Active voice: "We found" not "It was found that"
- Define any technical term on first use, then use the plain version
...
- Animate data appearing step by step as you explain
...
- Supporting visual in center
- Source/citation in small text at bottom

### Delivery Tips

**Opening:** Do not start with "So, um, today I'll be talking about..." Start with a question, a surprising fact, or a patient story (if appropriate).
...
- Prepare for the three hardest questions someone could ask about your work
...
- Engage passersby: "Would you like a quick overview?"
...
- "We don't know yet whether..." (honest limitations)
...
- "Off the record" (nothing is truly off the record)
- Speculating beyond your data
- Criticizing other researchers by name

### After the Interview

- Ask when the piece will publish
- Offer to fact-check quotes before publication (journalists may or may not agree)
- If misquoted, contact the journalist directly and politely request a correction
- Share accurate coverage through your institution and social media
- If coverage is sensationalized, work with your press office to request corrections
...
```
Paragraph 1: The hook - a timely event or striking statement
Paragraph 2: The problem or question
Paragraph 3: What your research reveals about it
Paragraph 4: Why the current approach or policy is insufficient
Paragraph 5: What should be done differently
Paragraph 6: The closing - return to the opening with resolution
```

Target: 700-800 words. Pitch to specific editors with a one-paragraph email explaining timeliness and your credentials.
...
Before sending any research communication:

- [ ] Is the main finding stated in the first paragraph?
- [ ] Would a non-specialist understand this without a dictionary?
- [ ] Are all claims supported by the actual data (not overclaimed)?
- [ ] Are limitations stated clearly and prominently?
- [ ] Is there a "so what?" explaining real-world relevance?
- [ ] Are numbers translated into meaningful comparisons?
- [ ] Is the reading level appropriate for the audience?
- [ ] Has a non-specialist read it and confirmed comprehension?
...
2. **Analyze context.** Review the information provided and identify key factors relevant to research communicator
...
```template
## Research Communicator Analysis
...
**Input:** "Help me with research communicator for my current situation"

**Output:**

Based on your situation, here is a structured approach to research communicator:
