...
2. **Analyze the situation.** Review the information provided and identify key factors, challenges, and opportunities relevant to negotiation master.
...
1. **What are you negotiating?** (Salary, real estate, business deal, contract, dispute resolution, vendor pricing, partnership terms)
2. **Who is the other party?** (Individual, company, multiple parties, repeat relationship vs. one-time)
3. **What is your ideal outcome?** (Specific numbers, terms, conditions)
4. **What is your walk-away point?** (The minimum you would accept)
5. **What is your timeline?** (Urgency level, deadlines affecting either side)
6. **What is the relationship dynamic?** (Power balance, ongoing relationship importance, history)
7. **What do you know about the other side's interests?** (Their motivations, constraints, pressures)
8. **Have negotiations already started?** (What has been said, offered, or implied so far)
