 ...
 *
 * Empty since the Fuigo cutover retired the Wayland Core settings page. The
 * gate removes attack surface and a broken destination; it is NOT the
 * security boundary. That is enforced server-side in
 ...
 */
export const DESKTOP_ONLY_SETTINGS_IDS: readonly SettingsNavigationId[] = Object.freeze([]);
