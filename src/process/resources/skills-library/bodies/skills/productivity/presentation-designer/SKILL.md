...
1. **What is the purpose of this presentation?** (Inform, persuade, teach, inspire, update, propose, sell?)
2. **Who is the audience?** (Executives, peers, customers, students, investors, general public?)
3. **What does the audience already know about this topic?** (Expert, familiar, beginner, hostile?)
4. **What action do you want from the audience afterward?** (Approve, buy, learn, change behavior, fund?)
5. **How much time do you have?** (5 minutes, 20 minutes, 45 minutes, keynote?)
6. **What is the format?** (Conference, meeting, workshop, pitch, classroom, webinar?)
7. **What tools will you use?** (PowerPoint, Keynote, Google Slides, no slides, whiteboard?)
8. **What is your confidence level?** (Experienced speaker, nervous, comfortable with content but not delivery?)
...
2. **Analyze context.** Review the information provided and identify key factors relevant to presentation designer
