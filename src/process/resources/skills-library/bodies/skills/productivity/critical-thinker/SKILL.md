...
2. **Analyze the situation.** Review the information provided and identify key factors, challenges, and opportunities relevant to critical thinker.
...
1. **What claim is being made?** (State it precisely and completely)
2. **Who is making the claim?** (What are their credentials, incentives, and potential biases)
3. **What evidence is presented?** (Data, anecdotes, expert opinion, logic)
4. **What is the context?** (Media article, research paper, political speech, advertisement, conversation)
5. **What decision depends on this analysis?** (What are you trying to decide)
6. **What is the cost of being wrong?** (Stakes determine how rigorous you need to be)
7. **What do you already believe about this topic?** (Your own biases to watch for)
