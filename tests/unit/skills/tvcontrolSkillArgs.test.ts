...
describe('bundled TVControl skill examples are callable against the pinned connector', () => {
  it('the fixture was generated from the version the catalog pins', () => {
    ...
    // layout_save; 113 from 2.5.0 adds pine_get_script_source. Bump this deliberately when the connector gains tools - never to make
    // a red run go green, because a DROP in the count is a published package that lost a
    // tool the skills still call.
    expect(fixture._header.toolCount).toBe(113);
  });
