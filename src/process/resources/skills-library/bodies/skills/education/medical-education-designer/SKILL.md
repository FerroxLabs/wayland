...
description: |
  Design clinical simulations, case-based learning experiences, competency assessments, and progress tracking for medical and health professions education.
...
- [ ] Scenarios are mapped to specific learning objectives and competencies
- [ ] Facilitators are trained in simulation pedagogy and debriefing
- [ ] Pre-briefing establishes a safe learning environment
- [ ] Debriefing follows a structured framework
- [ ] Learner feedback is collected and used for improvement
- [ ] Scenarios are pilot-tested before full deployment
- [ ] Equipment is maintained and tested before each session
...
1. **Identify the learning objective**: What should learners be able to do after working through this case?
2. **Select the clinical scenario**: Choose a case that naturally requires the target skills or knowledge
3. **Write the patient narrative**: Create a realistic, detailed patient story
4. **Develop progressive disclosure**: Reveal information in stages that mirror clinical reasoning
5. **Create discussion questions**: Design questions that probe understanding at each stage
6. **Prepare facilitator guide**: Include key teaching points, common misconceptions, and evidence references
7. **Peer review**: Have a subject matter expert and an educator review the case
8. **Pilot test**: Run the case with a small group and refine based on feedback
...
- [ ] Assessment aligns with stated learning objectives
- [ ] Assessment criteria are shared with learners in advance
- [ ] Multiple assessment methods are used across the program (no single method dominates)
- [ ] Assessors are trained and calibrated
- [ ] Both formative and summative assessments are included
- [ ] Assessment data is tracked longitudinally
- [ ] Learners receive timely, specific, actionable feedback
- [ ] Assessment results inform curricular improvements
...
1. **Collect data**: Learner evaluations, assessment results, outcome data
2. **Analyze patterns**: What is working? What is not? Where are the gaps?
3. **Identify priorities**: Focus on the changes with the greatest impact
4. **Implement changes**: Revise curriculum, methods, or assessments
...
2. **Analyze context.** Review the information provided and identify key factors relevant to medical education designer
