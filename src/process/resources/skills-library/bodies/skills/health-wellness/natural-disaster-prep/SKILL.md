---
name: natural-disaster-prep
description: |
  Disaster-specific preparation guide covering earthquakes, hurricanes, tornadoes, floods, wildfires, and winter storms with preparation checklists for each type, evacuation route planning, family communication plans, insurance review considerations, post-disaster recovery procedures, and community resilience building.
  Use when the user asks about natural disaster prep, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of natural disaster prep or requires a different specialized skill.
license: Apache-2.0
metadata:
...
1. What natural disasters are most likely in your geographic area?
2. Do you live in a designated flood zone, wildfire interface, earthquake zone, or hurricane/tornado corridor?
3. How many people are in your household (including pets and anyone with special needs)?
4. Do you have current emergency supplies (72-hour kit, water, food)?
5. Does your family have a communication and meeting plan?
6. When was the last time you reviewed your insurance coverage?
7. Do you know your evacuation routes and local shelter locations?
8. Is your home structurally prepared for your area's most likely disasters?
9. Do you have important documents backed up and accessible?
10. How would you receive emergency alerts (phone, radio, siren)?

---

## Disaster Type 1: Earthquake Preparedness
...
- [ ] Ensure home is bolted to its foundation (older homes may not be)
...
- Flashlight near each bed
- Whistle near each bed (for signaling if trapped)
- Fire extinguisher
...
## Disaster Type 2: Hurricane Preparedness
...
- [ ] Review and photograph home contents for insurance
...
- [ ] Extra water (flooding can contaminate water supply)
- [ ] Plastic sheeting and tarps (for temporary roof repairs)
...
- Do not go outside during the eye of the storm (the second half is coming)
...
- Be cautious of carbon monoxide from generators (outdoor use only)
...
- [ ] Have helmets or heavy blankets for head protection
- [ ] NOAA weather radio with battery backup and auto-alert
...
- If caught outside, lie flat in a ditch or low area, cover your head
- Do NOT seek shelter under highway overpasses
- Do NOT try to outrun a tornado in a car (if you can see it, seek shelter)
...
- [ ] Install check valves in plumbing (prevents backup)
- [ ] Clear gutters and drains regularly
- [ ] Have sandbags available or know where to get them
- [ ] Know your property's elevation relative to nearby water sources
- [ ] Waterproof your basement (sump pump with battery backup)

### Flash Flood Safety

**The leading cause of weather-related death in the US is drowning in flash floods.**

- NEVER drive through flooded roads ("Turn Around, Don't Drown")
- 6 inches of water can knock you off your feet
- 12 inches of water can carry away a small car
- 24 inches of water can carry away most vehicles
...
- Assume floodwater is contaminated (sewage, chemicals, debris)
- Discard food that contacted floodwater
- Disinfect everything that was submerged
- Watch for mold (begins growing within 24-48 hours)
- Have electrical system inspected before restoring power

---

## Disaster Type 5: Wildfire Preparedness
...
- Remove tree branches within 6 feet of the ground
...
- Long-sleeved cotton clothing (not synthetic -- melts)
...
- Turn on exterior lights (makes house visible in smoke)
- Leave a ladder against the house for firefighter roof access
...
- [ ] Have backup heating source (fireplace, space heater -- with safety features and ventilation)
- [ ] Insulate windows and doors (weatherstripping, plastic film)
- [ ] Stock winter driving supplies in vehicles
- [ ] Have rock salt or sand for walkways
...
- [ ] Extra water (pipes may freeze)
- [ ] Camp stove with fuel (for outdoor use or well-ventilated area only)
...
4. Shut off utilities if damage is suspected
5. Document all damage with photos and video
6. Contact insurance company
7. Register with FEMA for disaster assistance (if a federal disaster is declared)
...
- [ ] Consider earthquake insurance if in a seismic area (not covered by standard policies)
- [ ] Create a home inventory with photos/video of all rooms and contents
- [ ] Store insurance documents in the cloud and in your go-bag
- [ ] Know your deductibles (especially wind/hurricane deductibles, which can be percentage-based)
- [ ] Review annually and update after major purchases or renovations
...
- Share resources and skills (someone may have a generator, another a chainsaw, another medical training)
- Establish a neighborhood communication plan
- Identify community meeting points and resources
...
- Share accurate information (do not spread rumors)
- Support local businesses during recovery
...
2. **Analyze context.** Review the information provided and identify key factors relevant to natural disaster prep
...
```template
## Natural Disaster Prep Analysis
...
**Input:** "Help me with natural disaster prep for my current situation"

**Output:**

Based on your situation, here is a structured approach to natural disaster prep:
