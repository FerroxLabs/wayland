...
description: |
  Helps families prepare for the school year with supply planning, routine building, extracurricular management, and transition strategies for smooth academic starts.
  Use when the user asks about back to school organizer, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of back to school organizer or requires a different specialized skill.
license: Apache-2.0
metadata:
...
Before creating your back-to-school plan, clarify:

- How many children are going back to school, and what are their grade levels?
- Is anyone starting at a new school or transitioning (elementary to middle, middle to high)?
- What is your total back-to-school budget for all children?
- Do any children have special needs, IEPs, or accommodations?
- What extracurricular activities are planned or being considered?
- What were the biggest challenges during last school year?
- What is the family's morning schedule like (parent work schedules, transportation)?
- Does anyone experience anxiety about returning to school?
- Are there before/after-school care needs?
- When does school start, and how much preparation time do you have?
...
- [ ] Apply for free/reduced lunch programs if eligible
- [ ] Register for before/after-school care
- [ ] Set up parent portal and communication accounts
- [ ] Review school handbook and policies
...
- [ ] Research extracurricular options and registration deadlines
- [ ] Begin adjusting bedtime and wake-up schedules gradually
...
- [ ] Order school-specific items (uniforms, PE clothes)
- [ ] Buy lunch supplies (containers, water bottles, lunch box)
...
- [ ] Organize closets and drawers for easy morning access
- [ ] Plan carpool arrangements and transportation logistics
...
- [ ] Set up after-school routine (snack, homework, activities, free time)
...
- [ ] Read age-appropriate books about school transitions
- [ ] Establish a "first day" family tradition
...
- [ ] Tissues, hand sanitizer, wipes (classroom supplies)
...
- [ ] Planner or assignment notebook
...
- [ ] Laptop or tablet (if school requires)
- [ ] Charging cables and portable charger
- [ ] Flash drive
- [ ] Note cards for studying
- [ ] Subject-specific supplies (art, lab notebooks, etc.)
...
- Purchase in bulk for frequently used items (glue sticks, pencils)
- Watch for tax-free weekends in your state
- Check for school supply drives or community giveaways
- Ask teachers which items are truly essential vs. optional
...
- Buy shoes slightly larger with growing room
- Check consignment shops and thrift stores first
- Organize clothing swaps with other families
- Wait for mid-September sales for non-urgent items
- Buy winter coats and boots in spring clearance
...
- [ ] Check for permission slips, homework, or special items
...
- [ ] How does it fit with the family schedule?
- [ ] Is transportation manageable?
- [ ] Does it allow enough downtime and free play?
...
- No unstructured free time during the week
- Family meals together are rare
...
- Practice conversation starters for meeting new people
...
- Set up regular check-in conversations (not interrogations)
- Be patient - adjustment takes 4-6 weeks typically
...
- Technology available when needed but put away otherwise
- Visible clock or timer for time management
...
4. Teach time management with timers and planners
5. Contact the teacher when persistent struggles arise
6. Know the difference between helping and doing it for them
...
- Request for specific guidance or meeting
...
- [ ] Meal planning space
- [ ] Paper management system (sign and return, keep, recycle)
- [ ] Key hooks and backpack storage
...
2. **Analyze context.** Review the information provided and identify key factors relevant to back to school organizer
...
```template
## Back To School Organizer Analysis
...
**Input:** "Help me with back to school organizer for my current situation"

**Output:**

Based on your situation, here is a structured approach to back to school organizer:
