...
description: |
  Age-appropriate screen time limits, digital wellness frameworks, content curation, family media plans, and engaging alternative activities for balanced technology use.
  Use when the user asks about screen time negotiator, or needs help with age-appropriate screen time limits, digital wellness frameworks, content curation, family media plans, and engaging alternative activities for balanced technology use.
  Do NOT use when the request requires professional specialized advice or falls outside the scope of screen time negotiator.
license: Apache-2.0
metadata:
...
- Children are motivated negotiators when it comes to screens
- Parents themselves struggle with their own screen habits
...
- **Co-viewing changes outcomes**: Watching together and discussing is better than solitary consumption
- **Age sensitivity**: Children under 2 have the strongest evidence for limiting screens; teen research is more nuanced
...
- **Negotiate together**: Teens who co-create the rules follow them more consistently

## The Family Media Plan

### Creating Your Plan (Do This Together)

```
FAMILY MEDIA AGREEMENT

Date created: ___________
Family members: ___________

SCREEN-FREE ZONES (places where no screens are used):
- [ ] Bedrooms at night
...
DAILY LIMITS BY FAMILY MEMBER:

Name: ____________  Age: ____
  School day limit: ____ hours recreational
  Weekend limit: ____ hours recreational
  Allowed apps/platforms: ________________
  Restricted apps/platforms: ______________

PARENTS COMMIT TO:
- [ ] Following the same screen-free zones and times
- [ ] Modeling healthy screen habits
- [ ] Reviewing this plan every _____ months

EARNING EXTRA TIME:
  Screen time can be earned by: _____________

CONSEQUENCES FOR BREAKING AGREEMENT:
  First time: ___________________________
...
- Use technology to enforce technology: Screen Time (iOS), Family Link (Android)
- Be consistent: Inconsistent enforcement teaches children to push boundaries

## Content Curation Strategies

### By Age

**Ages 2-5**: Curate a specific library of approved shows/apps. No free browsing.
**Ages 6-9**: Approved list with some choice. Parent reviews new content before access.
**Ages 10-12**: Discuss content expectations. Spot-check occasionally.
**Ages 13+**: Teach critical media literacy. Discuss concerning content openly.
...
- [ ] Understanding of permanence (everything online can be saved/shared)
- [ ] Emotional resilience to handle comparison and negative interactions
- [ ] Willingness to follow family social media agreements
...
- Sleep quality and quantity remain good
...
- Mood changes tied to social media use
...
6. **Seek help if needed**: Pediatrician or therapist for persistent issues

## Alternative Activities

### The Boredom List

Create a list TOGETHER of non-screen activities:

**Active**: Bike ride, sports practice, dance party, obstacle course, swimming, playground
**Creative**: Drawing, LEGO building, writing stories, making music, cooking, photography
**Social**: Board games, phone calls, letter writing, neighborhood play, playdates
**Quiet**: Reading, puzzles, journaling, audiobooks, origami, crafts
**Exploratory**: Nature walks, science experiments, gardening, bird watching, fort building

### The "Before Screens" Checklist

```
BEFORE SCREENS, HAVE YOU:

[ ] Completed homework?
[ ] Done your chores?
[ ] Spent time outside today?
[ ] Read for at least 20 minutes?
[ ] Played or talked with a family member?

If all boxes are checked, enjoy your screen time!
```
...
- **Connect privilege to responsibility**: More freedom when they demonstrate readiness
- **Follow through consistently**: Every exception undermines the agreement

## Parent Self-Assessment

Before setting children's limits, honestly assess your own habits:

```
PARENT SCREEN AUDIT (track for 1 week)

Average daily phone screen time: _____ hours
Do I use my phone during family meals? [ ] Yes [ ] No
Do I check my phone first thing in the morning? [ ] Yes [ ] No
Do I scroll while my child is talking to me? [ ] Sometimes
Am I present during family time or half-watching a screen? _____
Would I be comfortable if my child had my exact habits? _____
```

Children imitate what they see, not what they are told. The most powerful thing you can do for your child's screen habits is to model the behavior you want to see.
...
- [ ] Bedtime screen lock enabled
- [ ] Safe search enabled on browsers
...
**Input:** "Help me get started with screen time negotiator"

**Output:** A structured screen time negotiator plan tailored to the user's specific situation, following the process outlined above.
