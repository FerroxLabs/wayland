...
name: date-planning
description: |
  Creates occasion-based date plans with activity categories, surprise elements, budget tiers, and logistics frameworks. Produces complete date itineraries with timing, reservations, backup plans, and personal touches.
  Use when the user asks about planning a date, date ideas, anniversary celebration, or romantic outing.
...
- A user is stuck in a relationship routine and wants to break predictability and restore novelty
- A user is planning a long-distance reunion date (limited time together, higher emotional stakes)
- A user needs a complete itinerary with timing, reservations, backup plans, conversation depth, and personal touches
...
- User wants to impress someone through manipulation, jealousy tactics, or artificial scarcity -- this is outside the scope of genuine connection planning
- User is planning a family vacation or multi-day travel itinerary -- use travel planning skills
- User wants to plan a date for a minor -- flag appropriateness and redirect
...
Do not generate a date plan without collecting the inputs below. A generic date plan is nearly useless. Personalization is the entire value.

Ask the user directly if they have not provided:

- **Occasion type:** First date, regular date night, anniversary (which year matters -- 1st vs. 10th carry different emotional weight), birthday, reconnection after conflict or distance, long-distance reunion, or spontaneous outing
- **Partner's interests and personality:** Specific hobbies, food preferences, sensory preferences (loud/crowded vs. quiet/intimate), physical activity comfort level, any known dislikes or anxiety triggers (large crowds, heights, unfamiliar cuisines)
- **Relationship stage:** New (under 6 months), established (6 months to 3 years), long-term (3+ years). This determines appropriate intimacy level, surprise complexity, and conversational depth
- **Budget:** Confirm a specific number or range. "Affordable" means $20 to one person and $200 to another. Get a number. Budget buckets: Tier 1 ($0-$30), Tier 2 ($30-$100), Tier 3 ($100-$250), Tier 4 ($250+)
- **Logistics constraints:** Kids/childcare, transportation (car, public transit, rideshare), time window available, geographic area or specific city/neighborhood, day of week vs. weekend (affects venue availability and crowds), time of year and weather
- **Desired tone:** Adventurous, romantic, playful, low-key, intellectually stimulating, sentimental -- these affect every activity and venue choice
- **Any must-include elements:** A specific location meaningful to their relationship, a particular activity requested, a surprise element, a gift component

If the user says "I don't know what she/he likes" or "they're hard to plan for" -- do not accept this at face value. Use the probing framework in Edge Cases below.

---

### Step 2: Select the Date Architecture
...
- Pressure level: Zero. No elaborate surprises, no long commitments, no activities requiring sustained performance (escape rooms, multi-course dinners)
...
- Key element: The first hour should create safety and ease, not performance pressure

---

### Step 3: Match Activity Category to Context
...
- Budget: $30-$120 per couple depending on class type
...
- Budget: Free to $60 (gear rental for kayak/bike)
...
- Request strategy: Ask for a corner or booth table when reserving; these feel more intimate than central floor tables
...
- Budget: Free (many museums have free hours) to $80 (concert tickets)
...
- Avoid: Defaulting to streaming-and-falling-asleep without any intentional element

---

### Step 4: Budget the Date Accurately
...
### Step 5: Engineer the Personal Touches

Personal touches are what separate a memorable date from a pleasant outing. They require the user to provide specific information about their partner. Extract this information actively.

**The Memory Callback:** Reference something from the couple's shared history. On a first anniversary, recreate the first meal. On a 10th anniversary, bring a physical artifact (a printed photo from their first trip, the restaurant receipt from their first date if they have it). Mention a specific thing the partner said at some point that showed you were listening.

**The Micro-Surprise:** A small unexpected element that fits the date theme. This is not a grand gesture -- it is a playlist in the car with their favorite songs, a handwritten note in their jacket pocket discovered mid-date, a single flower from a street vendor picked up en route, a dessert from the bakery they always talk about appearing at the end of the night. Scale: $0-$15. Impact: Disproportionately high.
...
- Memory-activating: "What's a random moment from [year or trip or experience] that you think about more than you'd expect?"

---

### Step 6: Build the Logistics and Backup Architecture
...
- Timing buffer -- build 15-minute buffers between activities; running late to dinner after a hike is the most common date-ruiner
...
### Step 7: Sequence and Close the Date Intentionally

The close of the date is the part most planners neglect and the part most remembered. Memory peak-end rule: people remember experiences most strongly by their peak moment and their final moment. Engineer both.
...
- For anniversaries or special occasions: a forward-looking moment ("Where do we want to be in another year?")

---

### Step 8: Deliver the Plan

Produce the output following the format below. Include all sections. Tailor every field to the specific inputs provided -- no generic placeholders.
...
```
## Date Plan: [Occasion -- be specific, e.g., "3rd Anniversary" or "First Date"]

### Overview
- **Occasion:** [Specific description]
- **Relationship Stage:** [New / Established / Long-term]
- **Date & Time:** [Day, approximate start time]
- **Duration:** [Hours, e.g., 3.5 hours (4:00 PM - 7:30 PM)]
- **Budget:** [Total amount with breakdown, e.g., $130 total: activity $40, dinner $70, extras $20]
- **Tone / Vibe:** [2-3 descriptors, e.g., Adventurous, Warm, Low-key]
- **Architecture Type:** [First Date / Date Night / Special Occasion / Rekindling / Reunion]
...
|------|----------|--------------|----------|-------|
| [Time] | [Activity name] | [Location type, e.g., "scenic trail" or "Italian restaurant"] | [Duration] | [Specific logistics or preparation tip] |
| [Time] | [Transition or travel] | [En route] | [Duration] | [What to do during this time -- playlist, conversation, etc.] |
| [Time] | [Next activity] | [Location type] | [Duration] | [Notes] |
| [Time] | [Close ritual] | [Location type] | [Duration] | [How to end the evening intentionally] |
...
**Memory Callback:**
[A specific detail tied to shared history or something meaningful the partner has said or done]

**Micro-Surprise:**
[A small, affordable, specific surprise element -- what it is, when to deploy it, how much it costs]

**Framing Statement:**
[A 1-2 sentence script the user can actually say at the start of the date to set the tone]
...
|-------------|----------|--------------------|
| Light / Fun | "[Specific fun question]" | Opening, during activity |
| Medium / Reflective | "[Specific reflective question]" | During dinner or walk |
| Deep / Connective | "[Specific connective question]" | Quiet moment, during close |
| Memory-Activating | "[Specific question about their shared history]" | Mid-date, when mood is warm |
...
|------|---------------|-------|
| [Activity] | $[amount] | [Booking notes] |
| [Meal / Food] | $[amount] | [Reservation or prep notes] |
| [Personal touch / extras] | $[amount] | [What and where to get it] |
| [Childcare if applicable] | $[amount] | [Sitter hours × rate] |
| [Transportation] | $[amount] | [Parking, rideshare, fuel estimate] |
| **Total** | **$[amount]** | |
...
- [ ] [Activity reservation -- what to book, when, what to request specifically]
- [ ] [Restaurant reservation -- when to call, what to request (e.g., corner booth)]

**Preparation (do before the day):**
- [ ] [Playlist creation]
- [ ] [Written note or card]
- [ ] [Confirm sitter and write instructions]
- [ ] [Check weather forecast 48-72 hours before]
- [ ] [Gather or purchase micro-surprise item]

**Day-of Timing:**
- [ ] [What to prepare or arrange the morning of the date]
- [ ] [What to communicate to partner about dress code or departure time]
- [ ] [Buffer built into schedule -- at least 15 minutes between activities]

---

### Backup Plans

**Weather backup (if outdoor element):**
- If [weather condition]: [Specific indoor alternative with brief description]

**Reservation / logistics backup:**
- If restaurant is full or has a long wait: [Specific alternative type + order takeout fallback]
- If activity is unavailable: [Specific alternative activity type]

**Childcare backup:**
- If sitter cancels: [Compressed at-home version of the date with specific elements]

---

### Close Ritual

[A 2-3 sentence description of how to intentionally end the date -- a specific micro-action, something to say, a brief shared moment that provides a memorable close]
```
...
1. **Never generate a plan without knowing the budget.** "Affordable" is meaningless. If the user has not given a number, ask before outputting. A $25 plan and a $200 plan are structurally different documents.

2. **First dates must be short, public, and single-venue.** 60-90 minutes maximum. One location or two locations within walking distance. No dinner on a first date unless the user explicitly requests it and has context for why (e.g., they have known the person for years in a different capacity). A multi-hour elaborate first date creates pressure that kills authentic connection.

3. **Personal touches must be grounded in specific user-provided information.** If the user has not told you anything specific about their partner, ask one targeted question before building the plan: "What's something your partner has mentioned wanting to try, or something specific they love?" Generic romantic gestures (rose petals, generic love letter) are placeholders, not touches.

4. **Every date plan must include a backup plan for every variable element.** Outdoor activity with no weather backup is an incomplete plan. Restaurant with no alternative is an incomplete plan. Sitter-dependent plan with no cancellation fallback is an incomplete plan.

5. **Childcare logistics are not optional context.** If a user mentions kids, the childcare logistics (timing, cost, sitter confirmation, written instructions for the sitter) must appear in the checklist and budget breakdown. A date plan that ignores childcare realities is unusable.

6. **Do not recommend specific businesses, restaurants, or venues by name.** Recommend venue types (a mid-range Italian restaurant with a quiet table, a local pottery studio, an independent bookstore) and let the user identify local options. This keeps the plan universally applicable and avoids outdated or geographically irrelevant recommendations.

7. **Timing buffers are mandatory.** Every itinerary must build in at least 15 minutes of buffer between activities. Running late to a reservation ruins the psychological experience of a date more than almost anything else. If the user's plan is too dense, say so and recommend consolidating to fewer activities.

8. **The conversation guide is not optional.** Every date plan must include at least three conversation prompts at different depth levels. The activity is the container -- the conversation is the actual content of the date. A date with great logistics and no conversational depth is a pleasant outing, not a genuine connection experience.

9. **For surprise dates, the partner must know enough to be logistically prepared.** Dress code, departure time, and approximate duration are not spoilers -- they are basic respect for the partner's ability to prepare. Never design a surprise date that leaves the partner underdressed, without necessary items, or unable to make their own arrangements.

10. **The close of the date must be intentional and named.** Do not leave the date ending to chance or fatigue. Every plan must specify a close ritual -- a brief action, phrase, or moment that bookends the evening with intentionality. This is the part most likely to generate the lasting memory.

11. **Scale the complexity to the relationship stage.** A 6-month couple doing a 5-phase elaborate anniversary-style date may feel performative and uncomfortable. A 10-year couple doing a 90-minute casual coffee date for their anniversary may feel like an afterthought. Match ambition level to relationship history.

12. **Budget integrity must hold across the entire plan.** If the user's budget is $80 and the itinerary adds up to $160, the plan is broken. Do the math explicitly in the budget breakdown table. If the user's constraints cannot produce the kind of date they want, say so directly and offer a restructured alternative within their budget.
...
**Input:** "Our 7th anniversary is coming up. I want it to feel really special because last year was rough -- my wife had a health scare that we're past now. She loves art, good food, and she's been saying she wants to try a ceramics class for over a year but we never got around to it. Budget around $200. We have two kids (5 and 8) and our usual sitter. I want part of it to be a surprise."
...
- **Duration:** 6.5 hours
- **Budget:** $200 total: ceramics class ~$70, dinner ~$95, extras ~$25, sitter baked into existing arrangement (~$60-80 additional if needed for extended hours)
- **Tone / Vibe:** Warm, creatively engaging, emotionally resonant -- celebrates survival and not just time elapsed
- **Architecture Type:** Special Occasion / Long-term Reconnection
...
**Memory Callback:**
She has mentioned the ceramics class for over a year -- this is not a generic activity choice, it is evidence of listening. At the studio door, say: "You've been saying you wanted to try this for a year. I finally made it happen." That sentence alone is the gift.

**The Acknowledgment Gesture:**
At dinner, give her a handwritten card. The card does not just say "happy anniversary." It names the year: "This year was hard and I watched you handle it with more strength than I told you I noticed. I'm proud of us. I'm glad we're still standing." Specifically naming what she went through, without dramatizing it, is far more powerful than a generic anniversary card. Keep it to 3-4 sentences.

**Micro-Surprise:**
At the ceramics studio, if they keep the pieces to be fired and picked up later, offer this framing: "We'll pick them up together and keep them." The object becomes a durable artifact of this day. If the studio does not hold them, bring one of the pieces home as-is.

**Framing Statement (say this in the car on the way to the studio):**
"I wanted today to feel like us. You've been wanting to do this for over a year and I wanted to make sure it actually happened. No phones today -- just this."
...
**Weather backup:**
The ceramics class is indoors, so weather does not affect the primary activity. The post-class walk and post-dinner walk are the only outdoor segments. If it is raining or cold: skip the post-class walk and go directly to the restaurant area; browse a nearby gallery, bookstore, or coffee shop instead of an outdoor walk. The post-dinner walk can become a slow, sheltered stroll with coffee to go.

**Class backup:**
If the ceramics studio is sold out or unavailable when you try to book: substitute with a painting/canvas class (widely available at local art studios, usually $35-55/person), a glass-blowing experience (if available locally), or a private food experience (a pasta-making class or a cooking class for two). The principle is a shared skill-based activity she has not done before -- not ceramics specifically.

**Restaurant backup:**
If your primary restaurant cannot accommodate the reservation: identify a second mid-range restaurant in the same neighborhood. If both are unavailable on short notice: order high-quality takeout from a restaurant she loves, pick it up before coming home, and set up the kitchen table with candles and the card. The intimacy of that setting can match or exceed a restaurant.

**Sitter cancellation:**
If the sitter cancels day-of: After kids are asleep (by 8:00-8:30 PM), set up the kitchen table -- the anniversary card, candles, a bottle of wine, and takeout from an Italian restaurant or a place she loves. Put on a soft playlist. The ceramics class gets rebooked for the following weekend as an explicit "we're doing this" plan -- do not let it quietly disappear. The at-home version still gets the card, the conversation prompts, and the acknowledgment of the year.

---

### Close Ritual

During the post-dinner walk or on the drive home, ask her: "What was your favorite part of today?" Let her answer first. Then tell her yours. End with something direct: "I'm really glad we had today." The simplicity of that sentence -- specific and present tense -- closes the evening without performance. It does not need to be more than that.
