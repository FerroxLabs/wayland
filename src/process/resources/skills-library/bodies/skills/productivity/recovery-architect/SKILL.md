...
description: |
  Synthesizes Active Recovery, Mobility work, Myofascial Release, Contrast Therapy, and Deload protocols into The Recovery Blueprint - a comprehensive framework for optimizing recovery between training sessions and preventing overtraining.
...
1. **What is your training routine?** (Frequency, intensity, types of exercise, current program?)
2. **What is your primary recovery concern?** (Soreness, fatigue, stiffness, injury prevention, performance plateau, sleep quality?)
3. **How do you currently recover?** (Nothing? Stretching? Foam rolling? Ice baths? Rest days?)
4. **How many rest days do you take per week?** (Be honest.)
5. **How is your sleep?** (Hours, quality, consistency - sleep is the number one recovery tool.)
6. **How is your nutrition?** (Adequate protein? Hydration? Post-workout nutrition?)
7. **Do you have any injuries or chronic pain?** (Current or recurring issues?)
8. **What is your training experience level?** (Beginner, intermediate, advanced, competitive athlete?)
...
2. **Analyze context.** Review the information provided and identify key factors relevant to recovery architect
