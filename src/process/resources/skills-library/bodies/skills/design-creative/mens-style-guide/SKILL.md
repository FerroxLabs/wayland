---
name: mens-style-guide
description: |
  Comprehensive men's style guidance including fit principles, wardrobe essentials, grooming basics, style evolution, and building a functional personal aesthetic.
  Use when the user asks about mens style guide, or needs help with comprehensive men's style guidance including fit principles, wardrobe essentials, grooming basics, style evolution, and building a functional personal aesthetic.
  Do NOT use when the request requires professional specialized advice or falls outside the scope of mens style guide.
license: Apache-2.0
metadata:
...
- A user is transitioning between life stages (college to career, casual to professional environment, post-weight-change wardrobe reset) and needs a structured style evolution plan
- A user wants to develop a coherent personal aesthetic rather than wearing random disconnected pieces
- A user needs grooming guidance integrated with their overall appearance goals
- A user is on a specific budget and needs to know exactly where to spend and where to save
...
- The user needs uniform compliance guidance for military, medical, or law enforcement dress codes -- those have regulatory requirements beyond personal style
- The user is asking about costume design, theatrical costuming, or cosplay -- use a costume design skill
- The user wants only laundry and garment care instructions -- use a dedicated fabric care skill
- The user is asking about athletic performance apparel for sport-specific needs -- use a performance apparel skill

---

## Process

### Step 1: Gather the User's Style Profile

Before giving any recommendations, collect four critical dimensions of context. Guessing any of these leads to useless or harmful advice.

- **Lifestyle breakdown**: Ask what percentage of their week falls into each context -- office/professional, casual social, formal events, active/outdoor, date/evening. A man who wears a suit five days a week needs an entirely different wardrobe than a remote-working freelancer.
- **Body type self-assessment**: Ask height, approximate weight, and which fit problem they encounter most often -- shoulders too wide, torso too long, thighs too large for slim cuts, etc. Use this to tailor every fit recommendation.
- **Current wardrobe state**: Is it empty, chaotic but large, functional but boring, or specific-occasion-heavy? The starting state determines whether to audit first or build immediately.
- **Budget reality**: Establish a total wardrobe investment budget and a per-piece comfort threshold. Numbers matter: a $500 total budget calls for a completely different strategy than a $500 per-piece budget.
- **Style reference**: Ask them to name 2-3 public figures, characters, or general aesthetics they admire (rugged workwear, clean minimalism, preppy, streetwear-informed smart casual, Mediterranean relaxed). This anchors personality direction immediately.

### Step 2: Diagnose Current Fit Problems

Fit is the single highest-leverage variable in men's appearance. Address it before anything else.

- **Shoulder seam position**: The seam must sit exactly at the bony acromion process -- the edge of the shoulder. If it droops past that point, the shirt is too large; if it pulls the sleeve upward creating a divot, it is too small. This is the one measurement that cannot be corrected by a tailor at reasonable cost.
- **Chest and torso**: In a dress shirt, you should be able to pinch 1.5 to 2 inches of fabric at the side seam. More than 3 inches means the garment is drowning the wearer. Less than 1 inch means it is too tight and will pull at the buttons, creating horizontal stress lines. In casual shirts, slightly more ease is acceptable.
- **Trouser seat and thigh**: These are the two most commonly wrong measurements in off-the-rack trousers. The seat should be smooth with no pulling across the backside and no sagging excess fabric. The thigh should allow a hand to slide in with light resistance -- not vacuum-sealed, not ballooning.
- **Jacket sleeve length**: With arms hanging naturally, the shirt cuff should show 0.25 to 0.5 inches below the jacket sleeve. This is a mark of intentionality that most men ignore.
- **Trouser break**: The break -- the fold of fabric where the trouser meets the shoe -- comes in no break (hem grazes the shoe top, contemporary and clean), slight break (one small horizontal fold, the most versatile), and full break (deep fold, traditional and now dated for most contexts). Recommend slight or no break for most men under 45 unless they specifically prefer traditional.
- **Alteration cost expectations**: Set realistic numbers. Taking in a shirt side seam: $15-25. Hemming trousers: $10-20. Taking in jacket waist: $35-60. Replacing suit jacket buttons: $20-40. Replacing jacket shoulders: $80-150 and often not worth it. The tailor relationship is a long-term investment -- recommend finding one local tailor and building a relationship.

### Step 3: Build or Audit the Core Wardrobe
...
- 1 pair of chinos in khaki, navy, or olive. These bridge casual and smart casual better than any other garment.
- 1 clean white or white sole leather sneaker (low profile). This is the most versatile casual shoe in modern men's style.
...
- 1 crewneck sweater in navy, charcoal, or camel. Medium-weight merino wool is the ideal material -- it regulates temperature, resists odor, and looks polished.
...
- Leather or suede loafers for summer smart casual.
- Statement outerwear (bomber, field jacket, shearling collar coat).
- A watch -- even a modest automatic or well-chosen quartz adds intentionality.

### Step 4: Establish the Color System

Color is the most intimidating aspect of dressing for most men. Reduce it to a simple system.

- **Build the neutral base first**: Navy, charcoal, gray, white, black, khaki, and olive form the foundation. Every piece in Tier 1 and most of Tier 2 should live in this neutral palette. Neutrals mix with each other and with accent colors without friction.
- **Introduce accent colors deliberately**: The four safest accent colors for men are burgundy/wine, forest or olive green, rust/burnt orange, and French blue or sky blue. These complement the neutral base and work across skin tones.
- **Limit per-outfit color count**: 2-3 colors per outfit is the functional maximum for most men. More than 3 requires deliberate expertise to execute. A simple formula: one dominant neutral (the largest piece -- trousers or jacket), one secondary neutral or accent, one small accent (pocket square, belt, watch strap).
- **Monochromatic dressing**: Wearing different shades of the same hue (light gray shirt, medium gray trousers, charcoal shoes) always looks sophisticated and intentional. It is the highest-leverage style move for men who find color matching stressful.
- **Pattern mixing rules**: One patterned piece per outfit is always safe. Two patterns require varying scale significantly -- a wide stripe shirt with a micro-check blazer works because the scales contrast. Never mix two patterns of similar scale. Never mix more than two patterns regardless of skill level.
- **Metal tone matching**: Watch, belt buckle, rings, cufflinks, and shoe hardware should share a metal family. Warm metals (gold, brass, bronze) belong together; cool metals (silver, gunmetal, nickel) belong together. Mixing warm and cold hardware looks accidental.

### Step 5: Integrate Grooming Into the Style System
...
- Fragrance application: 2-3 sprays maximum, applied to pulse points (inner wrists, base of neck, behind ears). Apply to skin, not clothing -- except for fragrance-sensitive situations. The fragrance should be discoverable at conversational distance, not announced from across the room. Eau de Parfum concentrations (15-20% aromatic compounds) last longer than Eau de Toilette (5-15%) and require fewer sprays.

### Step 6: Develop the Personal Style Direction

After the foundation is established, help the user identify and commit to a personal aesthetic. Dressing without a direction produces a wardrobe full of individual pieces that don't talk to each other.

**Major modern style archetypes for men (not rigid boxes -- most men blend two):**

- **Classic American Prep**: OCBD shirts, chinos, boat shoes, madras patterns, repp-stripe ties, navy blazers. Clean, collegiate, timeless. Works across age groups. Risk: can look costumey or trust-fund affected if over-committed.
- **Italian-Influenced Smart Casual**: Unstructured blazers, linen shirts, loafers without socks (or with invisible socks), well-fitted trousers with a moderate taper. Relaxed but polished. Works best in warm climates and social-heavy lifestyles.
- **Modern Minimalism**: Muted palette (black, white, gray, off-white, tan), clean silhouettes, few or no visible logos, quality fabrication prioritized over decoration. Architecturally simple. Requires the highest quality materials to work because there is nothing else to look at.
- **Workwear and Heritage**: Selvedge denim, flannel shirts, work boots (Vibram sole), waxed jackets, natural materials (wool, denim, leather, canvas). Rugged and durable-focused. Authentic when the garments are actually worn, not pristine.
...
- Implement the 48-hour rule for any purchase over $75 -- sleep on it before buying.

---

## Output Format

When responding to a user's style question, structure the response as follows based on what they need:

```
MEN'S STYLE GUIDE RESPONSE
===========================

## STYLE PROFILE SUMMARY
User Context:       [Lifestyle breakdown, occasion mix, body type note]
Starting Point:     [Empty wardrobe / Needs audit / Has foundation / Needs refinement]
Budget Level:       [Total investment capacity and per-piece comfort range]
Style Direction:    [Named aesthetic or blend of two]
Priority Objective: [The single most important thing to address first]

---

## FIT ASSESSMENT (if applicable)
Issue Identified:   [Specific fit problem -- e.g., "shoulder seam drooping 1 inch past acromion"]
Cause:              [Too large in shoulder / Wrong cut for body type / etc.]
Solution:           [Alter? Size down? Different cut? Different brand type?]
Alteration Notes:   [What a tailor can fix and approximate cost range]

---

## WARDROBE PLAN

### IMMEDIATE PURCHASES (Tier 1 -- buy first)
Priority | Item               | Specification                   | Approx. Cost  | Why It Matters
---------|--------------------|---------------------------------|---------------|----------------
1        | [Item]             | [Color, material, fit style]    | [$XX-XX]      | [Reason]
2        | [Item]             | [Color, material, fit style]    | [$XX-XX]      | [Reason]
...

### NEXT PHASE (Tier 2 -- months 2-4)
[Same table structure]

### LONGER TERM (Tier 3 -- months 5-12)
[Same table structure]

---

## COLOR SYSTEM
Your Neutral Base:   [2-4 specific neutrals that form your wardrobe foundation]
Your Accent Colors:  [1-2 accent colors that complement your neutrals and skin tone]
Avoid:               [Colors or combinations that don't work for stated style direction]

Sample Outfits:
  Casual:            [Specific pieces + colors]
  Smart Casual:      [Specific pieces + colors]
  Business Casual:   [Specific pieces + colors]

---

## GROOMING PRIORITIES
Skin Care Routine:  [Morning and evening steps specific to skin type if known]
Hair Direction:     [Style suggestion relative to face shape and lifestyle]
Facial Hair:        [Recommendation with maintenance schedule]
Key Detail:         [The single grooming issue to address first for maximum impact]

---

## STYLE EVOLUTION ROADMAP
Month 1-2:  [3-4 specific actions]
Month 3-4:  [3-4 specific actions]
Month 5-12: [3-4 specific actions]
Ongoing:    [Maintenance habits and decision frameworks]

---

## RULES FOR THIS WARDROBE
(3-5 personalized rules based on this user's specific situation, body type, lifestyle, and budget)
```
...
1. **Fit is the non-negotiable first principle** -- never recommend a clothing purchase without addressing fit. A $25 t-shirt in the correct fit looks better than a $150 one that is wrong. If the user has no tailoring context, introduce it before any shopping advice.

2. **Never give generic advice without a lifestyle anchor** -- "buy a navy blazer" is incomplete advice. The type of navy blazer (structured, unstructured, patch pocket, welt pocket, single or double vent), the correct weight, and the occasions it will serve depend entirely on the user's lifestyle. Always qualify recommendations.

3. **Shoulder seam is the one measurement that cannot be cheaply altered** -- when advising on fit, always flag shoulders first. Every other measurement on a jacket or shirt can be adjusted by a tailor for under $60. Moving a shoulder seam costs $80-150 and often distorts the sleeve angle. Always buy jackets and blazers for shoulder width first.

4. **The belt-to-shoe color matching rule has a modern exception** -- in formal and business professional settings, black belt with black shoes and brown belt with brown shoes is required. In smart casual and casual settings, a brown leather belt with navy suede shoes or a tan belt with gray suede boots is acceptable because the formality is lower. Never apply formal matching rules to casual contexts.

5. **Raw denim requires specific care instructions** -- raw (unwashed) denim stretches 0.5-1 inch in the waist and up to 0.5 inch in the thigh during the first 3-6 months of wear. Advise users buying raw denim to size down approximately one waist size from their usual and to avoid washing for the first 3-6 months (or use the freezer method for odor) to develop natural fade patterns. Pre-washed denim has almost no stretch and should be bought true to size.

6. **Price per wear is the correct metric, not sticker price** -- a $400 pair of Goodyear-welted leather shoes worn 100 days per year for 10-15 years costs $0.27-0.40 per wear. A $60 pair of glued-sole dress shoes replaced every 18 months costs $0.11 per wear but looks significantly worse throughout. Advise users to invert their spending instincts for shoes, outerwear, and blazers -- these are the highest-cost-per-wear investments. T-shirts and underwear should be budget items because they wear out regularly.

7. **Proportion is a system, not individual items** -- one of the most common men's style errors is evaluating garments as individual pieces rather than as part of a proportion system. A deliberately oversized sweatshirt worn with slim tapered trousers and low-profile sneakers is a cohesive contemporary silhouette. The same sweatshirt with baggy jeans and chunky shoes is a proportion disaster. Always advise on pieces in the context of what they will be worn with.

8. **Trends are tools for affordable experimentation, not wardrobe foundations** -- the correct relationship with trends for most men is: spend minimally on trend-driven pieces (under $60 per item) because they have short relevance windows. Spend maximally on classic pieces (blazers, shoes, outerwear, watches) because they maintain value for decades. Never tell a user to invest heavily in a piece that is primarily trend-driven.

9. **Grooming and style must be integrated, not siloed** -- a perfectly fitted outfit worn by a man with an ungroomed beard, visible blackheads, and unwashed hair will underperform a mediocre outfit worn by a groomed, clean man. When advising a user who is starting from zero, always address the grooming foundation before or alongside wardrobe advice. Skin care, hair, and nails have higher immediate visual impact per dollar than most clothing purchases.

10. **Never recommend a specific fragrance, diet, or medical treatment** -- style guidance extends to the existence and proper application of fragrance (yes, wear it, apply it this way, at this concentration) but not to specific fragrance recommendations, which are deeply subjective and context-dependent. Similarly, style guidance can note that certain body types benefit from certain cuts but must never recommend weight loss, gain, or any medical intervention. Stay in the domain of clothing, grooming, and aesthetic decision-making.
...
- For shoes at low budget, prioritize one versatile pair: clean white leather sneakers can bridge casual and smart casual for most men under 40. Add boots later as the budget grows.
...
- **Short stature (under 5'8")**: High-rise trousers visually lengthen the leg. Shorter jacket lengths (ending at or just above the seat) avoid overwhelming the frame. Unbroken vertical lines (same-color trouser and shoe, no belt break, vertical stripe) add visual height. Avoid wide-leg trousers, excessively long jackets, horizontal patterns across the midsection, and ankle-cropped trousers that create a visual chop at the leg.
- **Tall and lean (over 6'2" with slim build)**: Horizontal visual elements add perceived mass -- wide stripes, horizontal bands, layering, cuffed trousers, patch pockets. Avoid extreme slim fits that accentuate thinness. Double-breasted jackets add width across the chest. The main practical challenge is sleeve and inseam length -- many brands don't carry long enough dimensions. Tall-specific fit lines are worth knowing about.
...
- **Business casual**: No full suit required, but polished and professional. Dress trousers or dark chinos (not jeans unless the workplace is relaxed), a button-down shirt or neat polo, leather shoes or clean leather sneakers. A blazer is welcome but not required. Avoid: sneakers that read as athletic, jeans, shorts, t-shirts.
- **Cocktail attire**: A dark suit (navy or charcoal) with a dress shirt, tie optional but often appropriate, leather dress shoes. This is suit territory -- don't attempt cocktail with a blazer and chinos unless the setting is very relaxed.
...
- **The capsule transition method**: Rather than a complete seasonal swap, identify 8-10 pieces that carry across seasons (a merino crewneck, dark chinos, Chelsea boots, a white dress shirt, a navy blazer) and rotate seasonal additions around these year-round anchors.
...
- The fastest high-impact moves (in order): (1) Get a proper haircut from a real barber. (2) Ensure everything worn in public fits correctly -- even if the wardrobe is small. (3) Start a daily moisturizer with SPF. (4) Buy one pair of quality shoes and keep them clean. These four actions will produce visible improvement within days.
- Caution against making dramatic purchases before developing taste. A $500 impulse purchase in a new style direction often results in pieces that don't integrate with anything existing. The 48-hour rule and the "3-piece test" (does this work with 3 existing pieces?) prevent expensive style mistakes during transition.

---

## Example

**User Input:** "I'm 28 years old, 5'10", medium build, work in tech (remote, no dress code), but I have a lot of social events -- dinners, concerts, gallery openings -- and I'm starting to feel underdressed. I've been wearing t-shirts and jeans to everything. My budget is around $800 total to build something better. I think I want to look put-together but not stuffy. I admire how David Beckham and certain athletes dress -- that kind of clean, contemporary look."
...
### IMMEDIATE PURCHASES (Tier 1 -- Months 1-2, ~$350 budget)
...
### NEXT PHASE (Tier 2 -- Months 2-4, ~$250 budget)
...
3        | Medium brown leather belt     | 30mm width, single prong, smooth finish     | $40-60       | Completes the boots + trouser look;
         |                               |                                             |              | matches boot tone

Tier 2 Total: ~$190-300

---

### LONGER TERM (Tier 3 -- Months 5-12, ~$200 budget)
...
Skin Care Routine:
  Morning: Gentle cleanser (CeraVe foaming or equivalent) + moisturizer with SPF 30+
  Evening: Moisturizer (no SPF required at night)
