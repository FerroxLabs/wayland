---
name: work-presentation-rescuer
description: |
  Emergency guide for improving work presentations quickly, covering visual hierarchy fixes, slide design principles, speaker notes, delivery techniques, and handling Q&A with confidence.
  Use when the user asks about work presentation rescuer, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of work presentation rescuer or requires a different specialized skill.
license: Apache-2.0
metadata:
...
- Transition slides that say "Now let's talk about..."
...
- Your recommendation/conclusion slide
- Your closing slide (the one thing you want them to remember)

### Fix 2: One Point Per Slide
...
• Churn rate increased to 4.2%
• Three new enterprise clients signed
• Marketing budget was 15% under
• Product launched two features
...
Slide 2: "Churn increased to 4.2% - our biggest concern"
[Trend line showing churn over 4 quarters]

Slide 3: "NPS improved to 72, but support tickets are up 23%"
[Two metrics side by side with context]
```
...
- Only show the bullet you are currently discussing (build animation)
...
When you put the conclusion in the title, the audience gets the message even if they stop reading.

### Fix 5: Design Cleanup (5 Minutes)

If your slides look amateur, these fixes take 5 minutes total:

1. **Pick one font.** Use it for everything. (Calibri, Arial, or your company's brand font.)
2. **Make text bigger.** If you have to squint, it is too small. Minimum 24pt for body, 32pt for titles.
3. **Remove clip art and stock photos of handshakes.** If a visual does not add meaning, remove it.
4. **Align everything.** Use the alignment guides in PowerPoint/Slides. Nothing floating randomly.
5. **Use white space.** Let slides breathe. Empty space is not wasted space; it is clarity.
...
**Data storytelling:** Do not just show the chart. Tell the audience what to see. "Notice the spike in March - that's when we launched the new feature."
...
- Timing notes ("2 minutes on this slide")
...
- **The recommendation:** "I'm recommending we invest $500K in X because it will deliver Y. Here's why."
...
**Do not end with:** "That's it" or "Any questions?" as your final words. State your conclusion first, THEN open for questions.
...
Anticipate the 3 hardest questions someone could ask and prepare answers:

1. The challenge to your data or methodology
2. The "what about [thing you didn't cover]?" question
3. The budget or resource concern
...
After any important presentation, send a follow-up within 24 hours:

```
Subject: Follow-up - [Presentation Topic] - Key Takeaways and Next Steps
...
I've attached the slides for reference. Please let me know if you have
...
If your presentation is tomorrow and you are panicking:

- [ ] Cut to 10-15 slides maximum
- [ ] One point per slide, stated in the title
- [ ] Remove any text the audience does not need to read
- [ ] Fix your opening: start with why this matters
- [ ] Fix your closing: end with the one thing you want them to remember
- [ ] Write one sentence of speaker notes per slide
- [ ] Practice the opening 5 times out loud
- [ ] Practice the full presentation once with a timer
...
2. **Analyze context.** Review the information provided and identify key factors relevant to work presentation rescuer
...
```template
## Work Presentation Rescuer Analysis
...
**Input:** "Help me with work presentation rescuer for my current situation"

**Output:**

Based on your situation, here is a structured approach to work presentation rescuer:
