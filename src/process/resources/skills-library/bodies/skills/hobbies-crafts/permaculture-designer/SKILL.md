...
description: |
  Guide to permaculture design including core principles, zone planning, food forests, companion planting, water management, soil building, seasonal planning, and community garden design. Use when the user asks about permaculture designer or needs help with related topics. Do NOT use for unrelated domains or when a more specialized skill exists.
license: Apache-2.0
metadata:
...
2. **Analyze the situation.** Review the information provided and identify key factors, challenges, and opportunities relevant to permaculture designer.
...
Before designing a permaculture system:

1. What is your site like? (Size, slope, sun exposure, soil type, climate zone)
2. What are your goals? (Food production, wildlife habitat, water management, beauty, all of the above)
3. How much time can you dedicate to maintenance? (1 hour/week, 5 hours/week, full-time)
4. What is your experience with gardening or land management?
5. Do you own the property, or is this a rental/community space?
6. What is your budget for initial implementation? ($100 / $500 / $2,000 / $10,000+)
7. What is your USDA Hardiness Zone? (Find at planthardiness.ars.usda.gov)
8. What are your water sources? (Municipal, well, rainwater, irrigation access)
9. Are there any restrictions? (HOA rules, local ordinances, deed restrictions)
10. Who else will be involved in the project?
...
4. **Apply self-regulation and accept feedback**: Learn from mistakes, adjust
5. **Use and value renewable resources**: Prefer perennials, solar, wind, biological
6. **Produce no waste**: Every output becomes an input elsewhere
7. **Design from patterns to details**: Observe natural patterns, then apply locally
8. **Integrate rather than segregate**: Every element serves multiple functions
9. **Use small and slow solutions**: Start small, scale what works
10. **Use and value diversity**: Polyculture over monoculture
11. **Use edges and value the marginal**: Edges between ecosystems are most productive
12. **Creatively use and respond to change**: Work with succession, adapt to conditions
...
- Worm farm
- Small animal housing (chickens, rabbits if allowed)
...
- **Fire sector**: Wildfire risk direction and buffer needs
- **Noise/visual sector**: Screen undesirable views, buffer highway noise
- **Wildlife sector**: Animal movement corridors, pest entry points
...
1. **Canopy layer**: Large trees (apple, pear, pecan, chestnut, walnut)
2. **Understory tree layer**: Small trees (plum, cherry, persimmon, pawpaw, hazelnut)
3. **Shrub layer**: Berry bushes (blueberry, elderberry, gooseberry, currant, hazelnut)
4. **Herbaceous layer**: Perennial herbs and vegetables (comfrey, rhubarb, artichoke, sorrel, mint)
5. **Ground cover layer**: Low-growing edibles (strawberry, clover, creeping thyme, violets)
6. **Vine layer**: Climbing plants (grape, kiwi, passionflower, hops, hardy kiwi)
7. **Root layer**: Root crops (Jerusalem artichoke, groundnut, horseradish, turmeric)
...
4. **Plan shrub and herbaceous layers**: Fill gaps with productive species
5. **Add ground covers**: Living mulch that suppresses weeds and feeds soil
6. **Install vines**: On trees, trellises, or fences (be careful of smothering smaller trees)
7. **Incorporate mushroom cultivation**: Inoculated logs and wood chip beds
...
- Plant the north side of the food forest with tallest trees (Northern Hemisphere)
...
- **Borage**: Potassium, calcium, attracts pollinators
...
- **Interplant** nitrogen fixers throughout the food forest and garden
...
- Plant the berm with trees and shrubs (roots stabilize and absorb)
- Swales slow, spread, and sink water into the landscape
...
- Depth: 4-8 inches deep
- Native plants with deep roots preferred (coneflower, switchgrass, iris)
...
- **Use**: Garden irrigation, livestock, toilet flushing (check local codes)
...
- Dramatically increases soil water-holding capacity
- Requires professional survey for proper implementation
...
4. **Cover cropping**: Plant clover, rye, vetch, or buckwheat during fallow periods
5. **Chop and drop**: Cut plants (especially comfrey) and leave on soil surface as mulch
6. **Biochar**: Charcoal mixed with compost and added to soil for long-term carbon storage
...
- Most fruit trees prefer pH 6.0-6.5
- Blueberries prefer pH 4.5-5.5 (acidic)
...
- Plant trees and shrubs (while dormant or just breaking bud)
- Apply compost to established beds
...
- Monitor and manage pests (beneficial insect habitat is your defense)
- Harvest and preserve (canning, drying, freezing)
- Plan fall plantings
...
- Build soil with leaf mulch (fall leaves are gold)
...
- Build and repair infrastructure (beds, trellises, paths)
- Study and take courses
- Start indoor microgreens and sprouts
...
- Secure (fencing, visibility from street or buildings)
...
- Water stations distributed throughout (every 50-100 feet)
- Gathering space: Picnic table, shade structure, bulletin board
- Compost area: Central, with clear usage guidelines
...
- Water usage policy
- Organic-only policy (recommended, prevents neighbor chemical drift)
- Conflict resolution process
- Seasonal cleanup requirements

## Safety Considerations

- Test soil for contaminants before growing food (especially urban sites, former industrial land, near old buildings with lead paint)
- Use raised beds with imported soil if contamination is found
- Be aware of poisonous plants on your site (castor bean, foxglove, hemlock)
- Wear gloves when handling compost (tetanus risk from soil bacteria)
- Use appropriate sun protection during long outdoor work sessions
- Secure water features to prevent drowning hazard (especially for children)
- Be aware of local wildlife: Snakes, ticks, poison ivy/oak/sumac

## Progression Path

1. **Phase 1**: Observe your site for one full year, build soil, start sheet mulching
2. **Phase 2**: Establish Zone 1 garden (herbs, salad, compost), install rain barrel
3. **Phase 3**: Plant first fruit trees, establish perennial beds, build swales
4. **Phase 4**: Develop food forest layers, expand to Zone 2-3
5. **Phase 5**: Integrate animals (chickens, bees), advanced water management
6. **Phase 6**: Design for community, teach others, earn PDC (Permaculture Design Certificate)

## Resources

- **Books**: "Gaia's Garden" by Toby Hemenway (best beginner book)
- **Books**: "The Permaculture Handbook" by Peter Bane
- **Books**: "Edible Forest Gardens" by Dave Jacke (comprehensive food forest reference)
- **Courses**: PDC (Permaculture Design Certificate) - 72-hour course available worldwide
- **Online**: Oregon State University permaculture courses, Verge Permaculture YouTube
...
```
[Permaculture Designer deliverable]
