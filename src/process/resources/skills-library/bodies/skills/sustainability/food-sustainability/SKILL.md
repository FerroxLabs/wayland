...
description: |
  Comprehensive guide to sustainable eating practices including local eating through CSAs and farmers markets, seasonal eating guide, reducing food waste through meal planning, storage, and composting, understanding food miles, exploring sustainable protein sources, garden-to-table growing, and food preservation techniques.
  Use when the user asks about food sustainability, or needs help with comprehensive guide to sustainable eating practices including local eating through csas and farmers markets, seasonal eating guide, reducing food waste through meal planning, storage, and composting, understanding food miles, exploring sustainable protein sources, garden-to-table growing, and food preservation techniques.
  Do NOT use when the request requires professional specialized advice or falls outside the scope of food sustainability.
license: Apache-2.0
metadata:
...
1. What does your current diet look like (omnivore, vegetarian, vegan, other)?
2. How many people are in your household?
3. What is your weekly grocery budget?
4. Do you have access to farmers markets, CSAs, or local farms?
5. Do you currently have a garden or space to grow food?
6. How much food do you estimate your household wastes per week?
7. What cooking skills do you have, and how much time can you spend cooking?
8. Are there dietary restrictions or allergies in your household?
9. What sustainability priorities matter most to you (climate, local economy, health, animal welfare)?
10. Are you looking for gradual changes or a significant shift in your food system?

---

## Phase 1: Understanding Food's Environmental Impact

### Where Food's Carbon Footprint Comes From

Food production accounts for approximately 26% of global greenhouse gas emissions. The breakdown includes animal agriculture at roughly 14.5%, crop production at around 6%, land use change at about 4%, and the supply chain (processing, transport, packaging, retail) at approximately 2%.
...
- [ ] Can you customize or is it the farmer's choice?
- [ ] Are there add-ons available (eggs, meat, bread, flowers)?
- [ ] What happens if you miss a pickup?
- [ ] Can you visit the farm?
- [ ] What farming practices do they use (organic, IPM, regenerative)?
...
- Buy what is abundant and in season for the best price and freshness
- Establish relationships with vendors for the best finds
...
- Neighborhood fruit gleaning programs
...
- Usually less expensive due to abundance
- Adds variety to your diet throughout the year

### Seasonal Produce Guide (Temperate Northern Hemisphere)

**Spring (March-May):**
Asparagus, artichokes, peas, radishes, spinach, strawberries, rhubarb, lettuce, green onions, herbs (mint, chives, parsley)

**Summer (June-August):**
Tomatoes, corn, zucchini, cucumbers, peppers, berries (blueberries, raspberries, blackberries), peaches, watermelon, green beans, eggplant, basil, okra

**Fall (September-November):**
Apples, pears, pumpkins, winter squash (butternut, acorn, delicata), sweet potatoes, Brussels sprouts, cauliflower, broccoli, beets, cranberries, grapes, figs

**Winter (December-February):**
Root vegetables (carrots, parsnips, turnips, rutabaga), kale, cabbage, citrus (oranges, grapefruit, lemons), stored squash, potatoes, onions, leeks, dried beans

### Seasonal Meal Planning Template

```
SEASONAL MEAL PLAN
Season: _____________ Week of: _____________
...
---------+----------------+----------------+----------------
Monday   | ______________ | ______________ | ______________
Tuesday  | ______________ | ______________ | ______________
Wednesday| ______________ | ______________ | ______________
Thursday | ______________ | ______________ | ______________
Friday   | ______________ | ______________ | ______________
Saturday | ______________ | ______________ | ______________
Sunday   | ______________ | ______________ | ______________

Seasonal ingredients used: _________________________
Preserved items from previous seasons: _____________
```
...
4. Buy only what is on the list and resist impulse purchases
5. Prep ingredients soon after shopping
6. Designate one "clean out" meal per week using leftovers and odds and ends
...
- Citrus peels: zest before using, infuse vinegar for cleaning, candied peels
- Broccoli stems: peel and slice for stir-fries, soup, or slaw

---

## Phase 5: Sustainable Protein Sources
...
- Try plant-based versions of favorite meals
- Explore cuisines that are naturally plant-forward (Indian, Ethiopian, Mexican, Mediterranean)
...
- Generally sustainable choices include sardines, anchovies, mussels, oysters, and certain wild salmon
- Generally avoid bluefin tuna, Atlantic cod (depleted), and imported shrimp (environmental and labor concerns)

---

## Phase 6: Garden-to-Table
...
- Zucchini (extremely productive)
- Green beans (quick growing, minimal maintenance)
- Radishes (ready in 30 days)
- Peppers (long season but low maintenance)
...
- Plant pollinator-friendly flowers alongside vegetables
- Rotate crops to maintain soil health

---

## Phase 7: Food Preservation
...
Vegetables (most need blanching first): Wash and cut, blanch in boiling water for 1-5 minutes, transfer immediately to an ice bath, drain and pat dry, spread on a sheet pan and freeze flat to prevent clumping, then transfer to freezer bags labeled with the date.

Fruits: Wash and cut, spread on a parchment-lined sheet pan, freeze flat, and transfer to freezer bags. Great for smoothies, baking, and compotes.

Prepared meals: Cool completely before freezing, use freezer-safe containers with minimal headspace, label with contents and date, and use within 3 months for best quality.

### Simple Fermentation: Quick Sauerkraut

Ingredients: 1 medium cabbage (shredded) and 1 tablespoon sea salt.

Method: Massage salt into shredded cabbage for 5-10 minutes until liquid is released. Pack tightly into a clean glass jar. Press down so liquid covers the cabbage. Cover loosely since gases need to escape. Keep at room temperature, pressing down daily. Taste after 3 days and ferment to your preference (3-14 days). Refrigerate when ready to slow fermentation.
...
4. Grow something, even just herbs
5. Buy seasonal and local when possible

### Weekly Tracking

```
WEEKLY FOOD SUSTAINABILITY TRACKER
Week of: _______________

Food waste this week (estimated): _____
Meatless meals this week: _____
Local or seasonal items purchased: _____
Food preserved or frozen to prevent waste: _____
Meals made from scraps or leftovers: _____
New sustainable recipe tried: _____
Money saved from waste reduction: $_____
```
...
**Input:** "Help me get started with food sustainability"

**Output:** A structured food sustainability plan tailored to the user's specific situation, following the process outlined above.
