...
2. **Analyze the situation.** Review the information provided and identify key factors, challenges, and opportunities relevant to college essay coach.
...
1. Which colleges are you applying to, and what essay prompts do they require?
2. What is your application deadline (early decision, early action, regular decision)?
3. Have you started brainstorming topics, or are you starting from scratch?
4. What do you think makes you unique or different from other applicants?
5. Is there a particular experience, challenge, or interest that has shaped who you are?
6. What is the rest of your application like (GPA, test scores, extracurriculars, recommendations)? What story does it already tell?
7. Is there anything important about you that is NOT reflected elsewhere in your application?
8. What kind of writing do you feel most comfortable with?
9. Do you have a draft already that needs revision, or do you need help getting started?
10. Are there any topics you feel strongly about writing about (or strongly want to avoid)?

---

## Phase 1: Understanding What Admissions Officers Want
...
- Who you are beyond grades and activities
...
- A window into your character, values, and how you process the world
...
- Trying to impress with vocabulary or SAT words
- A topic chosen because it sounds impressive rather than meaningful
- Shock value or controversial takes for their own sake
...
- A memorable, authentic essay stands out far more than a technically perfect but generic one

---

## Phase 2: Common App Prompts Analysis
...
- What is something you believe that most of your peers do not?
- What is a small, specific moment you remember vividly?
- What would your closest friend say is your most defining quality?
- What is something you have failed at that mattered to you?
- What is a family tradition or cultural practice that shaped you?
...
- A quirky interest or perspective
...
- Is this MY story, or could anyone write this essay?

---

## Phase 4: Finding Your Authentic Voice

### What Authentic Voice Sounds Like

**Authentic:** "I reorganize my bookshelf by color when I am stressed. It started as procrastination, but somewhere between alphabetizing and rainbow-sorting, I realized I was sorting my own thoughts."

**Not authentic:** "Throughout my life, I have demonstrated resilience in the face of challenges, which has taught me the value of perseverance."
...
## Phase 5: Structure That Works

### The Classic Structure (Modified for College Essays)

**Opening (Hook):** Start with a specific moment, image, or statement that draws the reader in. Drop them into a scene.

**Context/Background:** Briefly provide necessary context (do not overexplain).

**The Turn:** The challenge, realization, or shift that drives the essay.

**Reflection:** What you learned, how you grew, what this means about who you are.

**Connection/Forward Look:** How this connects to your future, your values, or how you will contribute to the college community.

### Alternative Structures

**The Montage:** String together several related vignettes or moments around a central theme. Works well for identity, interest, or background essays.

**The Narrative Arc:** Tell one story from beginning to end with a clear climax and resolution. Works well for challenge or growth essays.

**The Lens:** Use one specific object, place, or activity as a lens through which to explore who you are. Works well for "topic of fascination" or identity essays.
...
- An op-ed or persuasive essay on a social issue

---

## Phase 6: Showing Not Telling

### The Most Important Writing Principle

**Telling:** "I am a hard worker who cares about my community."
**Showing:** "At 5 AM, while my teammates were still asleep, I was setting up 200 chairs in the gymnasium for the community breakfast we had spent six months planning."
...
- [ ] What was the emotional sensation in your body?
...
- Does the essay end strongly (not with a generic conclusion)?
...
- Are there any cliches to replace?
...
- Your parent can read for typos but should not rewrite sentences
- A school counselor or English teacher can provide structural feedback

---

## Phase 8: Supplemental Essays
...
- Spend as much time on supplementals as the main essay -- schools notice
...
- Mental health struggles (can be powerful if you show growth, not just suffering)
- Immigration stories (common at some schools -- must be YOUR unique angle)
...
- Someone else's story (the essay must be about YOU)
- Topics meant to make the reader feel sorry for you (without agency or growth)

---

## Essay Checklist Before Submitting

- [ ] Does the essay answer the specific prompt?
- [ ] Is the essay within the word count limit?
- [ ] Does the opening grab attention in the first two sentences?
- [ ] Is there a clear central insight or theme?
- [ ] Do you show rather than tell?
- [ ] Does the essay sound like YOUR voice?
- [ ] Does it reveal something the rest of the application does not?
- [ ] Have you proofread for grammar, spelling, and punctuation?
- [ ] Is the school name correct in every supplemental (common mistake when reusing)?
- [ ] Have 2-3 people read it and provided feedback?
- [ ] Do you feel genuinely represented by this essay?
- [ ] Would you be comfortable if your teacher, friend, and grandmother all read it?
...
```
[College Essay Coach deliverable]
