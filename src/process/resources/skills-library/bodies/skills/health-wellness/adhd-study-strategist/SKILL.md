---
name: adhd-study-strategist
description: |
  Evidence-based study strategies designed for ADHD brains covering active recall, spaced repetition, environment design, working with medication timing, focus techniques, and exam preparation approaches.
  Use when the user asks about adhd study strategist, related techniques, best practices, or needs guidance in this domain.
...
- What are you studying (subject, level, specific course)?
- Are you currently diagnosed and/or medicated for ADHD?
- If medicated, what time does your medication typically peak and wear off?
- What study methods have you tried before, and what failed?
- What does your current study environment look like?
- How far away is your next exam or deadline?
- Do you tend to hyperfocus on some subjects? Which ones?
- What is your biggest study pain point (starting, sustaining, retaining, testing)?

## Understanding Your ADHD Brain in Study Mode
...
**Default mode (most of studying):** Interest-driven, not importance-driven. Your brain will not allocate attention to something just because it is "important." It needs novelty, challenge, urgency, or personal interest.
...
- Interest: connect material to something you care about

## Active Recall Strategies

### What Active Recall Is

Active recall means testing yourself on material rather than passively reviewing it. It is the single most effective study technique for any brain, and it is especially powerful for ADHD because it demands engagement.
...
- Make cards in your own words, not copied from the textbook
...
- Keep decks focused: one deck per subject, not one massive deck

### The Feynman Technique

1. Study a concept
2. Close your book/notes
3. Explain the concept out loud as if teaching a child
4. When you get stuck or vague, that is what you do not understand yet
5. Go back and study only those gaps
6. Repeat until your explanation flows

**Why this works for ADHD:** It is active, verbal (auditory processing), and immediately reveals gaps rather than creating false confidence.

### Question Generation Method

Instead of highlighting or rereading, read a section and then write 3-5 questions about it.

- "What would happen if [X variable] changed?"
- "How does this connect to [previous topic]?"
- "Why does [this process] work this way instead of another way?"
- "What is the most likely exam question from this section?"

Answer your own questions the next day without looking at notes.

## Environment Design

### The Optimal ADHD Study Space
...
- [ ] A snack is available (blood sugar drops destroy concentration)
- [ ] Temperature is comfortable (too warm = drowsy)
- [ ] Lighting is bright (dim environments increase drowsiness)

**Audio environment options (experiment to find yours):**
| Option | Best For | Examples |
|--------|----------|---------|
| Brown noise / white noise | Masking distracting sounds | myNoise, Noisli apps |
| Lo-fi study beats | Light reading, flashcard review | YouTube "lofi hip hop," Spotify playlists |
| Video game soundtracks | Problem sets, math, coding | Zelda, Skyrim, Halo soundtracks (designed to maintain focus) |
| Nature sounds | Writing, creative work | Rain, forest, ocean |
| Silence | High-complexity tasks, deep analysis | Noise-canceling headphones |
| Familiar music on repeat | Getting into flow | One song on loop (reduces novelty-seeking) |
...
- Tuesday: Coffee shop
- Wednesday: Home desk
- Thursday: Different library floor or room
- Friday: Study group location
...
- Use full-screen mode for your study materials
- If you must use your phone, turn it to grayscale mode (reduces dopamine pull)

## Focus Techniques

### The Pomodoro Method (Modified for ADHD)

Standard Pomodoro (25 minutes work, 5 minutes break) is often too long for ADHD, especially on non-preferred tasks.
...
- After 4 work sprints, take a 15-20 minute longer break
...
- Discord study servers with cameras on
- YouTube "study with me" livestreams

### The 2-Minute Start Rule

The hardest part of studying with ADHD is starting. The brain resists task initiation.

**The rule:** Commit to studying for only 2 minutes. Set a timer. After 2 minutes, you can stop with zero guilt.
...
5. Reread the last sentence you remember
6. Continue

## Working with Medication Timing

### Aligning Study with Medication

If you take ADHD medication, your cognitive performance varies throughout the day.
...
- Rely more heavily on environmental controls and body doubling
- Use shorter work sprints (10-15 minutes)
- Favor active methods (teaching aloud, flashcards) over passive methods
- Accept lower output; compensate by studying more sessions rather than longer sessions
- Exercise before studying (30 minutes of cardio improves focus for 1-2 hours)
...
- Do a "brain dump" on scratch paper as soon as the exam starts (write down formulas, key facts, anything you are afraid of skipping)

### During the Exam

1. Read the entire exam first (2 minutes)
2. Answer the easiest questions first (builds confidence and momentum)
3. Mark difficult questions and return to them
4. If your mind goes blank: close your eyes, take three breaths, move to another question
5. Manage time: divide remaining minutes by remaining questions
6. Use all available time (check your work, but do not second-guess correct answers)
...
- Visualize yourself working through the exam calmly and methodically
...
This keeps the streak alive without requiring a good brain day.
...
2. **Analyze context.** Review the information provided and identify key factors relevant to adhd study strategist
...
```template
## Adhd Study Strategist Analysis
...
**Input:** "Help me with adhd study strategist for my current situation"

**Output:**

Based on your situation, here is a structured approach to adhd study strategist:
