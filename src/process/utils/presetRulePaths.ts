 ...
 * a workspace-relative `<dir>/skills/market-open-report` path that must stay
 * relative. The unanchored rewrite spliced an absolute path into the middle of it and
 * seeded `cd <dir>//Users/<user>/.wayland-config/skills/market-open-report` —
 ...
 * any `<segment>/skills/` is left alone.
 */
