...
description: |
  Creates Socratic seminar question sets across Bloom's taxonomy levels with facilitation notes for educators. Produces a complete discussion guide with opening, core, and closing questions plus facilitation strategies -- not a list of generic discussion prompts.
  Use when an educator asks to create discussion questions, design a Socratic seminar, prepare seminar questions, or build a discussion-based lesson.
...
Use this skill when any of the following triggers appear:

- An educator explicitly asks to create discussion questions, seminar questions, or a discussion guide for a specific text, topic, film, case study, or primary source
- A teacher wants to design a Socratic seminar -- including inner/outer circle fishbowl, structured academic controversy (SAC), philosophical chairs, or Paideia seminar formats
- An instructor needs a complete facilitation guide with sequenced questions at multiple cognitive levels, not just a flat list of prompts
- A user mentions discussion formats by name: fishbowl, think-pair-share, Socratic questioning, Harkness table, Paideia, structured academic controversy, or four corners
- A user wants to build participation equity strategies alongside questions -- managing dominant voices, drawing out quiet students, or scaffolding for diverse learners
- A curriculum developer or instructional coach wants a model discussion guide to share with a teaching team as a planning artifact
...
- The user wants a rubric for evaluating written arguments or essays -- use `rubric-design` instead
- The user wants to build a student-facing study guide -- discussion questions in this skill are teacher-facing facilitation tools, not student handouts
- The user is asking about discussion board design for an online course with asynchronous written responses as the primary mode -- this skill can adapt for that context but is optimized for synchronous dialogue

---

## Process

### Step 1: Gather Specific Context Before Writing a Single Question

Never generate questions from a vague prompt. Collect the following information -- ask if any is missing:

- **Content:** What is the exact text, reading, case study, film, or topic? If a text, which edition, chapters, or pages are in scope? If a topic, what specific angle (e.g., "the ethics of CRISPR," not just "genetics")?
- **Grade level and course:** A 10th grade English class and a college-level philosophy seminar require completely different cognitive demands, vocabulary, and scaffolding even on the same text
- **Discussion format:** Socratic seminar (whole circle or inner/outer fishbowl), Harkness table (collaborative, student-led), structured academic controversy (two-team debate structure), philosophical chairs (physical positioning on a spectrum), or think-pair-share (small group with report-out)
- **Duration:** Critical for calibrating question count. A 20-minute discussion needs 5-7 questions total; a 50-minute seminar can sustain 10-14 with facilitation moves between each
- **Learning objectives:** What do you want students to be able to do or think differently about by the end of this discussion? Objectives shape which Bloom's levels to emphasize
- **Student preparation:** Have students read/viewed the source material in advance? Will they have the text in front of them? Have they annotated? This determines whether opening questions can assume shared knowledge
- **Classroom context:** Any students with IEPs or 504s that affect verbal participation? English language learners who need sentence frames? High-stakes emotional content that needs pre-framing?

If the educator provides topic and grade level but omits format and duration, default to whole-class Socratic seminar and ask for time. Never write questions without knowing the content.

---

### Step 2: Map Questions to Bloom's Taxonomy with Intentional Sequencing
...
- Example pattern: "What happened?" then "What did you notice?" then "What word/image/moment stayed with you?"
...
- Build in at least one comparison question (two characters, two time periods, two interpretations) -- comparison is the most reliable tool for deepening analysis
- Build in at least one "devil's advocate" question that forces students to steelman a position they disagree with
...
- 1-2 questions at Evaluate/Create (closing)
- Never write a question set with zero Evaluate-level questions

---

### Step 3: Write Each Question with Precision
...
- Create-level questions begin with: "If you were...what would you change?" / "What new argument could you make using this evidence?" / "How would you redesign...?"
...
- A **Socratic probe** tests the logic of a claim: "If that's true, then what would we expect to see in [related scenario]?"

---

### Step 4: Write Facilitation Notes for Every Question

The facilitation notes are the difference between a question list and a discussion guide. Write them with the assumption that a teacher picking this up for the first time could run the discussion.

For every question, provide:

**Purpose (1 sentence):** What this question is designed to elicit -- not just the topic, but the cognitive move. "Forces students to distinguish between Atticus's legal strategy and his moral convictions" is useful. "Discusses the trial" is not.

**Expected responses (2-4 bullet points):** Anticipate the most likely directions students will go. Include the "easy" correct answer, the sophisticated correct answer, and at least one plausible misconception or oversimplification. This prepares the teacher to recognize partial understanding and probe further rather than accepting the first good answer.

**Follow-up probes (2-3, labeled by type):** See Step 3 above. Number them so the teacher knows the order to deploy them.

**If discussion stalls (1-2 specific strategies):** Every question needs a "rescue" plan. Options include: read a short passage aloud and ask students to respond to it directly; use a polling move ("raise your hand if..."); assign 90 seconds of silent individual writing before re-opening discussion; call on a specific outer-circle observer in a fishbowl; or lower the abstraction ("Before we answer the big question, let's just describe what's happening on page 12").

**Connection to next question (1 sentence):** How does this question's resolution set up the next question? This is how the teacher creates narrative flow rather than a series of disconnected prompts.

---

### Step 5: Build the Facilitation Toolkit

The toolkit is a separate section from the questions -- it addresses mechanics, not content. It must include:
...
- "So you're saying... Is that right?" -- revoicing: teacher paraphrases to confirm and elevate
- "Who sees it differently?" -- invites counter-argument after a strong claim
- "What would someone who disagrees say?" -- forces steelmanning
- "Is there a different way to interpret that?" -- opens multiple readings
...
4. Discussion goes off-topic productively -- acknowledge the connection, note it on the board as a "parking lot" idea, return the group to the text
...
4. Questioning: Does the student raise a genuine question that opens new thinking?
...
### Step 7: Format and Final Review

Before delivering the guide, verify:

- Every question references the specific content (character name, event, term, page reference) -- no generic questions
- At least 3 different Bloom's levels are represented
- Every core question has 2-3 follow-up probes
- No yes/no questions anywhere in the set
- The timing allocations add up to the stated discussion duration
- Opening questions are answerable by a student who read carefully but is not confident
- Closing questions require synthesis and could not be answered without the preceding discussion
- The facilitation toolkit includes at least one strategy for dominant speakers and one for quiet students
- Assessment rubric has 4-5 indicators with distinct performance descriptors at 3 levels
...
```
## Discussion Guide: [Topic -- specific enough to identify the exact text/content/chapter]

**Subject:** [Subject area]
**Grade/Level:** [Specific grade or course level]
**Format:** [Socratic seminar / Harkness table / fishbowl / philosophical chairs / structured academic controversy / think-pair-share]
**Duration:** [Total minutes with phase breakdown, e.g., 45 min: 8 opening / 27 core / 10 closing]
**Source Material:** [Full citation: title, author, chapter/section, edition if relevant]
**Learning Objectives:** By the end of this discussion, students will be able to:
  1. [Specific cognitive goal tied to content]
  2. [Specific cognitive goal tied to content]
**Prerequisites:** [What students must have done before discussion begins]

---

### Discussion Norms
Post these before discussion begins and refer to them when redirecting students.
1. Ground your claim: When you make an argument, point to the text.
2. Address ideas: Respond to what was said, not who said it.
3. Build the conversation: Connect your comment to the previous speaker's idea.
4. [Add any format-specific norm, e.g., "Inner circle speaks; outer circle observes and takes notes."]

---

### Pre-Discussion Check (2-3 min)
[Optional but recommended for text-based seminars]
- Quick annotation check or entry question to confirm student preparation
- Specific prompt: [e.g., "Write one sentence: What is the central conflict in this chapter?"]

---

### Opening Questions ([X] min)

**Q1 [Remember]:** [Question text -- must reference specific content, not generic]
- *Purpose:* [What cognitive work this question does]
- *Expected responses:*
  - [Likely response 1 -- basic comprehension]
  - [Likely response 2 -- more textured comprehension]
  - [Common misreading or gap to watch for]
- *Follow-up probe:* [Specific deepening question if response is shallow]
- *Connection to Q2:* [One sentence bridging move]

**Q2 [Understand]:** [Question text]
- *Purpose:* [What cognitive work this question does]
- *Expected responses:*
  - [Likely response 1]
  - [Likely response 2]
- *Follow-up probe:* [Specific deepening question]
- *Connection to Q3:* [One sentence bridging move]

---

### Core Questions ([X] min)

**Q3 [Apply]:** [Question text]
- *Bloom's level:* Apply
- *Purpose:* [What this question forces students to do cognitively]
- *Expected responses:*
  - [Sophisticated response]
  - [Surface-level response]
  - [Plausible misconception]
- *Follow-up probes:*
  - [Deepening probe -- label type]
  - [Widening probe -- label type]
  - [Transfer probe -- label type]
- *If discussion stalls:* [Specific structural rescue strategy]
- *Connection to Q4:* [Bridging sentence]

**Q4 [Analyze]:** [Question text]
...
- *Follow-up probes:*
  ...
  - [Socratic probe]
- *If discussion stalls:* [Specific structural rescue strategy]
- *Connection to Q5:* [Bridging sentence]

**Q5 [Analyze/Evaluate]:** [Question text]
- *Bloom's level:* Analyze / Evaluate
- *Purpose:* [What this question forces students to do cognitively]
- *Expected responses:*
  - [Multiple legitimate interpretations -- list 2-3]
  - [Oversimplification to redirect]
- *Follow-up probes:*
  - [Deepening probe]
  - [Devil's advocate probe: "What would someone who disagrees say?"]
  - [Transfer probe]
- *If discussion stalls:* [Structural rescue]
- *Connection to Q6:* [Bridging sentence]

**Q6 [Evaluate]:** [Question text -- comparison or judgment question]
- *Bloom's level:* Evaluate
- *Purpose:* [Judgment-making; requires weighing evidence for competing interpretations]
- *Expected responses:*
  - [Position A with supporting reasoning]
  - [Position B with supporting reasoning]
  - [Nuanced "both/and" response to elevate]
- *Follow-up probes:*
  - [Deepening probe]
  - [Steelmanning probe]
  - [Evidence check probe]
- *If discussion stalls:* [Polling move or quick-write strategy]
- *Connection to closing:* [How this sets up synthesis]

---

### Closing Questions ([X] min)

**Q7 [Evaluate/Create]:** [Synthesis question connecting content to larger theme or contemporary context]
- *Purpose:* [What broader thinking this synthesizes]
- *Expected responses:*
  - [Thematic synthesis response]
  - [Personal connection response]
  - [Unexpected but valid direction]
- *Follow-up probe:* [One question only -- time is limited here]
- *Connection:* [How this connects to the next lesson, unit theme, or broader curriculum]

**Q8 [Create]:** [Generative closing question -- what question are you left with, or what would you do differently?]
- *Purpose:* Transfers ownership of inquiry to students; assesses what threads remain live
- *Expected responses:* [Range of questions students might raise -- helps teacher plan next lesson]
- *Note:* Do not open new substantive debate here. Acknowledge responses and note on board for next class.
...
**Talk Moves:**
| Move | Prompt | When to Use |
|------|--------|-------------|
| Revoicing | "So what you're saying is... Did I get that right?" | Student's point is strong but unclear; elevate it by paraphrasing |
| Evidence redirect | "Where in the text do you see that?" | Claim made without specific support |
| Counter-invite | "Who sees it differently?" | After a strong claim dominates; open the floor |
| Elaboration | "Can you say more about that?" | Surface-level response that has more depth available |
| Building | "Who can add to what [name] said?" | Redistribute participation; build on a strong contribution |
| Steelmanning | "What would someone who disagrees say?" | Force engagement with opposing view |
| Wait time | [7 seconds of silence -- do not fill it] | After any question; silence is processing, not failure |
| Parking lot | "That's an important connection -- let me write it here and we'll return to it." | Off-topic but valuable thread; don't discard or chase |

**Managing Participation:**
- *Dominant speakers:* After 2 contributions, use a hand signal (not public correction) to indicate "yield the floor." Announce the norm at the start: "Our goal is that everyone speaks at least once before anyone speaks a third time."
- *Quiet students:* Use structured think time (90 seconds of silent writing) before re-opening. In fishbowl: quiet students in the outer circle write a response they will share in debrief. Cold call only after think time has been given.
- *Mixed proficiency:* Post sentence starters: "I notice that...", "The text says..., which suggests...", "I want to build on what [name] said because...", "I see it differently because..."

**Handling Difficult Moments:**
- *Factually incorrect claim:* Do not correct directly. "Let's check that against the text -- can someone find a passage that addresses this?" If no one corrects it, read the passage yourself and ask what students make of it.
- *Harmful or biased statement:* Separate claim from person. "That's one interpretation that some people hold -- what does the text itself show us about how this operated?" Redirect from personal opinion to evidence.
- *Complete silence after 7 seconds:* Lower the abstraction. "Before we answer the big question, let's just describe what's happening in [specific scene]. [Name], what do you see there?"
- *Productive tangent:* Write it in the parking lot. "This is worth exploring. Let me note it here. For now, let's return to [specific question] -- [bridging move]."

---

### Assessment

**Observation Tally (Teacher Use During Discussion):**
Place student names across the top of a grid. Checkmark each contribution. Add a symbol for quality: E = evidence used, B = built on peer, Q = raised a question, P = perspective shift.

| Indicator | Exceeds (4) | Meets (3) | Developing (2) | Beginning (1) |
|-----------|-------------|-----------|----------------|---------------|
| Textual Evidence | Cites specific passage by location; analyzes language choices and their effect | References the text generally; makes connection between evidence and claim | Mentions text but does not connect it directly to claim | Makes claims without any reference to text |
| Building on Peers | Explicitly extends, challenges, or synthesizes a peer's idea with new evidence | Responds to peer ("I agree/disagree because...") with reasoning | Acknowledges peer but does not develop the connection | Speaks only independently; no peer references |
| Analytical Depth | Offers multiple interpretations; names complexity or contradiction; considers author's choices | Provides one interpretation with clear reasoning beyond plot summary | Offers a supported opinion; does not move beyond surface analysis | Summarizes without interpretation |
| Questioning | Raises a genuine question that reframes the discussion or opens a new thread | Asks a relevant clarifying question | Asks for factual confirmation already in the text | Does not raise questions |
| Perspective-Taking | Names and engages substantively with a view they disagree with | Acknowledges another interpretation exists | Identifies disagreement without engaging with it | Presents only own view as the only view |

**Student Self-Assessment (5 min at close):**
Provide this prompt on a slip of paper or verbally:
1. One specific contribution I made that moved the discussion forward: ___
2. One idea someone else said that changed or added to my thinking: ___
3. One question I still have: ___
```
...
1. **Never write a question set with fewer than 3 distinct Bloom's taxonomy levels represented.** A discussion that stays at Remember and Understand is recitation, not discussion. A discussion that jumps straight to Evaluate without establishing shared understanding collapses into unsupported opinion-sharing.

2. **Opening questions must be answerable by any student who engaged with the material in good faith.** If a student who read carefully but is not confident cannot answer Q1, the discussion has already failed to include the full class. Test each opening question against this standard before including it.

3. **Every core question must require evidence -- not opinion.** "Do you think Atticus was brave?" is an opinion question. "Is Atticus's behavior better characterized as courage or obligation? What textual evidence supports your reading?" is an evidence question. Rewrite every question that a student could answer entirely from personal feeling without referencing the content.

4. **Never write a compound question as a primary question.** "Why does the author use this structure and what effect does it have and how does that connect to the theme?" is three questions. The follow-up probes exist to pull the second and third questions out after students answer the first. Compound questions in the primary position confuse students about what to address.

5. **Question count must match the allocated time.** Use this calibration rule: each core question, with facilitation, typically runs 4-6 minutes. Opening questions run 2-3 minutes each. Closing questions run 3-4 minutes each. A 35-minute discussion supports 7-9 questions total. A 20-minute discussion supports 5-6 questions. Never write 12 questions for a 30-minute discussion -- questions will be rushed or skipped, breaking the sequencing logic.

6. **Always write follow-up probes as complete questions, not as topics.** "Evidence" is not a follow-up probe. "Where in the text do you find support for that interpretation?" is a follow-up probe. The facilitator must be able to say it aloud verbatim without constructing it under pressure.

7. **The closing question must not open a new substantive debate.** If the final question introduces a new idea that requires extensive discussion to answer, the guide has a design flaw. Closing questions synthesize -- they draw the threads together, they do not introduce a new thread.

8. **All questions must reference the specific content.** "What motivates this character?" is a generic template. "What motivates Atticus to take Tom Robinson's case when he knows the likely outcome?" is a specific discussion question. Generic questions produce generic discussion.

9. **Never include a rubric indicator for number of times spoken.** Assessing participation frequency rather than quality is the most common assessment mistake in discussion facilitation. It rewards performance over thinking, and it disadvantages students with language processing differences, ELL students, and students with anxiety.

10. **Always include a stall strategy for every core question.** Teachers under pressure default to answering their own questions when students go silent. The stall strategy must be concrete and structural -- a specific passage to read aloud, a polling move, a quick-write prompt, or a lowered-abstraction reframe -- so the teacher has a tool to use before the impulse to fill the silence wins.

11. **Questions about sensitive topics must include a sensitivity note directly on the question, not in a separate section.** A teacher running a seminar does not have time to cross-reference sections. If Q4 addresses racial violence, the sensitivity framing belongs directly in Q4's facilitation notes, immediately visible.

12. **The discussion guide is a teacher document, not a student handout.** Write with the teacher as the audience. Include the facilitation purpose, expected responses, and management strategies that a student should never see in advance. If the user asks to convert it to a student-facing document, that is a separate task.
...
- Replace "what do you think?" questions with "what does the evidence suggest?" questions -- this is not about suppressing students' views, it is about teaching students to argue from evidence rather than from identity
- Add a **"landing" norm**: before the discussion ends, all students should be able to articulate the strongest version of at least one view they did not hold coming in
- Include a "temperature check" instruction at the midpoint: "If voices are rising or students appear distressed, pause and acknowledge: 'This topic carries real weight. Let's take 60 seconds to write individually before we continue.'"
...
- Use structured pair talk before every core question -- ELL students need to rehearse ideas in a low-stakes context before the whole group hears them
- Pre-teach 3-5 key disciplinary vocabulary terms before the discussion begins; include these in the guide with brief definitions
- Allow students to reference notes or annotated texts during discussion -- ELL students who read in two languages often process meaning more slowly
...
- Specify response parameters: original posts 150-250 words, peer responses 75-100 words, minimum 2 peer responses per student
- Replace the facilitation toolkit with moderation guidelines: when to prompt for evidence, when to introduce a counter-perspective as a reply, when to synthesize threads in a mid-week instructor post
- The "closing question" becomes a synthesis reflection due after all discussion has closed, not in real time
...
- Limit total questions to 4-5; use only Remember, Understand, and early Apply levels
- Use physical discussion tokens (each student has 2 tokens to spend; place one on the table each time they speak) to manage participation and make equity visual
- Replace written facilitation notes with a list of sentence stems the teacher models aloud: "I think... because...", "I see...", "I wonder..."
- Replace the assessment rubric with a simple observation checklist: Did the student speak at least once? Did the student use a sentence starter? Did the student listen when peers spoke?
...
- Spend the first 8-10 minutes on a structured read-aloud of a key passage (300-500 words) that anchors the core questions; ask students to annotate as they hear it
- Replace the comprehension-based opening questions with immediate analysis of the passage heard: "What surprised you?" / "What questions does this raise?"
- Compress the question set: drop 2-3 core questions to maintain depth over breadth with reduced material
...
- Write separate role instructions for the outer circle: observers complete a structured note-taking protocol (what evidence was used, what questions were raised, what was left unaddressed)
- The outer circle debrief is its own facilitation moment -- include 2-3 debrief questions the teacher uses when rotating circles ("What pattern did the inner circle develop? What question would you have asked?")
- Opening questions must be answered by the full group before fishbowl begins -- use the opening phase as a whole-class warm-up, then move to fishbowl for core questions only
...
- Including a student facilitation guide (separate from the teacher guide) with 3-4 norms the student facilitator uses to manage the conversation
- Replacing teacher facilitation notes with student preparation prompts: "Before the seminar, find 2 pieces of evidence for this question and write 1 question you want to ask the group"
- Assessment shifts heavily toward self-assessment and peer assessment -- include a post-seminar peer feedback form with 2-3 specific criteria

---

## Example

**Input:** "I need discussion questions for a 9th grade world history class doing a Socratic seminar on the causes of World War I. 45-minute seminar. Students have read a 3-page excerpt on the alliance system, nationalism, and the assassination of Franz Ferdinand. They have the reading in front of them."

---

## Discussion Guide: Causes of World War I -- Alliance Systems, Nationalism, and the July Crisis

**Subject:** World History / Global Studies
**Grade/Level:** 9th Grade
**Format:** Socratic seminar (whole class circle, teacher as facilitator)
...
4. **Speak to the circle:** Direct your comments to the group, not just to the teacher.
