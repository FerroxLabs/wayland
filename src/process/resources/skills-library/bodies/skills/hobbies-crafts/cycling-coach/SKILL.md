...
name: cycling-coach
description: |
  Guide to road, mountain, and gravel cycling including bike fit, training plans, nutrition, maintenance, group riding etiquette, race preparation, and commuting.
  Use when the user asks about cycling coach, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of cycling coach or requires a different specialized skill.
license: Apache-2.0
metadata:
...
Before recommending a cycling approach:

1. What type of cycling interests you? (Road, mountain, gravel, commuting, touring, triathlon)
2. What is your experience level? (New to cycling / Casual rider / Intermediate / Competitive)
3. What is your fitness level? (Sedentary / Moderately active / Very fit / Athletic)
4. Do you own a bike? What type and age?
5. What are your goals? (Fitness, weight loss, commuting, century ride, racing, adventure)
6. How many hours per week can you ride? (2-3 / 4-6 / 7-10 / 10+)
7. What is your budget for a bike? ($300-500 / $500-1,500 / $1,500-4,000 / $4,000+)
8. What terrain is around you? (Flat, hilly, mountainous)
9. Do you have any injuries or physical limitations?
10. Will you ride solo, with a group, or both?
...
- **Race geometry**: Aggressive, aerodynamic position (Specialized Tarmac, Cervelo R5)
- **Budget**: Entry-level $800-1,500, enthusiast $1,500-4,000, high-end $4,000+
...
- **Travel**: Cross-country (100-120mm), trail (120-150mm), enduro (150-170mm), downhill (170-200mm)
- **Budget**: Entry $500-1,000, enthusiast $1,500-3,500, high-end $3,500+
...
- **Budget**: Entry $1,000-2,000, enthusiast $2,000-4,500
...
- Too high: Rocking hips, hamstring pain, knee pain at back of knee
...
- Finding the right saddle may take trying 2-3 options (many shops offer demo programs)
...
- **Focus**: Smooth pedaling, consistent cadence (80-95 RPM)
...
- **Recovery rides**: 2-3 easy rides (30-45 minutes, very easy effort)
...
- FTP (Functional Threshold Power): Your maximum sustainable power for 1 hour
...
- **Carbohydrate sources**: Energy gels (Gu, Clif), bars, fig newtons, rice cakes, bananas, dates
...
- Carry enough water for the route (plan refill stops on long rides)
...
- **A**ir: Tires properly inflated (check with gauge, not squeeze test)
  ...
  - Gravel: 35-50 PSI
- **B**rakes: Squeeze levers, check pad wear, ensure wheels stop
- **C**hain: Clean, lubricated, not stretched/rusted
- **Quick releases/thru-axles**: Tight and secure
...
4. Patch or replace tube
5. Check inside tire for thorn, glass, or wire (the cause)
6. Reinstall tube (slightly inflated for shape), seat tire bead
...
4. Wipe off excess (lube the rollers, not the outside of the chain)
...
- Multi-tool (hex keys, screwdriver, chain tool)
- Patch kit
- Phone with charge
- ID and cash/card
...
- **Hold your line**: Ride predictably, no sudden swerving
...
- **"Slowing!"**: Announce before braking
- **"Stopping!"**: Announce before stopping
- **Left arm behind back**: Mechanical issue, pulling off
- **Hand wave down**: Slow down
...
- Help riders with mechanicals (share tubes, tools, support)
- Do not half-wheel (riding half a bike length ahead of the person next to you, forcing them to speed up)
- Regroup at intersections and after hills
...
- **Time trial**: Individual effort against the clock
- **Gravel races**: Mixed surface, endurance, self-supported
- **Mountain bike races**: Cross-country, enduro, downhill
...
4. **Equipment check**: Tune bike, check tires, charge computer, test accessories
5. **Pre-ride logistics**: Registration, parking, start time, course map
6. **Race week**: Reduce training volume (taper), eat well, sleep well
7. **Race day**: Arrive early, warm up 15-20 minutes, start conservative (do not go out too fast)
...
- **Lock**: U-lock (Kryptonite, Abus) is most secure, cable lock for secondary
- **Rack and panniers**: Carry clothes, laptop, lunch (do not use a backpack if possible - back sweat)
- **Clothing**: Change at work, or bike-specific commuter clothing that looks professional
...
- Watch for car doors (the "door zone" is the #1 urban cycling hazard)
- Eye contact with drivers at intersections
- Take the lane when the road is too narrow to share safely
...
- May qualify for employer incentives or tax credits in some jurisdictions

## Safety Considerations

- **Helmet**: Always, for every ride, no exceptions. Replace after any crash.
- **Visibility**: Lights front and rear (even daytime), bright clothing, reflective elements
- **Road awareness**: Ride with traffic (never against), use bike lanes when available, signal turns
- **Mechanical safety**: Ensure brakes work before every ride
- **Weather**: Rain reduces visibility and braking; avoid riding in thunderstorms or on icy roads
- **Hydration and nutrition**: Bonking (running out of energy) can cause impaired judgment and crashes
- **ID and ICE**: Carry identification and emergency contact information on every ride
- **First aid**: Know how to treat road rash (clean thoroughly, keep moist, cover)

## Progression Path

1. **Phase 1**: Get a bike that fits, ride 2-3 times per week, 30-60 minutes, learn basic maintenance
2. **Phase 2**: Extend rides to 1-2 hours, join a group ride, develop nutrition strategy
3. **Phase 3**: Structured training, complete a century or other event goal, explore new terrain types
4. **Phase 4**: Racing or advanced riding, power meter training, bike travel
5. **Phase 5**: Multiple disciplines (road + gravel + mountain), bike touring, mentoring others
6. **Phase 6**: Competitive racing, coaching certification, long-distance touring, community advocacy

## Resources

- **Strava** (app): Activity tracking, segment competition, route finding, community
- **TrainerRoad / Zwift**: Indoor training platforms with structured plans
- **GCN (Global Cycling Network)** on YouTube: Technique, maintenance, reviews
- **Books**: "The Cyclist's Training Bible" by Joe Friel
- **Books**: "Zinn and the Art of Road Bike Maintenance" by Lennard Zinn
- **Apps**: Ride with GPS (route planning), Komoot (adventure cycling)
...
2. **Analyze context.** Review the information provided and identify key factors relevant to cycling coach
...
**Input:** "Help me with cycling coach for my current situation"

**Output:**

Based on your situation, here is a structured approach to cycling coach:
