---
name: burnout-risk-evaluator
description: |
  Evidence-based burnout risk assessment incorporating Maslach Burnout Inventory dimensions, environmental risk factors, early warning sign identification, and personalized intervention strategies for prevention and recovery.
  Use when the user asks about burnout risk evaluator, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of burnout risk evaluator or requires a different specialized skill.
license: Apache-2.0
metadata:
...
- Are you experiencing any physical symptoms (fatigue, insomnia, headaches, illness)?
- Do you feel emotionally exhausted at the end of most work days?
- Have you noticed changes in how you feel about your work or the people you work with?
- How many hours are you working per week?
- Do you have control over how you do your work?
- When was the last time you took genuine time off?
- Is your stress primarily work-related, or does it span multiple life domains?

## Understanding Burnout

### What Burnout Is (and Is Not)

Burnout is not just being tired. The WHO classifies burnout as an occupational phenomenon characterized by three dimensions:

1. **Emotional exhaustion:** Feeling drained, unable to cope, lacking energy for work
2. **Depersonalization/cynicism:** Detachment from work, negative or callous attitudes toward colleagues or clients, loss of idealism
3. **Reduced personal accomplishment:** Feeling ineffective, doubting the value of your work, declining productivity

**Burnout vs. Depression:** Burnout is context-specific (primarily work-related) while depression pervades all life domains. However, chronic burnout can develop into clinical depression. If you are experiencing persistent sadness, hopelessness, or loss of interest in ALL activities (not just work), please consult a mental health professional.
...
- [ ] Chest tightness, elevated heart rate at rest

### Emotional Warning Signs

- [ ] Dread on Sunday evening about Monday morning
- [ ] Crying more easily or feeling numb
- [ ] Irritability that leaks into non-work relationships
- [ ] Loss of joy in activities you used to enjoy
- [ ] Feeling trapped or hopeless about your situation
- [ ] Anxiety that does not match the actual threat level
- [ ] Emotional detachment from people you care about

### Behavioral Warning Signs

- [ ] Withdrawing from social activities
- [ ] Increased alcohol, caffeine, or substance use
- [ ] Procrastinating on tasks you previously handled easily
...
- [ ] Forgetfulness (missing meetings, losing things)
- [ ] Negative self-talk ("I can't do this," "What's the point")
- [ ] Cynicism about work, organization, or colleagues
- [ ] Black-and-white thinking about your situation
- [ ] Fantasizing about quitting without a plan

**Count your checks:** 0-3: Normal stress. 4-7: Elevated risk. 8+: High risk - take action now.
...
4. Reestablish one healthy habit that has lapsed (sleep, exercise, meals)
5. Set a hard stop time for work today and honor it
...
- Medical evaluation (rule out medical causes of fatigue)

### Long-Term Strategies (3-12 Months)

- Evaluate whether your current role and organization can change enough
- Develop a career plan that aligns work with values and strengths
- Build a financial buffer that reduces the fear of leaving
- Invest in relationships and identity outside of work
- Establish sustainable work practices that prevent recurrence

## Monthly Burnout Check-In

Track these monthly to detect trends:

```
Month: ___________  Date: ___________
...
One thing I will change next month:
_________________________________________________
```

**Trend alert:** If any score drops by 2+ points over two consecutive months, take immediate action. Do not wait for full burnout.
...
- You have been unable to improve despite consistent effort for 3+ months
...
2. **Analyze context.** Review the information provided and identify key factors relevant to burnout risk evaluator
...
```template
## Burnout Risk Evaluator Analysis
...
**Input:** "Help me with burnout risk evaluator for my current situation"

**Output:**

Based on your situation, here is a structured approach to burnout risk evaluator:
