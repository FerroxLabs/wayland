...
description: |
  Self-directed curriculum design including resource curation, milestone planning, accountability systems, progress tracking, and learning methodology for independent learners.
  Use when the user asks about learning path designer, or needs help with self-directed curriculum design including resource curation, milestone planning, accountability systems, progress tracking, and learning methodology for independent learners.
  Do NOT use when the request requires professional specialized advice or falls outside the scope of learning path designer.
license: Apache-2.0
metadata:
...
- Hit the "intermediate plateau" and lose motivation

This guide provides the system to prevent each of these failures.

### The Learning Path Lifecycle

```
1. DEFINE  -->  2. MAP  -->  3. RESOURCE  -->  4. EXECUTE  -->  5. ASSESS
   |                                                                  |
   +<----- 6. ITERATE (adjust based on assessment) ------<-----------+
```

## Phase 1: Define Your Learning Goal
...
Specific outcome: ________________________
Evidence of completion: __________________
  (How will I KNOW I have achieved this?)
Target date: _____________________________
Time available per week: ____ hours
Current knowledge level (1-10): ____
Why this matters to me: __________________
What I will DO with this knowledge: _______
```
...
4. What are the prerequisites for the prerequisites?

This creates a natural learning sequence.

## Phase 2: Map the Curriculum

### Skill Decomposition

Break your subject into components using this hierarchy:
...
DOMAIN (e.g., Web Development)
  ...
  |     +-- SKILL (e.g., React)
  |     |     |
  |     |     +-- SUB-SKILL (e.g., State Management)
  |     |     +-- SUB-SKILL (e.g., Component Architecture)
  |     |     +-- SUB-SKILL (e.g., Hooks)
  |     |
  |     +-- SKILL (e.g., CSS)
  |     +-- SKILL (e.g., HTML)
...
Identify which skills must come before others:

```
HTML/CSS --> JavaScript --> React --> Full-Stack Project
                |                          ^
                +--> Node.js --> Express ---+
                       |
                       +--> Databases -----+
...
Focus your learning path on high-frequency, high-impact skills first.

### Curriculum Template

```
LEARNING PATH: ________________________
Total estimated time: _____ hours
Target completion: ___________

MODULE 1: ________________________ (__ hours)
  Prerequisites: None
  Key skills: _______________________
  Milestone: ________________________

MODULE 2: ________________________ (__ hours)
  Prerequisites: Module 1
  Key skills: _______________________
  Milestone: ________________________

MODULE 3: ________________________ (__ hours)
...
CAPSTONE PROJECT: ________________________
  Combines: All modules
  Deliverable: ________________________
```

## Phase 3: Curate Resources
...
- [ ] **Practice**: Does it include exercises, projects, or assessments?
- [ ] **Completion rate**: Do people finish it? (For courses)
- [ ] **Author credibility**: Practitioner or academic? What is their background?
- [ ] **Format match**: Does it suit your learning style?
...
Do NOT collect 10+ resources per topic. This is procrastination disguised as preparation.
...
Total hours available: _____

Monday:    ___:___ to ___:___  Focus: ________________
Tuesday:   ___:___ to ___:___  Focus: ________________
Wednesday: ___:___ to ___:___  Focus: ________________
Thursday:  ___:___ to ___:___  Focus: ________________
Friday:    ___:___ to ___:___  Focus: ________________
Saturday:  ___:___ to ___:___  Focus: ________________
Sunday:    ___:___ to ___:___  Focus: ________________

Time distribution:
  Input (reading, watching, listening):  ___% (target: 30-40%)
  Practice (exercises, coding, writing): ___% (target: 40-50%)
  Review (spaced repetition, notes):     ___% (target: 10-20%)
  Reflection (journaling, planning):     ___% (target: 5-10%)
```
...
- Set micro-goals that show daily progress
...
Month: ___________
Hours invested this month: _____
Cumulative hours: _____

Module progress:
  Module 1: [=========>] 100% - Complete
  Module 2: [======>   ]  65% - On track
  Module 3: [          ]   0% - Not started

Milestones achieved: _________________
Current skill level (1-10): ____
Key wins this month: _________________
Key struggles: _______________________
Adjustments for next month: __________
On track for target date? [ ] Yes [ ] No
If no, new target date: ______________
```
...
- **Certifications**: When relevant and recognized
- **Presentations**: Teach a workshop or give a talk
...
4. Is the pace sustainable?
5. What has been the biggest obstacle?
6. What has been the most effective learning method?
7. Does the remaining plan need adjustment?
...
4. What is my focus for next week?
5. Is anything blocking my progress?
...
**Input:** "Help me get started with learning path designer"

**Output:** A structured learning path designer plan tailored to the user's specific situation, following the process outlined above.
