...
description: |
  Lease review guidance, security deposit rights, repair obligations, eviction process understanding, and tenant protections for informed renting decisions.
...
- [ ] Waiver of landlord's maintenance obligations
- [ ] Tenant responsible for ALL repairs regardless of cause
- [ ] Landlord can enter without notice
- [ ] No limit on late fees
- [ ] Non-refundable "security deposit" (may be illegal in your state)
- [ ] Tenant waives right to jury trial or to join class action
- [ ] Lease allows landlord to change terms unilaterally
- [ ] No specified process for returning the security deposit
- [ ] Automatic renewal with no opt-out window
- [ ] Tenant responsible for landlord's attorney fees in ALL disputes
...
4. Both you and landlord sign and date the checklist
...
4. Request a walk-through with the landlord (required in some states)
5. Return all keys, remotes, and access devices
...
1. Send a formal written demand for return of deposit (certified mail)
2. Reference your state's specific statute
3. Include your documentation (move-in/move-out photos, condition report)
4. Set a deadline for response (10-14 days)
5. If no response: file in small claims court
6. Many states award 2-3x the deposit amount as penalty for bad faith withholding
