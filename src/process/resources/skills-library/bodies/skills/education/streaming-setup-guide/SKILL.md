...
description: |
  Patient, step-by-step guidance for setting up and using streaming services like Netflix, YouTube, and music apps, including casting to TVs, sound system basics, troubleshooting common issues, and managing subscriptions.
  Use when the user asks about streaming setup guide, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of streaming setup guide or requires a different specialized skill.
license: Apache-2.0
metadata:
...
- What device do you want to watch or listen on (TV, tablet, phone, computer)?
- What is the brand and approximate age of your TV?
- Does your TV connect to the internet (Smart TV), or do you use a separate device?
- Do you have a Wi-Fi internet connection at home? Do you know the password?
- What streaming services are you interested in (Netflix, YouTube, Hulu, etc.)?
- Do you currently have any streaming subscriptions?
- Do you have anyone who can help with the initial physical setup if needed?
- What do you mostly want to watch (movies, news, sports, shows, music)?
...
- Monthly cost is typically less than cable
- You choose which services to subscribe to

## Setting Up Your TV for Streaming

### Option 1: Smart TV (TV Has Streaming Built In)
...
5. Enter your Wi-Fi password using the on-screen keyboard (this is the slowest part - take your time)
6. Select Connect
...
4. Open the app and follow the sign-in instructions on screen

### Option 2: Streaming Stick or Box

If your TV is older or does not have good built-in apps, a small device plugs into your TV and adds streaming.
...
3. Turn on your TV
4. Switch to the correct HDMI input (use the Input or Source button on your remote)
5. Follow the on-screen setup instructions
6. Connect to your Wi-Fi when prompted
...
## Major Streaming Services Guide
...
4. Create a password (use something you can remember, at least 8 characters)
5. Enter your payment information if required
6. Many services offer a free trial period - set a reminder before it ends

## Casting to Your TV

### What Casting Means

Casting means sending what is on your phone or tablet screen to your TV. You control what plays from your phone, but it appears on the big screen.
...
4. Tap the AirPlay icon (a rectangle with a triangle at the bottom)
...
2. Open the streaming app on your phone
3. Start playing what you want to watch
4. Tap the Cast icon (a rectangle with Wi-Fi waves in the corner)
5. Select your TV from the list
6. The video will appear on your TV

**Important:** Your phone and TV must be on the same Wi-Fi network for casting to work.
...
- Price range: $100-300 for a good one
...
5. On most Smart TVs, you can adjust subtitle size in the TV's accessibility settings

## Troubleshooting

### "It won't connect to Wi-Fi"

1. Make sure you are entering the correct Wi-Fi password (capital letters matter)
2. Restart your Wi-Fi router: unplug it, wait 30 seconds, plug it back in, wait 2 minutes
3. Restart your TV or streaming device: turn it off completely, wait 30 seconds, turn it back on
4. Move the router closer to the TV if possible (walls and distance weaken the signal)
...
4. Restart your router (unplug, wait 30 seconds, plug back in)

### "I can't find the right input on my TV"

1. Press the Input, Source, or HDMI button on your TV remote
2. Cycle through the inputs until you see the streaming device screen
3. Inputs are usually labeled HDMI 1, HDMI 2, HDMI 3
4. Check which HDMI port on your TV the device is plugged into (they are usually numbered)

### "I skipped my password"

1. On the sign-in screen, look for "skipped Password" or "Reset Password"
2. Enter your email address
3. Check your email for a reset link (check the Spam or Junk folder too)
4. Create a new password
5. Write it down and keep it somewhere safe

### "The remote stopped working"

1. Replace the batteries (this fixes most remote problems)
2. Point the remote directly at the TV
3. Try standing closer to the TV
4. If using a streaming device remote: remove batteries, wait 10 seconds, reinsert
5. Restart the TV by unplugging it for 30 seconds

## Managing Subscriptions

### Tracking What You Pay

Write down all your streaming subscriptions:

```
Service               Monthly Cost    Payment Method    Renewal Date
─────────────────────────────────────────────────────────────────────
[Service 1]           $              [Card ending in]   [Date]
[Service 2]           $              [Card ending in]   [Date]
[Service 3]           $              [Card ending in]   [Date]
─────────────────────────────────────────────────────────────────────
TOTAL MONTHLY:        $
```
...
- **Rotate services:** Subscribe to one or two at a time, watch what you want, then switch
- **Free trials:** Use them, but set a phone reminder to cancel before they charge you
- **Free services:** PBS, Pluto TV, Tubi, and YouTube (with ads) are completely free
- **Family plans:** Some services offer discounts for multiple people on one account
- **Annual plans:** If you know you will keep a service, the yearly price is usually cheaper
- **Library cards:** Many libraries provide free access to streaming services like Kanopy and Hoopla
...
4. Select Cancel
5. They will ask why - you can skip this
6. You usually keep access until the end of your current billing period
...
2. **Analyze context.** Review the information provided and identify key factors relevant to streaming setup guide
...
```template
## Streaming Setup Guide Analysis
...
**Input:** "Help me with streaming setup guide for my current situation"

**Output:**

Based on your situation, here is a structured approach to streaming setup guide:
