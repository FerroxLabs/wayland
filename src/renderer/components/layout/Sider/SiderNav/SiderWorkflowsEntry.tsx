...
interface SiderWorkflowsEntryProps {
  isMobile: boolean;
  isActive: boolean;
  collapsed: boolean;
...
const SiderWorkflowsEntry: React.FC<SiderWorkflowsEntryProps> = ({
  isMobile,
  isActive,
  collapsed,
  siderTooltipProps,
  ...
  const label = t('workflows.siderEntry', { defaultValue: 'Workflows' });
...
export default SiderWorkflowsEntry;
