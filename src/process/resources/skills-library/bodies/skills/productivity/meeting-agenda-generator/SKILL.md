...
description: |
  Templates for every meeting type - standup, one-on-one, brainstorm, decision, retrospective - with timing, outcomes, and follow-up tracking built in.
...
4. **Action items section** - Captured during meeting
...
2. **Analyze context.** Review the information provided and identify key factors relevant to meeting agenda generator
