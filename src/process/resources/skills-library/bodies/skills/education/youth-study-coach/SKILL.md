...
2. **Analyze the situation.** Review the information provided and identify key factors, challenges, and opportunities relevant to youth study coach.
...
This skill provides direct, student-facing homework support -- like having a tutor sitting next to the student. The tone should be encouraging, patient, and age-appropriate. For parent-facing guidance on building homework systems and routines, see the Homework Strategies skill.

## Questions to Ask First

1. What grade are you in?
2. What subject or assignment do you need help with?
3. What part is tricky -- understanding the concept, getting started, staying focused, or finishing on time?
4. Do you have any learning accommodations (IEP, 504 plan)?
5. When is this due?
6. What have you already tried or completed?
7. Do you have your textbook, class notes, or the assignment rubric?
8. How do you feel about this subject generally?
9. Would you like me to explain things step by step, or ask you guiding questions to help you figure it out?
10. Is this a one-time question, or do you keep running into trouble with this subject?

---

## Core Approach: Help You Learn, Not Just Get Answers
...
- "Does your answer make sense? How could you check?"
...
- You are running out of time (but flag the gap for later review)

---

## Phase 1: Study Environment Setup

### Physical Environment Checklist

- [ ] Dedicated workspace (desk, table -- same place each day)
- [ ] Good lighting (avoid dim or harsh fluorescent)
- [ ] Comfortable but not too comfortable chair (not bed or couch)
- [ ] All needed materials within reach (pencils, paper, calculator, textbook)
- [ ] Water bottle nearby
- [ ] Phone put away or in another room (biggest single distraction)
- [ ] Computer available if needed (with non-essential tabs closed)
- [ ] Background noise minimized (no TV, consider white noise or quiet music without lyrics)
...
- Open only tabs related to the assignment
- Bookmark reference sites for quick access
...
## Phase 2: Time Management for Students

### The Homework Planning Process

**Step 1: Brain Dump**
Write down every assignment, test, and project (all subjects).

**Step 2: Prioritize**
| Priority | Criteria | Action |
|----------|----------|--------|
| Urgent + Hard | Due soon, requires the most effort | Do first |
| Urgent + Easy | Due soon, quick to complete | Do second |
| Not Urgent + Hard | Due later, requires effort | Start early, break into parts |
| Not Urgent + Easy | Due later, quick | Schedule for later |

**Step 3: Time Estimate**
For each assignment, estimate how long it will take (students tend to underestimate -- help them learn to be realistic).

**Step 4: Schedule**
Block time for each assignment. Include short breaks.
...
========================
Name: _______________ Week of: _______________

Day     | Subject    | Assignment         | Due Date | Est. Time | Done?
--------+------------+--------------------+----------+-----------+------
Monday  | __________ | __________________ | ________ | _________ | [ ]
        | __________ | __________________ | ________ | _________ | [ ]
Tuesday | __________ | __________________ | ________ | _________ | [ ]
        | __________ | __________________ | ________ | _________ | [ ]
Wednesday| _________ | __________________ | ________ | _________ | [ ]
        | __________ | __________________ | ________ | _________ | [ ]
Thursday| __________ | __________________ | ________ | _________ | [ ]
        | __________ | __________________ | ________ | _________ | [ ]
Friday  | __________ | __________________ | ________ | _________ | [ ]
        | __________ | __________________ | ________ | _________ | [ ]

Long-term projects/upcoming tests:
1. _________________________________ Due: ________
2. _________________________________ Due: ________
```

---

## Phase 3: Subject-Specific Support Strategies
...
4. **Use concrete examples** -- relate abstract concepts to real objects or situations
5. **Show multiple methods** -- there is often more than one way to solve a problem
6. **Work backward** -- start from the answer and check if the process makes sense
7. **Look for patterns** -- math is built on patterns and relationships
8. **Practice similar problems** -- one problem understood is not mastery

**Resources:** Khan Academy, IXL, Photomath (for checking work, not for copying), Desmos (graphing calculator).
...
4. **Revise for content and organization** (does it make sense? is it logical?)
5. **Edit for grammar, spelling, punctuation**
...
- [ ] Is there evidence or examples supporting each point?
- [ ] Are transitions between paragraphs smooth?
- [ ] Does the conclusion wrap up the main idea?
- [ ] Is the language appropriate for the assignment?
...
4. **Explain the "why" not just the "what"** -- science is about understanding processes
5. **Lab reports:** Follow the structure (purpose, hypothesis, materials, procedure, data, analysis, conclusion)

**Resources:** CK-12, Crash Course (YouTube), PhET simulations, National Geographic Kids (younger students).
...
4. **Focus on cause and effect** rather than memorizing dates
5. **Make connections to current events** when possible
...
4. **Grammar patterns** -- look for rules, not memorize every conjugation
5. **Context clues** before looking up every word
6. **Immersion resources** -- music, shows, podcasts in the target language

---

## Phase 4: Grade-Level Communication Strategies
...
- Make it a game whenever possible
...
- Allow reasonable independence with check-ins
- Introduce basic organizational tools (planner, checklist)
...
- Encourage self-advocacy (asking teachers for help)
...
- Know when to suggest tutoring or teacher office hours

---

## Phase 5: Motivation Techniques
...
**Instead of:** "This is easy" --> **Try:** "I can see you're putting in effort"
**Instead of:** "You got it wrong" --> **Try:** "That's not quite right yet. Let's figure out why."
**Instead of:** "I can't help you with this" --> **Try:** "Let's figure this out together"
**Instead of:** "Just try harder" --> **Try:** "Let's try a different approach"
...
- Long-term goal connection (college, career interests)

**Best practice:** Move from external rewards toward intrinsic motivation over time. The goal is self-direction, not compliance for a prize.
...
- **Ask a parent or guardian** to help you find a tutor if the gap is persistent
...
- **Grades 9-12:** You should be driving your own learning. Seek out resources yourself.
...
4. Use spaced repetition (review a little each day)
5. Practice retrieval (test yourself rather than re-reading)
6. Teach the material to someone else (strongest learning technique)
