...
description: |
  Design and develop courses, worksheets, videos, quizzes, and interactive educational content for diverse learning environments and audiences.
  Use when the user asks about educational content creator, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of educational content creator or requires a different specialized skill.
license: Apache-2.0
metadata:
...
- What is the learning objective this content must support?
- Who is the target audience (age, skill level, context)?
- What format is needed (worksheet, video, quiz, full course, interactive module)?
- What delivery platform will be used (LMS, print, video hosting, app)?
- What is the scope (single lesson, unit, full course)?
- What existing content can be built upon or must be aligned with?
- What accessibility requirements must be met?
- What is the timeline and budget?
- How will the effectiveness of this content be measured?

## Course Design

### Course Development Process

1. **Analysis**: Define audience, objectives, constraints, and success criteria
2. **Design**: Create the course outline, learning path, and assessment strategy
3. **Development**: Build content modules, activities, and assessments
4. **Review**: Conduct quality checks, peer review, pilot testing
5. **Implementation**: Deploy content and train facilitators
6. **Evaluation**: Collect data, gather feedback, iterate
...
Learning Outcomes:
  ...
  1. [Outcome using measurable verb]
  2. [Outcome using measurable verb]
  3. [Outcome using measurable verb]
...
Final Assessment:
  ...
  Criteria: [Reference to rubric]

Resources Required:
  - [List of materials, tools, access needs]
```
...
### Effective Worksheet Principles

- **Clear purpose**: Every worksheet should support a specific learning objective
- **Appropriate challenge**: Match the difficulty to the learner's level
- **Progressive structure**: Start with simpler items and build to more complex
- **Variety**: Mix question types to maintain engagement
- **White space**: Do not overcrowd; leave room for work and thought
- **Clear instructions**: State exactly what is expected for each section
- **Visual appeal**: Use consistent formatting, readable fonts, and purposeful graphics

### Worksheet Structure Template

```
Title: [Descriptive title]
Subject / Topic:
Objective: [What the learner should be able to do after completing this]
Estimated Time: [Minutes]

Section 1: Warm-Up / Review (3-5 items)
  Purpose: Activate prior knowledge
  Format: [Quick recall, matching, or fill-in]

Section 2: Guided Practice (3-5 items)
  Purpose: Apply new concepts with support
  Format: [Worked examples with blanks, step-by-step prompts]

Section 3: Independent Practice (5-10 items)
  Purpose: Demonstrate understanding independently
  Format: [Problem-solving, short answer, application]

Section 4: Challenge / Extension (2-3 items)
  Purpose: Stretch thinking for students who are ready
  Format: [Open-ended, multi-step, real-world application]

Section 5: Reflection
  Purpose: Metacognitive processing
  Prompt: "What was the most important thing you learned? What is still confusing?"
```
...
- [ ] Script or detailed outline written
- [ ] Visual aids and graphics planned
- [ ] Recording environment prepared (lighting, audio, background)
- [ ] Equipment tested (camera, microphone, screen recording software)
- [ ] Accessibility plan in place (captions, transcript, audio description)
...
- Clean your desktop and close unnecessary applications
- Use a consistent cursor style and movement speed
- Zoom in on areas of focus
- Narrate every action as you perform it
- Pause briefly before and after key steps
- Record in short segments and edit together
- Add annotations or callouts for emphasis
...
- Randomize answer options when possible
- Provide feedback for both correct and incorrect responses
- Include a mix of difficulty levels
- Test application, not just memorization

### Multiple Choice Question Checklist

- [ ] Stem is a clear, complete question or statement
...
- [ ] "All of the above" and "None of the above" are avoided
- [ ] Options are roughly the same length
- [ ] Only one correct answer exists (unless it is a select-all question)
- [ ] The question tests meaningful knowledge, not trivia
...
- [ ] Every interaction serves a learning purpose (not just clicking for the sake of clicking)
- [ ] Instructions for interaction are clear and visible
- [ ] Feedback is immediate and informative
- [ ] Content is accessible via keyboard and screen reader
- [ ] Fallback content exists for environments where interactivity is not supported
- [ ] Load times are reasonable on standard connections
- [ ] Mobile compatibility has been tested
- [ ] Progress saves if the learner leaves and returns
...
1. Select 3-5 representative learners from the target audience
2. Have them work through the content independently
3. Observe where they struggle, get confused, or disengage
4. Collect written feedback on clarity, difficulty, and engagement
...
2. **Analyze context.** Review the information provided and identify key factors relevant to educational content creator
...
```template
## Educational Content Creator Analysis
...
**Input:** "Help me with educational content creator for my current situation"

**Output:**

Based on your situation, here is a structured approach to educational content creator:
