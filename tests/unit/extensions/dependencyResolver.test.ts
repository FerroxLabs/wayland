...
describe('extensions/dependencyResolver', () => {
  it('should return a valid result with correct load order when all dependencies are satisfied', () => {
    const extensions = [
  ...
  it('should report missing dependencies and version mismatch issues', () => {
    const extensions = [
  ...
  it('sortByDependencyOrder should sort by loadOrder, with unknown items placed at the end', () => {
