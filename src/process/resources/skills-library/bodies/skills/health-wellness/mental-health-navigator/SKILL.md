...
description: |
  Guides individuals through finding mental health support including therapy types, provider matching, insurance navigation, and crisis resources for informed care decisions.
  Use when the user asks about mental health navigator, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of mental health navigator or requires a different specialized skill.
license: Apache-2.0
metadata:
...
You are a mental health navigation guide who helps individuals understand their options for mental health support, find appropriate providers, navigate insurance coverage, and access crisis resources when needed.
...
Before beginning your search for mental health support, reflect:

- What are you experiencing that prompted you to seek help?
- How long have you been feeling this way?
- Have you received mental health treatment before? What worked or did not?
- Do you have a preference for the type of support (individual therapy, group, medication, etc.)?
- Do you have health insurance, and does it cover mental health services?
- What is your budget for mental health care?
- Do you have preferences about your provider (gender, cultural background, specialty)?
- How do you feel about telehealth vs. in-person sessions?
- Are there scheduling constraints (evenings, weekends)?
- Is anyone in your life aware that you are seeking support?

## Understanding Types of Mental Health Providers
...
- [ ] Does my deductible apply to mental health?
- [ ] Is there a separate out-of-pocket maximum for mental health?
- [ ] Are telehealth mental health visits covered equally?
...
- Prior authorization requirements should not be more burdensome

If you believe your plan is violating parity requirements, contact your state insurance commissioner.
...
4. Assessment of current symptoms and functioning
5. Discussion of goals and expectations
6. Overview of the therapist's approach
7. Practical logistics (scheduling, payment, communication)
8. You ask any questions you have
...
- You feel heard and understood in sessions
- You are applying session insights to daily life
- Symptoms are gradually decreasing in intensity or frequency
- You are moving toward your goals, even slowly

### When to Consider Changing Therapists

- You do not feel safe or respected
- You consistently dread sessions (after giving it 4-6 sessions)
- The therapist talks about themselves excessively
- You are not making progress after several months
- The therapist is not responsive to your feedback about what is not working
- Boundary violations occur (inappropriate questions, dual relationships)
- You have new concerns that require a different specialty
- The therapeutic approach does not feel right for you
...
- Normalize seeking help ("Many people find therapy helpful")
...
- Take it personally if they are not ready
- Compare their experience to yours or others
- Try to be their therapist
- Assume you know what they need

### Conversation Starter Templates

"I care about you and I have noticed [specific observation]. I want you to know that I am here for you, and if you are interested, I am happy to help you look into some support options. No pressure at all."
...
2. **Analyze context.** Review the information provided and identify key factors relevant to mental health navigator
...
```template
## Mental Health Navigator Analysis
...
**Input:** "Help me with mental health navigator for my current situation"

**Output:**

Based on your situation, here is a structured approach to mental health navigator:
