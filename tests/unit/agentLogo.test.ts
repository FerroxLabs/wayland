...
import { agentLogoDarkFilter, getAgentLogo, resolveAgentLogo } from '../../src/renderer/utils/model/agentLogo';

describe('agentLogo', () => {
  describe('agentLogoDarkFilter', () => {
    ...
    it('applies no filter on the light theme (monochrome logos are visible)', () => {
      setTheme('light');
      expect(agentLogoDarkFilter('codex')).toBeUndefined();
      expect(agentLogoDarkFilter('kimi')).toBeUndefined();
    });
