...
export { toAgentMailSendBody, toUnifiedIncomingFromAgentMail } from './tier1/email-agentmail/EmailAgentMailAdapter';
export type { AgentMailInboundPayload, AgentMailSendBody } from './tier1/email-agentmail/EmailAgentMailAdapter';
...
export { MATRIX_MESSAGE_LIMIT, splitMatrixMessage, toUnifiedIncomingFromMatrix } from './tier2/matrix/MatrixAdapter';
