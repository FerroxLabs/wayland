...
description: |
  Guide to antique identification and appraisal covering authentication methods, valuation factors, market analysis, condition assessment, and navigating the antiques marketplace for buyers, sellers, and collectors.
  Use when the user asks about antique appraiser, related techniques, best practices, or needs guidance in this domain.
  Do NOT use when the request is outside the scope of antique appraiser or requires a different specialized skill.
license: Apache-2.0
metadata:
...
- What type of item are you inquiring about? (furniture, ceramics, glass, silver, jewelry, art, textiles, tools, toys, other)
- Can you describe the item in detail? (size, materials, colors, decorative elements)
- Are there any markings, stamps, labels, or signatures on the item?
- What is the overall condition? (any damage, repairs, alterations, missing parts)
- How did you acquire it? (inheritance, purchase, estate sale, found)
- Do you know or suspect its approximate age?
- What is your goal? (sell, insure, donate, satisfy curiosity, add to collection)
- Do you have photographs available, especially of any marks or damage?

## Important Disclaimers

- Remote appraisal based on descriptions and photographs has significant limitations
- Formal appraisals for insurance, estate, or tax purposes must be conducted in person by a qualified, credentialed appraiser
- Market values fluctuate based on trends, regional demand, and economic conditions
- Authentication of high-value items requires physical examination and sometimes scientific testing
- This guidance provides educational frameworks for understanding value, not certified appraisals
...
- Straight saw marks (up-and-down): pre-1830s
- Wire nails: post-1890s
- Cut nails (square and tapered): 1790s-1890s
- Hand-forged nails (irregular): pre-1790s
...
- Specific wood species correlate with periods and regions
...
- Reproductions of popular styles were produced in every subsequent era
...
- Absence of marks does not mean low quality or value
...
- Continental European silver has national assay marks
...
- Perfect condition on an item claimed to be very old
- Marks that appear freshly applied or do not match known patterns
- Provenance stories that cannot be verified
- Price that seems too good to be true for a genuine example
- Consistent patina throughout (genuine aging is uneven)
...
- Limited production pieces command premiums
...
- Completeness matters (all original parts, matching sets)
...
- Original receipts, photographs, or documentation
...
- Cross-collector appeal (items interesting to multiple collecting categories)
...
- Maker or brand reputation
- Position within the maker's body of work (masterpiece vs. ordinary production)
...
- Competition among bidders can drive prices above estimates
- Major auction houses handle primarily high-value items
...
- Authentication concerns for buyers reduce prices on high-end items
...
- Small decorative items generally outperform large furniture (shipping and space considerations)
- Provenance and condition matter more than ever
- The market for common, undistinguished antiques has declined significantly
...
4. Visit antique shows and shops to see current asking prices
5. Join collector communities and forums for category-specific knowledge
6. Remember: asking price is not selling price; focus on actual sale data
...
- Photographs documenting the item and any marks
- Comparable sales data supporting the valuation
- Statement of value type (fair market value, replacement value, liquidation value)
- Appraiser's qualifications and signature
- Date of appraisal (values are time-specific)
...
- Learn from mistakes (every collector has made regrettable purchases)
- Build relationships with knowledgeable dealers
- Handle as many items as possible to develop your eye and feel for quality
...
- Do not assume age equals value (many old items have little market value)
- Buy from reputable sources who stand behind their attributions
- Keep all receipts and documentation for provenance
...
- Dust regularly with soft, lint-free cloths
- Do not use harsh cleaners or polishes on antique surfaces
- Store textiles flat or rolled on acid-free tubes, never folded
- Inventory and photograph your collection annually for insurance purposes
- Update insurance appraisals every 3-5 years or when the market shifts significantly

## Common Mistakes to Avoid

- Assuming family lore about age or value is accurate without verification
- Cleaning or polishing aggressively (removing original patina destroys value)
- Attempting amateur repairs on valuable items
- Relying on a single source for valuation
- Confusing sentimental value with market value
- Ignoring condition issues when assessing value
- Assuming all old things are valuable (most are not)
- Paying retail prices when buying for investment
...
2. **Analyze context.** Review the information provided and identify key factors relevant to antique appraiser
...
**Input:** "Help me with antique appraiser for my current situation"

**Output:**

Based on your situation, here is a structured approach to antique appraiser:
