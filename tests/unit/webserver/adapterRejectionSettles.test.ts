...
// The confirmation answer key — wire-allowed (a paired WebUI answering an
// ordinary prompt is a feature).
...
describe('webserver adapter - rejected bridge invocations settle the caller (#684)', () => {
  ...
  it('an ordinary remote confirmation is dispatched normally', () => {
    const ws = makeWs();
